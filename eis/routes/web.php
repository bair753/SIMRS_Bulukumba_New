...
//    Route::get('/bed', "Auth\AuthController@showIndex")->name("home");
    ...
    Route::get('/get-detail-kamar','MainController@getPasienMasihDirawat');
    Route::get('/get-detail-layanan','MainController@getDetailLayanan');
    Route::get('/get-detail-im','MainController@getDetailImArog');
    Route::get('/get-detail-om','MainController@getDetailOmArog');
    Route::get('/arogya','MainController@getArogya');

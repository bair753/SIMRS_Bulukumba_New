                                            ...
                                            <div class="col-md-12">
                                                <div class="table-responsive" >
                                                    <table id="t_Stok" class="table  table-striped table-sm table-styling"
                                                        ...
                                                        <tbody>
                                                         @php
                                                            $res['stok'] = App\Http\Controllers\MainController::getInfoStok(request()->get("tglawal"),request()->get("tglakhir"),session('kdProfile'));
                                                        @endphp
                                                        @php
                                                            $total=0;
                                                            $sama = false;
                                                            ...
                                                            foreach ($resultSumDep as $key => $row) {
                                                                $count[$key] = $row['qtyproduk'];
                                                            }
                                                            if(count($resultSumDep) > 0){
                                                                array_multisort($count, SORT_DESC, $resultSumDep);
                                                            }                                                                                                                                                                               
                                                        @endphp

...
@section('content-body')
                                                        ...
                                                        <table class="table  table-striped table-sm table-styling" id="t_Layanan"
                                                            ...
                                                            @forelse($resultSumDep as $i => $d)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td >{{ $d['dokter'] }}</td>
                                                                    <td >{{ $d['count'] }}</td>
                                                                    <td ><a href='#'   class="btn btn-primary btn-outline-primary btn-mini click-layanan"
                                                                        data-dokter="{{ $d['iddokter'] }}"
                                                                        nama-dokter="{{ $d['dokter'] }}" >
    ...
    <div class="modal fade" id="modalLayanan" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg"  role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><span id="titleModalLayanan"></span></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" id="load_layanan">
                </div>
...
@section('javascript')
    <script>
        ...
        $(".click-layanan").click(function(e) {
            e.preventDefault();
            var dokter = $(this).attr("data-dokter");
            var nama = $(this).attr("nama-dokter");
            
            document.getElementById("titleModalLayanan").innerHTML =   nama
            $.ajax({
                type    : 'GET',
                url     : APP_URL+'/get-detail-layanan',
                data    : { dokter:dokter},
                success : function(respond){
                    $('#modalLayanan').modal("show");
                    $("#load_layanan").html(respond);
                }
            })

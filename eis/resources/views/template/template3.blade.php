...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('comp/bower_components/bootstrap/css/bootstrap.min.css') }}">
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('comp/assets/icon/font-awesome/css/font-awesome.min.css') }}">
    <!-- Data Table Css -->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('comp/bower_components/datatables.net-bs4/css/dataTables.bootstrap4.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('comp/assets/pages/data-table/css/buttons.dataTables.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('comp/bower_components/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('comp/assets/pages/advance-elements/css/bootstrap-datetimepicker.css') }}">
    <!-- Date-range picker css  -->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('comp\bower_components\bootstrap-daterangepicker\css\daterangepicker.css') }}">
    <!-- Date-Dropper css -->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('comp\bower_components\datedropper\css\datedropper.min.css') }}">
    <!-- Color Picker css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('comp\bower_components\spectrum\css\spectrum.css') }}">
    <!-- Mini-color css -->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('comp\bower_components\jquery-minicolors\css\jquery.minicolors.css') }}">
    <!-- radial chart -->
    <link rel="stylesheet" href="{{ asset('comp\assets\pages\chart\radial\css\radial.css') }}" type="text/css"
        media="all">
    <!-- Style.css -->
    ...
    <style>
        ...
        .pcoded .pcoded-header .navbar-logo[logo-theme="theme1"] {
            background-color: var(--v-bulukumba);
        }

        .pcoded .pcoded-header[header-theme="theme6"] {
            background: var(--v-bulukumba);
        }
    ...
    <script type="text/javascript" src="{{ asset('comp\bower_components\jquery-slimscroll\js\jquery.slimscroll.js') }}">
    </script>

    <!-- Bootstrap date-time-picker js -->
    <script type="text/javascript" src="{{ asset('comp\assets\pages\advance-elements\moment-with-locales.min.js') }}">
    </script>
    <script type="text/javascript"
        src="{{ asset('comp\bower_components\bootstrap-datepicker\js\bootstrap-datepicker.min.js') }}"></script>
    <script type="text/javascript"
        src="{{ asset('comp\assets\pages\advance-elements\bootstrap-datetimepicker.min.js') }}"></script>


    <!-- Date-range picker js -->
    <script type="text/javascript"
        src="{{ asset('comp\bower_components\bootstrap-daterangepicker\js\daterangepicker.js') }}"></script>
    ...
    <!-- Mini-color js -->
    <script type="text/javascript"
        src="{{ asset('comp\bower_components\jquery-minicolors\js\jquery.minicolors.min.js') }}"></script>
    ...
    <script src="{{ asset('comp\bower_components\datatables.net-responsive\js\dataTables.responsive.min.js') }}">
    </script>
    <script src="{{ asset('comp\bower_components\datatables.net-responsive-bs4\js\responsive.bootstrap4.min.js') }}">
    </script>

    <!-- i18next.min.js -->
    <script type="text/javascript" src="{{ asset('comp\bower_components\i18next\js\i18next.min.js') }}"></script>
    <script type="text/javascript"
        src="{{ asset('comp\bower_components\i18next-xhr-backend\js\i18nextXHRBackend.min.js') }}"></script>
    <script type="text/javascript"
        src="{{ asset('comp\bower_components\i18next-browser-languagedetector\js\i18nextBrowserLanguageDetector.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('comp\bower_components\jquery-i18next\js\jquery-i18next.min.js') }}">
    </script>
    ...
    white-space: nowrap;">
                            ...
                            <span style="font-size: 18px; margin-left: 20px;font-weight: bold;padding-top: 10px;">
                                ...
                                <div class="white--text"
                                    ...
                                    <div style="font-size: 1.5rem;">{!! $configData['namaProfile'] !!}</div>
                                    <div style="font-weight: 300;">{!! $configData['project'] !!}</div>
                                </div>
                        </a>

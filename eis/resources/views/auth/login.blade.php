...
">
                <div class="card p-4">
                    <div class="card-body">
                        ...
                        <!--     <span id="captcha" hidden></span>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <button  class="btn btn-info px-4" type="submit" id="btnMasuk" style="background-color: var(--v-bulukumba);">Continue</button>
            ...
            <div class="card text-white  py-5 d-md-down-none" style="width:44%;background-color: var(--v-bulukumba);">
                <div class="card-body ">
                    ...
                    <div style="margin-top: -20px">
                        ...
                        <h1 style="color:white">Executive Information System </h1>
                            <!-- <img src="{{ asset('images/logo-bw.png')}}" alt="Image" style="width: 100px"> -->

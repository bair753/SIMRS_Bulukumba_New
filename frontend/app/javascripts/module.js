define(['ApiService', 'Configuration', 'require', 'config', 'Controller', 'AngularRoute', 'OcLazyLoad', 'header', 'HeaderService', 'HttpService', 'core', 'AngularUIRouter', 'AngularAnimate', 'EventRouteState', 'ComponentDirective', 'routing', 'AngularFilter', 'LoginService'],
    function(ApiService,  configuration, require, config, Controller, ngRoute, lazy, header, headerService, httpService, core, AngularUIRouter, AngularAnimate, EventRouteState, ComponentDirective, routing, AngularFilter, LoginService) {
        'use strict';
        var app = angular
            .module('myApp', ['ApiService', 'ui.router', 'ngAnimate', 'ngRoute', 'core', 'kendo.directives', 'oc.lazyLoad', 'Headers', 'HttpServices', 'ui.router', 'EventRouteState', 'ComponentDirective', 'btford.socket-io', 'angular.filter', 'ngMaterial', 'ngSanitize', 'LoginServices'])

define(['Configuration', 'jQuery', 'kendo.angular',
    ...
    var core = angular.module('core', ["kendo.directives", 'btford.socket-io', 'HttpServices'])
        .factory('socket', function(socketFactory) {
            ...
            var myIoSocket = null;
            if(configuration.aktifkanSocket != undefined && configuration.aktifkanSocket == true ){
                try{
    ...
    .directive('coreLoginWindow', ['socket','$http', function(socket,$http) {
            ...
            return {
                ...
                link: function(scope) {
                    ...
                    //     $http({
                    //         method: 'GET',
                    //         url:configuration.baseApiBackend + 'get-profile-login'
                    //     }).then(function (response) {
                    //         scope.image = response.data.profile;  
                    //     })
                    // }
                    // scope.onload()

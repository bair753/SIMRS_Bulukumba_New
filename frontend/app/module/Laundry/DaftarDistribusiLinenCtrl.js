define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarDistribusiLinenCtrl', ['$scope', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($scope, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            function LoadCache() {
                var chacePeriode = cacheHelper.get('DaftarDistribusiLinenCtrl');
            ...
            function init() {
                ...
                cacheHelper.set('DaftarDistribusiLinenCtrl', chacePeriode);

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanDistribusiLinenCtrl', ['$scope', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($scope, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            function LoadCache() {
                var chacePeriode = cacheHelper.get('LaporanDistribusiLinenCtrl');
            ...
            function init() {
                ...
                medifirstService.get("laundry/get-data-laporan-distribusi-linen?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +
                    "&kelompokTransaksi=" + 120 + rg + ra, true).then(function (dat) {
                        $scope.isRouteLoading = false;                        
                ...
                cacheHelper.set('LaporanDistribusiLinenCtrl', chacePeriode);
            ...
            $scope.columnGrid = {
                ...
                excel: {
                    fileName: "LaporanDistribusiLinen.xlsx",
                    allPages: true,
                },
                excelExport: function (e) {
                    ...
                    var myHeaders = [{
                        value: "Laporan Distribusi Linen",
                        fontSize: 20,
                        textAlign: "center",
                        background: "#ffffff",
                        // color:"#ffffff"

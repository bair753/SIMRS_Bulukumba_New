define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanPencucianLinenCtrl', ['$scope', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($scope, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            function LoadCache() {
                var chacePeriode = cacheHelper.get('LaporanPencucianLinenCtrl');
            ...
            function init() {
                ...
                cacheHelper.set('LaporanPencucianLinenCtrl', chacePeriode);
            ...
            $scope.columnGrid = {
                ...
                excel: {
                    fileName: "LaporanPencucianLinen.xlsx",
                    allPages: true,
                },

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('InventarisLinenCtrl', ['$sce', '$rootScope', '$scope', 'ModelItem', 'DateHelper', '$state', 'MedifirstService','CacheHelper',
        function ($sce, $rootScope, $scope, ModelItem, dateHelper, $state, medifirstService,cacheHelper) {
            ...
            var init = function () {
                ...
                medifirstService.get('laundry/get-combo-laundry').then(function (data) {
                    ...
                    $scope.item.kelompokBarang = { id: 15, kelompokproduk: 'Pelayanan Laundry' }
                })
            }
            init();

define(['initialize'], function (initialize) {
	'use strict';
	initialize.controller('InformasiJadwalPemeliharaanCtrl', ['$rootScope', '$scope', 'ModelItem', 'DateHelper', 'MedifirstService',
		function ($rootScope, $scope, ModelItem, dateHelper, medifirstService) {
			...
			function LoadData() {
				...
				medifirstService.get("asset/get-jadwal-pemeliharaan?"  + 

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DetailDaftarPemesananBarangCtrl', ['$scope', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($scope, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            function init() {
                ...
                medifirstService.get("logistik/get-data-detail-sppb?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +

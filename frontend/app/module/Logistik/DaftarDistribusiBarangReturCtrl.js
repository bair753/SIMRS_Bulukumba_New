...
define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarDistribusiBarangReturCtrl', ['$scope', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($scope, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            function LoadCache() {
                var chacePeriode = cacheHelper.get('DaftarDistribusiBarangReturCtrl');
            ...
            function init() {
                ...
                medifirstService.get("logistik/get-daftar-distribusi-barang?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +
                ...
                cacheHelper.set('DaftarDistribusiBarangReturCtrl', chacePeriode);
            ...
            $scope.EditKirim = function () {
                ...
                $state.go('KirimBarangLogistikRetur')
            }                        

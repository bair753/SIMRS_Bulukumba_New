define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('InputSPKCtrl', ['$scope', '$state', 'CacheHelper', 'MedifirstService',
        function ($scope, $state, cacheHelper, medifirstService) {
            ...
            function LoadCache() {
                ...
                var chacePeriode = cacheHelper.get('InputSPKCtrl');
            ...
            function init() {
                ...
                medifirstService.get("logistik/get-combo-logistik", true).then(function (dat) {
                    ...
                    $scope.item.noUsulan = dataCombo.kodeusulan
                    ...
                    if (noOrder != '') {
                        if (noOrder == 'EditTerima') {
                            medifirstService.get("logistik/get-detail-spk?norecOrder=" + norecResep, true).then(function (data_ih) {
                                ...
                                $scope.item.BiayaKirim = data_ih.data.detail.totalbiayakirim
                                ...
                                $scope.item.pegawaiConfirm = { id: data_ih.data.detail.idpegawaispk, namalengkap: data_ih.data.detail.pegawaispk }
                                ...
                                if (data_ih.data.detail != undefined) {
                                    if (data_ih.data.detailnamarekanan == null ) {
            ...
            $scope.klikGrid = function (dataSelected) {
                ...
                medifirstService.get("logistik/get-combo-barang-logistik?namaproduk=" + dataSelected.namaproduk, true, true, 20).then(function (data) {                                    
                    ...
                    $scope.item.ppnpersen = persenpajak;//dataSelected.persenppn
            ...
            $scope.simpan = function () {
                ...
                medifirstService.post('logistik/save-data-spk',data).then(function (e) {

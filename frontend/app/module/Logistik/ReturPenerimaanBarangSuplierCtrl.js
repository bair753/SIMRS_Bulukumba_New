define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('ReturPenerimaanBarangSuplierCtrl', ['$scope', '$state', 'CacheHelper', 'DateHelper', '$mdDialog', 'MedifirstService',
        function ($scope, $state, cacheHelper, dateHelper, $mdDialog, medifirstService) {
            ...
            function GetprodukRetur() {
                ...
                medifirstService.get("logistik/get-data-to-retur?noTerima=" + norecTerima
                    + "&ruanganfk=" + $scope.item.ruanganPenerima.id
                    , true).then(function (dat) {
                        ...
                        for (var i = 0; i < datas.length; i++) {
                            for (var j = 0; j < data2.length; j++) {
                                if (data2[j].produkfk == datas[i].kdeproduk) {
                                    if (datas[i].qtyproduk <= data2[j].qtyprodukretur) {
                                        jumlah = i + 1;
                                    }
                                }
                            }
                        ...
                        if (data2.length <= jumlah) {
                            ...
                            medifirstService.post('logistik/retur-penerimaan-barang-supplier',objSave).then(function (e) {

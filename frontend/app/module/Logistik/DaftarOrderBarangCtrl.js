define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarOrderBarangCtrl', ['$scope', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($scope, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            function init() {
                ...
                medifirstService.get("logistik/get-data-order-barang-ruangan?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarPenerimaanBarangSuplierReturCtrl', ['$scope', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($scope, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            loadCombo();
            function LoadCache() {
                var chacePeriode = cacheHelper.get('DaftarPenerimaanBarangSuplierReturCtrl');
            ...
            function init() {
                ...
                cacheHelper.set('DaftarPenerimaanBarangSuplierReturCtrl', chacePeriode);
            ...
            $scope.EditTerima = function () {
                ...
                $state.go('ReturPenerimaanBarangSuplier')
            }

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarBarangExpiredCtrl', ['$scope', 'CacheHelper', '$mdDialog', 'MedifirstService',
        function ($scope, cacheHelper, $mdDialog, medifirstService) {
            ...
            var norecOrder = '';
            var statusLoad = ''
            $scope.item.Keterangan = "Barang Kadaluarsa";
            ...
            // init();
            function LoadCache() {
                var chacePeriode = cacheHelper.get('DaftarBarangExpiredCtrl');
                if (chacePeriode != undefined) {
                    ...
                    cacheHelper.set('DaftarBarangExpiredCtrl', chacePeriode);
                } else {
                    init()
                }
            }
            ...
            function ComboLoad() {
                ...
                medifirstService.get("logistik/get-combo-logistik", true).then(function (dat) {
                    ...
                    $scope.listRuanganTujuan = dat.data.ruangan;
            ...
            function init() {                
                    if (statusLoad != '') {
                        if (statusLoad == 'EditKirim') {
                            medifirstService.get("logistik/get-detail-kirim-barang?norec=" + noreckirim, true).then(function (data_ih) {
            ...
            $scope.getProdukRuangan = function () {
                if ($scope.item.ruanganTujuan != undefined) {
                    medifirstService.get("logistik/get-daftar-produkkadaluarsa?objectruangan=" + $scope.item.ruanganTujuan.id, true).then(function (dat) {
            ...
            $scope.SaveKirim = function () {
                ...
                medifirstService.post('logistik/save-barang-kadaluarsa',objSave).then(function (e) {
                    Kosongkan();
                });
            }

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarReturDistribusiBarangCtrl', ['$scope', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($scope, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            function init() {
                ...
                medifirstService.get("logistik/get-daftar-retur-distribusi-ruangan?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +

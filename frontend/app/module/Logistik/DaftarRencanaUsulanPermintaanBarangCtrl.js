define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarRencanaUsulanPermintaanBarangCtrl', ['$scope', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($scope, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            function loadCombo() {
                ...
                medifirstService.get("logistik/get-combo-logistik", true).then(function (dat) {
                    ...
                    var jabatan = dataCombo.jabatanpengelolaurusan[0];
                    var jenisjabatan = dataCombo.kainstalasi[0];
            ...
            function init() {
                ...
                var tglAkhir = moment($scope.item.tglAkhir).format('YYYY-MM-DD HH:mm:ss');
                 medifirstService.get("logistik/get-daftar-rencana-usulan-permintaan-barang-ruangan?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +
            ...
            $scope.BatalUsulan = function () {
                ...
                medifirstService.post('logistik/delete-data-rencana-usulan-ruangan',objSave).then(function (e) {
                    init()
                })
            }
            ...
            $scope.VerifikasiDK = function () {
                ...
                medifirstService.post('logistik/save-verifikasi-direktur-keuangan',objSave).then(function (e) {
            ...
            $scope.VerifikasiPU = function (current) {
                ...
                medifirstService.post('logistik/save-verifikasi-pengelola-urusan',objSave).then(function (e) {
                    init();
                });
            }
            ...
            //     manageLogistikPhp.verifikasikepalainstalasi('logistik/save-verifikasi-kepala-instalasi',objSave).then(function (e) {
            //         init();
            //     });
            // }

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarPemeriksaanLuarLabCtrl', ['$q', '$scope', 'CacheHelper', 'DateHelper', 'MedifirstService', '$mdDialog',
        function ($q, $scope, cacheHelper, dateHelper, medifirstService, $mdDialog) {
            ...
            function loadCombo() {
                ...
                medifirstService.get("rawatjalan/get-combo", false).then(function (data) {
            ...
            function loadData() {
                ...
                medifirstService.get("rawatjalan/get-pemeriksaan-keluar-lab?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +

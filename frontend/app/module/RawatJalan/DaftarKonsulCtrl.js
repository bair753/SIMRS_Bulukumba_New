define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('DaftarKonsulCtrl', ['SaveToWindow', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper','DateHelper',  '$mdDialog', 'CetakHelper', 'MedifirstService','$q', 
        // function(saveToWindow, $rootScope, $scope, ModelItem, $state, findPasien, dateHelper, socket, managePasien, $mdDialog, window, cetakHelper, manageSarprasPhp, cacheHelper, $q) {            
            ...
            function loadCombo(){
                var chacePeriode = cacheHelper.get('daftarKonsulCache');
            ...
            function loadData(){
                ...
                $q.all([
                   medifirstService.get("rawatjalan/get-daftar-konsul-from-order?"+
                    "&tglAwal="+tglAwal+
                    "&tglAkhir="+tglAkhir+
                    "&norm="+nocm+
                    "&noreg="+noRegistrasi+
                    ...
                    for (var i = 0; i < datas.length; i++) {
                        ...
                        cacheHelper.set('daftarKonsulCache', chacePeriode);
                    });
            }
            ...
            function verif(e) {
                ...
                // var jawabanKonsul = prompt("Masukan Jawaban Konsul", "");
                // // return alert(jawabanKonsul)
                // if(jawabanKonsul == ''){
                //     toastr.error('Jawaban Konsul Masih Kosong')
                //     return
                // }

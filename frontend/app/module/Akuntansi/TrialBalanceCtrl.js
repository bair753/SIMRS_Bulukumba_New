define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('TrialBalanceCtrl', ['$scope', 'MedifirstService', '$state', 'CacheHelper', 'DateHelper',
        function ($scope, medifirstService, $state, cacheHelper, dateHelper) {
            ...
            $scope.closingJurnal = function () {
                ...
                if (confirm('Close Jurnal bulan "' + dateHelper.formatDate($scope.item.bulan, "MMMM YYYY") + '"')) {
                    ...
                    medifirstService.post('akuntansi/save-data-closing-jurnal',objSave).then(function (e) {
            ...
            $scope.batalClosingJurnal = function () {
                ...
                if (confirm('Batal Closing Jurnal bulan "' + dateHelper.formatDate($scope.item.bulan, "MMMM YYYY") + '"')) {
                    ...
                    medifirstService.post('akuntansi/save-batal-closing-jurnal',objSave).then(function (e) {
            ...
            function init() {
                ...
                medifirstService.get("akuntansi/get-data-trial-balance?" +
                    "tglAwal=" + tglAwal1 +
                    "&tglAkhir=" + tglAkhir1

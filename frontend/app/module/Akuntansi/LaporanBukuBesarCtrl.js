define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanBukuBesarCtrl', ['$scope', 'CacheHelper', 'MedifirstService',
        function ($scope, cacheHelper, medifirstService) {
            ...
            function LoadCombo() {
                ...
                // });
                medifirstService.getPart("akuntansi/get-data-combo-coa", true, true, 20).then(function (data) {
                    $scope.listAkun = data;
                });
            ...
            function LoadData() {
                ...
                //     return
                // };;
                medifirstService.get("akuntansi/get-data-buku-besar-rev2?" + jp + jp2 + "&tglAwal=" + tglAwal + "&tglAkhir=" + tglAkhir).then(function (data) {
            ...
            $scope.hapusSaldo = function () {
                ...
                medifirstService.post('akuntansi/save-data-hapus-saldo-awal', objSave).then(function (e) {
                    medifirstService.get("akuntansi/get-data-daftar-saldo-awal?coaid=" + $scope.item.kdAkun.id, true).then(function (dat) {
                        for (var i = dat.data.length - 1; i >= 0; i--) {
                            dat.data[i].no = i + 1
                        }

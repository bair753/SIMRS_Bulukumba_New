define(['initialize', 'Configuration'], function (initialize, configuration) {
  ...
  var baseTransaksi = configuration.baseApiBackend;
    initialize.controller('AkuntansiLaporanAktivitasCtrl', ['$scope', 'MedifirstService', '$state', 'CacheHelper', 'DateHelper',
        function ($scope, medifirstService, $state, cacheHelper, dateHelper) {
            ...
            function init() {
                ...
                // }
                var level = "&namalaporan='8','9'" //+$scope.item.level.id
            ...
            $scope.optionsDataGrid = {
                toolbar: [
                     "excel",
                    {
                        name: "  Cetak", text: "  Cetak",
                        template: '<button ng-click="CetakNeraca()" class="k-button k-button-icontext k-grid-upload" href="\\#"><span class="fa fa-file-pdf-o"></span>&nbsp;&nbsp;Cetak Pdf</button>'
                    },
                ],
                excel: {
            ...
            $scope.CetakNeraca = function(){
                ...
                window.open(baseTransaksi + "report/cetak-labarugi?tahun=" + tahunss + "&tglAwal=" + tglAwal1 + "&tglAkhir=" + tglAkhir1 + "&user=" + user.namaLengkap + "&tgltgl=" + tgltgl + level);
                // window.history.back();
            }
            //***********************************

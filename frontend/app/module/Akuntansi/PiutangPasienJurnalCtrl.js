define(['initialize'], function (initialize) {
	'use strict';
	initialize.controller('PiutangPasienJurnalCtrl', ['$scope', 'CacheHelper', 'MedifirstService',
		function ($scope, cacheHelper, medifirstService) {
			...
			function LoadCombo() {
				medifirstService.get("akuntansi/get-data-combo-master", false).then(function (data) {
			...
			function LoadData() {
				...
				medifirstService.get("akuntansi/get-data-piutang-pasien?"

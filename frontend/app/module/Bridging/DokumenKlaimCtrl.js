define(['initialize', 'Configuration'], function (initialize,configuration) {
	...
	initialize.controller('DokumenKlaimCtrl', ['$mdDialog', '$timeout', '$state', '$q', '$rootScope', '$scope', 'ModelItem', 'CacheHelper', 'DateHelper', 'MedifirstService',
		function ($mdDialog, $timeout, $state, $q, $rootScope, $scope, ModelItem, cacheHelper, DateHelper, medifirstService) {
			...
			function loadData() {
				...
				$q.all
				$q.all([
					medifirstService.get("bridging/inacbg/get-daftar-pasien-klaim?" +
						"tglAwal=" + tglAwal +
						"&tglAkhir=" + tglAkhir +
						reg + rm + nm + sep + ins + rg + kp + dk
						+ '&jmlRows=' + jmlRows
				...
				columns:
					[
						...
						},
						{
							...
							"title": "Kelompok",
							"width": "15%",
							"template": '# if( kelompokpasien==null) {# - # } else {# #= kelompokpasien # #} #'
						},
						{
							"field": "nosep",
							"title": "No SEP",

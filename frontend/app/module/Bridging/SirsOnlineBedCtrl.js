define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SirsOnlineBedCtrl', ['$q', '$rootScope', '$scope', '$state', 'CacheHelper', 'MedifirstService', '$timeout',
           ...
           $scope.gridJenisPemeriksaan = {
            ...
            $scope.gridTT = {
                ...
                columns: [
                    ...
                    {
                        "field": "terpakai_suspek",
                        "title": "Terpakai Suspek",
                        "width": 110,
                    },
                    {
                        "field": "terpakai_konfirmasi",
                        "title": "Terpakai Konfirmasi",
                        "width": 110,
                    },
                    {
                        "field": "prepare",

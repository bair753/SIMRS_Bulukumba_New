define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PendaftaranTriageCtrl', ['$scope', 'ModelItem', '$state', '$rootScope', '$interval', 'socket', 'MedifirstService',
        function ($scope, modelItem, $state, $rootScope, $interval, socket, medifirstService) {
            ...
            // Buatan urang
            medifirstService.get("igd/get-pemeriksaan-triage").then(function (dat) {
            ...
            if ($state.params.noCm !== undefined && $state.params.noCm !== '') {
                ...
                //         // var tempNoCm='832796';
                //         //medifirstService.get("igd/get-data-pasien?noCm=832796").then(function(e){ 
                //        medifirstService.get("igd/get-data-pasien?noCm="+$state.params.noCm).then(function(e){     
                ...
                if ($scope.isRegistrasi === true) {
                    ...
                    //medifirstService.get("igd/get-hasil-triase?noRec=0c6cf9a0-db31-11e8-b873-d900bcda").then(function(e){ 
                    //medifirstService.get("igd/get-hasil-triase?noRec=600c86c0-dd84-11e8-aa23-9773ae83").then(function(e){    
                    // noRec='600c86c0-dd84-11e8-aa23-9773ae83';

                    medifirstService.get("igd/get-hasil-triase?noRec=" + $state.params.noRec).then(function (e) {
            ...
            //Buatan urang
            medifirstService.get("igd/get-combo-triase").then(function (dat) {
            ...
            if($scope.jenisKategori == undefined){
                toastr.error('Kategori Triage Harus di isi')
                return
            }
                ...
                var data = {
                    ...
                    tanggalMasuk: $scope.item.tglMasuk,
                ...
                medifirstService.post("igd/simpan-triage", data).then(
                    function (e) {

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LapBendaharaFungsionalCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'MedifirstService', 'DateHelper',
        function (cacheHelper, $q, $rootScope, $scope, medifirstService, DateHelper) {
            ...
            function LoadData() {
                ...
                cacheHelper.set('LapBendaharaFungsionalCtrl', chacePeriode);

                medifirstService.get("kasir/get-data-lap-opd-fungsional?"
                    + "tglAwal=" + tglAwal
            ...
            $scope.columnPasienPulang =
                {
                    ...
                    excel: {
                        fileName: "LaporanBendaharaOPDFungsional.xlsx",
                        allPages: true,
                    },
                    excelExport: function (e) {
                        ...
                        var myHeaders = [
                            {
                                value: "LAPORAN PERTANGGUNGJAWABAN BENDAHARA PENERIMAAN OPD FUNGSIONAL " + DateHelper.formatDate($scope.item.tglAwal, 'DD-MM-YY') + ' sampai ' +
                    ...
                    columns:
                        [
                            ...
                            {
                                "field": "",
                                "title": "<h3 align=center>Sampai dengan bulan lalu<h3>",
                                "width": "140px",
                                "columns":[
                                    {
                                        "field": "",
                                    ...
                                    {
                                        "field": "",
                                        "title": "<h3 align=center>Penyetoran<h3",
                                        "width": "100px",                               
                                    },
                                    {
                                        "field": "",
                            ...
                            {
                                "field": "",
                                "title": "<h3 align=center>Sampai dengan Bulan ini<h3>",
                                "width": "140px",
                                "columns":[
                                    {
                                        "field": "",
                                        "title": "<h3 align=center>Jumlah Anggaran Terealisasi<h3>",
                                        "width": "100px",                               
                                    },
                                    {
                                        "field": "",
                                        "title": "<h3 align=center>Jumlah Anggaran yang Telah Disetor<h3>",
                                        "width": "100px",                               
                                    },
                                    {
                                        "field": "",
                                        "title": "<h3 align=center>Sisa yang belum Disetor<h3>",
                                        "width": "100px",                               
                                    },
                                    {
                                        "field": "",
                                        "title": "<h3 align=center>Sisa Anggaran Belum Terealisasi / Pelampauan Anggaran<h3>",
                                        "width": "100px",                               
                                    }
                                ]                             
                            },

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LapBendaharaAdministrasiCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'MedifirstService', 'DateHelper',
        function (cacheHelper, $q, $rootScope, $scope, medifirstService, DateHelper) {
            ...
            function LoadData() {
                ...
                medifirstService.get("kasir/get-data-lap-opd-administrasi?"
                    + "tglAwal=" + tglAwal
            ...
            $scope.columnPasienPulang =
                {
                    ...
                    excel: {
                        fileName: "LaporanBendaharaOPDAdministrasi.xlsx",
                        allPages: true,
                    },
                    excelExport: function (e) {
                        ...
                        var myHeaders = [
                            {
                                value: "LAPORAN PERTANGGUNGJAWABAN BENDAHARA PENERIMAAN OPD ADMINISTRASI " + DateHelper.formatDate($scope.item.tglAwal, 'DD-MM-YY') + ' sampai ' +

define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('DaftarDepositPasienCtrl', ['$q', '$scope', 'CacheHelper','DateHelper', 'MedifirstService',
		function($q, $scope, cacheHelper, dateHelper, medifirstService) {
			...
			function loadData(){
				...
				$q.all([
					medifirstService.get("tatarekening/get-daftar-deposit-pasien?"+
						"tglAwal="+tglAwal+
						"&tglAkhir="+tglAkhir+

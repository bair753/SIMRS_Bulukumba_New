define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanKegiatanOperasionalCtrl', ['$scope', 'DateHelper', 'ReportHelper', 'MedifirstService',
        function ($scope, DateHelper, reportHelper, medifirstService) {            
            $scope.now = new Date();
            $scope.dataSelected = {};
            $scope.item = {};
            ...
            medifirstService.get("sysadmin/get-list-combo-ruangan", true).then(function (dat) {
            ...
            function loadData() {
                ...
                medifirstService.get("tatarekening/get-laporankegiatanoperasional?"
                    + "monthYear=" + bulan
                    +jenisId
                ).then(function (data) {
            ...
            function Detail(e) {
                ...
                medifirstService.get("tatarekening/get-detail-laporankegiatan?"

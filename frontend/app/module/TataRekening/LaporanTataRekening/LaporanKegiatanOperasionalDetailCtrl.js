define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanKegiatanOperasionalDetailCtrl', ['$scope', 'DateHelper', 'ReportHelper', 'MedifirstService',
        function ($scope, DateHelper, reportHelper, medifirstService) {
            ...
            function loadData() {
                ...
                medifirstService.get("tatarekening/get-laporankegiatanoperasional-detail?"
                    + "monthYear=" + bulan
                    + jenisId
                ).then(function (data) {

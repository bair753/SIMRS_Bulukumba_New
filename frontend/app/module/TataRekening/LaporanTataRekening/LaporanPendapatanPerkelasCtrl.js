define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanPendapatanPerkelasCtrl', ['CacheHelper', '$scope', 'DateHelper', 'MedifirstService',
        function (cacheHelper, $scope, DateHelper, medifirstService) {
            ...
            function LoadData() {
                ...
                medifirstService.get("tatarekening/get-data-lap-pendapatan-perkelas?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    // + tempDepartemenId
                    + tempRuanganId
                    ...
                    + tempKelPasienId).then(function (data) {
                        ...
                        for (var i = 0; i < data.data.data.length; i++) {
                            doubleTotal = doubleTotal + parseFloat(data.data.data[i].total)
                            doubleKarcis = doubleKarcis + parseFloat(data.data.data[i].karcis)
                        }
            ...
            $scope.CetakVolume = function () {
                ...
                var kelompokPasien = "";
                var stt = 'false'
                if (confirm('View Laporan Volume ? ')) {
                    // Save it!
                    stt = 'true';
                } else {
                    // Do nothing!
            ...
            $scope.CetakVolumePerKelas = function () {
                ...
                var stt = 'false'
                if (confirm('View Laporan Volume Per Kelas ? ')) {
                    // Save it!
                    stt = 'true';
                } else {
                    // Do nothing!

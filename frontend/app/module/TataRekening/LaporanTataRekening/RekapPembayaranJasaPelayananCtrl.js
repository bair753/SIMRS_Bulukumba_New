define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RekapPembayaranJasaPelayananCtrl', ['$scope', 'ReportHelper', 'MedifirstService',
        function ($scope, reportHelper, medifirstService) {
            //Inisial Variable 
            ...
            function getCombo() {
                medifirstService.get('tatarekening/get-data-combo-daftarregpasien').then(function (e) {
                    $scope.listDepartemen = e.data.departemen
                    $scope.item.namUser =  medifirstService.getUserLogin();
            ...
            function loadData() {
                ...
                medifirstService.get("tatarekening/get-rekappembayaran-jasapelayanan?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
            ...
            function Detail(e) {
                ...
                medifirstService.get("tatarekening/get-detail-rekappembayaran-jasapelayanan?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    + deptId + ruangId + typePegawaiId 
                    + dokterId + jadwalKerja + tipePasien

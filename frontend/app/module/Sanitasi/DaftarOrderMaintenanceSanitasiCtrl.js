define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarOrderMaintenanceSanitasiCtrl', ['$scope', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($scope, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            function loadCombo() {
                ...
                medifirstService.getPart("sanitasi/get-jenis-layanan-sanitasi").then(function (data) {
            ...
            function init2() {
                ...
                medifirstService.get("sanitasi/get-daftar-permohonan-sanitasi?" +
                    "tglAwal=" + tglAwal +
            ...
            $scope.saveJenisKerusakan = function () {
                ...
                medifirstService.post('sanitasi/save-jenis-layanan-sanitasi', objSave).then(function (e) {
                    $scope.popupJenisKerusakan.close();
                    init2()
                })
            ...
            $scope.Status = function () {
                ...
                medifirstService.getPart("sanitasi/get-status-pekerjaan-sanitasi").then(function (data) {
            ...
            $scope.hapus = function () {
                ...
                if (del) {
                    medifirstService.post('sanitasi/hapus-permohonan-sanitasi', { norec: $scope.dataSelected.norec }).then(function (e) {
                        init2()
                    })
                }
            }

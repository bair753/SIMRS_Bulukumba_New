define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PermintaanPerbaikandariRuanganSIMRSCtrl', ['$scope', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($scope, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.simpan = function () {        
                ...
                medifirstService.post('sysadmin/general/save-permohonan-simrs',objSave).then(function(e) {
                    // $scope.popupSignDate.close();
                    // init2()
                })

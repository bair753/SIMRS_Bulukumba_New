define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('MapRuanganToJenisRuanganCtrl', ['$scope', 'MedifirstService',
        function ($scope, medifirstService) {
            ...
            $scope.loadData = function (jenis) {
                $scope.isRouteLoading = true;
                $scope.currentRuangan = []
                medifirstService.get("sysadmin/get-map-ruangantojenis?idjenis=" + jenis.id).then(function (res) {
            ...
            $scope.simpan = function () {
                ...
                medifirstService.post('sysadmin/save-map-ruangantojenis',objSave).then(function (e) {
                    $scope.item = {}
                })

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('MasterDepartemenCtrl', ['$rootScope', '$scope', 'MedifirstService', '$window', '$timeout',
        function ($rootScope, $scope, medifirstService, $window, $timeout) {
            ...
            $scope.Clear = function () {
                ...
                delete $scope.item.kdDepartemen
                delete $scope.item.namaDepartemen
            ...
            function loadData() {
                ...
                var kdDepartemen = ""
                if ($scope.item.kdDepartemen != undefined) {
                    kdRuangan = "&kdDepartemen=" + $scope.item.kdDepartemen
                }
                var namaDepartemen = ""
                if ($scope.item.namaDepartemen != undefined) {
                    namaDepartemen = "&namaDepartemen=" + $scope.item.namaDepartemen
                }
                medifirstService.get("sysadmin/master/get-daftar-master-departemen?"
                    + kdDepartemen + namaDepartemen + id).then(function (data) {
                        $scope.isRouteLoading = false;
            ...
            $scope.columnGrid = {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "title": "<h3 align=center>Nama Departemen</h3>",
                        "width": "150px"
                    },
                    {
                        "command": [
            ...
            $scope.save = function () {
                ...
                var namaDepartemen = ""
                if ($scope.popUp.namaDepartemen != undefined)
                    namaDepartemen = $scope.popUp.namaDepartemen
            ...
            function editData(e) {
                ...
                $scope.popUp.namaDepartemen = dataItem.namadepartemen

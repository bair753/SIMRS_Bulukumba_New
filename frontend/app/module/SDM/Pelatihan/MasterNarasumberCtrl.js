define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('MasterNarasumberCtrl', ['$q', '$scope', 'MedifirstService', 'ModelItem',
        function ($q, $scope, medifirstService, ModelItem) {
            ...
            function init() {
                $scope.cari = {}
                medifirstService.get('sdm/pelatihan/get-combo-pelatihan').then(function (e) {
                    $scope.listJenisKelamin = e.data.jeniskelamin
                    $scope.listPendidikanTerakhir = e.data.pendidikan
                })

                $q.all([
                    medifirstService.get("sdm/pelatihan/get-daftar-narasumber"),
                ]).then(function (res) {
            ...
            $scope.Save = function () {
                ...
                if (isValid.status) {
                    ...
                    medifirstService.post('sdm/pelatihan/save-data-narasumber',data).then(function (e) {
                        init();
                        ClearAll()
                    });
                } else {
            ...
            function deleteRow(e) {
                ...
                medifirstService.post('sdm/pelatihan/hapus-data-narasumber',data).then(function (e) {
                    init()
                })
            }
            function editRow(e) {

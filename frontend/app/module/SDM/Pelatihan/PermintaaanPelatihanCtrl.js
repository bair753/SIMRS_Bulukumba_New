define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('PermintaaanPelatihanCtrl', ['$scope', '$state', 'CacheHelper', 'MedifirstService',
		function($scope, $state, cacheHelper, medifirstService) {
			...
			LoadCache()
			 ...
			 function LoadCache(){
	            var chacePeriode = cacheHelper.get('PermintaaanPelatihanCtrl');
		    ...
		    function init() {
                ...
                medifirstService.get("sdm/pelatihan/get-data-pengajuan-pelatihan?"+
                    "tglAwal=" + tglAwal + 
                    "&tglAkhir=" + tglAkhir +
                ...
                cacheHelper.set('PermintaaanPelatihanCtrl', chacePeriode);                
            }
		    ...
		    $scope.columnGrid = [
				...
				},
				{
					...
					title: "Tanggal Awal",
                    width: "120px",
                    "template": "<span class='style-left'>{{formatTanggal('#: tglsiklusawal #')}}</span>"
				},
				{
					field: "tglsiklusakhir",
					title: "Tanggal Akhir",
                    "template": "<span class='style-left'>{{formatTanggal('#: tglsiklusakhir #')}}</span>",
					width: "120px"
				},
                {
                    field: "statusverifikasi",
                    title: "Verifikasi Bag SDM",
                    width: "120px"
                }                
            ];
			...
			$scope.tambahPengajuanPelatihan = function () {
				$state.go('TambahPengajuanPelatihan',{})
			}
			...
			$scope.editPengajuanPelatihan = function(current){
                ...
                cacheHelper.set('TambahPengajuanPelatihanCtrl', chacePeriode);
                $state.go('TambahPengajuanPelatihan', {
            ...
            $scope.VerifikasiPengajuan = function(current){
                ...
                medifirstService.post('sdm/pelatihan/verifikasi-pengajuan-pelatihan',objSave).then(function(e) {
                    init();
                    ClearAll();                   
                });   
            }
            ...
            $scope.UnverifikasiPengajuan = function(current){
                ...
                medifirstService.post('sdm/pelatihan/unverifikasi-pengajuan-pelatihan',objSave).then(function(e) {
                    init();
                    ClearAll();                   
                });   
            }
            ...
            $scope.hapusPengajuan = function(current){
                ...
                medifirstService.post('sdm/pelatihan/hapus-pengajuan-pelatihan',objSave).then(function(e) {
                	init();
                    ClearAll();                   
            	});
            }

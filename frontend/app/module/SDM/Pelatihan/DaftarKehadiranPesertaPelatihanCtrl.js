define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('DaftarKehadiranPesertaPelatihanCtrl', ['$scope', 'CacheHelper','MedifirstService',
		function($scope, cacheHelper, medifirstService ) {
			...
			function LoadCache(){
           	...
           	function init() {
                ...
                medifirstService.get("sdm/pelatihan/get-daftar-kehadiran-peserta-pelatihan?"+
                    "tglAwal=" + tglAwal + 
                    "&tglAkhir=" + tglAkhir +
	     ...
	     //            }     
			...
			function Hadir(e) {
                ...
                medifirstService.post('sdm/pelatihan/save-kehadiran-peserta-pelatihan',objSave).then(function(e) {
                	init();                  
            	});
            }

define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('DaftarEvaluasiPenyelenggaraCtrl', ['$scope', '$state', 'CacheHelper', 'MedifirstService', 
		function($scope, $state, cacheHelper, medifirstService) {
		    ...
		    function init() {
                ...
                medifirstService.get("sdm/pelatihan/get-daftar-evaluasi-penyelenggara?"+
                    "tglAwal=" + tglAwal + 
                    "&tglAkhir=" + tglAkhir +
            ...
            $scope.Hapus = function(current){
                ...
                medifirstService.post('sdm/pelatihan/hapus-evaluasi-penyelenggara',objSave).then(function(e) {
                	init();
                    ClearAll();                   
            	});
            }

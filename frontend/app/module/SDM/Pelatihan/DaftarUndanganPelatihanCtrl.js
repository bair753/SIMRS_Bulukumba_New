define(['initialize'], function (initialize) {
	'use strict';
	initialize.controller('DaftarUndanganPelatihanCtrl', ['$scope', 'CacheHelper', 'MedifirstService', 'DateHelper',
		function ($scope, cacheHelper, medifirstService, dateHelper) {
			...
			function loadDataCombo() {
				...
				medifirstService.get("sdm/pelatihan/get-combo-data-pelatihan?", true).then(function (dat) {
					$scope.listPelatihan = dat.data.strukplanning;
				});
			}
			...
			function init() {
				...
				medifirstService.get("sdm/pelatihan/get-data-peserta-pelatihan?" +
					"tglAwal=" + tglAwal +
					"&tglAkhir=" + tglAkhir +

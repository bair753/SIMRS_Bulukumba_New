define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('InputEvaluasiPenyelenggaraanCtrl', ['$scope', 'CacheHelper', 'MedifirstService',
        function ($scope, cacheHelper, medifirstService) {
            ...
            function LoadCache() {
                var chacePeriode = cacheHelper.get('InputEvaluasiPenyelenggaraanCtrl');
            ...
            function init() {
                if (noOrder != '') {
                    if (noOrder == 'EditEvaluasi') {
                        medifirstService.get("sdm/pelatihan/get-data-detail-evaluasi-penyelenggara?norecOrder=" + NorecEvaluasiNarasumber, true).then(function (data_ih) {
                            $scope.isRouteLoading = false;
            ...
            $scope.Save = function () {
                ...
                if (isValid.status) {
                    ...
                    medifirstService.post('sdm/pelatihan/save-evaluasi-penyelenggara',objSave).then(function (e) {
                        ClearAll();
                    });

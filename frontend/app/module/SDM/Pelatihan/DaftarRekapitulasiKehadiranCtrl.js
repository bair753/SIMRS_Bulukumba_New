define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('DaftarRekapitulasiKehadiranCtrl', ['$scope', 'CacheHelper', 'MedifirstService', '$parse',
		function($scope,  cacheHelper, medifirstService, $parse) {
			$scope.item = {};
			...
			function LoadCache(){
           	...
           	function init() {
                ...
                medifirstService.get("sdm/pelatihan/get-daftar-rekapitulasi-kehadiran-peserta-pelatihan?"+
                    "tglAwal=" + tglAwal + 
                    "&tglAkhir=" + tglAkhir +
			...
			$scope.showDetail = function(noplanning){
                ...
                var tglAwal = moment($scope.item.tglawal).format('YYYY-MM-DD HH:mm:ss');
                var tglAkhir = moment($scope.item.tglakhir).format('YYYY-MM-DD HH:mm:ss');
                medifirstService.get("sdm/pelatihan/get-detail-kehadiran-peserta-pelatihan?"+
                	"tglAwal=" + tglAwal + 
                    "&tglAkhir=" + tglAkhir +

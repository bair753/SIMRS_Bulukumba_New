define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarEvaluasiNarasumberCtrl', ['$scope', '$state', 'CacheHelper', 'MedifirstService',
        function ($scope, $state, cacheHelper, medifirstService) {
            ...
            function LoadCache() {
                var chacePeriode = cacheHelper.get('DaftarEvaluasiNarasumberCtrl');
            ...
            function init() {
                ...
                medifirstService.get("sdm/pelatihan/get-daftar-evaluasi-narasumber?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +
            ...
            $scope.Hapus = function (current) {
                ...
                medifirstService.post('sdm/pelatihan/hapus-evaluasi-narasumber',objSave).then(function (e) {
                    init();
                    ClearAll();
                });
            }
            ...
            $scope.Cetak = function () {
                ...
                var stt = 'false'
                if (confirm('View Evaluasi Narasumber? ')) {
                    // Save it!
                    stt = 'true';
                } else {
                    // Do nothing!
                ...
                client.get('http://127.0.0.1:1237/printvb/sdm?cetak-evaluasi-narasumber=1&nores=' + Pelatihan + '&strIdPegawai=' + $scope.item.idPegawai + '&view=' + stt, function (response) {

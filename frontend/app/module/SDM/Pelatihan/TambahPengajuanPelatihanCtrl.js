define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('TambahPengajuanPelatihanCtrl', ['$scope', 'CacheHelper', 'MedifirstService', 'DateHelper',
		function($scope, cacheHelper, medifirstService, dateHelper ) {
			...
			function LoadCache(){
               var chacePeriode = cacheHelper.get('TambahPengajuanPelatihanCtrl');
            ...
            function init(){				
				if (noOrder != '') {
			   		if (noOrder == 'EditPengajuan') {
			   			medifirstService.get("sdm/pelatihan/get-detail-pengajuan-pelatihan?norecOrder="+norecPlanning, true).then(function(data_ih){
                            $scope.isRouteLoading=false;
    ...
    //             }
			...
			$scope.simpan = function () {
				...
				medifirstService.post('sdm/pelatihan/save-pengajuan-pelatihan',objSave).then(function(e) {
                   ClearAll();
                });
			}

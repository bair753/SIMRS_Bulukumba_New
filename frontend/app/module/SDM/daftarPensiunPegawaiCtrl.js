define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('daftarPensiunPegawaiCtrl', ['$scope', 'MedifirstService', 'DateHelper', '$timeout', 
		function($scope, medifirstService, dateHelper, $timeout) {
            ...
            function FormLoad() {
                 medifirstService.get("sdm/data-combo-pensiun?", true).then(function(dat){                 
            ...
            function loadData2 (){
                ...
                medifirstService.get("sdm/get-data-pensiun").then(function(res){
            ...
            $scope.opsiDataPensiun = {
                ...
                excel: {
                    fileName: kendo.toString(new Date, "dd/MM/yyyy HH:mm")+"Daftar Pensiun Pegawai.xlsx",
                    allPages: true,
                },

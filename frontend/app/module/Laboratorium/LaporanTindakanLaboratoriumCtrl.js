define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanTindakanLaboratoriumCtrl', ['MedifirstService', 'CacheHelper', '$scope', 'DateHelper', '$state', 'ModelItem',
        function (medifirstService, cacheHelper, $scope, DateHelper, $state, ModelItem) {
            ...
            function loadData() {
                ...
                if ($scope.item.tindakan != undefined) {
                    tindakan = "&tindakan=" + $scope.item.tindakan;
                }
                ...
                medifirstService.get("laboratorium/get-laporan-tindakan?tglAwal=" + tglAwal + "&tglAkhir=" + tglAkhir + "&KpArr=" + listKelompokPasien + tindakan)
                    .then(function (data) {
                        $scope.isRouteLoading = false;
            ...
            $scope.columnGrid = {
                ...
                excel: {
                    fileName: "LaporanTindakanLaboratorium.xlsx",
                    allPages: true,
                },
                excelExport: function (e) {
                    ...
                    var myHeaders = [{
                        value: "Laporan Tindakan Laboratorium",
                        fontSize: 20,
                        textAlign: "center",
                        background: "#ffffff",
                        // color:"#ffffff"

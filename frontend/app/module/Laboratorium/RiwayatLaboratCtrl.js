define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RiwayatLaboratCtrl', ['$scope', 'MedifirstService', '$state', 'CacheHelper', '$window',
        function ($scope, medifirstService, $state, cacheHelper, $window) {
            ...
            LoadCache();
            function LoadCache() {
                var chacePeriode = cacheHelper.get('RiwayatLaborat');
            ...
            function init() {
                ...
                medifirstService.get("registrasi/get-pelayanan-laboratorium?noregistrasifk=" + norec_apd
                    ...
                    , true).then(function (dat) {
                        ...
                        for (var i = 0; i < dat.data.data.length; i++) {
                            ...
                            if (dat.data.data[i].hr_norec != undefined) {
            ...
            $scope.LihatHasil = function () {
                ...
                if ($scope.showRadiologi == true) {
                    medifirstService.get("radiologi/get-acc-number?noOrder=" + $scope.noOrder)
                        .then(function (e) {
                            ...
                            if ($scope.dataRisOrder != undefined) {
                                ...
                                toastr.error('Data Belum dikirim ke RIS')
                            }
                        })
                } else {
                    if(urlHasilVansLab ==''){
            ...
            //     }
             ...
             $scope.LihatEkpertise = function () {
                ...
                medifirstService.get('radiologi/get-hasil-radiologi?norec_pp='+$scope.dataSelected.norec_pp).then(function (e) {
                    if(e.data.length>0)
                    {
            ...
            $scope.CetakEkspertise = function(){  
                ...
                for (let i = 0; i < daftarCetak.length; i++) {
                    ...
                    if (element.expertise == "✘") {
                        toastr.error("Expertise Belum Diisi !!!")                                                
                        return;
                    }
                ...
                var stt = 'false'
				if (confirm('View Expertise Radiologi? ')) {
					// Save it!
					stt = 'true';
				} else {
					// Do nothing!

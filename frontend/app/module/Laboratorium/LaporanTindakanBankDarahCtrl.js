define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanTindakanBankDarahCtrl', ['MedifirstService', 'CacheHelper', '$scope', 'DateHelper', '$state', 'ModelItem',
        function (medifirstService, cacheHelper, $scope, DateHelper, $state, ModelItem) {
            ...
            function loadData() {
                ...
                medifirstService.get("laboratorium/get-laporan-tindakan-bank-darah?tglAwal=" + tglAwal + "&tglAkhir=" + tglAkhir + "&KpArr=" + listKelompokPasien)
                    .then(function (data) {
                        $scope.isRouteLoading = false;
            ...
            $scope.columnGrid = {
                ...
                excel: {
                    fileName: "LaporanTindakanBankDarah.xlsx",
                    allPages: true,
                },
                excelExport: function (e) {
                    ...
                    var myHeaders = [{
                        value: "Laporan Tindakan Bank Darah",
                        fontSize: 20,
                        textAlign: "center",
                        background: "#ffffff",
                        // color:"#ffffff"

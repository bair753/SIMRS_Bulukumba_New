define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RincianPelayananDarahCtrl', ['$q', '$rootScope', '$scope', '$state', 'CacheHelper', '$window', 'MedifirstService',
        function ($q, $rootScope, $scope, $state, cacheHelper, $window, medifirstService) {
            ...
            $scope.pakaiDarah = function(){
                $state.go("PemakaianDarah")
            }

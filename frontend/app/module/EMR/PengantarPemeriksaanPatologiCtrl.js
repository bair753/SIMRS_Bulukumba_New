define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('PengantarPemeriksaanPatologiCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[32116540] = antrianPasien.nocm;
                    $scope.item.obj[32116541] = antrianPasien.noidentitas;
                    $scope.item.obj[32116542] = antrianPasien.namapasien;
                    $scope.item.obj[32116543] = antrianPasien.jeniskelamin;
                    $scope.item.obj[32116544] = chacePeriode[4];
                    $scope.item.obj[32116545] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
                    $scope.item.obj[32116546] = antrianPasien.alamatlengkap;
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Pengantar Pemeriksaan Patologi' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

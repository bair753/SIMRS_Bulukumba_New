define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('AlatMonitoringCPAPCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.cetakBlade = function () {
                ...
                window.open(config.baseApiBackend + 'report/cetak-alat-monitoring-cpap?nocm='
                    ...
                    + '&kdprofile=' + local.id
                    // + '&index=' + $scope.$parent.lisIndex.length
                    + '&nama=' + nama, '_blank');
            }
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[32103886] = antrianPasien.namapasien;
                    $scope.item.obj[32103887] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
                })
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Alat Monitoring CPAP'+ ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

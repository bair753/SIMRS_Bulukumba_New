define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSBidan7Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210124).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[22028898] = $scope.skor1
                $scope.item.obj[22028899] = $scope.skor2
                $scope.item.obj[22028900] = $scope.skor3
                $scope.item.obj[22028901] = $scope.skor4
                $scope.item.obj[22028902] = $scope.skor5
                $scope.item.obj[22028903] = $scope.skor6
                $scope.item.obj[22028904] = $scope.skor7
                $scope.item.obj[22028905] = $scope.skor8
                $scope.item.obj[22028906] = $scope.skor9
                $scope.item.obj[22028907] = $scope.skor10
                $scope.item.obj[22028908] = $scope.skor11
                $scope.item.obj[22028909] = $scope.skor12
                $scope.item.obj[22028910] = $scope.skor13
            }

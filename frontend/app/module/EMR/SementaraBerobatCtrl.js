define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('SementaraBerobatCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.cetakPdf = function () {
                ...
                window.open(config.baseApiBackend + 'report/cetak-suket-sementara-berobat?nocm='
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[32116797] = $scope.cc.namapasien;
                    $scope.item.obj[32116799] = antrianPasien.pekerjaan;
                    $scope.item.obj[32116800] = antrianPasien.alamatlengkap;
                    $scope.item.obj[32116801] = $scope.now;
                    $scope.item.obj[32116805] = $scope.now;
                    ...
                    $scope.item.obj[32116798] = thn + 'thn ' + bln + 'bln ' + day + 'hr ';
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Surat Keterangan Sementara Berobat' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

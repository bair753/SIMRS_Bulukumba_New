define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSBidan9Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210126).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[22029938] = $scope.skor1
                $scope.item.obj[22029939] = $scope.skor2
                $scope.item.obj[22029940] = $scope.skor3
                $scope.item.obj[22029941] = $scope.skor4
                $scope.item.obj[22029942] = $scope.skor5
                $scope.item.obj[22029943] = $scope.skor6
                $scope.item.obj[22029944] = $scope.skor7
                $scope.item.obj[22029945] = $scope.skor8
                $scope.item.obj[22029946] = $scope.skor9
                $scope.item.obj[22029947] = $scope.skor10
                $scope.item.obj[22029948] = $scope.skor11
                $scope.item.obj[22029949] = $scope.skor12
                $scope.item.obj[22029950] = $scope.skor13
            }

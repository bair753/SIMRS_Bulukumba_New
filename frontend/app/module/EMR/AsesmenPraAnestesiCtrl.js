define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AsesmenPraAnestesiCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.listAlergi = [
                {
                    ...
                    "detail": [
                        { "id": 16769, "nama": "1.", "type": "textbox" },
                        { "id": 16770, "nama": "2.", "type": "textbox" },
                        { "id": 16771, "nama": "3.", "type": "textbox" },
                        { "id": 16772, "nama": "4.", "type": "textbox" },
                    ]
                },
            ]
            $scope.listAlergi = [
            ...
            $scope.listTanda = [
                {
                    ...
                    "detail": [
                        { "id": 16773, "nama": "TD :", "type": "textbox" },
                        { "id": 16774, "nama": "Nadi :", "type": "textbox" },
                        { "id": 16775, "nama": "BB :", "type": "textbox" },
                        { "id": 16776, "nama": "RR :", "type": "textbox" },
                        { "id": 16777, "nama": "TB :", "type": "textbox" },
                        { "id": 16778, "nama": "Suhu :", "type": "textbox" },
                    ]
                },
            ]
            $scope.listADL = [
            ...
            $scope.listPemeriksaanLab = [
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 16813, "nama": "Ureum", "type": "textbox" },
                        { "id": 16814, "nama": "Creatin", "type": "textbox" },
                    ]
                },
                {
                    "id": 4, "nama": "Fungsi Hati",
                    "detail": [
                        { "id": 16815, "nama": "SGOT", "type": "textbox" },
                        { "id": 16816, "nama": "SGPT", "type": "textbox" },
                        { "id": 16817, "nama": "Albumin", "type": "textbox" },
                        { "id": 16818, "nama": "Globumin", "type": "textbox" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 16819, "nama": "NA", "type": "textbox" },
                        { "id": 16820, "nama": "K ", "type": "textbox" },
                        { "id": 16821, "nama": "CL ", "type": "textbox" },
                        { "id": 16822, "nama": "Ca", "type": "textbox" },
                        { "id": 16823, "nama": "Mg", "type": "textbox" },
                    ]
                },
                {
                    "id": 6, "nama": "Lain-lain",
                    "detail": [
                        { "id": 16824, "nama": "", "type": "textbox" },
                    ]
                },
                // {
            ...
            $scope.listIntruksi = [
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 16825, "nama": "Puasa", "type": "textbox" },
                    ]
                },
                {
                    "id": 2, "nama": "",
                    "detail": [
                        { "id": 16826, "nama": "Makanan Padat", "type": "textbox" },
                        { "id": 16827, "nama": "Makanan Cairan", "type": "textbox" },
                    ]
                },
                {
                    "id": 2, "nama": "Obat-obat diberikan terus",
                    "detail": [
                        { "id": 16828, "nama": "Ya", "type": "checkbox" },
                        { "id": 16829, "nama": "Tidak", "type": "checkbox" },
                    ]
                },
                {
                    "id": 3, "nama": "",
                    "detail": [
                        { "id": 16830, "nama": "Obat yang dihentikan", "type": "textbox" },
                    ]
                },
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Pra anestesi'+ ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

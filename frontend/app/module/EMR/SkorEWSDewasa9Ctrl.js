define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSDewasa9Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 256).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[61527] = $scope.skor1
                $scope.item.obj[61528] = $scope.skor2
                $scope.item.obj[61529] = $scope.skor3
                $scope.item.obj[61530] = $scope.skor4
                $scope.item.obj[61531] = $scope.skor5
                $scope.item.obj[61532] = $scope.skor6
                $scope.item.obj[61533] = $scope.skor7
                $scope.item.obj[61534] = $scope.skor8
                $scope.item.obj[61535] = $scope.skor9
                $scope.item.obj[61536] = $scope.skor10
                $scope.item.obj[61537] = $scope.skor11
                $scope.item.obj[61538] = $scope.skor12
                $scope.item.obj[61539] = $scope.skor13
            }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Skor Early Warning System Dewasa9 ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

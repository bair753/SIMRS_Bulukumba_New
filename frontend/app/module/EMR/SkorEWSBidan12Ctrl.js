define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSBidan12Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210129).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[22031498] = $scope.skor1
                $scope.item.obj[22031499] = $scope.skor2
                $scope.item.obj[22031500] = $scope.skor3
                $scope.item.obj[22031501] = $scope.skor4
                $scope.item.obj[22031502] = $scope.skor5
                $scope.item.obj[22031503] = $scope.skor6
                $scope.item.obj[22031504] = $scope.skor7
                $scope.item.obj[22031505] = $scope.skor8
                $scope.item.obj[22031506] = $scope.skor9
                $scope.item.obj[22031507] = $scope.skor10
                $scope.item.obj[22031508] = $scope.skor11
                $scope.item.obj[22031509] = $scope.skor12
                $scope.item.obj[22031510] = $scope.skor13
            }

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirAntibiotikCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210032).then(function (e) {
            ...
            $scope.TindakanKeper1 = [
                {
                    "id": 1, "nama": "1.","tpye":"textbox",
                    "detail": [
                        { "id": 21001644, "nama": "", "type": "textbox" },
                        { "id": 21001645, "nama": "", "type": "time" },
                        { "id": 21001646, "nama": "", "type": "textbox" },
                        { "id": 21001647, "nama": "", "type": "textbox" },
                    ]
                },
                {
                    "id": 1, "nama": "1.","tpye":"textbox",
                    "detail": [
                        { "id": 21001648, "nama": "", "type": "textbox" },
                        { "id": 21001649, "nama": "", "type": "time" },
                        { "id": 21001650, "nama": "", "type": "textbox" },
                        { "id": 21001651, "nama": "", "type": "textbox" },
                    ]
                },
                {
                    "id": 1, "nama": "1.","tpye":"textbox",
                    "detail": [
                        { "id": 21001652, "nama": "", "type": "textbox" },
                        { "id": 21001653, "nama": "", "type": "time" },
                        { "id": 21001654, "nama": "", "type": "textbox" },
                        { "id": 21001655, "nama": "", "type": "textbox" },
                    ]
                },
                {
                    "id": 1, "nama": "1.","tpye":"textbox",
                    "detail": [
                        { "id": 21001656, "nama": "", "type": "textbox" },
                        { "id": 21001657, "nama": "", "type": "time" },
                        { "id": 21001658, "nama": "", "type": "textbox" },
                        { "id": 21001659, "nama": "", "type": "textbox" },
                    ]
                },
            ]
            $scope.listRujukan = [
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'FormulirAntibiotikCtrl ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

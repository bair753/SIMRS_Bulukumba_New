define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSBidan15Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210132).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[22033058] = $scope.skor1
                $scope.item.obj[22033059] = $scope.skor2
                $scope.item.obj[22033060] = $scope.skor3
                $scope.item.obj[22033061] = $scope.skor4
                $scope.item.obj[22033062] = $scope.skor5
                $scope.item.obj[22033063] = $scope.skor6
                $scope.item.obj[22033064] = $scope.skor7
                $scope.item.obj[22033065] = $scope.skor8
                $scope.item.obj[22033066] = $scope.skor9
                $scope.item.obj[22033067] = $scope.skor10
                $scope.item.obj[22033068] = $scope.skor11
                $scope.item.obj[22033069] = $scope.skor12
                $scope.item.obj[22033070] = $scope.skor13
            }

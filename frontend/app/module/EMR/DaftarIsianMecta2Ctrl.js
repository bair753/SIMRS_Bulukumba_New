define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarIsianMecta2Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.cetakPdf = function () {
                ...
                client.get('http://127.0.0.1:1237/printvb/e-rekammedis?cetak-emr-daftarmecta&id='
                 + $scope.cc.nocm + '&emr=' + norecEMR + '&view=true' + '&idemr=' + 402  , function (response) {
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-rekam-medis-dynamic?emrid=402").then(function (e) {

define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('PenundaanPelayananCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart("emr/get-datacombo-icd10-secondary", true, true, 10).then(function(data) {
                $scope.listICD10 = data
            });

            medifirstService.getPart("emr/get-datacombo-part-diagnosa-tindakan", true, true, 10).then(function(data) {
                $scope.listICD9 = data;
            });
            ...
            $scope.listInformasi = [
                {
                    "id": 1,
                    "detail": [
                        { "id": 31103170, "caption": "Nama :", "type": "textbox", "dataList": ""},
                        { "id": 31103171, "caption": "Tanggal Lahir :", "type": "date" },
                        { "id": 31103172, "caption": "Hubungan dengan pasien:", "type": "textbox", "dataList": ""},
                        { "id": 31103173, "caption": "Nama Pasien :", "type": "textbox"},
                        { "id": 31103174, "caption": "Jenis Kelamin :", "type": "textbox"},
                        { "id": 31103175, "caption": "Tanggal Lahir :", "type": "date" },
                        { "id": 31103176, "caption": "Poli / Ruang", "type": "combobox", "dataList": "listRuangan" },
                        { "id": 31103177, "caption": "Nama Dokter :", "type": "combobox", "dataList": "listDokter" },
                        { "id": 31103178, "caption": "Pelayanan yang akan dilakukan :", "type": "textarea" },
            ...
            $scope.listCheck = [
                {
                    "id": 1,
                    "detail": [
                        { "id": 31103179, "nama": "Kerusakan alat", "caption": "", "type": "checkbox", "dataList": "", "satuan": "" },
                        { "id": 31103180, "nama": "Kondisi umum pasien", "caption": "", "type": "checkbox", "dataList": "", "satuan": "" },
                        { "id": 31103181, "nama": "Penundaan penjadwalan", "caption": "", "type": "checkbox", "dataList": "", "satuan": "" },
                        { "id": 31103182, "nama": "Pemadaman instalasi listrik", "caption": "", "type": "checkbox", "dataList": "", "satuan": "" },
                        { "id": 31103183, "nama": "Lain-lain", "caption": "", "type": "checkbox", "dataList": "", "satuan": "" },
                        { "id": 31103184, "nama": "", "caption": "", "type": "textbox1", "dataList": "", "satuan": "" },
            ...
            $scope.listCheck2 = [
                {
                    "id": 1,
                    "detail": [
                        { "id": 31103185, "nama": "Dijadwalkan ulang dan menjadi prioritas", "caption": "", "type": "checkbox", "dataList": "", "satuan": "" },
                        { "id": 31103186, "nama": "Jadwal yang akan datang :", "caption": "", "type": "checkbox", "dataList": "", "satuan": "" },
                        { "id": 31103187, "nama": "", "caption": "", "type": "textbox1", "dataList": "", "satuan": "" },
                        { "id": 31103188, "nama": "Dirujuk ke layanan kesehatan lain : Ke","caption": "", "type": "checkbox", "dataList": "", "satuan": "" },
                        { "id": 31103189, "nama": "", "caption": "", "type": "textbox1", "dataList": "", "satuan": "" },
                        { "id": 31103190, "nama": "Dikembalikan kepada dokter pengirim","caption": "", "type": "checkbox", "dataList": "", "satuan": "" },
                        { "id": 31103191, "nama": "Lain-lain", "caption": "", "type": "checkbox", "dataList": "", "satuan": "" },
                        { "id": 31103192, "nama": "", "caption": "", "type": "textbox1", "dataList": "", "satuan": "" },
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[31103173] = antrianPasien.namapasien;
                    $scope.item.obj[31103175] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
                    $scope.item.obj[31103174] = antrianPasien.jeniskelamin;

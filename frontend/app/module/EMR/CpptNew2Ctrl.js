define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('CpptNew2Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.listItem =[ {id:111593,inuse:true},{id:111603},{id:111613},{id:111623},{id:111633},{id:111643},{id:111653},
              {id:111663},{id:111673},{id:111683},{id:111693},{id:111703},{id:111717},{id:111727},{id:111737},{id:111747},
              {id:1117573},{id:111767}, {id:111777},{id:111787},{id:111797},{id:111807},{id:111817},{id:111827}]
            ...
            $scope.cetakPdf = function () {
                ...
                client.get('http://127.0.0.1:1237/printvb/e-rekammedis?cetak-emr-cppt-ranap&id=' + $scope.cc.nocm + '&norec_apd='+  $scope.cc.norec +'&emr=' + norecEMR + '&view=true', function (response) {
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[111713]=$scope.cc.tglregistrasi
                $scope.item.obj[111714]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
                $scope.item.obj[111715]={ value: $scope.cc.objectruanganfk, text: $scope.cc.namaruangan }
                $scope.item.obj[111716]={ value: $scope.cc.objectkelasfk, text: $scope.cc.namakelas }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Cppt rawat inap new  2' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
            ...
            $scope.tambah = function(){
              ...
              if(details.length == 0){
                ...
                toastr.info('Isi di Tab Berikutnya')
                return
              }
              let json = {
                noemr : nomorEMR,
              ...
              // medifirstService.get("emr/get-sttaus-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
              // })          
            }

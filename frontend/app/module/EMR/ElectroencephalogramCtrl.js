define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('ElectroencephalogramCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.totalSkor2 = 0
            $scope.item.objImg =[]
            $scope.item.objImg[32116623] = "../app/images/svg/no-image.svg"
            ...
            $scope.cetakPdf = function () {
                ...
                window.open(config.baseApiBackend + 'report/cetak-electroencephalogram?nocm='
           ...
           medifirstService.getPart('emr/get-datacombo-part-diagnosa', true, true, 20).then(function (data) {
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                $scope.item.obj = []
                $scope.item.obj2 = []
                $scope.item.obj[32116622] = $scope.now;
            ...
            $scope.Save = function () {
                ...
                if($scope.item.objImg[32116623].substring(17, 20) == 'pdf'){
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Electroencephalogram' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
                ...
                for (var i = 0; i < e.files.length; i++) {
                    ...
                    if (file) {
                       ...
                       //     debugger;
                           ...
                           $scope.item.objImg[32116623] = binaryString;

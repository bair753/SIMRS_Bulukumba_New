define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('OrderPelayananJenazahCtrl', ['$q', '$rootScope', '$scope', '$state', 'CacheHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, $state, cacheHelper, medifirstService) {
            ...
            $scope.Simpan = function () {
                ...
                medifirstService.post('jenazah/save-order-pelayanan-jenazah', objSave).then(function (e) {
                    medifirstService.postLogging('Order Pelayanan Jenazah', 'Norec strukorder_t', e.data.strukorder.norec,
                        'Order Pelayanan Jenazah No Order-' + e.data.strukorder.noorder + ' No Registrasi ' + $scope.item.noregistrasi
                    ).then(function (res) { })
                    ClearSave();
                })
            }
            ...
            function loadRiwayat(params) {
                medifirstService.get('jenazah/get-riwayat-order-jenazah?' + params).then(function (e) {

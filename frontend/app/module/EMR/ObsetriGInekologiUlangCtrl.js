define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('ObsetriGInekologiUlangCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210060).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    "id": 1, "nama": "Anamnesa",
                    "detail": [
                        { "id": 21032279, "nama": "Auto anamnesa ", "type": "checkbox" },
                        { "id": 21032280, "nama": "Allo anamnesa ", "type": "checkbox" },
                        { "id": 21032281, "nama": "Keluarga ", "type": "checkbox2" },
                        { "id": 21032282, "nama": "Penerjemah bahasa", "type": "checkbox2" },
                        { "id": 21032283, "nama": "Orang lain ", "type": "checkbox2" },
                        { "id": 21032284, "nama": "Nama :", "type": "textbox" },
                        { "id": 21032285, "nama": "Hubungan :", "type": "textbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Cara Masuk",
                    "detail": [
                        { "id": 21032286, "nama": "Jalan tanpa bantuan ", "type": "checkbox3" },
                        { "id": 21032287, "nama": "Jalan dengan bantuan", "type": "checkbox3" },
                        { "id": 21032288, "nama": "Tempat tidur dorong", "type": "checkbox3" },
                        { "id": 21032289, "nama": "Lain-lain", "type": "textbox" }
                    ]
                },
                {
                    "id": 1, "nama": "Asal Masuk",
                    "detail": [
                        { "id": 21032290, "nama": "Non Rujukan", "type": "checkbox3" },
                        { "id": 21032291, "nama": "Rujukan", "type": "checkbox3" },
                    ]
                },
                {
                    "id": 1, "nama": "Alasan Masuk",
                    "detail": [
                        { "id": 21032292, "nama": "", "type": "textarea" },
                    ]
                },
            ]
            $scope.GCSKuantitatif = function ()
            {
                let e = parseInt($scope.item.obj[21032299]) || 0;
                let v = parseInt($scope.item.obj[21032300]) || 0;
                let m = parseInt($scope.item.obj[21032301]) || 0;
                let hasil =  e + v + m;
                console.log(hasil);
                if(hasil >= 14 && hasil <=15)
                {
                    $scope.item.obj[21009276] = hasil + " Compos mentis";
                } else if(hasil >= 12 && hasil <= 13)
                {
                    $scope.item.obj[21009276] = hasil + " Apatis";
                } else if(hasil >= 11 && hasil <= 12)
                {
                    $scope.item.obj[21009276] = hasil + " Somnolent";
                }else if(hasil >= 8 && hasil <= 10)
                {
                    $scope.item.obj[21009276] = hasil + " Stupor";
                }else if(hasil < 5)
                {
                    $scope.item.obj[21009276] = hasil + " Koma";
                }else
                {
                    $scope.item.obj[21009276] = "";
                }
            }
            $scope.listKesadaran = [
                {
                    "id": 1, "nama": "GCS",
                    "detail": [
                        { "id": 21032299, "nama": "E ", "type": "textboxgcs" },
                        { "id": 21032300, "nama": "V ", "type": "textboxgcs" },
                        { "id": 21032301, "nama": "M ", "type": "textboxgcs" },
                        { "id": 21009276, "nama": "Skor ", "type": "textboxskorgcs" },
                    ]
                },
                {
                    "id": 1, "nama": "Refleks Cahaya",
                    "detail": [
                        { "id": 21032302, "nama": "Ka ", "type": "textbox" },
                        { "id": 21032303, "nama": "Ki ", "type": "textbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Ukuruna Pupil",
                    "detail": [
                        { "id": 21032304, "nama": "Ka ", "type": "textbox" },
                        { "id": 21032305, "nama": "Ki ", "type": "textbox" },
                    ]
                }             
            ]
            ...
            $scope.listRujukan2 = [
                {
                    ...
                    "detail": [
                        { "id": 21032306, "nama": "Pola Makan : ","satuan" : "x/hari", "type": "textbox" },
                        { "id": 21032307, "nama": "Pola minum : ","satuan" : "cc/hari", "type": "textbox" },
                        { "id": 21032308, "nama": "BAK : ","satuan" : "x/hari", "type": "textbox" },
                        { "id": 21032309, "nama": "BAB : ","satuan" : "x/hari", "type": "textbox" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 21032310, "nama": "1. Masalah Perkawinan", "type": "label" },
                        { "id": 21032311, "nama": "Ada", "type": "checkbox" },
                        { "id": 21032312, "nama": "Tidak Ada", "type": "checkbox" },
                        { "id": 21032313, "nama": "Cerai", "type": "checkbox3" },
                        { "id": 21032314, "nama": "Istri Baru", "type": "checkbox3" },
                        { "id": 21032315, "nama": "Lain-lain", "type": "textbox2" },
                        { "id": 21032316, "nama": "2. Masalah Kekerasan Fisik", "type": "label" },
                        { "id": 21032317, "nama": "Ada", "type": "checkbox" },
                        { "id": 21032318, "nama": "Tidak Ada", "type": "checkbox" },
                        { "id": 21032319, "nama": "memcederai diri sendiri/oranglain", "type": "label" },
                        { "id": 21032320, "nama": "Pernah", "type": "checkbox" },
                        { "id": 21032321, "nama": "Tidak Pernah", "type": "checkbox" },
                        { "id": 21032322, "nama": "Trauma dalam kehidupan", "type": "label" },
                        { "id": 21032323, "nama": "Ada", "type": "checkbox" },
                        { "id": 21032324, "nama": "Tidak Ada", "type": "checkbox" },
                        { "id": 21032325, "nama": "Jelaskan", "type": "textbox" },
                        { "id": 21032326, "nama": "Gangguan Tidur", "type": "label" },
                        { "id": 21032327, "nama": "Ada", "type": "checkbox" },
                        { "id": 21032328, "nama": "Tidak Ada", "type": "checkbox" },
                        { "id": 21032329, "nama": "Jelaskan", "type": "textbox" },
                        { "id": 21032330, "nama": "Konsultasi dengan Psikolog/Psikiater", "type": "label" },
                        { "id": 21032331, "nama": "Ada", "type": "checkbox" },
                        { "id": 21032332, "nama": "Tidak Ada", "type": "checkbox" },
                        { "id": 21032333, "nama": "Jelaskan", "type": "textbox" },
                        { "id": 21032334, "nama": "Penerimaan saat ini", "type": "label" },
                        { "id": 21032335, "nama": "Tidak menerima", "type": "checkbox" },
                        { "id": 21032336, "nama": "Menerima", "type": "checkbox" },
                        { "id": 21032337, "nama": "Jelaskan", "type": "textbox" },
                        { "id": 21032338, "nama": "Dukungan Sosial dari", "type": "label" },
                        { "id": 21032339, "nama": "Suami", "type": "checkbox" },
                        { "id": 21032340, "nama": "Orang tua", "type": "checkbox" },
                        { "id": 21032341, "nama": "Keluarga", "type": "checkbox" },
                        { "id": 21032342, "nama": "Lain-lain", "type": "textbox" },
                        { "id": 21032343, "nama": "Pendamping persalinan yang diinginkan(bila hamil)", "type": "textarea" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 21032344, "nama": "Status Perkawinan", "type": "label" },
                        { "id": 21032345, "nama": "Single", "type": "checkbox2" },
                        { "id": 21032346, "nama": "Bercerai", "type": "checkbox2" },
                        { "id": 21032347, "nama": "Janda/Duda", "type": "checkbox2" },
                        { "id": 21032348, "nama": "Menikah", "type": "checkbox3" },
                        { "id": 21032349, "nama": "berapa kali?", "type": "textbox" },
                        { "id": 21032350, "nama": "Umur waktu pertama kawin","type": "label" },
                        { "id": 21032351, "nama": "kawin dengan suami ke 1", "type": "textarea","satuan":"tahun" },
                        { "id": 21032352, "nama": "ke 2", "type": "textarea","satuan":"tahun" },
                        { "id": 21032353, "nama": "ke 3", "type": "textarea","satuan":"tahun" },
                        { "id": 21032354, "nama": "Tinggal bersama", "type": "label" },
                        { "id": 21032355, "nama": "Suami/Istri", "type": "checkbox2" },
                        { "id": 21032356, "nama": "Anak", "type": "checkbox2" },
                        { "id": 21032357, "nama": "Orang tua", "type": "checkbox2" },
                        { "id": 21032358, "nama": "Sendiri", "type": "checkbox3" },
                        { "id": 21032359, "nama": "Lainnya", "type": "textbox" },
                        { "id": 21032360, "nama": "Nama", "type": "textbox" },
                        { "id": 21032361, "nama": "Nomer telp.", "type": "textbox" },
                        { "id": 21032362, "nama": "Kebiasaan", "type": "label" },
                        { "id": 21032363, "nama": "Merokok", "type": "checkbox" },
                        { "id": 21032364, "nama": "alkohol", "type": "checkbox" },
                        { "id": 21032365, "nama": "Lainnya", "type": "textbox" },
                        { "id": 21032366, "nama": "Jenis & jumlah perhari", "type": "textbox" },
                        { "id": 21032367, "nama": "Alamat Rumah", "type": "textarea" },
                        { "id": 21032368, "nama": "No.telepon", "type": "textarea" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 21032369, "nama": "agama", "type": "label" },
                        { "id": 21032370, "nama": "Islam", "type": "checkbox3" },
                        { "id": 21032371, "nama": "Protestan", "type": "checkbox3" },
                        { "id": 21032372, "nama": "Hindu", "type": "checkbox3" },
                        { "id": 21032373, "nama": "Khatolik", "type": "checkbox3" },
                        { "id": 21032374, "nama": "Budha", "type": "checkbox3" },
                        { "id": 21032375, "nama": "Konghucu", "type": "checkbox3" },
                        { "id": 21032376, "nama": "Lain-lain", "type": "textbox" }, 
                        { "id": 21032377, "nama": "Kegiatan Spiritual dan nilai-nilai Kepercayaan ", "type": "label" },
                        { "id": 21032378, "nama": "Ada", "type": "checkbox3" },
                        { "id": 21032379, "nama": "Tidak Ada", "type": "checkbox3" }, 
                        { "id": 21032380, "nama": "Sebutkan", "type": "textbox" }, 
                        { "id": 21032381, "nama": "Bahasa sehari-hari", "type": "label" },
                        { "id": 21032382, "nama": "Indonesia", "type": "checkbox3" },
                        { "id": 21032383, "nama": "Inggris", "type": "checkbox3" }, 
                        { "id": 21032384, "nama": "Daerah", "type": "checkbox3" }, 
                        { "id": 21032385, "nama": "Lain-lain", "type": "textbox" },  
                        // { "id": 116064, "nama": "Pola Minum ","satuan" : "cc/hari", "type": "textbox2" },
                        // { "id": 116065, "nama": "BAK ","satuan" : "x/hari", "type": "textbox2" },
                        // { "id": 116066, "nama": "BAB","satuan" : "x/hari", "type": "textbox2" },
                    ]
            ...
            $scope.listRujukan3 = [
                {
                    ...
                    "detail": [
                        { "id": 21032528, "nama": "Pribadi ", "type": "checkbox3" },
                        { "id": 21032529, "nama": "Perusahaan", "type": "checkbox3" },
                        { "id": 21032530, "nama": "Asuransi ", "type": "checkbox3" },
                    ]
                },
                {
                    "id": 1, "nama": "Pendapatan",
                    "detail": [
                        { "id": 21032531, "nama": "UMR", "type": "checkbox2" },
                        { "id": 21032532, "nama": "UMR s/d 5 juta rp", "type": "checkbox2" },
                        { "id": 21032533, "nama": "5 s/d 10 juta rp", "type": "checkbox2" },
                        { "id": 21032534, "nama": "10 s/d 15 juta rp", "type": "checkbox2" },
                        { "id": 21032535, "nama": "> 15 juta rp", "type": "checkbox2" }
                    ]
                },
                // {
                //     "id": 1, "nama": "Asal Masuk",
            ...
            $scope.listRujukan4 = [
                {
                    ...
                    "detail": [
                        { "id": 21032386, "nama": "","satuan":"G", "type": "textbox2" },
                        { "id": 21032387, "nama": "","satuan":"P", "type": "textbox2" },
                        { "id": 21032388, "nama": "","satuan":"A", "type": "textbox2" },
                    ]
                },
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 21032389, "nama": "Hari Pertama hari terakhir haid", "type": "textarea" },
                        { "id": 21032390, "nama": "TP", "type": "textarea" },
                        { "id": 21032391, "nama": "Pergerakan janin pertama kali dirasakan", "type": "textarea" },
                        { "id": 21032392, "nama": "SP", "type": "textarea" },
                        { "id": 21032393, "nama": "Pergerakan Janin dalam 24 jam", "type": "textarea" },
                        { "id": 21032394, "nama": "Imunisasi", "type": "textarea" },
                        { "id": 21032395, "nama": "ANC", "type": "textarea" },
                        { "id": 21032396, "nama": "Teratur", "type": "checkbox" },
                        { "id": 21032397, "nama": "Tidak Teratur", "type": "checkbox" },
                        { "id": 21032398, "nama": "di", "type": "textarea" },
                        { "id": 21032399, "nama": "TTt2 tgl", "type": "textarea" },
                        { "id": 21032400, "nama": "Keluhan yang dirasakan selama kehamilan ini", "type": "textbox" },
            ...
            $scope.listKonsep5 = [
                {
                    ...
                    "detail": [
                        { "id": 21032401, "nama": "Ya", "type": "checkbox" }, 
                        { "id": 21032402, "nama": "Tidak", "type": "checkbox" },
                        { "id": 21032403, "nama": "Jelaskan", "type": "textbox" },
                ...
                },
                {
                    "id": 1, "nama": "Makanan",
                    "detail": [
                        { "id": 21032404, "nama": "Ya", "type": "checkbox" }, 
                        { "id": 21032405, "nama": "Tidak", "type": "checkbox" },
                        { "id": 21032406, "nama": "Jelaskan", "type": "textbox" },
                ...
                },
                {
                    "id": 1, "nama": "Debu",
                    "detail": [
                        { "id": 21032407, "nama": "Ya", "type": "checkbox" }, 
                        { "id": 21032408, "nama": "Tidak", "type": "checkbox" },
                        { "id": 21032409, "nama": "Jelaskan", "type": "textbox" },
                ...
                },
                {
                    "id": 1, "nama": "Lain-lain",
                    "detail": [
                        { "id": 21032410, "nama": "", "type": "textarea" },
            ...
            $scope.listNyeri3 = [{
                ...
                "detail": [
                    { "id": 21032421, "nama": "Ruda Paksa", "type": "checkbox" },
                    { "id": 21032422, "nama": "Benturan", "type": "checkbox" },
                    { "id": 21032423, "nama": "Sayatan", "type": "checkbox" },
                    { "id": 21032424, "nama": "dll", "type": "textbox" },
                ]
            },
            {
                "id": 1, "nama": "Quality",
                "detail": [
                    { "id": 21032425, "nama": "Tertusuk", "type": "checkbox" },
                    { "id": 21032426, "nama": "Tertekan/Tertindih", "type": "checkbox" },
                    { "id": 21032427, "nama": "Diiris-iris", "type": "checkbox" },
                    { "id": 21032428, "nama": "dll", "type": "textbox" },
                ]
            },
            {
                "id": 1, "nama": "menjalar",
                "detail": [
                    { "id": 21032429, "nama": "Ya", "type": "checkbox" },
                    { "id": 21032430, "nama": "Tidak", "type": "checkbox" },
                    { "id": 21032431, "nama": "ke :", "type": "textbox" },
                ]
            },
            {
                "id": 1, "nama": "Scala",
                "detail": [
                    { "id": 21032432, "nama": "ke :", "type": "textbox" },
                ]
            },
            {
                "id": 1, "nama": "Time",
                "detail": [
                    { "id": 21032433, "nama": "Jarang", "type": "checkbox" },
                    { "id": 21032434, "nama": "Hilang/Timbul", "type": "checkbox" },
                    { "id": 21032435, "nama": "Terus-Menerus", "type": "checkbox" },
                ]
            }
            ]
           $scope.listStatusFungsional = [
                {
                    ...
                    "detail": [
                        { "id": 21032452, "nama": "Normal ", "type": "checkbox" },
                        { "id": 21032453, "nama": "Kabur ", "type": "checkbox" },
                        { "id": 21032454, "nama": "Kacamata ", "type": "checkbox" },
                        { "id": 21032455, "nama": "Lensa Kontak ", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Penciuman :",
                    "detail": [
                        { "id": 21032456, "nama": "Normal ", "type": "checkbox" },
                        { "id": 21032457, "nama": "Tidak ", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Pendenganran :",
                    "detail": [
                        { "id": 21032458, "nama": "Normal ", "type": "checkbox" },
                        { "id": 21032459, "nama": "Tuli Kanan/Kiri ", "type": "checkbox" },
                        { "id": 21032460, "nama": "Alat Bantu dengan kanan/kiri ", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Kognitif :",
                    "detail": [
                        { "id": 21032461, "nama": "Orientasi penuh ", "type": "checkbox" },
                        { "id": 21032462, "nama": "Bingung", "type": "checkbox" },
                        { "id": 21032463, "nama": "Pelupa", "type": "checkbox" },
                        { "id": 21032464, "nama": "Tidak Dapat dimengerti", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Aktifitas Sehari-hari :",
                    "detail": [
                        { "id": 21032465, "nama": "Mandiri", "type": "checkbox" },
                        { "id": 21032466, "nama": "Bantuan Minimal", "type": "checkbox" },
                        { "id": 21032467, "nama": "Bantuan Sebagian", "type": "checkbox" },
                        { "id": 21032468, "nama": "Ketergantungan Total", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Berjalan :",
                    "detail": [
                        { "id": 21032469, "nama": "Tidak Ada Kesulitan", "type": "checkbox" },
                        { "id": 21032470, "nama": "Perlu Bantuan", "type": "checkbox" },
                        { "id": 21032471, "nama": "Sering Jatuh ", "type": "checkbox" },
                        { "id": 21032472, "nama": "Kelumpuhan", "type": "checkbox" },
                    ]
                }
            ]
            ...
            $scope.listNyeri5 = [
            {
                ...
                "detail": [
                    { "id": 21032488, "nama": "Tidak ", "type": "checkbox" },
                    { "id": 21032489, "nama": "Ya ", "type": "checkbox" },
                ]
            },
            {
                "id": 1, "nama": "B. Jika Ya,sebutkan hambatanya( bisa dilingkari lebih dari satu)",
                "detail": [
                    { "id": 21032490, "nama": "Pendenganran ", "type": "checkbox" },
                    { "id": 21032491, "nama": "Penglihatan ", "type": "checkbox" },
                    { "id": 21032492, "nama": "Kognitif ", "type": "checkbox" },
                    { "id": 21032493, "nama": "Fisik ", "type": "checkbox" },
                    { "id": 21032494, "nama": "Budaya ", "type": "checkbox" },
                    { "id": 21032495, "nama": "Agama ", "type": "checkbox" },
                    { "id": 21032496, "nama": "Emosi ", "type": "checkbox" },
                    { "id": 21032497, "nama": "Bahasa ", "type": "checkbox" },
                    { "id": 21032498, "nama": "Lainnya ", "type": "textbox" },
                ]
            },
            {
                "id": 1, "nama": "C. Perlu Penerjemah",
                "detail": [
                    { "id": 21032499, "nama": "Ya ", "type": "checkbox" },
                    { "id": 21032500, "nama": "Tidak ", "type": "checkbox" },
                    { "id": 21032501, "nama": "Sebutkan ", "type": "textbox" },
            ...
            },
            {
                ...
                "detail": [
                    { "id": 21032502, "nama": "Diagnosa & Manajemen ", "type": "checkbox2" },
                    { "id": 21032503, "nama": "Obat-obatan ", "type": "checkbox2" },
                    { "id": 21032504, "nama": "Perawatan Luka ", "type": "checkbox2" },
                    { "id": 21032505, "nama": "Rehabilitasi ", "type": "checkbox2" },
                    { "id": 21032506, "nama": "Manajemen nyeri ", "type": "checkbox2" },
                    { "id": 21032507, "nama": "Diet & Nutrisi ", "type": "checkbox2" },
                    { "id": 21032508, "nama": "Lain-lain  : ", "type": "textbox" },
                ]
            }             
            ]
            $scope.listNyeri6 = [{
            ...
            // },
            {
                ...
                "detail": [
                    { "id": 21032509, "nama": "ya  ", "type": "checkbox" },
                    { "id": 21032510, "nama": "tidak ", "type": "checkbox" },
                ]
            },
            {
                "id": 1, "nama": "Perawatan dan Pengobatan lanjutan",
                "detail": [
                    { "id": 21032511, "nama": "ya  ", "type": "checkbox" },
                    { "id": 21032512, "nama": "tidak ", "type": "checkbox" },
                ]
            },
            {
                "id": 1, "nama": "Bantuan untuk melakukan Aktifitas sehari-hari",
                "detail": [
                    { "id": 21032513, "nama": "ya  ", "type": "checkbox" },
                    { "id": 21032514, "nama": "tidak ", "type": "checkbox" },
                ]
            },
            {
                "id": 1, "nama": "Bila salah satu Jawaban Ya, maka lakukan Prencanaan lanjutan",
                "detail": [
                    { "id": 21032515, "nama": "Perawatan diri (Mandi, BAK,BAB)  ", "type": "checkbox" },
                    { "id": 21032516, "nama": "Pemantauan pemberian obat ", "type": "checkbox" },
                    { "id": 21032517, "nama": "Pemantauan diet ", "type": "checkbox" },
                    { "id": 21032518, "nama": "Perawatan Luka ", "type": "checkbox" },
                    { "id": 21032519, "nama": "Latihan Fisik Lanjutan ", "type": "checkbox" },
                    { "id": 21032520, "nama": "Pendampingan tenaga khusus dirumah ", "type": "checkbox" },
                    { "id": 21032521, "nama": "Bantuan medis/perawatan di rumah (Homecare) ", "type": "checkbox" },
                    { "id": 21032522, "nama": "Bantuan untuk melakukan Aktifitas fisik (kursi roda, alat bantu jalan) ", "type": "checkbox" },
            ...
            $scope.listSkorNRC = [{
                "id": 8, "nama": "Score ",
                "detail": [
                    { "id": 21032411, "nama": "0= Tidak Nyeri", "type": "checkbox" },
                    { "id": 21032412, "nama": "1 - 3= Nyeri Ringan", "type": "checkbox"},
                    { "id": 21032413, "nama": "4 - 6= Nyeri Sedang", "type": "checkbox" },
                    { "id": 21032414, "nama": "7 - 10= Nyeri Berat", "type": "checkbox"},
                ]
            }]
            $scope.listSkorWong = [{
                "id": 9, "nama": "Score ",
                "detail": [
                    { "id": 21032415, "nama": "0 - 1= Tidak Ada Nyeri", "type": "checkbox"},
                    { "id": 21032416, "nama": "2 - 3= Sedikit Nyeri", "type": "checkbox"},
                    { "id": 21032417, "nama": "4 - 5= Cukup Nyeri", "type": "checkbox" },
                    { "id": 21032418, "nama": "6 - 7= Lumayan Nyeri", "type": "checkbox"},
                    { "id": 21032419, "nama": "8 - 9= Sangat Nyeri", "type": "checkbox"},
                    { "id": 21032420, "nama": "10= Amat Sangat Nyeri", "type": "checkbox", },
                ]
            }]
            $scope.listNyeriAnak = [
                {
            ...
            $scope.listNutrisi = [

                {
                    ...
                    "detail": [
                        { "id": 21032474, "nama": "a. Tidak ada penurunan berat badan", "descNilai": "0" },
                        { "id": 21032475, "nama": "b. Tidak yakin / tidak tahu / terasa baju lebih longgar", "descNilai": "2" },
                        { "id": 21032476, "nama": "c. Penurunan : > 1 - 5 kg", "descNilai": "1" },
                        { "id": 21032477, "nama": "               > 6 - 10 kg", "descNilai": "2" },
                        { "id": 21032478, "nama": "               > 11 - 15 kg", "descNilai": "3" },
                        { "id": 21032479, "nama": "               > 15 kg", "descNilai": "4" },
                        { "id": 21032480, "nama": "  Tidak tahu berapa penurunan berat badan", "descNilai": "2" },
                    ]
                },
                {
                    "id": 2, "nama": "Asupan Makan Berkurang karena tidak nafsu makan",
                    "detail": [
                        { "id": 21032481, "nama": "a. Tidak", "descNilai": "0" },
                        { "id": 21032482, "nama": "b. Ya", "descNilai": "1" }
                    ]
                },
            ]
            $scope.listNutrisi2 = [
...

                {
                    ...
                    "detail": [
                        { "id": 21032436, "nama": "Tidak", "descNilai": "0" },
                        { "id": 21032437, "nama": "Ya", "descNilai": "25" },
                    ]
                },
                {
                    "id": 2, "nama": "Diagnosa Sekunder",
                    "detail": [
                        { "id": 21032438, "nama": "Tidak", "descNilai": "0" },
                        { "id": 21032439, "nama": "Ya", "descNilai": "15" },
                    ]
                },
                {
                    "id": 3, "nama": "Ambulasi",
                    "detail": [
                        { "id": 21032440, "nama": "3.1 Istirahat ditempat Tidur, Kursi Roda, bantuan perawat", "descNilai": "0" },
                        { "id": 21032441, "nama": "3.2 Kruk,tongkat,walker", "descNilai": "15" },
                        { "id": 21032442, "nama": "3.3 Furniture", "descNilai": "30" },
                    ]
                },
                {
                    "id": 4, "nama": "IV Line/Heparin Lock/Obat",
                    "detail": [
                        { "id": 21032443, "nama": "a. Tidak", "descNilai": "0" },
                        { "id": 21032444, "nama": "b. Ya", "descNilai": "20" }
                    ]
                },
                {
                    "id": 5, "nama": "Gaya Berjalan",
                    "detail": [
                        { "id": 21032445, "nama": "Normal, Istirahat Total", "descNilai": "0" },
                        { "id": 21032446, "nama": "Lemah", "descNilai": "10" },
                        { "id": 21032447, "nama": "Gangguan", "descNilai": "20" },
                    ]
                },
                {
                    "id": 6, "nama": "Status Mental",
                    "detail": [
                        { "id": 21032448, "nama": "Orientasi Baik", "descNilai": "0" },
                        { "id": 21032449, "nama": "Keterbatasan daya ingat", "descNilai": "15" },
                    ]
                },
            ]
            $scope.listPasienDiagKhusus = [
            {
                ...
                "detail": [
                    { "id": 21032484, "nama": "Sudah dilaporkan ke tim Terapi Gizi", "type": "label" },
                    { "id": 21032485, "nama": "Ya", "type": "checkbox" },
                    { "id": 21032486, "nama": "Tidak", "type": "checkbox" },
                    { "id": 21032487, "nama": "Tanggal & jam,", "type": "datetime" },
                ]
            }
            ]
            $scope.listPsiko = [{
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'ObsetriGInekologiUlangCtrl ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

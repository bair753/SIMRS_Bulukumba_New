define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('PersetujuanTindakanHemodialisaCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.listPeringatan = [
                {
                    "id": 1,
                    "detail": [
                        { "id": 428355, "nama": "Kondisi dan diagnosis pasien :", "type": "checkbox2", "satuan": "", "nourut": 1 },
                        { "id": 428356, "nama": "Gagal ginjal tahap akhir", "type": "checkbox3", "satuan": "", "nourut": 2 },
                        { "id": 428357, "nama": "Gagal ginjal akut", "type": "checkbox3", "satuan": "", "nourut": 3 },
                        { "id": 428358, "nama": "Rencana tindakan kedokteran : Terapi pengganti fungsi ginjal", "type": "checkbox2", "satuan": "", "nourut": 4 },
                        { "id": 32116611, "nama": "Penggunaan Dialyzer :", "type": "checkbox2", "satuan": "", "nourut": 5 },
                        { "id": 32116612, "nama": "Single Use", "type": "checkbox3", "satuan": "", "nourut": 6 },
                        { "id": 32116613, "nama": "Re-use", "type": "checkbox3", "satuan": "", "nourut": 7 },
                        { "id": 428359, "nama": "Dokter penanggung jawab tindakan/pengobatan :", "type": "checkbox", "satuan": "", "nourut": 8 },
                        { "id": 428360, "nama": "", "type": "combobox", "satuan": "", "nourut": 9 },
                        { "id": 428361, "nama": "Tujuan/manfaat tindakan kedokteran yang dilakukan : Untuk membuat zat-zat yang berbahaya dalam tubuh", "type": "checkbox2", "satuan": "", "nourut": 10 },
                        { "id": 428362, "nama": "Kekurangan tindakan kedokteran yang dilakukan : Dilakukan berulang dan tindakan menggunakan mesin", "type": "checkbox2", "satuan": "", "nourut": 11 },
                        { "id": 428363, "nama": "Alternatif tindakan lain / perluasan daerah operasi dan risikonya :", "type": "checkbox2", "satuan": "", "nourut": 12 },
                        { "id": 428364, "nama": "CAPD (Continuous Ambulatory Peritoneal Dialysis)", "type": "checkbox3", "satuan": "", "nourut": 13 },
                        { "id": 428365, "nama": "Transplantasi ginjal", "type": "checkbox3", "satuan": "", "nourut": 14 },
                        { "id": 428366, "nama": "Dialisis Peritonal akut", "type": "checkbox3", "satuan": "", "nourut": 15 },
                        { "id": 428367, "nama": "Kemungkinan keberhasilan :", "type": "checkbox", "satuan": "", "nourut": 16 },
                        { "id": 428368, "nama": "", "type": "textbox2", "satuan": "%", "nourut": 17},
                        { "id": 428369, "nama": "Kemungkinan masalah terkait proses pemulihan (Resiko/komplikasi) : hipotensis, kram otot, mual dan muntah, sakit kepala, nyeri dada, nyeri punggung, gatal, demam menggigil, perdarahan, reaksi alergi, syok, hipertensi krisis, gangguan irama jantung, kejang, emboli udara, penularan infeksi", "type": "checkbox2", "satuan": "", "nourut": 18 },
                        { "id": 428370, "nama": "Kemungkinan hasil tidak dirawat/diberi tindakan kedokteran : pernurukan kondisi pasien", "type": "checkbox2", "satuan": "", "nourut": 19 },
                        { "id": 428371, "nama": "Prognosis terhadap tindakan yang mungkin dilakukan", "type": "checkbox", "satuan": "", "nourut": 20 },
                        { "id": 428372, "nama": "", "type": "textbox2", "satuan": "", "nourut": 21 }
                    ]
                }
            ];

            $scope.listPenjelasanDokter = [
                {
                    "id": 1,
                    "detail": [
                        { "id": 428373, "nama": "Tindakan pemberian obat-obatan dan transfuse darah kemungkinan diperlukan dan semua tindakan ini mengandung risiko", "type": "checkbox2" },
                        { "id": 428374, "nama": "Operasi atau tindakan tambahan kemungkinan diperlukan jika dokter menemukan sesuatu yang tak terduga", "type": "checkbox2" },
                        { "id": 428375, "nama": "Operasi/tindakan ini memungkinkan tidak memberikan hasil yang sesuai harapan walaupun sudah dilakukan sesuai standar prosedur yang berlaku", "type": "checkbox2" }
                    ]
                }
            ];
            ...
            $scope.cetakPdf = function () {
                ...
                window.open(config.baseApiBackend + 'report/cetak-persetujuan-tindakan-hemodialisa?nocm='
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    //     }
                    // }
                    if (antrianPasien.iddpjp != null && antrianPasien.dokterdpjp) {
                        $scope.item.obj[428360] = {
                            value: antrianPasien.iddpjp,
                            text: antrianPasien.dokterdpjp
                        }
                    }
                    if (antrianPasien.iddpjp != null && antrianPasien.dokterdpjp) {
                        $scope.item.obj[428385] = {
                            value: antrianPasien.iddpjp,
                            text: antrianPasien.dokterdpjp
                        }
                    }
                    $scope.item.obj[428379] = antrianPasien.namapasien;
                    $scope.item.obj[428380] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
                    $scope.item.obj[428381] = antrianPasien.jeniskelamin;
                    $scope.item.obj[428382] = antrianPasien.alamatlengkap;
                    $scope.item.obj[428384] = $scope.now;
                })
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Persetujuan Tindakan Hemodialisa ' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('JatuhMenurutMorseCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210034).then(function (e) {
            ...
            $scope.listNutrisi = [
...

                {
                    ...
                    "detail": [
                        { "id": 21030910, "nama": "Tidak", "descNilai": "0" },
                        { "id": 21030911, "nama": "Ya", "descNilai": "25" },
                    ]
                },
                {
                    "id": 2, "nama": "Diagnosa Sekunder",
                    "detail": [
                        { "id": 21030912, "nama": "Tidak", "descNilai": "0" },
                        { "id": 21030913, "nama": "Ya", "descNilai": "15" },
                    ]
                },
                {
                    "id": 3, "nama": "Ambulasi",
                    "detail": [
                        { "id": 21030914, "nama": "3.1 Istirahat ditempat Tidur, Kursi Roda, bantuan perawat", "descNilai": "0" },
                        { "id": 21030915, "nama": "3.2 Kruk,tongkat,walker", "descNilai": "15" },
                        { "id": 21030916, "nama": "3.3 Furniture", "descNilai": "30" },
                    ]
                },
                {
                    "id": 4, "nama": "IV Line/Heparin Lock/Obat",
                    "detail": [
                        { "id": 21030917, "nama": "a. Tidak", "descNilai": "0" },
                        { "id": 21030918, "nama": "b. Ya", "descNilai": "20" }
                    ]
                },
                {
                    "id": 5, "nama": "Gaya Berjalan",
                    "detail": [
                        { "id": 21030919, "nama": "Normal, Istirahat Total", "descNilai": "0" },
                        { "id": 21030920, "nama": "Lemah", "descNilai": "10" },
                        { "id": 21030921, "nama": "Gangguan", "descNilai": "20" },
                    ]
                },
                {
                    "id": 6, "nama": "Status Mental",
                    "detail": [
                        { "id": 21030922, "nama": "Orientasi Baik", "descNilai": "0" },
                        { "id": 21030923, "nama": "Keterbatasan daya ingat", "descNilai": "15" },
                    ]
                },
            ]
            $scope.listNutrisi2 = [
...

                {
                    "id": 1, "nama": "Riwayat Jatuh segera atau dalam kurun waktu 3 bulan (umur > 65 tahun dalma waktu 12 bulan)",
                    "detail": [
                        { "id": 21031095, "nama": "Tidak", "descNilai": "0" },
                        { "id": 21031096, "nama": "Ya", "descNilai": "25" },
                    ]
                },
                {
                    "id": 2, "nama": "Diagnosa Sekunder",
                    "detail": [
                        { "id": 21031097, "nama": "Tidak", "descNilai": "0" },
                        { "id": 21031098, "nama": "Ya", "descNilai": "15" },
                    ]
                },
                {
                    "id": 3, "nama": "Ambulasi",
                    "detail": [
                        { "id": 21031099, "nama": "3.1 Istirahat ditempat Tidur, Kursi Roda, bantuan perawat", "descNilai": "0" },
                        { "id": 21031100, "nama": "3.2 Kruk,tongkat,walker", "descNilai": "15" },
                        { "id": 21031101, "nama": "3.3 Furniture", "descNilai": "30" },
                    ]
                },
                {
                    "id": 4, "nama": "IV Line/Heparin Lock/Obat",
                    "detail": [
                        { "id": 21031102, "nama": "a. Tidak", "descNilai": "0" },
                        { "id": 21031103, "nama": "b. Ya", "descNilai": "20" }
                    ]
                },
                {
                    "id": 5, "nama": "Gaya Berjalan",
                    "detail": [
                        { "id": 21031104, "nama": "Normal, Istirahat Total", "descNilai": "0" },
                        { "id": 21031105, "nama": "Lemah", "descNilai": "10" },
                        { "id": 21031106, "nama": "Gangguan", "descNilai": "20" },
                    ]
                },
                {
                    "id": 6, "nama": "Status Mental",
                    "detail": [
                        { "id": 21031107, "nama": "Orientasi Baik", "descNilai": "0" },
                        { "id": 21031108, "nama": "Keterbatasan daya ingat", "descNilai": "15" },
                    ]
                },
            ]
            $scope.listNutrisi3 = [
...

                {
                    "id": 1, "nama": "Riwayat Jatuh segera atau dalam kurun waktu 3 bulan (umur > 65 tahun dalma waktu 12 bulan)",
                    "detail": [
                        { "id": 21031112, "nama": "Tidak", "descNilai": "0" },
                        { "id": 21031113, "nama": "Ya", "descNilai": "25" },
                    ]
                },
                {
                    "id": 2, "nama": "Diagnosa Sekunder",
                    "detail": [
                        { "id": 21031114, "nama": "Tidak", "descNilai": "0" },
                        { "id": 21031115, "nama": "Ya", "descNilai": "15" },
                    ]
                },
                {
                    "id": 3, "nama": "Ambulasi",
                    "detail": [
                        { "id": 21031116, "nama": "3.1 Istirahat ditempat Tidur, Kursi Roda, bantuan perawat", "descNilai": "0" },
                        { "id": 21031117, "nama": "3.2 Kruk,tongkat,walker", "descNilai": "15" },
                        { "id": 21031118, "nama": "3.3 Furniture", "descNilai": "30" },
                    ]
                },
                {
                    "id": 4, "nama": "IV Line/Heparin Lock/Obat",
                    "detail": [
                        { "id": 21031119, "nama": "a. Tidak", "descNilai": "0" },
                        { "id": 21031120, "nama": "b. Ya", "descNilai": "20" }
                    ]
                },
                {
                    "id": 5, "nama": "Gaya Berjalan",
                    "detail": [
                        { "id": 21031121, "nama": "Normal, Istirahat Total", "descNilai": "0" },
                        { "id": 21031122, "nama": "Lemah", "descNilai": "10" },
                        { "id": 21031123, "nama": "Gangguan", "descNilai": "20" },
                    ]
                },
                {
                    "id": 6, "nama": "Status Mental",
                    "detail": [
                        { "id": 21031124, "nama": "Orientasi Baik", "descNilai": "0" },
                        { "id": 21031125, "nama": "Keterbatasan daya ingat", "descNilai": "15" },
                    ]
                },
            ]
                    ...
                    if (parseFloat($scope.cc.emrfk) == dataLoad[i].emrfk) {
                        ...
                        if (dataLoad[i].type == "textbox") {
                            ...
                            if(dataLoad[i].emrdfk == 115952)
                              ...
                              if(dataLoad[i].emrdfk == 21030925)
                                $scope.skorNutrisi = parseFloat(dataLoad[i].value)
                                if(dataLoad[i].emrdfk == 21031111)
                                $scope.SkorNutrisi2 = parseFloat(dataLoad[i].value)
                                if(dataLoad[i].emrdfk == 21031128)
                                $scope.SkorNutrisi3 = parseFloat(dataLoad[i].value)
            ...
            $scope.getSkorNutrisi = function (stat) {
                ...
                $scope.item.obj[21030925] = $scope.skorNutrisi
            }
            $scope.SkorNutrisi2 = 0
            $scope.getSkorNutrisi2 = function (stat) {
                var arrobj = Object.keys($scope.item.obj)
                var arrSave = []
                for (var i = arrobj.length - 1; i >= 0; i--) {
                    if (arrobj[i] == stat.id) {
                        if ($scope.item.obj[parseFloat(arrobj[i])] == true) {
                            $scope.SkorNutrisi2 = $scope.SkorNutrisi2 + parseFloat(stat.descNilai)
                            break
                        } else {
                            $scope.SkorNutrisi2 = $scope.SkorNutrisi2 - parseFloat(stat.descNilai)
                            break
                ...
                $scope.item.obj[21031111] = $scope.SkorNutrisi2
            }
            $scope.SkorNutrisi3 = 0
            $scope.getSkorNutrisi3 = function (stat) {
                var arrobj = Object.keys($scope.item.obj)
                var arrSave = []
                for (var i = arrobj.length - 1; i >= 0; i--) {
                    if (arrobj[i] == stat.id) {
                        if ($scope.item.obj[parseFloat(arrobj[i])] == true) {
                            $scope.SkorNutrisi3 = $scope.SkorNutrisi3 + parseFloat(stat.descNilai)
                            break
                        } else {
                            $scope.SkorNutrisi3 = $scope.SkorNutrisi3 - parseFloat(stat.descNilai)
                            break
                ...
                $scope.item.obj[21031128] = $scope.SkorNutrisi3
            }
            ...
            $scope.$watch('item.obj[21030925]', function(newValue,oldValue){
                    if(newValue!=oldValue){
                
                      if($scope.item.obj[21030925] >= 0 && $scope.item.obj[21030925]<= 24){
                          $scope.item.obj[21030926] = "Risiko Rendah"
                          
                      }
                       if($scope.item.obj[21030925] >= 25 && $scope.item.obj[21030925]<= 44){
                          $scope.item.obj[21030926] = "Risiko Sedang"
                          
                      }
                       if($scope.item.obj[21030925] >= 45 ){
                          $scope.item.obj[21030926] = "Risiko Tinggi"
            ...
            $scope.$watch('item.obj[21031111]', function(newValue,oldValue){
                    if(newValue!=oldValue){
                
                      if($scope.item.obj[21031111] >= 0 && $scope.item.obj[21031111]<= 24){
                          $scope.item.obj[21031110] = "Risiko Rendah"
                          
                      }
                       if($scope.item.obj[21031111] >= 25 && $scope.item.obj[21031111]<= 44){
                          $scope.item.obj[21031110] = "Risiko Sedang"
                          
                      }
                       if($scope.item.obj[21031111] >= 45 ){
                          $scope.item.obj[21031110] = "Risiko Tinggi"
            ...
            $scope.$watch('item.obj[21031128]', function(newValue,oldValue){
                    if(newValue!=oldValue){
                
                      if($scope.item.obj[21031128] >= 0 && $scope.item.obj[21031128]<= 24){
                          $scope.item.obj[21031127] = "Risiko Rendah"
                          
                      }
                       if($scope.item.obj[21031128] >= 25 && $scope.item.obj[21031128]<= 44){
                          $scope.item.obj[21031127] = "Risiko Sedang"
                          
                      }
                       if($scope.item.obj[21031128] >= 45 ){
                          $scope.item.obj[21031127] = "Risiko Tinggi"
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'JatuhMenurutMorseCtrl ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

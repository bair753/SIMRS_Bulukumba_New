define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormBCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.cetakPdf = function () {
                ...
                client.get('http://127.0.0.1:1237/printvb/e-rekammedis?cetak-emr-formb&id='
                 + $scope.cc.nocm + '&emr=' + norecEMR + '&view=true' + '&idemr=' + 145  , function (response) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 145).then(function (e) {
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                $scope.item.obj = []
                $scope.item.obj2 = []
                $scope.item.obj[13204] = $scope.cc.tglregistrasi
                $scope.item.obj[13205] ={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
                $scope.item.obj[13206] ={ value: $scope.cc.objectruanganfk, text: $scope.cc.namaruangan }
                $scope.item.obj[13207] ={ value: $scope.cc.objectkelasfk, text: $scope.cc.namakelas }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'F O R M B - E V A L U A S I A W A L M P P ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

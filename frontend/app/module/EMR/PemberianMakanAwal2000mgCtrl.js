define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('PemberianMakanAwal2000mgCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.cetakPdf = function () {
                ...
                window.open(config.baseApiBackend + 'report/cetak-pemberian-makan-awal-2000?nocm='
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Pemberian Makan Awal 2000-2500 gram' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '
            ...
            $scope.listInfo1 = [
                {
                    id: 1,
                    detail: [
                        { id: 1001752, caption: 'HARI 1 :', type: 'label' },
                        { id: 1001753, caption: '00 cc/kg/hr', type: 'label' },
                        { id: 1001754, caption: '80 cc/kg/hr', type: 'label' },
                        { id: 1001755, caption: 'D10', type: 'label' },
                        { id: 1001756, caption: '80 cc/kg/hr', type: 'label' },
                    ]
                },
                {
                    id: 2,
                    detail: [
                        { id: 1001757, caption: 'HARI 2 :', type: 'label' },
                        { id: 1001758, caption: '10 cc/kg/hr', type: 'label' },
                        { id: 1001759, caption: '90 cc/kg/hr', type: 'label' },
                        { id: 1001760, caption: 'D10', type: 'label' },
                        { id: 1001761, caption: '100 cc/kg/hr', type: 'label' },
                    ]
                },
                {
                    id: 3,
                    detail: [
                        { id: 1001762, caption: 'HARI 3 :', type: 'label' },
                        { id: 1001763, caption: '30 cc/kg/hr', type: 'label' },
                        { id: 1001764, caption: '70 cc/kg/hr', type: 'label' },
                        { id: 1001765, caption: 'D10 1/5 NS', type: 'label' },
                        { id: 1001766, caption: '100 cc/kg/hr', type: 'label' },
                    ]
                },
                {
                    id: 4,
                    detail: [
                        { id: 1001767, caption: 'HARI 4 :', type: 'label' },
                        { id: 1001768, caption: '50 cc/kg/hr', type: 'label' },
                        { id: 1001769, caption: '70 cc/kg/hr', type: 'label' },
                        { id: 1001770, caption: 'D10 1/5 NS', type: 'label' },
                        { id: 1001771, caption: '120 cc/kg/hr', type: 'label' },
                    ]
                },
                {
                    id: 5,
                    detail: [
                        { id: 1001772, caption: 'HARI 5 :', type: 'label' },
                        { id: 1001773, caption: '70 cc/kg/hr', type: 'label' },
                        { id: 1001774, caption: '50 cc/kg/hr', type: 'label' },
                        { id: 1001775, caption: 'D10 1/5 NS', type: 'label' },
                        { id: 1001776, caption: '120 cc/kg/hr', type: 'label' },
                    ]
                },
                {
                    id: 6,
                    detail: [
                        { id: 1001777, caption: 'HARI 6 :', type: 'label' },
                        { id: 1001778, caption: '90 cc/kg/hr', type: 'label' },
                        { id: 1001779, caption: '40 cc/kg/hr', type: 'label' },
                        { id: 1001780, caption: 'D10 1/5 NS', type: 'label' },
                        { id: 1001781, caption: '130 cc/kg/hr', type: 'label' },
                    ]
                },
                {
                    id: 7,
                    detail: [
                        { id: 1001782, caption: 'HARI 7 :', type: 'label' },
                        { id: 1001783, caption: '100 cc/kg/hr', type: 'label' },
                        { id: 1001784, caption: '20 cc/kg/hr', type: 'label' },
                        { id: 1001785, caption: 'D10 1/5 NS', type: 'label' },
                        { id: 1001786, caption: '140 cc/kg/hr', type: 'label' },
                    ]
                },
                {
                    id: 8,
                    detail: [
                        { id: 1001787, caption: 'HARI 8 :', type: 'label' },
                        { id: 1001788, caption: '150 cc/kg/hr', type: 'label' },
                        { id: 1001789, caption: 'OFF', type: 'label' },
                        { id: 1001790, caption: 'D10 1/5 NS', type: 'label' },
                        { id: 1001791, caption: '150 cc/kg/hr', type: 'label' },
                    ]
                },
                {
                    id: 9,
                    detail: [
                        { id: 1001792, caption: 'HARI 9 :', type: 'label' },
                        { id: 1001793, caption: 'LEMBAR PEMELIHARAAN', type: 'label' },
                        { id: 1001794, caption: 'OFF', type: 'label' },
                        { id: 1001795, caption: 'D10 1/5 NS', type: 'label' },
                        { id: 1001796, caption: '150 cc/kg/hr', type: 'label' },
                    ]
                },
                {
                    id: 10,
                    detail: [
                        { id: 1001797, caption: 'HARI 10 :', type: 'label' },
                        { id: 1001798, caption: 'LEMBAR PEMELIHARAAN', type: 'label' },
                        { id: 1001799, caption: 'OFF', type: 'label' },
                        { id: 1001800, caption: 'D10 1/5 NS', type: 'label' },
                        { id: 1001801, caption: '150 cc/kg/hr', type: 'label' },
                    ]
                },
                {
                    id: 11,
                    detail: [
                        { id: 1001802, caption: 'HARI 11 :', type: 'label' },
                        { id: 1001803, caption: 'LEMBAR PEMELIHARAAN', type: 'label' },
                        { id: 1001804, caption: 'OFF', type: 'label' },
                        { id: 1001805, caption: 'D10 1/5 NS', type: 'label' },
                        { id: 1001806, caption: '150 cc/kg/hr', type: 'label' },
                    ]
                },
                {
                    id: 12,
                    detail: [
                        { id: 1001807, caption: 'HARI 12 :', type: 'label' },
                        { id: 1001808, caption: 'LEMBAR PEMELIHARAAN', type: 'label' },
                        { id: 1001809, caption: 'OFF', type: 'label' },
                        { id: 1001810, caption: 'D10 1/5 NS', type: 'label' },
                        { id: 1001811, caption: '150 cc/kg/hr', type: 'label' },
                    ]
                },
            ]

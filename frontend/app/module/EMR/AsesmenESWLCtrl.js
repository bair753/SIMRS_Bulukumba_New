define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AsesmenESWLCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 21032).then(function (e) {
            ...
            $scope.listRujukan = [
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 21020884, "nama": "Jalan", "type": "checkbox3" },
                        { "id": 21020885, "nama": "Kursi Roda", "type": "checkbox3" },
                        { "id": 21020886, "nama": "Brankar", "type": "checkbox3" },
                    ]
                },
                {
                    "id": 1, "nama": "Asal Masuk",
                    "detail": [
                        { "id": 21020888, "nama": "IRJ", "type": "checkbox3" },
                        { "id": 21020889, "nama": "Ranap", "type": "checkbox3" },
                        { "id": 21020887, "nama": "", "type": "textbox" }
                    ]
                },
                {
            ...
            $scope.listKesadaran = [
                {
                    "id": 1, "nama": "GCS",
                    "detail": [
                        { "id": 21020832, "nama": "E ", "type": "textbox3" },
                        { "id": 21020833, "nama": "V ", "type": "textbox3" },
                        { "id": 21020834, "nama": "M ", "type": "textbox3" },
                        { "id": 21009269, "nama": "Skor", "type": "textboxdis" },
                    ]
                },
                {
            ...
            $scope.listRujukan2 = [
                {
                    ...
                    "detail": [
                        { "id": 21020841, "nama": "Pola Makan : ","satuan" : "x/hari", "type": "textbox3" },
                        { "id": 21040360, "nama": "Terakhir Jam","satuan" : "", "type": "textbox3" },
                        { "id": 21020842, "nama": "Pola minum : ","satuan" : "cc/hari", "type": "textbox3" },
                        { "id": 21040361, "nama": "Terakhir Jam","satuan" : "", "type": "textbox3" },
                        { "id": 21020843, "nama": "BAK : ","satuan" : "x/hari", "type": "textbox3" },
                        { "id": 21040362, "nama": "Terakhir Jam","satuan" : "", "type": "textbox4" },
                        { "id": 21040363, "nama": "Warna","satuan" : "", "type": "textbox4" },
                        { "id": 21020844, "nama": "BAB : ","satuan" : "x/hari", "type": "textbox3" },
                        { "id": 21040364, "nama": "Terakhir Jam","satuan" : "", "type": "textbox3" },
                    ]
                },
                {
                    "id": 1, "nama": "Status Mental",
                    "detail": [
                        { "id": 21040365, "nama": "Kooperatif", "type": "checkbox3" },
                        { "id": 21040366, "nama": "Tidak Kooperatif ", "type": "checkbox3" },
                        { "id": 21040367, "nama": "Gelisah atau dellrium dan berontak ", "type": "checkbox3" },
                        { "id": 21040368, "nama": "Ketidakmampuan dalam mengikuti perintah ", "type": "checkbox3" },
                    ]
                },
                {
                    "id": 1, "nama": "Restrain",
                    "detail": [
                        { "id": 21040369, "nama": "Tidak", "type": "checkbox3" },
                        { "id": 21040370, "nama": "Ya, Lakukan Pengkajian Restrain (RM/009/010) ", "type": "checkbox3" },
                    ]
                },
                {
            ...
            // $scope.item.obj[21020832] = 0;
            // $scope.item.obj[21020833] = 0;
            // $scope.item.obj[21020834] = 0;
            $scope.GCSKuantitatif = function ()
            {
                let e = parseInt($scope.item.obj[21020832]) || 0;
                let v = parseInt($scope.item.obj[21020833]) || 0;
                let m = parseInt($scope.item.obj[21020834]) || 0;
                let hasil =  e + v + m;
                console.log(hasil);
                if(hasil >= 14 && hasil <=15)
                {
                    $scope.item.obj[21009269] = hasil + " Compos mentis";
                } else if(hasil >= 12 && hasil <= 13)
                {
                    $scope.item.obj[21009269] = hasil + " Apatis";
                } else if(hasil >= 11 && hasil <= 12)
                {
                    $scope.item.obj[21009269] = hasil + " Somnolent";
                }else if(hasil >= 8 && hasil <= 10)
                {
                    $scope.item.obj[21009269] = hasil + " Stupor";
                }else if(hasil < 5)
                {
                    $scope.item.obj[21009269] = hasil + " Koma";
                }else
                {
                    $scope.item.obj[21009269] = "";
                }
            }

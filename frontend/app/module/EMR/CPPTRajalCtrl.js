define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('CPPTRajalCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            var nomorEMR = '-';
            var norecEMR = '';
            $scope.cc.emrfk = 290015;
            var dataLoad = [];
            $scope.isCetak = true;
            $scope.show = true;
            $scope.allDisabled = false;
            $scope.listItem = [
                { id: 421650, inuse: true },
                { id: 421658 },
                { id: 421666 },
                { id: 421674 },
                { id: 421682 },
            ...
            if (nomorEMR == '-') {
                ...
                var status = "t";
                $scope.item.obj[421650] = $scope.now;
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Catatan Perkembangan Pasien Terintegrasi Rawat Jalan ' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSDewasa11Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 374).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[103058] = $scope.skor1
                $scope.item.obj[103059] = $scope.skor2
                $scope.item.obj[103060] = $scope.skor3
                $scope.item.obj[103061] = $scope.skor4
                $scope.item.obj[103062] = $scope.skor5
                $scope.item.obj[103063] = $scope.skor6
                $scope.item.obj[103064] = $scope.skor7
                $scope.item.obj[103065] = $scope.skor8
                $scope.item.obj[103066] = $scope.skor9
                $scope.item.obj[103067] = $scope.skor10
                $scope.item.obj[103068] = $scope.skor11
                $scope.item.obj[103069] = $scope.skor12
                $scope.item.obj[103070] = $scope.skor13
            }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Skor Early Warning System Dewasa11 ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSDewasa3Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 250).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[17903] = $scope.skor1
                $scope.item.obj[17904] = $scope.skor2
                $scope.item.obj[17905] = $scope.skor3
                $scope.item.obj[17906] = $scope.skor4
                $scope.item.obj[17907] = $scope.skor5
                $scope.item.obj[17908] = $scope.skor6
                $scope.item.obj[17909] = $scope.skor7
                $scope.item.obj[17910] = $scope.skor8
                $scope.item.obj[17911] = $scope.skor9
                $scope.item.obj[17912] = $scope.skor10
                $scope.item.obj[17913] = $scope.skor11
                $scope.item.obj[17914] = $scope.skor12
                $scope.item.obj[17915] = $scope.skor13
            }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Skor Early Warning System Dewasa3 ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

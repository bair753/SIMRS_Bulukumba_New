define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormPoliCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.listPelayanan = [
                { name: "Lanjut Rawat Tower 5", id: 1 },
            ...
            $scope.$watch('item.obj[18000094]', function (newValue, oldValue) {
                if (newValue != oldValue) {
                    if ($scope.item.obj[18000094] == 2 || $scope.item.obj[18000038] == "2") {

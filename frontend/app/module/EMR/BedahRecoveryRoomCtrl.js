define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('BedahRecoveryRoomCtrl', ['$rootScope', '$scope', '$state', 'CacheHelper', 'MedifirstService',
            ...
            if (nomorEMR == '-') {
                medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + emrfk_).then(function (e) {
                    ...
                    for (var i = e.data.kolom4.length - 1; i >= 0; i--) {
                        if (e.data.kolom4[i].id >= 21021712) {
                ...
                medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + emrfk_).then(function (e) {
                    ...
                    medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                        ...
                        for (let ii = 0; ii < arrobj.length; ii++) {
                            if (parseInt(arrobj[ii]) >= 21021712 && parseInt(arrobj[ii]) <= 21021759) {
                        ...
                        for (var i = arrobj.length - 1; i >= 0; i--) {
                            ...
                            for (let y = 0; y < 47; y++) {
                                if (arrobj[i] == 22034734 + y && arrobj[i] != '')
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    for (let i = 0; i < arrobj.length; i++) {
                        if (arrobj[i] >= 21021712 && arrobj[i] <= 21021759) {
                    ...
                    for (var i = arrobj.length - 1; i >= 0; i--) {
                        ...
                        for (let z = 0; z < 47; z++) {
                            if (arrobj[i] == 22034734 + z && arrobj[i] != '')

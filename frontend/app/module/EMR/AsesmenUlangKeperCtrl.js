define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AsesmenUlangKeperCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-diagnosa', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210003).then(function (e) {
            ...
            $scope.listPengkajian = [
                {
                    ...
                    "detail": [
                        ...
                        { "id": 21005170, "nama": "", "type": "checkbox" },
                        { "id": 21005171, "nama": "", "type": "checkbox" },
                ...
                },
                {
                    ...
                    "detail": [
                        ...
                        { "id": 21005172, "nama": "", "type": "checkbox" },
                        { "id": 21005173, "nama": "", "type": "checkbox" },
                    ]
                }
            ]
            $scope.listHasil = [
                {
                    ...
                    "detail": [
                        ...
                        { "id": 21005174, "nama": "", "type": "textarea" },
                    ]
                },
                {
                    "id": 1, "nama": "2.",
                    "detail": [
                        ...
                        { "id": 21005175, "nama": "", "type": "textarea" },
                    ]
                },
                {
                    "id": 1, "nama": "3.",
                    "detail": [
                        ...
                        { "id": 21005176, "nama": "", "type": "textarea" },
                    ]
                },
            ...
            $scope.listTindakan = [
                {
                    ...
                    "detail": [
                        ...
                        { "id": 21005177, "nama": "", "type": "checkbox" },
                        { "id": 21005178, "nama": "", "type": "checkbox" },
                        { "id": 21005179, "nama": "", "type": "combobox" },
                    ]
                },
                {
                    "id": 1, "nama": "2.",
                    "detail": [
                        ...
                        { "id": 21005180, "nama": "", "type": "checkbox" },
                        { "id": 21005181, "nama": "", "type": "checkbox" },
                        { "id": 21005182, "nama": "", "type": "combobox" },
                    ]
                },
                {
                    "id": 1, "nama": "3.",
                    "detail": [
                        ...
                        { "id": 21005183, "nama": "", "type": "checkbox" },
                        { "id": 21005184, "nama": "", "type": "checkbox" },
                        { "id": 21005185, "nama": "", "type": "combobox" },
                    ]
                },
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "nama": "", "type": "label" },
                        { "nama": "Edukasi", "type": "label" },
                        { "id": 21005186, "nama": "", "type": "checkbox" },
                        { "id": 21005187, "nama": "", "type": "checkbox" },
                        { "id": 21005188, "nama": "", "type": "combobox" },
                    ]
                },
            ]
            ...
            $scope.listNutrisional = [
                {
                    ...
                    "detail": [
                        { "id": 21005189, "nama": "a. Tidak", "descNilai" : "0", "type": "checkbox" },
                        { "id": 21005190, "nama": "b. Tidak Yakin", "descNilai" : "2", "type": "checkbox" },
                        { "nama": "(Tanda: ukuran baju atau celana menjadi lebih longgar)", "type": "label" },
                        { "id": 21005191, "nama": "c. Ya, 1-5 Kg", "descNilai" : "1", "type": "checkbox" },
                        { "id": 21005192, "nama": "6-10 Kg", "descNilai" : "2", "type": "checkbox" },
                        { "id": 21005193, "nama": "11-15 Kg", "descNilai" : "3", "type": "checkbox" },
                        { "id": 21005194, "nama": "> 15 Kg", "descNilai" : "4", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "no": 2, "nama": "Apakah asupan makan menurun yang dikarenakan adanya penurunan nafsu makan/kesulitan menerima makan ?",
                    "detail": [
                        { "id": 21005195, "nama": "Tidak", "descNilai" : "0", "type": "checkbox" },
                        { "id": 21005196, "nama": "Tidak yakin", "descNilai" : "1", "type": "checkbox" },
                    ]
                },
            ]
            ...
            $scope.listRujukan2 = [
                ...
                },
                {
                    ...
                    "detail": [
                        ...
                        { "id": 21000052, "nama": "Tenang ", "type": "checkbox3" },
                        { "id": 21000051, "nama": "Kecenderugan Bunuh diri ","satuan" : "x/hari", "type": "checkbox3" },
                        { "id": 22034958, "nama": "dll :", "type": "textbox" },
                        // { "id": 116064, "nama": "Pola Minum ","satuan" : "cc/hari", "type": "textbox2" },
                        // { "id": 116065, "nama": "BAK ","satuan" : "x/hari", "type": "textbox2" },
                        // { "id": 116066, "nama": "BAB","satuan" : "x/hari", "type": "textbox2" },
                    ]
            ...
            $scope.listKonsep5 = [
                {
                    ...
                    "detail": [
                        ...
                        { "id": 21000091, "nama": "Sticker tanda alergi dipasang (warna merah)", "type": "checkbox" },                 
                    ]
                }
            ]
            $scope.listNyeri3 = [{
            ...
            $scope.$watch('item.obj[116131]', function (nilai) {
                ...
                if (nilai == 0) {
                    $scope.item.obj[21000094] = true
                    $scope.item.obj[21000095] = false
                    $scope.item.obj[21000096] = false
                    $scope.item.obj[21000097] = false
                }
               if (nilai >= 1 && nilai <= 3) {
                    $scope.item.obj[21000094] = false
                    $scope.item.obj[21000095] = true   
                    $scope.item.obj[21000096] = false
                    $scope.item.obj[21000097] = false
                }
                if (nilai >= 4 && nilai <= 6) {
            ...
            $scope.getSkorNutrisi = function (jawab) {
                ...
                $scope.item.obj[21005224] = $scope.skorNutrisi
            }
            ...
            $scope.getSkalaNyeri = function (data, stat) {
                ...
                if (nilai >= 0 && nilai <= 1) {
                    $scope.item.obj[21000098] = true
                    $scope.item.obj[21000099] = false
                    $scope.item.obj[21000100] = false
                    $scope.item.obj[21000101] = false
                    $scope.item.obj[21000102] = false
                    $scope.item.obj[21000103] = false
                }
                if (nilai >= 2 && nilai <= 3) {
                    $scope.item.obj[21000098] = false
                    $scope.item.obj[21000099] = true
                    $scope.item.obj[21000100] = false
                    $scope.item.obj[21000101] = false
                    $scope.item.obj[21000102] = false
                    $scope.item.obj[21000103] = false

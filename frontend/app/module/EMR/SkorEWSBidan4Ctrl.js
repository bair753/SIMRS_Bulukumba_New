define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSBidan4Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210121).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[22027338] = $scope.skor1
                $scope.item.obj[22027339] = $scope.skor2
                $scope.item.obj[22027340] = $scope.skor3
                $scope.item.obj[22027341] = $scope.skor4
                $scope.item.obj[22027342] = $scope.skor5
                $scope.item.obj[22027343] = $scope.skor6
                $scope.item.obj[22027344] = $scope.skor7
                $scope.item.obj[22027345] = $scope.skor8
                $scope.item.obj[22027346] = $scope.skor9
                $scope.item.obj[22027347] = $scope.skor10
                $scope.item.obj[22027348] = $scope.skor11
                $scope.item.obj[22027349] = $scope.skor12
                $scope.item.obj[22027350] = $scope.skor13
            }

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('CrisisTriageRatingScaleCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 132).then(function (e) {
                // debugger
            ...
            $scope.cetakPdf = function () {
                ...
                client.get('http://127.0.0.1:1237/printvb/e-rekammedis?cetak-emr-asesmen-ctrs&id=' + $scope.cc.nocm + '&emr=' + norecEMR + '&view=true', function (response) {
            ...
            if (chacePeriode != undefined) {
                ...
                medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                    $scope.item.obj = []
                    $scope.item.obj2 = []
                    $scope.item.obj[4266]=$scope.now
                    $scope.item.obj[4283]=$scope.now
                    $scope.item.obj[4265]={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                   ...
                   'Crisis Triage Rating Scale ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

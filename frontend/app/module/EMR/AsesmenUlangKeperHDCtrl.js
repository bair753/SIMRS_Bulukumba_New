define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AsesmenUlangKeperHDCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210013).then(function (e) {
            ...
            $scope.getSkorMorse = function (id, descNilai) {
                ...
                $scope.item.obj[21000641] = $scope.skorMorse
            }
            ...
            $scope.getSkorNutrisi = function (id, descNilai) {
                ...
                $scope.item.obj[21000672] = $scope.skorNutrisi
            }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'AsesmenUlangKeperHDCtrl ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

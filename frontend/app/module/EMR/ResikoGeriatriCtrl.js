define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('ResikoGeriatriCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.skor7 = 0
            $scope.skor8 = 0
            $scope.getSkorNew = function (index, stat) {
                console.log(index);
                ...
                $scope.item.obj[21021100] = $scope.skor1
                $scope.item.obj[21021101] = $scope.skor2
                $scope.item.obj[21021102] = $scope.skor3
                $scope.item.obj[21021103] = $scope.skor4
            ...
            $scope.skor7 = 0
            $scope.skor8 = 0
            $scope.getSkorNew2 = function (index, stat) {
                console.log(index);
                var arrobj = Object.keys($scope.item.obj)
                var arrSave = []
                for (var i = arrobj.length - 1; i >= 0; i--) {
                ...
                $scope.item.obj[21021152] = $scope.skor5
                $scope.item.obj[21021153] = $scope.skor6
                $scope.item.obj[21021154] = $scope.skor7
                $scope.item.obj[21021155] = $scope.skor8
            }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'ResikoGeriatriCtrl ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

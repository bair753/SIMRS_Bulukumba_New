define(['initialize'], function (initialize) {
  'use strict';
  initialize.controller('AsesmenPDRCtrl', ['$q', '$rootScope', '$scope', '$state', 'CacheHelper', 'MedifirstService', '$mdDialog',
      function ($q, $rootScope, $scope, $state, cacheHelper, medifirstService, $mdDialog) {
          ...
          function init() {
              ...
              medifirstService.get("emr/get-emr-transaksi-detail-form?"+paramSearch+ "&jenisEmr=pdr", true).then(function (dat) {
              ...
              medifirstService.get("emr/get-menu-rekam-medis-dynamic?namaemr=pdr").then(function (e) {
          ...
          $scope.Lihat = function () {
              ...
              $state.go("RekamMedis.AsesmenPDR.FormPDR", {
                  namaEMR: 18001,
                  nomorEMR: noemr2
              });
          ...
          $scope.asupKaForm = function (noemr, reportdisplay, emrfk, norec) {
              ...
              if (noemr2 != '-')
                  noemr2.trim()
              var url = "RekamMedis.AsesmenPDR.FormPDR"

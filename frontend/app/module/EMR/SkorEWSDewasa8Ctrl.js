define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSDewasa8Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 255).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[61004] = $scope.skor1
                $scope.item.obj[61005] = $scope.skor2
                $scope.item.obj[61006] = $scope.skor3
                $scope.item.obj[61007] = $scope.skor4
                $scope.item.obj[61008] = $scope.skor5
                $scope.item.obj[61009] = $scope.skor6
                $scope.item.obj[61010] = $scope.skor7
                $scope.item.obj[61011] = $scope.skor8
                $scope.item.obj[61012] = $scope.skor9
                $scope.item.obj[61013] = $scope.skor10
                $scope.item.obj[61014] = $scope.skor11
                $scope.item.obj[61015] = $scope.skor12
                $scope.item.obj[61016] = $scope.skor13
            }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Skor Early Warning System Dewasa8 ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSDewasa15Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 378).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[105150] = $scope.skor1
                $scope.item.obj[105151] = $scope.skor2
                $scope.item.obj[105152] = $scope.skor3
                $scope.item.obj[105153] = $scope.skor4
                $scope.item.obj[105154] = $scope.skor5
                $scope.item.obj[105155] = $scope.skor6
                $scope.item.obj[105156] = $scope.skor7
                $scope.item.obj[105157] = $scope.skor8
                $scope.item.obj[105158] = $scope.skor9
                $scope.item.obj[105159] = $scope.skor10
                $scope.item.obj[105160] = $scope.skor11
                $scope.item.obj[105161] = $scope.skor12
                $scope.item.obj[105162] = $scope.skor13
            }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Skor Early Warning System Dewasa15 ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

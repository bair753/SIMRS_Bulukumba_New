define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('SkriningGiziPadaPasienAnakCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.cetakPdf = function () {
                ...
                window.open(config.baseApiBackend + 'report/cetak-skrining-gizi-pasien-anak?nocm='
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                for (var i = 0; i <= dataLoad.length - 1; i++) {
                    ...
                    $scope.item.obj[32116661] = 
                    Number($scope.item.obj[32116651] ?? 0) + 
                    Number($scope.item.obj[32116652] ?? 0) + 
                    Number($scope.item.obj[32116653] ?? 0) + 
                    Number($scope.item.obj[32116654] ?? 0) + 
                    Number($scope.item.obj[32116655] ?? 0) + 
                    Number($scope.item.obj[32116656] ?? 0) + 
                    Number($scope.item.obj[32116657] ?? 0) + 
                    Number($scope.item.obj[32116658] ?? 0) + 
                    Number($scope.item.obj[32116659] ?? 0); 
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Skrining Gizi Pada Pasien Anak' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '
            ...
            $scope.getSkorParameter = function(skor, id) {
                ...
                $scope.item.obj[32116138] = $scope.skorParameter;
            }
            ...
            $scope.getSkorParameter2 = function (skor, id) {
                ...
                $scope.item.obj[32116138] = $scope.skorParameter2;
            }
            ...
            $scope.getSkorParameter3 = function (skor, id) {
                ...
                $scope.item.obj[32116138] = $scope.skorParameter3;
            }
            ...
            $scope.getSkorParameter4 = function (skor, id) {
                ...
                $scope.item.obj[32116138] = $scope.skorParameter4;
            }
            ...
            $scope.getSkorParameter5 = function (skor, id) {
                ...
                $scope.item.obj[32116138] = $scope.skorParameter5;
            }
            ...
            $scope.getSkorParameter6 = function (skor, id) {
                ...
                $scope.item.obj[32116138] = $scope.skorParameter6;
            }

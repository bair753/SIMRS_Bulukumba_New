define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSBidan14Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210131).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[22032538] = $scope.skor1
                $scope.item.obj[22032539] = $scope.skor2
                $scope.item.obj[22032540] = $scope.skor3
                $scope.item.obj[22032541] = $scope.skor4
                $scope.item.obj[22032542] = $scope.skor5
                $scope.item.obj[22032543] = $scope.skor6
                $scope.item.obj[22032544] = $scope.skor7
                $scope.item.obj[22032545] = $scope.skor8
                $scope.item.obj[22032546] = $scope.skor9
                $scope.item.obj[22032547] = $scope.skor10
                $scope.item.obj[22032548] = $scope.skor11
                $scope.item.obj[22032549] = $scope.skor12
                $scope.item.obj[22032550] = $scope.skor13
            }

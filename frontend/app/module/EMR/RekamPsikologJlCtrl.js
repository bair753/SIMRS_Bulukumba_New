define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RekamPsikologJlCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.cetakPdf = function () {
                ...
                client.get('http://127.0.0.1:1237/printvb/e-rekammedis?cetak-emr-shj&id=' + $scope.cc.nocm + '&emr=' + norecEMR + '&view=true', function (response) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 323).then(function (e) {
            ...
            $scope.listKebutuhanEdukasi = [
                {
                    "id": 1, "nama": "JENIS PELAYANAN  :",
                    "detail": [
                        { "id": 100118, "nama": "Konseling", "type": "checkbox" },
                        { "id": 100119, "nama": "Terapi", "type": "checkbox" },
                        { "id": 100120, "nama": "Tes Kenal Diri", "type": "checkbox" },
                        { "id": 100121, "nama": "Tes Bakat Minat", "type": "checkbox" },
                        { "id": 100122, "nama": "Tes Pekerjaan", "type": "checkbox" },
                        { "id": 100123, "nama": "Tes Inteligensi", "type": "checkbox" },
                        { "id": 100124, "nama": "Asesmen pasien", "type": "checkbox" },
                        { "id": 100125, "nama": "Kiriman Dokter", "type": "checkbox" },
                        { "id": 100126, "nama": "Mediko Legal", "type": "checkbox" },
                        
                    ]
                },
                {
                    "id": 2, "nama": "Masalah / Keluhan /Keperluan :",
                    "detail": [
                        { "id": 100127, "nama": "", "type": "textarea" },
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                $scope.item.obj = []
                $scope.item.obj2 = []
                $scope.item.obj[100132]=$scope.now
                $scope.item.obj[100133] = { value:peagawaiLogin.id,text:peagawaiLogin.namaLengkap}
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                   ...
                   'Rekam medis Psikolog rajal ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

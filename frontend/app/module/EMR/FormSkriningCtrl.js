define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormSkriningCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 21028).then(function (e) {
            ...
            $scope.listTanggal = [
                {
                    "id": 1, "nama": "Tanggal",
                    "detail": [
                        { "id": 21001558, "nama": "", "type": "datetime" },
                    ]
                },
            ]
            $scope.listAsalSkrining = [
                {
                    "id": 1, "nama": "Asal Skrining",
                    "detail": [
                        { "id": 21001559, "nama": "Dalam", "type": "checkbox" },
                        { "id": 21001560, "nama": "Luar : ", "type": "checkbox" },
                        { "id": 21001561, "nama": "Rumah Sakit", "type": "checkbox2" },
                        { "id": 21001562, "nama": "", "type": "textbox" },
                        { "id": 21001563, "nama": "Puskesmas", "type": "checkbox2" },
                        { "id": 21001564, "nama": "", "type": "textbox" },
                        { "id": 21001565, "nama": "Klinik", "type": "checkbox2" },
                        { "id": 21001566, "nama": "", "type": "textbox" },
                        { "id": 21001567, "nama": "Dokter/Praktek mandiri", "type": "checkbox2" },
                        { "id": 21001568, "nama": "", "type": "textbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Alasan Masuk",
                    "detail": [
                        { "id": 21001569, "nama": "Pasien dalam pengawasan", "type": "textarea" },
                    ]
                },
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 21001570, "nama": "Dapat dilayani", "type": "checkbox2" },
                        { "id": 21001571, "nama": "Tidak Dapat dilayani", "type": "checkbox2" },
                        { "id": 21001572, "nama": "Tertunda", "type": "checkbox2" },
                        { "id": 21001573, "nama": "Rujuk", "type": "checkbox2" },
                        { "id": 21001574, "nama": "IGD", "type": "checkbox2" },
                        { "id": 21001575, "nama": "Poliklinik", "type": "checkbox3" },
                        { "id": 21001576, "nama": "", "type": "textbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Keterangan",
                    "detail": [
                        { "id": 21001577, "nama": "Pasien dalam pengawasan", "type": "textarea" },
                    ]
                },
            ]
            ...
            $scope.cetakPdf = function () {
                ...
                client.get('http://127.0.0.1:1237/printvb/e-rekammedis?cetak-emr-skrining-pasien&id=' + $scope.cc.nocm + '&emr=' + norecEMR + '&view=true', function (response) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'FormSkriningCtrl ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

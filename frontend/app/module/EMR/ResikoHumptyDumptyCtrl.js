define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('ResikoHumptyDumptyCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 21048).then(function (e) {
            ...
            $scope.getSkorNew = function (index, stat) {
                ...
                $scope.item.obj[21007088] = $scope.skor1
                $scope.item.obj[21007089] = $scope.skor2
                $scope.item.obj[21007090] = $scope.skor3
                $scope.item.obj[21007091] = $scope.skor4
            }
            $scope.totalSkor5 = 0

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormACtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.cetakPdf = function () {
                ...
                client.get('http://127.0.0.1:1237/printvb/e-rekammedis?cetak-emr-forma&id=' + $scope.cc.nocm + '&emr=' + norecEMR + '&view=true', function (response) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 144).then(function (e) {
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                $scope.item.obj = []
                $scope.item.obj2 = []
                $scope.item.obj[13198] = $scope.cc.tglregistrasi
                $scope.item.obj[13199] ={ value: $scope.cc.iddpjp, text: $scope.cc.dokterdpjp }
                $scope.item.obj[13200] ={ value: $scope.cc.objectruanganfk, text: $scope.cc.namaruangan }
                $scope.item.obj[13201] ={ value: $scope.cc.objectkelasfk, text: $scope.cc.namakelas }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'F O R M A - E V A L U A S I A W A L M P P ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

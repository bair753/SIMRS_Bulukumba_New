define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('PernyataanBersediaBerlakuUmumCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.listPasien = [
                {
                    "id": 1,
                    "detail": [
                        { "id": 31101205, "caption": "Nama Pasien :", "type": "textbox"},
                        { "id": 31101206, "caption": "Jenis Kelamin :", "type" : "textbox" },
                        { "id": 31101207, "caption": "No RM :", "type" : "textbox" },
                        { "id": 31101208, "caption": "Tanggal Lahir :", "type": "date" },
                        { "id": 31101209, "caption": "Dirawat di Ruang", "type": "combobox", "dataList": "listRuangan" },
                        { "id": 31101210, "caption": "Kelas", "type": "combobox", "dataList": "listKelas" },
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[31101205] = antrianPasien.namapasien;
                    $scope.item.obj[31101208] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
                    $scope.item.obj[31101206] = antrianPasien.jeniskelamin;
                    $scope.item.obj[31101207] = antrianPasien.nocm;

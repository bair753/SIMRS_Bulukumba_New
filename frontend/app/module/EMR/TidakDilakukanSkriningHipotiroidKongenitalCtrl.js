define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('TidakDilakukanSkriningHipotiroidKongenitalCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[32116764] = $scope.cc.namapasien;
                    $scope.item.obj[32116765] = $scope.cc.jeniskelamin;
                    $scope.item.obj[32116766] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
                    $scope.item.obj[32116767] = antrianPasien.nocm;
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Pernyataan Tidak Dilakukan Skrining Hipotiroid Kongenital' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

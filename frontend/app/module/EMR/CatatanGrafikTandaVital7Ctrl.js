define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('CatatanGrafikTandaVital7Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
           ...
           $scope.listData1 = []
            ...
            $scope.listSuhu = []
            $scope.listNadi = []
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 288).then(function (e) {

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSBidan13Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210130).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[22032018] = $scope.skor1
                $scope.item.obj[22032019] = $scope.skor2
                $scope.item.obj[22032020] = $scope.skor3
                $scope.item.obj[22032021] = $scope.skor4
                $scope.item.obj[22032022] = $scope.skor5
                $scope.item.obj[22032023] = $scope.skor6
                $scope.item.obj[22032024] = $scope.skor7
                $scope.item.obj[22032025] = $scope.skor8
                $scope.item.obj[22032026] = $scope.skor9
                $scope.item.obj[22032027] = $scope.skor10
                $scope.item.obj[22032028] = $scope.skor11
                $scope.item.obj[22032029] = $scope.skor12
                $scope.item.obj[22032030] = $scope.skor13
            }

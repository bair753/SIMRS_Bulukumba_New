define(['initialize'], function (initialize) {
  'use strict';
  initialize.controller('AsesmenCovidCtrl', ['$q', '$rootScope', '$scope', '$state', 'CacheHelper', 'MedifirstService', '$mdDialog',
      function ($q, $rootScope, $scope, $state, cacheHelper, medifirstService, $mdDialog) {
          ...
          function init() {
              ...
              medifirstService.get("emr/get-emr-transaksi-detail-form?"+paramSearch+ "&jenisEmr=covid", true).then(function (dat) {
              ...
              medifirstService.get("emr/get-menu-rekam-medis-dynamic?namaemr=covid").then(function (e) {
                  ...
                  $scope.mainTreeViewBedahOption = {
                      dataBound: function (e) {
                          $('span.k-in').each(function () {
                              if ($(this).text() == 'Form Mini Triase') { $(this).addClass('gemblung') }
                              if ($(this).text() == 'Form Poli Umum') { $(this).addClass('gemblung') }
                              if ($(this).text() == 'Ceklist Kondisi Psikologis Pasien') { $(this).addClass('gemblung') } 
                              if ($(this).text() == 'CPPT') { $(this).addClass('gemblung') } 
                              if ($(this).text() == 'IGD') { $(this).addClass('gemblung') } 
                              if ($(this).text() == 'Triase  Gawat Darurat') { $(this).addClass('gemblung') } 
                              if ($(this).text() == 'Pengkajian Gawat Darurat') { $(this).addClass('gemblung') } 
          ...
          $scope.Lihat = function () {
              ...
              $state.go("RekamMedis.AsesmenCovid.FormMiniTriase", {
                  namaEMR: 18001,
                  nomorEMR: noemr2
              });
          ...
          $scope.asupKaForm = function (noemr, reportdisplay, emrfk, norec) {
              ...
              if (noemr2 != '-')
                  noemr2.trim()
              var url = "RekamMedis.AsesmenCovid.AsesmenCovidDetail"
          ...
          function onSelect(e) {
              ...
              if (urlTrue == null) {
                  $state.go("RekamMedis.AsesmenCovid.AsesmenCovidDetail", {
                      namaEMR: idTree,
                      nomorEMR: noemr
                  });
              } else {

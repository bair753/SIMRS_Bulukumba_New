define(['initialize'], function (initialize) {
  'use strict';
  initialize.controller('PengkajianMedisNewCtrl', ['$q', '$rootScope', '$scope', '$state', 'CacheHelper', 'MedifirstService', '$mdDialog',
      function ($q, $rootScope, $scope, $state, cacheHelper, medifirstService, $mdDialog) {
          ...
          function init() {
              ...
              medifirstService.get("emr/get-emr-transaksi-detail-form?"+paramSearch+ "&jenisEmr=pengkajiannew", true).then(function (dat) {
              ...
              medifirstService.get("emr/get-menu-rekam-medis-dynamic?namaemr=pengkajiannew").then(function (e) {
          ...
          $scope.Lihat = function () {
              ...
              $state.go("RekamMedis.PengkajianMedisNew.AsesmenMedisRJ", {
                  namaEMR: 227,
                  nomorEMR: noemr2
              });
          ...
          $scope.asupKaForm = function (noemr, reportdisplay, emrfk, norec) {
              ...
              if (noemr2 != '-')
                  noemr2.trim()
              var url = "RekamMedis.PengkajianMedisNew.AsesmenMedisRJ"
          ...
          function onSelect(e) {
              ...
              if (urlTrue == null) {
                  $state.go("RekamMedis.PengkajianMedisNew.PengkajianMedisNewCtrl", {
                      namaEMR: idTree,
                      nomorEMR: noemr
                  });
              } else {

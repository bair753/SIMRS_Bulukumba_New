define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AsesmenPraAnestesiSedasiCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
           ...
           $scope.listDataAlergi = [
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210004).then(function (e) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                     for (let i = 0; i < arrobj.length; i++) {
                        if (arrobj[i] == 21000224 ||  arrobj[i] == 21000225) {
            ...
            function afterSave(e) {
                ...
                medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                    'Asesmen Pra Sedasi' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

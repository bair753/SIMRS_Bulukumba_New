define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSBidan8Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210125).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[22029418] = $scope.skor1
                $scope.item.obj[22029419] = $scope.skor2
                $scope.item.obj[22029420] = $scope.skor3
                $scope.item.obj[22029421] = $scope.skor4
                $scope.item.obj[22029422] = $scope.skor5
                $scope.item.obj[22029423] = $scope.skor6
                $scope.item.obj[22029424] = $scope.skor7
                $scope.item.obj[22029425] = $scope.skor8
                $scope.item.obj[22029426] = $scope.skor9
                $scope.item.obj[22029427] = $scope.skor10
                $scope.item.obj[22029428] = $scope.skor11
                $scope.item.obj[22029429] = $scope.skor12
                $scope.item.obj[22029430] = $scope.skor13
            }

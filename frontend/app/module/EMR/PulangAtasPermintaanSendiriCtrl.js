define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PulangAtasPermintaanSendiriCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            if (nomorEMR == '-') {
                ...
                var status = "t";
                $scope.item.obj[430010] = $scope.now;
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    var antrianPasien = e.data.result;
                    $scope.item.obj[429995] = $scope.cc.namapasien;
                    $scope.item.obj[429998] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
                    $scope.item.obj[429996] = antrianPasien.jeniskelamin;
                    $scope.item.obj[429997] = antrianPasien.nocm;
                    if (antrianPasien.namakelas != null && antrianPasien.objectkelasfk != null) {
                        $scope.item.obj[430000] = {
            ...
            $scope.listAlasanPulang = [
                {
                    "id": 1,
                    "detail": [
                        { "id": 430001, "nama": "Menolak rawat inap", "type": "checkbox" },
                        { "id": 430002, "nama": "Pindah RS/alih rawat", "type": "checkbox" },
                        { "id": 430003, "nama": "Merasa sembuh", "type": "checkbox" },
                        { "id": 430004, "nama": "Merasa tidak ada perubahan", "type": "checkbox" },
                        { "id": 430005, "nama": "Merasa tidak ada harapan", "type": "checkbox" },
                        { "id": 430006, "nama": "Ekonomi", "type": "checkbox" },
                        { "id": 430007, "nama": "Tidak puas dengan pelayanan", "type": "checkbox" },
                        { "id": 430008, "nama": "Lain-lain :", "type": "checkbox" },
                        { "id": 430009, "nama": "", "type": "textbox2" }
                    ]
                }
            ]

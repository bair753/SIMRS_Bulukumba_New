define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('AsesmenPraBedahRanapCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
            ...
            $scope.listPulang = [
                {
                    ...
                    "detail": [
                        ...
                        { "id": 423806, "caption": "ICD 10", "type": "combobox", "dataList": "listICD10" },
                        { "id": 423807, "caption": "Komorbiditas Lain", "type": "textarea", "dataList": "" },
                        { "id": 423808, "caption": "ICD 10", "type": "combobox", "dataList": "listICD10" },
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Asesmen Pra Bedah Rawat Inap ' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('CatatanGrafikTandaVital5Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.listSuhu = []
            $scope.listNadi = []
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 286).then(function (e) {

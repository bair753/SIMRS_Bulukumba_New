define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSDewasa12Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 375).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[103581] = $scope.skor1
                $scope.item.obj[103582] = $scope.skor2
                $scope.item.obj[103583] = $scope.skor3
                $scope.item.obj[103584] = $scope.skor4
                $scope.item.obj[103585] = $scope.skor5
                $scope.item.obj[103586] = $scope.skor6
                $scope.item.obj[103587] = $scope.skor7
                $scope.item.obj[103588] = $scope.skor8
                $scope.item.obj[103589] = $scope.skor9
                $scope.item.obj[103590] = $scope.skor10
                $scope.item.obj[103591] = $scope.skor11
                $scope.item.obj[103592] = $scope.skor12
                $scope.item.obj[103593] = $scope.skor13
            }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Skor Early Warning System Dewasa12 ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

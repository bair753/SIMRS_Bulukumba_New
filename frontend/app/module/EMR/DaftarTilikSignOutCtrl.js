define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarTilikSignOutCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210020).then(function (e) {
            ...
            $scope.SignoutCheck2 = [
                ...
                {
                    "id": 1, "nama": "Apakah ada masalah peralatan",
                    "detail": [
                ...
                {
                    "id": 1, "nama": "Apakah ada yang menjadi perhatian khusus pada pemulihan dan penatalaksanaan pasien ?",
                    "detail": [
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'DaftarTilikSignOutCtrl ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

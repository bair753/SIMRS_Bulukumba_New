define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSDewasa14Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 377).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[104627] = $scope.skor1
                $scope.item.obj[104628] = $scope.skor2
                $scope.item.obj[104629] = $scope.skor3
                $scope.item.obj[104630] = $scope.skor4
                $scope.item.obj[104631] = $scope.skor5
                $scope.item.obj[104632] = $scope.skor6
                $scope.item.obj[104633] = $scope.skor7
                $scope.item.obj[104634] = $scope.skor8
                $scope.item.obj[104635] = $scope.skor9
                $scope.item.obj[104636] = $scope.skor10
                $scope.item.obj[104637] = $scope.skor11
                $scope.item.obj[104638] = $scope.skor12
                $scope.item.obj[104639] = $scope.skor13
            }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Skor Early Warning System Dewasa14 ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

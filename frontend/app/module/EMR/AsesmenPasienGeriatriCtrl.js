define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AsesmenPasienGeriatriCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                for (var i = 0; i <= dataLoad.length - 1; i++) {
                    ...
                    $scope.item.obj[32115832] = 
                    Number($scope.item.obj[32115802] ?? 0) + 
                    Number($scope.item.obj[32115803] ?? 0) + 
                    Number($scope.item.obj[32115804] ?? 0) + 
                    Number($scope.item.obj[32115805] ?? 0) + 
                    Number($scope.item.obj[32115806] ?? 0) + 
                    Number($scope.item.obj[32115807] ?? 0) + 
                    Number($scope.item.obj[32115808] ?? 0) + 
                    Number($scope.item.obj[32115809] ?? 0) + 
                    Number($scope.item.obj[32115810] ?? 0) + 
                    Number($scope.item.obj[32115811] ?? 0) + 
                    Number($scope.item.obj[32115812] ?? 0) + 
                    Number($scope.item.obj[32115813] ?? 0) + 
                    Number($scope.item.obj[32115814] ?? 0) + 
                    Number($scope.item.obj[32115815] ?? 0) + 
                    Number($scope.item.obj[32115816] ?? 0) + 
                    Number($scope.item.obj[32115817] ?? 0) + 
                    Number($scope.item.obj[32115818] ?? 0) +
                    Number($scope.item.obj[32115819] ?? 0) + 
                    Number($scope.item.obj[32115820] ?? 0) +
                    Number($scope.item.obj[32115821] ?? 0) +
                    Number($scope.item.obj[32115822] ?? 0) +
                    Number($scope.item.obj[32115823] ?? 0) +
                    Number($scope.item.obj[32115824] ?? 0) +
                    Number($scope.item.obj[32115825] ?? 0) +
                    Number($scope.item.obj[32115826] ?? 0) +
                    Number($scope.item.obj[32115827] ?? 0) +
                    Number($scope.item.obj[32115828] ?? 0) +
                    Number($scope.item.obj[32115829] ?? 0) +
                    Number($scope.item.obj[32115830] ?? 0) +
                    Number($scope.item.obj[32115831] ?? 0) ;

                    $scope.item.obj[32115857] = 
                    Number($scope.item.obj[32115836] ?? 0) +
                    Number($scope.item.obj[32115841] ?? 0) +
                    Number($scope.item.obj[32115848] ?? 0) +
                    Number($scope.item.obj[32115855] ?? 0) +
                    Number($scope.item.obj[32115856] ?? 0);
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Asesmen Pasien Geriatri'+ ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

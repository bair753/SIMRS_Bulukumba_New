define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AwalAnakUlangCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210058).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    "id": 1, "nama": "Anamnesa",
                    "detail": [
                        { "id": 21040079, "nama": "Auto anamnesa ", "type": "checkbox" },
                        { "id": 21040080, "nama": "Allo anamnesa ", "type": "checkbox" },
                        { "id": 21040081, "nama": "Keluarga ", "type": "checkbox2" },
                        { "id": 21040082, "nama": "Penerjemah bahasa", "type": "checkbox2" },
                        { "id": 21040083, "nama": "Orang lain ", "type": "checkbox2" },
                        { "id": 21040084, "nama": "Nama :", "type": "textbox" },
                        { "id": 21040085, "nama": "Hubungan :", "type": "textbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Cara Masuk",
                    "detail": [
                        { "id": 21040086, "nama": "Jalan tanpa bantuan ", "type": "checkbox3" },
                        { "id": 21040087, "nama": "Jalan dengan bantuan", "type": "checkbox3" },
                        { "id": 21040088, "nama": "Tempat tidur dorong", "type": "checkbox3" },
                        { "id": 21040089, "nama": "Lain-lain", "type": "textbox" }
                    ]
                },
                {
                    "id": 1, "nama": "Asal Masuk",
                    "detail": [
                        { "id": 21040090, "nama": "Non Rujukan", "type": "checkbox3" },
                        { "id": 21040091, "nama": "Rujukan", "type": "checkbox3" },
                    ]
                },
                {
                    "id": 1, "nama": "Alasan Masuk",
                    "detail": [
                        { "id": 21040092, "nama": "", "type": "textarea" },
                    ]
                },
            ]
            $scope.GCSKuantitatif = function ()
            {
                let e = parseInt($scope.item.obj[21040099]) || 0;
                let v = parseInt($scope.item.obj[21040100]) || 0;
                let m = parseInt($scope.item.obj[21040101]) || 0;
                let hasil =  e + v + m;
                console.log(hasil);
                if(hasil >= 14 && hasil <=15)
                {
                    $scope.item.obj[21009272] = hasil + " Compos mentis";
                } else if(hasil >= 12 && hasil <= 13)
                {
                    $scope.item.obj[21009272] = hasil + " Apatis";
                } else if(hasil >= 11 && hasil <= 12)
                {
                    $scope.item.obj[21009272] = hasil + " Somnolent";
                }else if(hasil >= 8 && hasil <= 10)
                {
                    $scope.item.obj[21009272] = hasil + " Stupor";
                }else if(hasil < 5)
                {
                    $scope.item.obj[21009272] = hasil + " Koma";
                }else
                {
                    $scope.item.obj[21009272] = "";
                }
            }
            $scope.listKesadaran = [
                {
                    "id": 1, "nama": "GCS",
                    "detail": [
                        { "id": 21040099, "nama": "E ", "type": "textboxgcs" },
                        { "id": 21040100, "nama": "V ", "type": "textboxgcs" },
                        { "id": 21040101, "nama": "M ", "type": "textboxgcs" },
                        { "id": 21009272, "nama": "Skor ", "type": "textboxskorgcs" },
                    ]
                },
                {
                    "id": 1, "nama": "Refleks Cahaya",
                    "detail": [
                        { "id": 21040102, "nama": "Ka ", "type": "textbox" },
                        { "id": 21040103, "nama": "Ki ", "type": "textbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Ukuruna Pupil",
                    "detail": [
                        { "id": 21040104, "nama": "Ka ", "type": "textbox" },
                        { "id": 21040105, "nama": "Ki ", "type": "textbox" },
                    ]
                }             
            ]
            $scope.listRiwayatKesehat = [
                {
                    ...
                    "detail": [
                        { "id": 21040154, "nama": "Penyakit waktu kecil", "type": "label" },
                        { "id": 21040155, "nama": "Demam", "type": "checkbox2" },
                        { "id": 21040156, "nama": "kejang", "type": "checkbox2" },
                        { "id": 21040157, "nama": "Batuk pilek", "type": "checkbox2" },
                        { "id": 21040158, "nama": "Lain-lain", "type": "checkbox2" },
                        { "id": 21040159, "nama": "Dirawat Di RS", "type": "label" },
                        { "id": 21040160, "nama": "Operasi", "type": "checkbox2" },
                        { "id": 21040161, "nama": "Kecelakaan", "type": "checkbox2" },
                        { "id": 21040162, "nama": "Penyakit Lain", "type": "textbox" },
                        { "id": 21040163, "nama": "Tahun", "type": "textbox" },
                        { "id": 21040164, "nama": "Obat yang masih digunakan saat ini", "type": "textarea" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 21040165, "nama": "Tidak ada", "type": "checkbox3" },
                        { "id": 21040166, "nama": "Asma", "type": "checkbox3" },
                        { "id": 21040167, "nama": "Hipertensi", "type": "checkbox3" },
                        { "id": 21040168, "nama": "jantung", "type": "checkbox3" },
                        { "id": 21040169, "nama": "Diabetes militus", "type": "checkbox3" },
                        { "id": 21040170, "nama": "Lain-lain", "type": "checkbox3" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 21040171, "nama": "Anak ke", "type": "checkbox" },
                        { "id": 21040172, "nama": "dari berapa saudara?", "type": "checkbox" },
                        { "id": 21040173, "nama": "Cara Kelahiran", "type": "label" },
                        { "id": 21040174, "nama": "Spontan", "type": "checkbox" },
                        { "id": 21040175, "nama": "Lain-lain", "type": "textbox" },
                        { "id": 21040176, "nama": "Umur Kelahiran", "type": "label" },
                        { "id": 21040177, "nama": "cukup Bulan", "type": "checkbox2" },
                        { "id": 21040178, "nama": "Kurang Bulan", "type": "checkbox" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 21040179, "nama": "BCG", "type": "checkbox3" },
                        { "id": 21040180, "nama": "DPT", "type": "checkbox3" },
                        { "id": 21040181, "nama": "Polio", "type": "checkbox3" },
                        { "id": 21040182, "nama": "Campak", "type": "checkbox3" },
                        { "id": 21040183, "nama": "Hepatitis B", "type": "checkbox3" },
                        { "id": 21040184, "nama": "PCV", "type": "checkbox3" },
                        { "id": 21040185, "nama": "Varicela", "type": "checkbox3" },
                        { "id": 21040186, "nama": "Typoid", "type": "checkbox3" },
                        { "id": 21040187, "nama": "Miningitis", "type": "checkbox3" },
                        { "id": 21040188, "nama": "Hepatitis A", "type": "checkbox3" },
                        { "id": 21040189, "nama": "Rotavirus", "type": "checkbox3" },
                        { "id": 21040190, "nama": "HIB", "type": "checkbox3" },
                        { "id": 21040191, "nama": "MMR", "type": "checkbox3" },
                        { "id": 21040192, "nama": "Influenza", "type": "checkbox3" },
                        { "id": 21040193, "nama": "Pneumokokus", "type": "checkbox3" },
                        { "id": 21040194, "nama": "HPV", "type": "checkbox3" },
                        { "id": 21040195, "nama": "Tetanus", "type": "checkbox3" },
                        { "id": 21040196, "nama": "Zooster", "type": "checkbox3" },
                        { "id": 21040197, "nama": "Lain-lain", "type": "textbox2" },
                    ]
                },
                {
                    "id": 1, "nama": "Riwayat Tumbuh Kembang Anak",
                    "detail": [
                        { "id": 21040198, "nama": "Pertumbuhan gigi pertama, usia", "type": "textbox" },
                        { "id": 21040199, "nama": "Berjalan Sendiri Mulai, usia", "type": "textbox" },
                        { "id": 21040200, "nama": "Mulai Membaca sendiri, Usia", "type": "textbox" },
                        { "id": 21040201, "nama": "Mulai Bisa Duduk, Usia", "type": "textbox" },
                        { "id": 21040202, "nama": "Mulai Bisa berdiri, Usia", "type": "textbox" },
            ...
            $scope.listRujukan2 = [
                {
                    ...
                    "detail": [
                        { "id": 21040106, "nama": "Pola Makan : ","satuan" : "x/hari", "type": "textbox2" },
                        { "id": 21040107, "nama": "Pola minum : ","satuan" : "cc/hari", "type": "textbox2" },
                        { "id": 21040108, "nama": "BAK : ","satuan" : "x/hari", "type": "textbox2" },
                        { "id": 21040109, "nama": "BAB : ","satuan" : "x/hari", "type": "textbox2" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 21040110, "nama": "Cemas","satuan" : "x/hari", "type": "checkbox3" },
                        { "id": 21040111, "nama": "Takut ","satuan" : "cc/hari", "type": "checkbox3" },
                        { "id": 21040112, "nama": "Marah ","satuan" : "x/hari", "type": "checkbox3" },
                        { "id": 21040113, "nama": "Sedih ","satuan" : "x/hari", "type": "checkbox3" },
                        { "id": 21040114, "nama": "Kecenderugan Bunuh diri ","satuan" : "x/hari", "type": "checkbox3" },
                        { "id": 21040115, "nama": "dll :", "type": "textbox" },
                        // { "id": 116064, "nama": "Pola Minum ","satuan" : "cc/hari", "type": "textbox2" },
                        // { "id": 116065, "nama": "BAK ","satuan" : "x/hari", "type": "textbox2" },
                        // { "id": 116066, "nama": "BAB","satuan" : "x/hari", "type": "textbox2" },
                    ]
                },
                {
                    ...
                    "detail": [
                        { "id": 21040116, "nama": "Wiraswasta", "type": "checkbox3" },
                        { "id": 21040117, "nama": "Pegawai Negeri", "type": "checkbox3" },
                        { "id": 21040118, "nama": "Pegawai Swasta", "type": "checkbox3" },
                        { "id": 21040119, "nama": "Tidak bekerja", "type": "checkbox3" },
                        { "id": 21040120, "nama": "Siswa/Mahasiswa", "type": "checkbox3" },
                        { "id": 21040121, "nama": "Pensiun", "type": "checkbox3" },
                        { "id": 21040122, "nama": "Alamat Rumah", "type": "textarea" },
                        { "id": 21040123, "nama": "No.Telp", "type": "textarea" },    
                        // { "id": 116064, "nama": "Pola Minum ","satuan" : "cc/hari", "type": "textbox2" },
                        // { "id": 116065, "nama": "BAK ","satuan" : "x/hari", "type": "textbox2" },
                        // { "id": 116066, "nama": "BAB","satuan" : "x/hari", "type": "textbox2" },
                    ]
                },
                {
                    ...
                    "detail": [
                        { "id": 21040124, "nama": "agama", "type": "label" },
                        { "id": 21040125, "nama": "Islam", "type": "checkbox3" },
                        { "id": 21040126, "nama": "Protestan", "type": "checkbox3" },
                        { "id": 21040127, "nama": "Hindu", "type": "checkbox3" },
                        { "id": 21040128, "nama": "Khatolik", "type": "checkbox3" },
                        { "id": 21040129, "nama": "Budha", "type": "checkbox3" },
                        { "id": 21040130, "nama": "Konghucu", "type": "checkbox3" },
                        { "id": 21040131, "nama": "Lain-lain", "type": "textbox" }, 
                        { "id": 21040132, "nama": "Kegiatan Spiritual dan nilai-nilai Kepercayaan ", "type": "label" },
                        { "id": 21040133, "nama": "Ada", "type": "checkbox3" },
                        { "id": 21040134, "nama": "Tidak Ada", "type": "checkbox3" }, 
                        { "id": 21040135, "nama": "Sebutkan", "type": "textbox" }, 
                        { "id": 21040136, "nama": "Bahasa sehari-hari", "type": "label" },
                        { "id": 21040137, "nama": "Indonesia", "type": "checkbox3" },
                        { "id": 21040138, "nama": "Inggris", "type": "checkbox3" }, 
                        { "id": 21040139, "nama": "Daerah", "type": "checkbox3" }, 
                        { "id": 21040140, "nama": "Lain-lain", "type": "textbox" },  
                        // { "id": 116064, "nama": "Pola Minum ","satuan" : "cc/hari", "type": "textbox2" },
                        // { "id": 116065, "nama": "BAK ","satuan" : "x/hari", "type": "textbox2" },
                        // { "id": 116066, "nama": "BAB","satuan" : "x/hari", "type": "textbox2" },
                    ]
            ...
            $scope.listRujukan3 = [
                {
                    ...
                    "detail": [
                        { "id": 21040141, "nama": "Pribadi ", "type": "checkbox3" },
                        { "id": 21040142, "nama": "Perusahaan", "type": "checkbox3" },
                        { "id": 21040143, "nama": "Asuransi ", "type": "checkbox3" },
                    ]
                },
                {
                    "id": 1, "nama": "Pendapatan",
                    "detail": [
                        { "id": 21040144, "nama": "UMR", "type": "checkbox2" },
                        { "id": 21040145, "nama": "UMR s/d 5 juta rp", "type": "checkbox2" },
                        { "id": 21040146, "nama": "5 s/d 10 juta rp", "type": "checkbox2" },
                        { "id": 21040147, "nama": "10 s/d 15 juta rp", "type": "checkbox2" },
                        { "id": 21040148, "nama": "> 15 juta rp", "type": "checkbox2" }
                    ]
                },
                {
                    "id": 1, "nama": "Asal Masuk",
                    "detail": [
                        { "id": 21040149, "nama": "Non Rujukan", "type": "checkbox3" },
                        { "id": 21040150, "nama": "Rujukan", "type": "checkbox3" },
                    ]
                },
                {
                    "id": 1, "nama": "Alasan Masuk",
                    "detail": [
                        { "id": 21040151, "nama": "", "type": "textarea" },
                    ]
                },
            ]
            $scope.listKonsep5 = [
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 21040203, "nama": "Ya", "type": "checkbox" }, 
                        { "id": 21040204, "nama": "Tidak", "type": "checkbox" },
                        { "id": 21040205, "nama": "makanan", "type": "textbox" },
                        { "id": 21040206, "nama": "obat", "type": "textbox" }, 
                        { "id": 21040207, "nama": "Lain-lain", "type": "textbox" }, 
                        { "id": 21040208, "nama": "Debu", "type": "checkbox" }, 
                        { "id": 21040209, "nama": "Udara", "type": "checkbox" },  
                        { "id": 21040210, "nama": "Sticker tanda alergi dipasang (warna merah)", "type": "checkbox" },                 
                    ]
                }
            ]
            ...
            $scope.listRencanaAsuhan = [
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 21040333, "nama": "Nyeri Akut ", "type": "checkbox" },
                        { "id": 21040334, "nama": "Kelebihan Volume Cairan ", "type": "checkbox" },  
                        { "id": 21040335, "nama": "Bersihkan jalan nafas tidak efektif ", "type": "checkbox" },  
                        { "id": 21040336, "nama": "Kekuragnan Volume Cairan ", "type": "checkbox" },  
                        { "id": 21040337, "nama": "Kekurangan Nutrisi ", "type": "checkbox" },  
                        { "id": 21040338, "nama": "Risiko Cidera", "type": "checkbox" },  
                        { "id": 21040339, "nama": "Hipertermi", "type": "checkbox" },  
                        { "id": 21040340, "nama": "Diare ", "type": "checkbox" },   
                        { "id": 21040341, "nama": "Lain-lain ", "type": "textbox" },                  
                    ]
                }
            ]
            $scope.listHumpty2 = [
            ...
            $scope.listNyeri3 = [{
                ...
                "detail": [
                    { "id": 21040223, "nama": "Ruda Paksa", "type": "checkbox" },
                    { "id": 21040224, "nama": "Benturan", "type": "checkbox" },
                    { "id": 21040225, "nama": "Sayatan", "type": "checkbox" },
                    { "id": 21040226, "nama": "dll", "type": "textbox" },
                ]
            },
            {
                "id": 1, "nama": "Quality",
                "detail": [
                    { "id": 21040227, "nama": "Tertusuk", "type": "checkbox" },
                    { "id": 21040228, "nama": "Tertekan/Tertindih", "type": "checkbox" },
                    { "id": 21040229, "nama": "Diiris-iris", "type": "checkbox" },
                    { "id": 21040230, "nama": "dll", "type": "textbox" },
                ]
            },
            {
                "id": 1, "nama": "menjalar",
                "detail": [
                    { "id": 21040231, "nama": "Ya", "type": "checkbox" },
                    { "id": 21040232, "nama": "Tidak", "type": "checkbox" },
                    { "id": 21040233, "nama": "ke :", "type": "textbox" },
                ]
            },
            {
                "id": 1, "nama": "Scala",
                "detail": [
                    { "id": 21040234, "nama": "ke :", "type": "textbox" },
                ]
            },
            {
                "id": 1, "nama": "Time",
                "detail": [
                    { "id": 21040235, "nama": "Jarang", "type": "checkbox" },
                    { "id": 21040236, "nama": "Hilang/Timbul", "type": "checkbox" },
                    { "id": 21040237, "nama": "Terus-Menerus", "type": "checkbox" },
                ]
            }
            ]
            $scope.listStatusFungsional = [
                {
                    ...
                    "detail": [
                        { "id": 21040264, "nama": "Normal ", "type": "checkbox" },
                        { "id": 21040265, "nama": "Kabur ", "type": "checkbox" },
                        { "id": 21040266, "nama": "Kacamata ", "type": "checkbox" },
                        { "id": 21040267, "nama": "Lensa Kontak ", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Penciuman :",
                    "detail": [
                        { "id": 21040268, "nama": "Normal ", "type": "checkbox" },
                        { "id": 21040269, "nama": "Tidak ", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Pendenganran :",
                    "detail": [
                        { "id": 21040270, "nama": "Normal ", "type": "checkbox" },
                        { "id": 21040271, "nama": "Tuli Kanan/Kiri ", "type": "checkbox" },
                        { "id": 21040272, "nama": "Alat Bantu dengan kanan/kiri ", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Kognitif :",
                    "detail": [
                        { "id": 21040273, "nama": "Orientasi penuh ", "type": "checkbox" },
                        { "id": 21040274, "nama": "Bingung", "type": "checkbox" },
                        { "id": 21040275, "nama": "Pelupa", "type": "checkbox" },
                        { "id": 21040276, "nama": "Tidak Dapat dimengerti", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Aktifitas Sehari-hari :",
                    "detail": [
                        { "id": 21040277, "nama": "Mandiri", "type": "checkbox" },
                        { "id": 21040278, "nama": "Bantuan Minimal", "type": "checkbox" },
                        { "id": 21040279, "nama": "Bantuan Sebagian", "type": "checkbox" },
                        { "id": 21040280, "nama": "Ketergantungan Total", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Berjalan :",
                    "detail": [
                        { "id": 21040281, "nama": "Tidak Ada Kesulitan", "type": "checkbox" },
                        { "id": 21040282, "nama": "Perlu Bantuan", "type": "checkbox" },
                        { "id": 21040283, "nama": "Sering Jatuh ", "type": "checkbox" },
                        { "id": 21040284, "nama": "Kelumpuhan", "type": "checkbox" },
                    ]
                }
            ]
            ...
            $scope.listHumpty = [

                {
                    "id": 1, "nama": "Usia",
                    "detail": [
                        { "id": 21040238, "nama": "< 3 tahun", "descNilai": "4" },
                        { "id": 21040239, "nama": "3-7 tahun", "descNilai": "3" },
                        { "id": 21040240, "nama": "8-13 tahun", "descNilai": "2" },
                        { "id": 21040241, "nama": "> 13 tahun", "descNilai": "1" },
                    ]
                },

                {
                    ...
                    "detail": [
                        { "id": 21040242, "nama": "Laki-laki", "descNilai": "2" },
                        { "id": 21040243, "nama": "Perempuan", "descNilai": "1" },
                    ]
                },

                {
                    "id": 3, "nama": "Diagnosis",
                    "detail": [
                        { "id": 21040244, "nama": "Kelainan Neurologi", "descNilai": "4" },
                        { "id": 21040245, "nama": "Perubahan dalam Oksigenasi (Masalah saluran pernafasan, dehidrasi, anemia, anoreksia, sinkop, Sakit Kepala, dll)", "descNilai": "3" },
                        { "id": 21040246, "nama": "Gangguan perilaku / psikiatri", "descNilai": "2" },
                        { "id": 21040247, "nama": "Diagnosis lainnya", "descNilai": "1" },
                    ]
...

                {
                    ...
                    "detail": [
                        { "id": 21040248, "nama": "Tidak menyadari keterbatasan dirinya", "descNilai": "3" },
                        { "id": 21040249, "nama": "Lupa keterbatasannya", "descNilai": "2" },
                        { "id": 21040250, "nama": "Orientasi baik terhadap diri sendiri", "descNilai": "1" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 21040251, "nama": "Riwayat jatuh-bayi diletakan ditempat tidur dewasa", "descNilai": "4" },
                        { "id": 21040252, "nama": "Pasien Menggunakan Alat bantu/bayi diletakan dalam tempat tidur bayi/perabot rumah", "descNilai": "3" },
                        { "id": 21040253, "nama": "Pasien diletakan ditempat tidur", "descNilai": "2" },
                        { "id": 21040254, "nama": "Area diluar rumah sakit", "descNilai": "1" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 21040255, "nama": "Dalam 24 jam ", "descNilai": "3" },
                        { "id": 21040256, "nama": "Dalam 48 jam", "descNilai": "2" },
                        { "id": 21040257, "nama": "> 48 jam/tidak mengalami perbedaan/sedasi/anestesi", "descNilai": "1" },
                ...
                },
                {
                    ...
                    "detail": [
                        { "id": 21040258, "nama": "penggunaan multiple, sedatif, obat hipnosis, harbiturat, fanotiazin, anti depresan, pencahar, diuretik, narkosa", "descNilai": "3" },
                        { "id": 21040259, "nama": "penggunaan salah satu obat diatas", "descNilai": "2" },
                        { "id": 21040260, "nama": "penggunaan medikasi lainnya atau tidak ada medikasi", "descNilai": "1" },
            ...
            $scope.listNyeri5 = [
            {
                ...
                "detail": [
                    { "id": 21040296, "nama": "Tidak ", "type": "checkbox" },
                    { "id": 21040297, "nama": "Ya ", "type": "checkbox" },
                ]
            },
            {
                "id": 1, "nama": "B. Jika Ya,sebutkan hambatanya( bisa dilingkari lebih dari satu)",
                "detail": [
                    { "id": 21040298, "nama": "Pendenganran ", "type": "checkbox" },
                    { "id": 21040299, "nama": "Penglihatan ", "type": "checkbox" },
                    { "id": 21040300, "nama": "Kognitif ", "type": "checkbox" },
                    { "id": 21040301, "nama": "Fisik ", "type": "checkbox" },
                    { "id": 21040302, "nama": "Budaya ", "type": "checkbox" },
                    { "id": 21040303, "nama": "Agama ", "type": "checkbox" },
                    { "id": 21040304, "nama": "Emosi ", "type": "checkbox" },
                    { "id": 21040305, "nama": "Bahasa ", "type": "checkbox" },
                    { "id": 21040306, "nama": "Lainnya ", "type": "textbox" },
                ]
            },
            {
                "id": 1, "nama": "C. Perlu Penerjemah",
                "detail": [
                    { "id": 21040307, "nama": "Ya ", "type": "checkbox" },
                    { "id": 21040308, "nama": "Tidak ", "type": "checkbox" },
                    { "id": 21040309, "nama": "Sebutkan ", "type": "textbox" },
            ...
            },
            {
                ...
                "detail": [
                    { "id": 21040310, "nama": "Diagnosa & Manajemen ", "type": "checkbox2" },
                    { "id": 21040311, "nama": "Obat-obatan ", "type": "checkbox2" },
                    { "id": 21040312, "nama": "Perawatan Luka ", "type": "checkbox2" },
                    { "id": 21040313, "nama": "Rehabilitasi ", "type": "checkbox2" },
                    { "id": 21031505, "nama": "Manajemen nyeri ", "type": "checkbox2" },
                    { "id": 21040314, "nama": "Diet & Nutrisi ", "type": "checkbox2" },
                    { "id": 21040315, "nama": "Lain-lain  : ", "type": "textbox" },
                ]
            }             
            ]
            $scope.listNyeri6 = [{
            ...
            },
            {
                ...
                "detail": [
                    { "id": 21040316, "nama": "ya  ", "type": "checkbox" },
                    { "id": 21040317, "nama": "tidak ", "type": "checkbox" },
                ]
            },
            {
                "id": 1, "nama": "B. Keterbatasan mobilitas",
                "detail": [
                    { "id": 21040318, "nama": "ya  ", "type": "checkbox" },
                    { "id": 21040319, "nama": "tidak ", "type": "checkbox" },
                ]
            },
            {
                "id": 1, "nama": "C. Perawatan dan Pengobatan lanjutan",
                "detail": [
                    { "id": 21040320, "nama": "ya  ", "type": "checkbox" },
                    { "id": 21040321, "nama": "tidak ", "type": "checkbox" },
                ]
            },
            {
                "id": 1, "nama": "D. Bantuan untuk melakukan Aktifitas sehari-hari",
                "detail": [
                    { "id": 21040322, "nama": "ya  ", "type": "checkbox" },
                    { "id": 21040323, "nama": "tidak ", "type": "checkbox" },
                ]
            },
            {
                "id": 1, "nama": "Bila salah satu Jawaban Ya, maka lakukan Prencanaan lanjutan",
                "detail": [
                    { "id": 21040324, "nama": "Perawatan diri (Mandi, BAK,BAB)  ", "type": "checkbox" },
                    { "id": 21040325, "nama": "Pemantauan pemberian obat ", "type": "checkbox" },
                    { "id": 21040326, "nama": "Pemantauan diet ", "type": "checkbox" },
                    { "id": 21040327, "nama": "Perawatan Luka ", "type": "checkbox" },
                    { "id": 21040328, "nama": "Latihan Fisik Lanjutan ", "type": "checkbox" },
                    { "id": 21040329, "nama": "Pendampingan tenaga khusus dirumah ", "type": "checkbox" },
                    { "id": 21040330, "nama": "Bantuan medis/perawatan di rumah (Homecare) ", "type": "checkbox" },
                    { "id": 21040331, "nama": "Bantuan untuk melakukan Aktifitas fisik (kursi roda, alat bantu jalan) ", "type": "checkbox" },
            ...
            $scope.listSkorNRC = [{
                "id": 8, "nama": "Score ",
                "detail": [
                    { "id": 21040213, "nama": "0= Tidak Nyeri", "type": "checkbox" },
                    { "id": 21040214, "nama": "1 - 3= Nyeri Ringan", "type": "checkbox"},
                    { "id": 21040215, "nama": "4 - 6= Nyeri Sedang", "type": "checkbox" },
                    { "id": 21040216, "nama": "7 - 10= Nyeri Berat", "type": "checkbox"},
                ]
            }]
            $scope.listSkorWong = [{
                "id": 9, "nama": "Score ",
                "detail": [
                    { "id": 21040217, "nama": "0 - 1= Tidak Ada Nyeri", "type": "checkbox"},
                    { "id": 21040218, "nama": "2 - 3= Sedikit Nyeri", "type": "checkbox"},
                    { "id": 21040219, "nama": "4 - 5= Cukup Nyeri", "type": "checkbox" },
                    { "id": 21040220, "nama": "6 - 7= Lumayan Nyeri", "type": "checkbox"},
                    { "id": 21040221, "nama": "8 - 9= Sangat Nyeri", "type": "checkbox"},
                    { "id": 21040222, "nama": "10= Amat Sangat Nyeri", "type": "checkbox", },
                ]
            }]
            $scope.listNyeriAnak = [
                {
            ...
            $scope.listNutrisi = [

                {
                    ...
                    "detail": [
                        { "id": 21040285, "nama": "a. Tidak ada penurunan berat badan", "descNilai": "0" },
                        { "id": 21040286, "nama": "b. Tidak yakin / tidak tahu / terasa baju lebih longgar", "descNilai": "2" },
                        { "id": 21040287, "nama": "c. Penurunan : > 1 - 5 kg", "descNilai": "1" },
                        { "id": 21040288, "nama": "               > 6 - 10 kg", "descNilai": "2" },
                        { "id": 21040289, "nama": "               > 11 - 15 kg", "descNilai": "3" },
                        { "id": 21040290, "nama": "               > 15 kg", "descNilai": "4" },
                        { "id": 21040291, "nama": "  Tidak tahu berapa penurunan berat badan", "descNilai": "2" },
                    ]
                },
                {
                    "id": 2, "nama": "Asupan Makan Berkurang karena tidak nafsu makan",
                    "detail": [
                        { "id": 21040292, "nama": "a. Tidak", "descNilai": "0" },
                        { "id": 21040293, "nama": "b. Ya", "descNilai": "1" }
                    ]
                },
            ]
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'AwalAnakUalngCtrl ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

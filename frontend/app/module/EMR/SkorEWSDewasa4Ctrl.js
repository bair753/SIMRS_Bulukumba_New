define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSDewasa4Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 251).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[18426] = $scope.skor1
                $scope.item.obj[18427] = $scope.skor2
                $scope.item.obj[18428] = $scope.skor3
                $scope.item.obj[18429] = $scope.skor4
                $scope.item.obj[18430] = $scope.skor5
                $scope.item.obj[18431] = $scope.skor6
                $scope.item.obj[18432] = $scope.skor7
                $scope.item.obj[18433] = $scope.skor8
                $scope.item.obj[18434] = $scope.skor9
                $scope.item.obj[18435] = $scope.skor10
                $scope.item.obj[18436] = $scope.skor11
                $scope.item.obj[18437] = $scope.skor12
                $scope.item.obj[18438] = $scope.skor13
            }

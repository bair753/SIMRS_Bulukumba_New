define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSDewasa13Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 376).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[104104] = $scope.skor1
                $scope.item.obj[104105] = $scope.skor2
                $scope.item.obj[104106] = $scope.skor3
                $scope.item.obj[104107] = $scope.skor4
                $scope.item.obj[104108] = $scope.skor5
                $scope.item.obj[104109] = $scope.skor6
                $scope.item.obj[104110] = $scope.skor7
                $scope.item.obj[104111] = $scope.skor8
                $scope.item.obj[104112] = $scope.skor9
                $scope.item.obj[104113] = $scope.skor10
                $scope.item.obj[104114] = $scope.skor11
                $scope.item.obj[104115] = $scope.skor12
                $scope.item.obj[104116] = $scope.skor13
            }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Skor Early Warning System Dewasa13 ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

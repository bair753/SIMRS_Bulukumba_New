define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AskepCtrl', ['$q', '$rootScope', '$scope', '$state', 'CacheHelper', 'MedifirstService', '$mdDialog',
        function ($q, $rootScope, $scope, $state, cacheHelper, medifirstService, $mdDialog) {
            ...
            function init() {
                ...
                medifirstService.get("emr/get-emr-transaksi-detail-form?" + paramSearch + "&jenisEmr=askep", true).then(function (dat) {
                ...
                medifirstService.get("emr/get-menu-rekam-medis-dynamic?namaemr=askep" + mapemr).then(function (e) {
            ...
            //     $state.go("RekamMedis.Askep.AskepDetail");
            // }
            $scope.back = function () {
                $scope.myVar = 1
                $scope.showRiwayatEMR = false
            ...
            $scope.asupKaForm = function (noemr, reportdisplay, emrfk, norec) {
                ...
                if (noemr2 != '-')
                    noemr2.trim()
                var url = "RekamMedis.Askep.AskepDetail"

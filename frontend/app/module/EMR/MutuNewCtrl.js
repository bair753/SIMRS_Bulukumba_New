define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('MutuNewCtrl', ['$q', '$rootScope', '$scope', '$state', 'CacheHelper', 'MedifirstService', '$mdDialog',
        function ($q, $rootScope, $scope, $state, cacheHelper, medifirstService, $mdDialog) {
            ...
            function init() {
                ...
                // });
                // medifirstService.get("emr/get-emr-transaksi?nocm=" + $scope.item.noMr + "&jenisEmr=askep", true).then(function (dat) {
                medifirstService.get("emr/get-emr-transaksi-detail-form?" + paramSearch + "&jenisEmr=mutu", true).then(function (dat) {
                ...
                medifirstService.get("emr/get-menu-rekam-medis-dynamic?namaemr=mutu" + mapemr).then(function (e) {
                    ...
                    $scope.treeSourceMutu = inlineDefault
                    $scope.mainTreeViewMutuOption = {
            ...
            // $scope.klikMutu = function(tree){
            //     $state.go("RekamMedis.MutuNew.MutuDetail");
            // }
            $scope.back = function () {
                $scope.myVar = 1
                $scope.showRiwayatEMR = false
            ...
            $scope.asupKaForm = function (noemr, reportdisplay, emrfk, norec) {
                ...
                if (noemr2 != '-')
                    noemr2.trim()
                var url = "RekamMedis.MutuNew.MutuDetail"

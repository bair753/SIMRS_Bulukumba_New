define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AsesmenPraBedahCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            function initDrawstuff() {
                // debugger
                var bkg = new Image();
                bkg.src = "../app/images/1608368309.jpg"; //temporary changed to load base64 directly to avoid security errors when running locally
          ...
          {		
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210005).then(function (e) {

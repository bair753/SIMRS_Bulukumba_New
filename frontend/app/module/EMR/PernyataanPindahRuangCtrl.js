define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('PernyataanPindahRuangCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.listPasien = [
                {
                    "id": 1,
                    "detail": [
                        { "id": 31101235, "caption": "Nama Pasien :", "type": "textbox"},
                        { "id": 31101236, "caption": "Jenis Kelamin :", "type" : "textbox" },
                        { "id": 31101237, "caption": "No RM :", "type" : "textbox" },
                        { "id": 31101238, "caption": "Tanggal Lahir :", "type": "date" },
                        { "id": 31101239, "caption": "Dirawat di Ruang", "type": "combobox", "dataList": "listRuangan" },
                        { "id": 31101240, "caption": "Kelas", "type": "combobox", "dataList": "listKelas" },
            ...
            $scope.listPindah = [
                {
                    "id": 1,
                    "detail": [
                        { "id": 31101241, "caption": "Kelas", "type": "combobox", "dataList": "listKelas" },
                        { "id": 31101242, "caption": "Ruang Perawatan", "type": "combobox", "dataList": "listRuangan" },
                        { "id": 31101243, "caption": "Tanggal dan Jam Pindah", "type": "datetime" },
                        { "id": 31101244, "caption": "Dengan Alasan :", "type": "textarea" },
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[31101235] = antrianPasien.namapasien;
                    $scope.item.obj[31101238] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
                    $scope.item.obj[31101236] = antrianPasien.jeniskelamin;
                    $scope.item.obj[31101237] = antrianPasien.nocm;

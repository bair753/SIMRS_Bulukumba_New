define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PersetujuanKolonoskopiCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.listPasien = [
                {
                    "id": 1,
                    "detail": [
                        { "id": 31101109, "nama": "", "caption": "Nama Pasien :", "type": "textbox"},
                        { "id": 31101110, "nama": "", "caption": "Tanggal Lahir :", "type": "date" },
                        { "id": 31101111, "nama": "", "caption": "Jenis Kelamin :", "type": "textbox" },
                        { "id": 31101112, "nama": "", "caption": "No. RM :", "type" : "textbox" },
                        { "id": 31101113, "nama": "", "caption": "Alamat :", "type" : "textbox"}
                    ]
                }
            ];
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[31101112] = antrianPasien.nocm;
                    $scope.item.obj[31101109] = antrianPasien.namapasien;
                    $scope.item.obj[31101110] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
                    $scope.item.obj[31101111] = antrianPasien.jeniskelamin;
                    $scope.item.obj[31101113] = antrianPasien.alamatlengkap;
                })

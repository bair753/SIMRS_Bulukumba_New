define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PersetujuanTindakanPembedahanCtrl', ['$scope', '$rootScope', '$state', 'CacheHelper', 'MedifirstService',
        function ($scope, $rootScope, $state, cacheHelper, medifirstService) {

            $scope.item = {};
            $scope.cc = {};
            var nomorEMR = '-'
            $scope.cc.emrfk = 210030
            var dataLoad = []

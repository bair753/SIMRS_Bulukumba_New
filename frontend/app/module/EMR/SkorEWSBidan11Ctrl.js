define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSBidan11Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210128).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[22030978] = $scope.skor1
                $scope.item.obj[22030979] = $scope.skor2
                $scope.item.obj[22030980] = $scope.skor3
                $scope.item.obj[22030981] = $scope.skor4
                $scope.item.obj[22030982] = $scope.skor5
                $scope.item.obj[22030983] = $scope.skor6
                $scope.item.obj[22030984] = $scope.skor7
                $scope.item.obj[22030985] = $scope.skor8
                $scope.item.obj[22030986] = $scope.skor9
                $scope.item.obj[22030987] = $scope.skor10
                $scope.item.obj[22030988] = $scope.skor11
                $scope.item.obj[22030989] = $scope.skor12
                $scope.item.obj[22030990] = $scope.skor13
            }

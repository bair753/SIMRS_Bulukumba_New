define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirPemberianInformasiCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.cc = {}
            var nomorEMR = '-'
            $scope.cc.emrfk = 17009
            var dataLoad = []
            var pegawaiInputDetail= ''
            medifirstService.getPart('emr/get-datacombo-part-pegawai', true, true, 20).then(function (data) {
                $scope.listPegawai = data
            })
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 17009).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    "id": 1, "nama": "Rujukan",
                    "detail": [
                        { "id": 17000401, "nama": "Dokter Pelaksana Tindakan", "type": "combobox" },
                        { "id": 17000402, "nama": "Pemberi Informasi", "type": "combobox" },
                        { "id": 17000403, "nama": "Penerima Informasi / Pemberi Persetujuan", "type": "textbox" },
                    ]
                },
            ]
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                $scope.item.obj = []
                $scope.item.obj2 = []
                $scope.item.obj[111055]=$scope.now
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                   ...
                   'FormulirPemberianInformasi ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

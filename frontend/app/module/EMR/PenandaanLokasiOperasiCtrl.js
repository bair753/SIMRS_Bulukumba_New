define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PenandaanLokasiOperasiCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {                
                $scope.item.obj = []
                $scope.item.obj2 = []
                $scope.item.obj[32104086] = $scope.cc.namapasien
                            ...
                            if (parseFloat($scope.cc.emrfk) == dataImg[i].emrfk ) {
                                if(dataImg[i].emrdfk== 1){
                                    ...
                                    background.onload = function() {
                                        context.drawImage(background, 0, 0, 700, 850);
                                    }
                                }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Penandaan Lokasi Operasi' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

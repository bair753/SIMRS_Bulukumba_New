define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PenolakanRawatInapHCUCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[32103373] = $scope.cc.namapasien;
                    $scope.item.obj[32103384] = $scope.cc.namapasien;
                    ...
                    $scope.item.obj[32103376] = antrianPasien.alamatlengkap
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Penolakan Rawat Inap Di HCU/ICU/CVCU/NICU/CIPU ' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

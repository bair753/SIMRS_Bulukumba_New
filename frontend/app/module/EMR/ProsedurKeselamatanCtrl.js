define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('ProsedurKeselamatanCtrl', ['$rootScope', '$scope', '$state', 'CacheHelper', 'MedifirstService',
        function ($rootScope, $scope, $state, cacheHelper, medifirstService) {
            ...
            $scope.cetakPdf = function () {
                ...
                client.get('http://127.0.0.1:1237/printvb/e-rekammedis?'+ urlcetak + '&id=' + $scope.cc.nocm + '&emr=' + norecEMR + '&noreg=' + $scope.cc.noregistrasi +'&view=true', function (response) {

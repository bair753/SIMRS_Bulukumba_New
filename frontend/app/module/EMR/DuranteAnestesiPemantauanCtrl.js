define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DuranteAnestesiPemantauanCtrl', ['$rootScope', '$scope', '$state', 'CacheHelper', 'MedifirstService',
        function ($rootScope, $scope, $state, cacheHelper, medifirstService) {
            ...
            if (nomorEMR == '-') {
                medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + emr_fk).then(function (e) {
                    ...
                    for (var i = e.data.kolom3.length - 1; i >= 0; i--) {
                        ...
                        if(e.data.kolom3[i].id != 21023115 && e.data.kolom3[i].id != 21023116)
                        {
            ...
            function setMasterTable(e){
                ...
                for (let i = 0; i < datas.length; i++) {
                    ...
                    if (element.id >= 21022864 && element.id <= 21023103) {
                        sama = false
                ...
                for (var i = e.data.kolom4.length - 1; i >= 0; i--) {
                    if (e.data.kolom4[i].id <= 21023103) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    for (let i = 0; i < arrobj.length; i++) {
                        if(arrobj[i] >= 21023057 && arrobj[i] <= 21023105 || arrobj[i] >= 21023109 && arrobj[i] <= 21023110){

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSBidan6Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210123).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[22028378] = $scope.skor1
                $scope.item.obj[22028379] = $scope.skor2
                $scope.item.obj[22028380] = $scope.skor3
                $scope.item.obj[22028381] = $scope.skor4
                $scope.item.obj[22028382] = $scope.skor5
                $scope.item.obj[22028383] = $scope.skor6
                $scope.item.obj[22028384] = $scope.skor7
                $scope.item.obj[22028385] = $scope.skor8
                $scope.item.obj[22028386] = $scope.skor9
                $scope.item.obj[22028387] = $scope.skor10
                $scope.item.obj[22028388] = $scope.skor11
                $scope.item.obj[22028389] = $scope.skor12
                $scope.item.obj[22028390] = $scope.skor13
            }

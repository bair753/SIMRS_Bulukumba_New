define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSDewasa6Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 253).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[19472] = $scope.skor1
                $scope.item.obj[19473] = $scope.skor2
                $scope.item.obj[19474] = $scope.skor3
                $scope.item.obj[19475] = $scope.skor4
                $scope.item.obj[19476] = $scope.skor5
                $scope.item.obj[19477] = $scope.skor6
                $scope.item.obj[19478] = $scope.skor7
                $scope.item.obj[19479] = $scope.skor8
                $scope.item.obj[19480] = $scope.skor9
                $scope.item.obj[19481] = $scope.skor10
                $scope.item.obj[19482] = $scope.skor11
                $scope.item.obj[19483] = $scope.skor12
                $scope.item.obj[19484] = $scope.skor13
            }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Skor Early Warning System Dewasa6 ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

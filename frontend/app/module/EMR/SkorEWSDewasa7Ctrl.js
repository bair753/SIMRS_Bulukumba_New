define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSDewasa7Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 254).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[60481] = $scope.skor1
                $scope.item.obj[60482] = $scope.skor2
                $scope.item.obj[60483] = $scope.skor3
                $scope.item.obj[60484] = $scope.skor4
                $scope.item.obj[60485] = $scope.skor5
                $scope.item.obj[60486] = $scope.skor6
                $scope.item.obj[60487] = $scope.skor7
                $scope.item.obj[60488] = $scope.skor8
                $scope.item.obj[60489] = $scope.skor9
                $scope.item.obj[60490] = $scope.skor10
                $scope.item.obj[60491] = $scope.skor11
                $scope.item.obj[60492] = $scope.skor12
                $scope.item.obj[60493] = $scope.skor13
            }

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AwalAnakCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210042).then(function (e) {
            ...
            $scope.listRujukan = [
                {
                    "id": 1, "nama": "Anamnesa",
                    "detail": [
                        { "id": 21031270, "nama": "Auto anamnesa ", "type": "checkbox" },
                        { "id": 21031271, "nama": "Allo anamnesa ", "type": "checkbox" },
                        { "id": 21031272, "nama": "Keluarga ", "type": "checkbox2" },
                        { "id": 21031273, "nama": "Penerjemah bahasa", "type": "checkbox2" },
                        { "id": 21031274, "nama": "Orang lain ", "type": "checkbox2" },
                        { "id": 21031275, "nama": "Nama :", "type": "textbox" },
                        { "id": 21031276, "nama": "Hubungan :", "type": "textbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Cara Masuk",
                    "detail": [
                        { "id": 21031277, "nama": "Jalan tanpa bantuan ", "type": "checkbox3" },
                        { "id": 21031278, "nama": "Jalan dengan bantuan", "type": "checkbox3" },
                        { "id": 21031279, "nama": "Tempat tidur dorong", "type": "checkbox3" },
                        { "id": 21031280, "nama": "Lain-lain", "type": "textbox" }
                    ]
                },
                {
                    "id": 1, "nama": "Asal Masuk",
                    "detail": [
                        { "id": 21031281, "nama": "Non Rujukan", "type": "checkbox3" },
                        { "id": 21031282, "nama": "Rujukan", "type": "checkbox3" },
                    ]
                },
                {
                    "id": 1, "nama": "Alasan Masuk",
                    "detail": [
                        { "id": 21031283, "nama": "", "type": "textarea" },
                    ]
                },
            ]
            $scope.GCSKuantitatif = function ()
            {
                let e = parseInt($scope.item.obj[21031290]) || 0;
                let v = parseInt($scope.item.obj[21031291]) || 0;
                let m = parseInt($scope.item.obj[21031292]) || 0;
                let hasil =  e + v + m;
                console.log(hasil);
                if(hasil >= 14 && hasil <=15)
                {
                    $scope.item.obj[21009271] = hasil + " Compos mentis";
                } else if(hasil >= 12 && hasil <= 13)
                {
                    $scope.item.obj[21009271] = hasil + " Apatis";
                } else if(hasil >= 11 && hasil <= 12)
                {
                    $scope.item.obj[21009271] = hasil + " Somnolent";
                }else if(hasil >= 8 && hasil <= 10)
                {
                    $scope.item.obj[21009271] = hasil + " Stupor";
                }else if(hasil < 5)
                {
                    $scope.item.obj[21009271] = hasil + " Koma";
                }else
                {
                    $scope.item.obj[21009271] = "";
                }
            }
            ...
            $scope.listKesadaran = [
                {
                    "id": 1, "nama": "GCS",
                    "detail": [
                        { "id": 21031290, "nama": "E ", "type": "textboxgcs" },
                        { "id": 21031291, "nama": "V ", "type": "textboxgcs" },
                        { "id": 21031292, "nama": "M ", "type": "textboxgcs" },
                        { "id": 21009271, "nama": "Skor ", "type": "textboxskorgcs" },
                    ]
                },
                {
                    "id": 1, "nama": "Refleks Cahaya",
                    "detail": [
                        { "id": 21031293, "nama": "Ka ", "type": "textbox" },
                        { "id": 21031294, "nama": "Ki ", "type": "textbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Ukuran Pupil",
                    "detail": [
                        { "id": 21031295, "nama": "Ka ", "satuan": "mm", "type": "textbox" },
                        { "id": 21031296, "nama": "Ki ", "satuan": "mm", "type": "textbox" },
                    ]
                }             
            ]
            ...
            $scope.listRujukan3 = [
                {
                    ...
                    "detail": [
                        { "id": 21031332, "nama": "Pribadi ", "type": "checkbox3" },
                        { "id": 21031333, "nama": "Perusahaan", "type": "checkbox3" },
                        { "id": 21031334, "nama": "Asuransi ", "type": "checkbox3" },
                    ]
                },
                {
                    "id": 1, "nama": "Pendapatan",
                    "detail": [
                        { "id": 21031335, "nama": "UMR", "type": "checkbox2" },
                        { "id": 21031336, "nama": "UMR s/d 5 juta rp", "type": "checkbox2" },
                        { "id": 21031337, "nama": "5 s/d 10 juta rp", "type": "checkbox2" },
                        { "id": 21031338, "nama": "10 s/d 15 juta rp", "type": "checkbox2" },
                        { "id": 21031339, "nama": "> 15 juta rp", "type": "checkbox2" }
                    ]
                },
                {
                    "id": 1, "nama": "Asal Masuk",
            ...
            $scope.listKonsep5 = [
                {
                    "id": 1, "nama": "",
                    "detail": [
                        { "id": 21031395, "nama": "Ya", "type": "checkbox" }, 
                        { "id": 21031396, "nama": "Tidak", "type": "checkbox" },
                        { "id": 21031397, "nama": "makanan", "type": "textbox" },
                        { "id": 21031398, "nama": "obat", "type": "textbox" }, 
                        { "id": 21031399, "nama": "Lain-lain", "type": "textbox" }, 
                        { "id": 21031400, "nama": "Debu", "type": "checkbox" }, 
                        { "id": 21031401, "nama": "Udara", "type": "checkbox" },  
                        { "id": 21031402, "nama": "Sticker tanda alergi dipasang (warna merah)", "type": "checkbox" },                 
                    ]
                }
            ]
            ...
            $scope.listNyeri3 = [{
                ...
                "detail": [
                    { "id": 21031415, "nama": "Ruda Paksa", "type": "checkbox" },
                    { "id": 21031416, "nama": "Benturan", "type": "checkbox" },
                    { "id": 21031417, "nama": "Sayatan", "type": "checkbox" },
                    { "id": 21031418, "nama": "dll", "type": "textbox" },
                ]
            },
            {
                "id": 1, "nama": "Quality",
                "detail": [
                    { "id": 21031419, "nama": "Tertusuk", "type": "checkbox" },
                    { "id": 21031420, "nama": "Tertekan/Tertindih", "type": "checkbox" },
                    { "id": 21031421, "nama": "Diiris-iris", "type": "checkbox" },
                    { "id": 21031422, "nama": "dll", "type": "textbox" },
                ]
            },
            {
                "id": 1, "nama": "menjalar",
                "detail": [
                    { "id": 21031423, "nama": "Ya", "type": "checkbox" },
                    { "id": 21031424, "nama": "Tidak", "type": "checkbox" },
                    { "id": 21031425, "nama": "ke :", "type": "textbox" },
                ]
            },
            {
                "id": 1, "nama": "Scala",
                "detail": [
                    { "id": 21031426, "nama": "ke :", "type": "textbox" },
                ]
            },
            {
                "id": 1, "nama": "Time",
                "detail": [
                    { "id": 21031427, "nama": "Jarang", "type": "checkbox" },
                    { "id": 21031428, "nama": "Hilang/Timbul", "type": "checkbox" },
                    { "id": 21031429, "nama": "Terus-Menerus", "type": "checkbox" },
                ]
            }
            ]
            $scope.listStatusFungsional = [
                {
                    ...
                    "detail": [
                        { "id": 21031457, "nama": "Normal ", "type": "checkbox" },
                        { "id": 21031458, "nama": "Kabur ", "type": "checkbox" },
                        { "id": 21031459, "nama": "Kacamata ", "type": "checkbox" },
                        { "id": 21031460, "nama": "Lensa Kontak ", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Penciuman :",
                    "detail": [
                        { "id": 21031461, "nama": "Normal ", "type": "checkbox" },
                        { "id": 21031462, "nama": "Tidak ", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Pendenganran :",
                    "detail": [
                        { "id": 21031463, "nama": "Normal ", "type": "checkbox" },
                        { "id": 21031464, "nama": "Tuli Kanan/Kiri ", "type": "checkbox" },
                        { "id": 21031465, "nama": "Alat Bantu dengan kanan/kiri ", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Kognitif :",
                    "detail": [
                        { "id": 21031466, "nama": "Orientasi penuh ", "type": "checkbox" },
                        { "id": 21031467, "nama": "Bingung", "type": "checkbox" },
                        { "id": 21031468, "nama": "Pelupa", "type": "checkbox" },
                        { "id": 21031469, "nama": "Tidak Dapat dimengerti", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Aktifitas Sehari-hari :",
                    "detail": [
                        { "id": 21031470, "nama": "Mandiri", "type": "checkbox" },
                        { "id": 21031471, "nama": "Bantuan Minimal", "type": "checkbox" },
                        { "id": 21031472, "nama": "Bantuan Sebagian", "type": "checkbox" },
                        { "id": 21031473, "nama": "Ketergantungan Total", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Berjalan :",
                    "detail": [
                        { "id": 21031474, "nama": "Tidak Ada Kesulitan", "type": "checkbox" },
            ...
            $scope.listNyeri5 = [
            {
                ...
                "detail": [
                    { "id": 21031488, "nama": "Tidak ", "type": "checkbox" },
                    { "id": 21031489, "nama": "Ya ", "type": "checkbox" },
                ]
            },
            {
                "id": 1, "nama": "B. Jika Ya,sebutkan hambatanya( bisa dilingkari lebih dari satu)",
                "detail": [
                    { "id": 21031490, "nama": "Pendenganran ", "type": "checkbox" },
                    { "id": 21031491, "nama": "Penglihatan ", "type": "checkbox" },
                    { "id": 21031492, "nama": "Kognitif ", "type": "checkbox" },
                    { "id": 21031493, "nama": "Fisik ", "type": "checkbox" },
                    { "id": 21031494, "nama": "Budaya ", "type": "checkbox" },
                    { "id": 21031495, "nama": "Agama ", "type": "checkbox" },
                    { "id": 21031496, "nama": "Emosi ", "type": "checkbox" },
                    { "id": 21031497, "nama": "Bahasa ", "type": "checkbox" },
                    { "id": 21031498, "nama": "Lainnya ", "type": "textbox" },
                ]
            },
            {
                "id": 1, "nama": "C. Perlu Penerjemah",
                "detail": [
                    { "id": 21031499, "nama": "Ya ", "type": "checkbox" },
                    { "id": 21031500, "nama": "Tidak ", "type": "checkbox" },
                    { "id": 21031501, "nama": "Sebutkan ", "type": "textbox" },
            ...
            },
            {
                ...
                "detail": [
                    { "id": 21031502, "nama": "Diagnosa & Manajemen ", "type": "checkbox2" },
                    { "id": 21031503, "nama": "Obat-obatan ", "type": "checkbox2" },
                    { "id": 21030818, "nama": "Perawatan Luka ", "type": "checkbox2" },
                    { "id": 21031504, "nama": "Rehabilitasi ", "type": "checkbox2" },
                    { "id": 21031505, "nama": "Manajemen nyeri ", "type": "checkbox2" },
                    { "id": 21031506, "nama": "Diet & Nutrisi ", "type": "checkbox2" },
                    { "id": 21031508, "nama": "Lain-lain  : ", "type": "textbox" },
                ]
            }             
            ]
            $scope.listNyeri6 = [{
            ...
            },
            {
                ...
                "detail": [
                    { "id": 21031511, "nama": "ya  ", "type": "checkbox" },
                    { "id": 21031512, "nama": "tidak ", "type": "checkbox" },
                ]
            },
            {
                "id": 1, "nama": "C. Perawatan dan Pengobatan lanjutan",
                "detail": [
                    { "id": 21031513, "nama": "ya  ", "type": "checkbox" },
                    { "id": 21031514, "nama": "tidak ", "type": "checkbox" },
                ]
            },
            {
                "id": 1, "nama": "D. Bantuan untuk melakukan Aktifitas sehari-hari",
                "detail": [
                    { "id": 21031515, "nama": "ya  ", "type": "checkbox" },
                    { "id": 21031516, "nama": "tidak ", "type": "checkbox" },
                ]
            },
            {
                "id": 1, "nama": "Bila salah satu Jawaban Ya, maka lakukan Prencanaan lanjutan",
                "detail": [
                    { "id": 21031517, "nama": "Perawatan diri (Mandi, BAK,BAB)  ", "type": "checkbox" },
                    { "id": 21031518, "nama": "Pemantauan pemberian obat ", "type": "checkbox" },
                    { "id": 21031519, "nama": "Pemantauan diet ", "type": "checkbox" },
                    { "id": 21031520, "nama": "Perawatan Luka ", "type": "checkbox" },
                    { "id": 21031521, "nama": "Latihan Fisik Lanjutan ", "type": "checkbox" },
                    { "id": 21031522, "nama": "Pendampingan tenaga khusus dirumah ", "type": "checkbox" },
                    { "id": 21031523, "nama": "Bantuan medis/perawatan di rumah (Homecare) ", "type": "checkbox" },
                    { "id": 21031524, "nama": "Bantuan untuk melakukan Aktifitas fisik (kursi roda, alat bantu jalan) ", "type": "checkbox" },
            ...
            $scope.listSkorNRC = [{
                "id": 8, "nama": "Score ",
                "detail": [
                    { "id": 21031405, "nama": "0= Tidak Nyeri", "type": "checkbox" },
                    { "id": 21031406, "nama": "1 - 3= Nyeri Ringan", "type": "checkbox"},
                    { "id": 21031407, "nama": "4 - 6= Nyeri Sedang", "type": "checkbox" },
                    { "id": 21031408, "nama": "7 - 10= Nyeri Berat", "type": "checkbox"},
                ]
            }]
            $scope.listSkorWong = [{
                "id": 9, "nama": "Score ",
                "detail": [
                    { "id": 21031409, "nama": "0 - 1= Tidak Ada Nyeri", "type": "checkbox"},
                    { "id": 21031410, "nama": "2 - 3= Sedikit Nyeri", "type": "checkbox"},
                    { "id": 21031411, "nama": "4 - 5= Cukup Nyeri", "type": "checkbox" },
                    { "id": 21031412, "nama": "6 - 7= Lumayan Nyeri", "type": "checkbox"},
                    { "id": 21031413, "nama": "8 - 9= Sangat Nyeri", "type": "checkbox"},
                    { "id": 21031414, "nama": "10= Amat Sangat Nyeri", "type": "checkbox", },
                ]
            }]
            $scope.listNyeriAnak = [
                {
            ...
            $scope.listNutrisi = [

                {
                    ...
                    "detail": [
                        { "id": 21031478, "nama": "a. Tidak ada penurunan berat badan", "descNilai": "0" },
                        { "id": 21031479, "nama": "b. Tidak yakin / tidak tahu / terasa baju lebih longgar", "descNilai": "2" },
                        { "id": 21031480, "nama": "c. Penurunan : > 1 - 5 kg", "descNilai": "1" },
                        { "id": 21031481, "nama": "               > 6 - 10 kg", "descNilai": "2" },
                        { "id": 21031482, "nama": "               > 11 - 15 kg", "descNilai": "3" },
                        { "id": 21031483, "nama": "               > 15 kg", "descNilai": "4" },
                        { "id": 21031484, "nama": "  Tidak tahu berapa penurunan berat badan", "descNilai": "2" },
                    ]
                },
                {
                    "id": 2, "nama": "Asupan Makan Berkurang karena tidak nafsu makan",
                    "detail": [
                        { "id": 21031485, "nama": "a. Tidak", "descNilai": "0" },
                        { "id": 21031486, "nama": "b. Ya", "descNilai": "1" }
                    ]
                },
            ]
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'AwalAnakCtrl ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

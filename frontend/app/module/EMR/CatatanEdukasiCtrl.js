define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('CatatanEdukasiCtrl', ['$rootScope', '$scope', '$state', 'CacheHelper', 'MedifirstService',
        function ($rootScope, $scope, $state, cacheHelper, medifirstService) {
            ...
            $scope.cetakPdf = function () {
                ...
                client.get('http://127.0.0.1:1237/printvb/e-rekammedis?cetak-emr-catatan-edukasi&id=' + $scope.cc.nocm + '&emr=' + norecEMR + '&view=true', function (response) {
            ...
            if (nomorEMR == '-') {
                medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + emrfk_).then(function (e) {
                    ...
                    for (var i = e.data.kolom4.length - 1; i >= 0; i--) {
                        if (e.data.kolom4[i].id >= 21007239) {
                ...
                medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + emrfk_).then(function (e) {
                    ...
                    medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                        ...
                        for (let ii = 0; ii < arrobj.length; ii++) {
                            if (parseInt(arrobj[ii]) >= 21007239 && parseInt(arrobj[ii]) <= 21021759) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    for (let i = 0; i < arrobj.length; i++) {
                        if (arrobj[i] >= 21007239 && arrobj[i] <= 21021759) {
            ...
            function afterSave(e) {
                ...
                medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                    'Observasi Di Ruang Pemulihan (Recovery Room)' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

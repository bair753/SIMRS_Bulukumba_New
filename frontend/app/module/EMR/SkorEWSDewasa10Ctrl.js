define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSDewasa10Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 257).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[62050] = $scope.skor1
                $scope.item.obj[62051] = $scope.skor2
                $scope.item.obj[62052] = $scope.skor3
                $scope.item.obj[62053] = $scope.skor4
                $scope.item.obj[62054] = $scope.skor5
                $scope.item.obj[62055] = $scope.skor6
                $scope.item.obj[62056] = $scope.skor7
                $scope.item.obj[62057] = $scope.skor8
                $scope.item.obj[62058] = $scope.skor9
                $scope.item.obj[62059] = $scope.skor10
                $scope.item.obj[62060] = $scope.skor11
                $scope.item.obj[62061] = $scope.skor12
                $scope.item.obj[62062] = $scope.skor13
            }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Skor Early Warning System Dewasa10 ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

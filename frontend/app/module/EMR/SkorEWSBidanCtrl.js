define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSBidanCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210118).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[22025778] = $scope.skor1
                $scope.item.obj[22025779] = $scope.skor2
                $scope.item.obj[22025780] = $scope.skor3
                $scope.item.obj[22025781] = $scope.skor4
                $scope.item.obj[22025782] = $scope.skor5
                $scope.item.obj[22025783] = $scope.skor6
                $scope.item.obj[22025784] = $scope.skor7
                $scope.item.obj[22025785] = $scope.skor8
                $scope.item.obj[22025786] = $scope.skor9
                $scope.item.obj[22025787] = $scope.skor10
                $scope.item.obj[22025788] = $scope.skor11
                $scope.item.obj[22025789] = $scope.skor12
                $scope.item.obj[22025790] = $scope.skor13
            }

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSBidan10Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210127).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[22030458] = $scope.skor1
                $scope.item.obj[22030459] = $scope.skor2
                $scope.item.obj[22030460] = $scope.skor3
                $scope.item.obj[22030461] = $scope.skor4
                $scope.item.obj[22030462] = $scope.skor5
                $scope.item.obj[22030463] = $scope.skor6
                $scope.item.obj[22030464] = $scope.skor7
                $scope.item.obj[22030465] = $scope.skor8
                $scope.item.obj[22030466] = $scope.skor9
                $scope.item.obj[22030467] = $scope.skor10
                $scope.item.obj[22030468] = $scope.skor11
                $scope.item.obj[22030469] = $scope.skor12
                $scope.item.obj[22030470] = $scope.skor13
            }

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('AsesmenMedisGawatDaruratCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.isCetak = true
            $scope.listSkor = [
                { "id": 4190, "nama": "<= 10 : Rawat Inap", "descNilai": "1" },
                { "id": 4191, "nama": ">= 10 : Rawat Jalan", "descNilai": "0" },
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-rekam-medis-dynamic?emrid=146").then(function (e) {
                ...
                medifirstService.get("emr/get-rekam-medis-dynamic?emrid=146").then(function (e) {
                    ...
                    medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                        ...
                        if (cacheEMR_CTRS != undefined) {
                            ...
                            // SET DARI SKOR CTRS
                            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + cacheEMR_CTRS + "&emrfk=" + 132, true).then(function (datss) {

define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('PersetujuanTerhadapTesSkriningHipotoroidKongenitalCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[32116752] = $scope.cc.namapasien;
                    $scope.item.obj[32116753] = $scope.cc.jeniskelamin;
                    $scope.item.obj[32116754] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
                    $scope.item.obj[32116755] = antrianPasien.nocm;
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Pernyataan Persetujuan Terhadap Tes Skrining Hipotoroid Kongenital' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

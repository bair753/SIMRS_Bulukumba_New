define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('SuratRujukanCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.listPasien = [
                {
                    "id": 1,
                    "detail": [
                        { "id": 31101136, "caption": "Nama Pasien :", "type": "textbox"},
                        { "id": 31101137, "caption": "No Kartu Askes :", "type" : "textbox" },
                        { "id": 31101138, "caption": "Tanggal Lahir :", "type": "date" },
                        { "id": 31101139, "caption": "Jenis Kelamin :", "type": "textbox" },
                        { "id": 31101140, "caption": "Alamat :", "type" : "textbox"},
                        { "id": 31101141, "caption": "Nomor Telp/HP :", "type" : "textbox"},
                        { "id": 31101142, "caption": "Diagnosa :", "type" : "textarea"},
                        { "id": 31101143, "caption": "Therapy/Tindakan yang telah diberikan :", "type" : "textarea"}
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[31101136] = antrianPasien.namapasien;
                    $scope.item.obj[31101138] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
                    $scope.item.obj[31101139] = antrianPasien.jeniskelamin;
                    $scope.item.obj[31101140] = antrianPasien.alamatlengkap;

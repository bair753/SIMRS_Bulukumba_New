define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('FormulirPemberianKeringanBiayaCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-tindakan', true, true, 20).then(function (data) {
                $scope.listProduk = data
            })
            medifirstService.getPart('emr/get-datacombo-part-dokter', true, true, 20).then(function (data) {
                $scope.listDokter = data
            })
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 330005).then(function (e) {
            ...
            $scope.listNutrisi = [
...

                {
                    "id": 1, "nama": "Skor IMT",
                    "detail": [
                        { "id": 22034946, "nama": "IMT>20", "descNilai": "0" },
                        { "id": 22034947, "nama": "IMT 18,5-20", "descNilai": "1" },
                        { "id": 22034948, "nama": "IMT<18,5", "descNilai": "2" },
                    ]
                },
                {
                    "id": 2, "nama": "Skor Kehilangan BB yang tidak direncanakan 3-6 bulan terakhir",
                    "detail": [
                        { "id": 22034949, "nama": "BB Hilang <5%", "descNilai": "0" },
                        { "id": 22034950, "nama": "BB Hilang 5-10%", "descNilai": "1" },
                        { "id": 22034951, "nama": "BB Hilang <10%", "descNilai": "2" },
                    ]
                },
                {
                    "id": 3, "nama": "Skor efek penyakit akut",
                    "detail": [
                        { "id": 22034952, "nama": "Ada Asupan nutrisi >5 hari", "descNilai": "1" },
                        { "id": 22034953, "nama": "Tidak ada asupan nutrisi >5 hari", "descNilai": "2" },
                    ]
                },
            ]
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[33000081]="Supriyanto Dharmoredjo, Sp. B, FINACS, M.Kes"
            ...
            $scope.getSkorNutrisi = function (stat) {
                ...
                $scope.item.obj[22034955] = $scope.skorNutrisi
            }
            ...
            $scope.$watch('item.obj[22034955]', function(newValue,oldValue){
                    if(newValue!=oldValue){
                
                      if($scope.item.obj[22034955] >= 0 && $scope.item.obj[22034955]<= 24){
                          $scope.item.obj[22034954] = "Risiko Rendah"
                          
                      }
                       if($scope.item.obj[22034955] >= 1 && $scope.item.obj[22034955]<= 44){
                          $scope.item.obj[22034954] = "Risiko Sedang"
                          
                      }
                       if($scope.item.obj[22034955] >= 2 ){
                          $scope.item.obj[22034954] = "Risiko Tinggi"
            ...
            $scope.$watch('item.obj[21031111]', function(newValue,oldValue){
                    if(newValue!=oldValue){
                      ...
                      if($scope.item.obj[21031111] >= 0 && $scope.item.obj[21031111]<= 24){
                       ...
                       if($scope.item.obj[21031111] >= 1 && $scope.item.obj[21031111]<= 44){
                          $scope.item.obj[21031110] = "Risiko Sedang"
                          
                      }
                       if($scope.item.obj[21031111] >= 2 ){
            ...
            $scope.$watch('item.obj[21031128]', function(newValue,oldValue){
                    if(newValue!=oldValue){
                      ...
                      if($scope.item.obj[21031128] >= 0 && $scope.item.obj[21031128]<= 24){
                       ...
                       if($scope.item.obj[21031128] >= 1 && $scope.item.obj[21031128]<= 44){
                          $scope.item.obj[21031127] = "Risiko Sedang"
                          
                      }
                       if($scope.item.obj[21031128] >= 2 ){
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Formulir Pemberian Keringanan Biaya' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

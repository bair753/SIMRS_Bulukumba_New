define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('LembarFormulirRawatJalanCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.cetakPdf = function () {
                ...
                window.open(config.baseApiBackend + 'report/cetak-lembar-formulir-rajal?nocm='
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[32110965] = antrianPasien.namapasien;
                    $scope.item.obj[32110969] = $scope.now;
                    $scope.item.obj[32110982] = $scope.now;
                    $scope.item.obj[32110983] = antrianPasien.namapasien;
                    $scope.item.obj[32110964] = antrianPasien.nocm;
                    $scope.item.obj[32110966] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
                    $scope.item.obj[32110967] = antrianPasien.alamatlengkap;
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Lembar Formulir Rawat Jalan' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

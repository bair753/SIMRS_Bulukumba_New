    ...
    initialize.controller('PengkajianEdukasi2Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-emr-transaksi-detail?noemr=" + nomorEMR + "&emrfk=" + $scope.cc.emrfk, true).then(function (dat) {
                ...
                $scope.item.obj[80671]=$scope.cc.umur
                $scope.item.obj[80672]= true
                $scope.item.obj[80675]=$scope.cc.alamatlengkap
                $scope.item.obj[80668]=$scope.cc.namapasien
                if ($scope.cc.jeniskelamin=="LAKI-LAKI") {
                    $scope.item.obj[80669]= true
                }else{$scope.item.obj[80670]= true}

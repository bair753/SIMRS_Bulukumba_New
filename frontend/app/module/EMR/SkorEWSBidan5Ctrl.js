define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSBidan5Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210122).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[22027858] = $scope.skor1
                $scope.item.obj[22027859] = $scope.skor2
                $scope.item.obj[22027860] = $scope.skor3
                $scope.item.obj[22027861] = $scope.skor4
                $scope.item.obj[22027862] = $scope.skor5
                $scope.item.obj[22027863] = $scope.skor6
                $scope.item.obj[22027864] = $scope.skor7
                $scope.item.obj[22027865] = $scope.skor8
                $scope.item.obj[22027866] = $scope.skor9
                $scope.item.obj[22027867] = $scope.skor10
                $scope.item.obj[22027868] = $scope.skor11
                $scope.item.obj[22027869] = $scope.skor12
                $scope.item.obj[22027870] = $scope.skor13
            }

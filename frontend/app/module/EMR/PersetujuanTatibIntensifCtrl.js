define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PersetujuanTatibIntensifCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[32111293] = antrianPasien.nocm;
                    $scope.item.obj[32111290] = antrianPasien.namapasien;
                    $scope.item.obj[32111291] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Persetujuan Mematuhi Aturan Tata Tertib Instalasi Perawatan Intensif' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

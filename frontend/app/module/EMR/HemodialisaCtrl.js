define(['initialize'], function (initialize) {
  'use strict';
  initialize.controller('HemodialisaCtrl', ['$q', '$rootScope', '$scope', '$state', 'CacheHelper', 'MedifirstService', '$mdDialog',
      function ($q, $rootScope, $scope, $state, cacheHelper, medifirstService, $mdDialog) {
          ...
          function init() {
              ...
              medifirstService.get("emr/get-emr-transaksi-detail-form?"+paramSearch+ "&jenisEmr=Hemodialisa", true).then(function (dat) {
              ...
              medifirstService.get("emr/get-menu-rekam-medis-dynamic?namaemr=Hemodialisa").then(function (e) {
          ...
          $scope.Lihat = function () {
              ...
              $state.go("RekamMedis.Hemodialisa.HemodialisaDetail", {
                  namaEMR: 210036,
                  nomorEMR: noemr2
              });
          ...
          $scope.create = function () {
              ...
              $scope.myVar = 2
              var noemr2 = '-'
              $state.go("RekamMedis.Hemodialisa.HemodialisaCtrl", {
                  namaEMR: 210007,
                  nomorEMR: noemr2
              });
              var arrStr = {
          ...
          $scope.asupKaForm = function (noemr, reportdisplay, emrfk, norec) {
              ...
              if (noemr2 != '-')
                  noemr2.trim()
              var url = "RekamMedis.Hemodialisa.HemodialisaDetail"

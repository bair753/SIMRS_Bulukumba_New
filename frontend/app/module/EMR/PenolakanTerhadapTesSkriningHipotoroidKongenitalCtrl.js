define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('PenolakanTerhadapTesSkriningHipotoroidKongenitalCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.cetakPdf = function () {
                ...
                window.open(config.baseApiBackend + 'report/cetak-penolakan-tes-skrining?nocm='
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[32116740] = $scope.cc.namapasien;
                    $scope.item.obj[32116741] = $scope.cc.jeniskelamin;
                    $scope.item.obj[32116742] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
                    $scope.item.obj[32116743] = antrianPasien.nocm;
                    ...
                    // $scope.item.obj[32116741] = antrianPasien.jeniskelamin;
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Pernyataan Penolakan Terhadap Tes Skrining Hipotoroid Kongenital' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

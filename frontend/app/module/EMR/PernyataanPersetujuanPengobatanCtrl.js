define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PernyataanPersetujuanPengobatanCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    if (antrianPasien.objectkelasfk != null && antrianPasien.namakelas) {
                        $scope.item.obj[32111297] = {
                            value: antrianPasien.objectkelasfk,
                            text: antrianPasien.namakelas
                        }
                    }
                    $scope.item.obj[32115914] = antrianPasien.namapasien;
                    $scope.item.obj[32115915] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
                    $scope.item.obj[32115916] = antrianPasien.jeniskelamin;
                    $scope.item.obj[32115917] = antrianPasien.nocm;
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Surat Pernyataan Persetujuan Pengobatan/Tindakan' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

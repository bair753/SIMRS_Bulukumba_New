define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('TindakanFisioterapiCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.cetakPdf = function () {
                ...
                window.open(config.baseApiBackend + 'report/cetak-tindakan-fisioterapi?nocm='
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[32110985] = antrianPasien.nocm;
                    $scope.item.obj[32110986] = antrianPasien.namapasien;
                    $scope.item.obj[32111031] = antrianPasien.namapasien;
                    $scope.item.obj[32110987] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Tindakan Fisioterapi' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

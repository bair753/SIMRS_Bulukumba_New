define(['initialize', 'Configuration'], function (initialize, config) {
    'use strict';
    initialize.controller('JadwalTindakanHemodialisaCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            $scope.cetakPdf = function () {
                ...
                window.open(config.baseApiBackend + 'report/cetak-jadwal-tindakan-hemodialisa?nocm='
            ...
            if (nomorEMR == '-') {
                ...
                medifirstService.get("emr/get-antrian-pasien-norec/" + noregistrasifk).then(function (e) {
                    ...
                    $scope.item.obj[32116156] = $scope.cc.namapasien;
                    $scope.item.obj[32116157] = new Date(moment(antrianPasien.tgllahir).format('YYYY-MM-DD'));
                    $scope.item.obj[32116158] = $scope.cc.nocm;
                    $scope.item.obj[32116159] = antrianPasien.nobpjs;
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    medifirstService.postLogging('EMR', 'norec emrpasien_t', e.data.data.norec,
                        'Jadwal Tindakan Hemodialisa' + ' dengan No EMR - ' + e.data.data.noemr + ' pada No Registrasi '

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarTilikSignInCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.getPart('emr/get-datacombo-part-ruangan-pelayanan', true, true, 20).then(function (data) {
             ...
             medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 210017).then(function (e) {
            ...
            $scope.listSignin = [
                ...
                {
                    "id": 1, "nama": "Apakah lokasi operasi diberi tanda ?",
                    "detail": [
                ...
                {
                    "id": 1, "nama": "Apakah mesin dan obat - obatan di cek lengkap ?",
                    "detail": [
                        { "id": 21001308, "nama": "Ya", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Apakah pasien memiliki alergi ?",
                    "detail": [
                ...
                {
                    "id": 1, "nama": "Apakah pasien memiliki riwayat penyakit Asma ?",
                    "detail": [
                        { "id": 21001311, "nama": "Tidak", "type": "checkbox" },
                    ]
                },
                {
                    "id": 1, "nama": "Apakah ada resiko aspirasi ?",
                    "detail": [
                ...
                {
                    "id": 1, "nama": "Apakah ada rencana pemasangan implant ?",
                    "detail": [
                ...
                {
                    "id": 1, "nama": "Apakah ada resiko kehilangan darah > 500 ml (7 ml/kg) BB pada anak :",
                    "detail": [
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'DaftarTilikSignInCtrl ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('SkorEWSDewasa16Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + 379).then(function (e) {
                // debugger
            ...
            $scope.getSkor = function (stat) {
                ...
                $scope.item.obj[105673] = $scope.skor1
                $scope.item.obj[105674] = $scope.skor2
                $scope.item.obj[105675] = $scope.skor3
                $scope.item.obj[105676] = $scope.skor4
                $scope.item.obj[105677] = $scope.skor5
                $scope.item.obj[105678] = $scope.skor6
                $scope.item.obj[105679] = $scope.skor7
                $scope.item.obj[105680] = $scope.skor8
                $scope.item.obj[105681] = $scope.skor9
                $scope.item.obj[105682] = $scope.skor10
                $scope.item.obj[105683] = $scope.skor11
                $scope.item.obj[105684] = $scope.skor12
                $scope.item.obj[105685] = $scope.skor13
            }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'Skor Early Warning System Dewasa16 ' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 

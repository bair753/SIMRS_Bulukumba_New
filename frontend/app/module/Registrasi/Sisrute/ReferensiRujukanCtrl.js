define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('ReferensiRujukanCtrl', ['$q', '$scope', 'ModelItem', 'DateHelper', 'CacheHelper', '$state', 'MedifirstService',
        function ($q, $scope, ModelItem, dateHelper, cacheHelper, $state, medifirstService) {
            ...
            function loadDataDiagnosa() {
                ...
                medifirstService.get("bridging/sisrute/referensi/diagnosa?"
                    + "query=" + nama

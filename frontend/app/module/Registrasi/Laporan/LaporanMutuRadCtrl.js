define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanMutuRadCtrl', ['MedifirstService', 'CacheHelper', '$scope', 'DateHelper', '$state', 'ModelItem',
        function (medifirstService, cacheHelper, $scope, DateHelper, $state, ModelItem) {
            ...
            function loadData() {
                ...
                if ($scope.item.namalengkap != undefined) {
                    dokter = "&dokter=" + $scope.item.namalengkap.id
                }
                ...
                medifirstService.get("registrasi/laporan/get-lap-mutu-rad?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +
                    namaruangan)
                    .then(function (data) {
            ...
            $scope.columnGrid = {
                ...
                excel: {
                    fileName: "LaporanMutuRadiologi.xlsx",
                    allPages: true,
                },

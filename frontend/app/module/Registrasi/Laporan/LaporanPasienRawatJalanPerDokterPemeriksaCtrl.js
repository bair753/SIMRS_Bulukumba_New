define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanPasienRawatJalanPerDokterPemeriksaCtrl', ['MedifirstService', 'CacheHelper', '$scope', 'DateHelper', '$state', 'ModelItem',
        function (medifirstService, cacheHelper, $scope, DateHelper, $state, ModelItem) {
            ...
            function loadData() {
                ...
                medifirstService.get("registrasi/laporan/get-lap-paseinrj-per-dokpemeriksa?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +
                    rm +
                    pasien +

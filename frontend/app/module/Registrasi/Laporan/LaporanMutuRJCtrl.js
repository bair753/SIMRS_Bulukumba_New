define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanMutuRJCtrl', ['MedifirstService', 'CacheHelper', '$scope', 'DateHelper', '$state', 'ModelItem',
        function (medifirstService, cacheHelper, $scope, DateHelper, $state, ModelItem) {
            ...
            function loadData() {
                ...
                medifirstService.get("registrasi/laporan/get-lab-mutu-rj?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +
                    namaruangan +
                    dokter)
                    .then(function (data) {
                        ...
                        for (var i = 0; i < data.data.length; i++) {
                            data.data[i].no = i+1
                            var tanggal = new Date(data.data[i].tglregistrasi);
            ...
            $scope.columnGrid = {
                ...
                excel: {
                    fileName: "DaftarKunjunganPasienTindakan.xlsx",
                    allPages: true,
                },
                excelExport: function (e) {
                    ...
                    var myHeaders = [{
                        value: "Daftar Kunjungan Pasien Tindakan",
                        fontSize: 20,
                        textAlign: "center",
                        background: "#ffffff",
                        // color:"#ffffff"
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "title": "Waktu Input",
                        "width": "80px",
                        "template": "<span class='style-left'>{{formatJam('#: tgldipanggilsuster #')}}</span>"
                    },
                    {
                        "field": "tglregistrasi",
                        "title": "Waktu Daftar",
                    ...
                    {
                        "field": "tglselesaiperiksa",
                        "title": "Jam Periksa",
                        "width": "100px",
                        "template": "<span class='style-left'>{{formatJam('#: tglselesaiperiksa #')}}</span>"
                    },
                    {
                        "field": "nocm",
                        "title": "No RM",
                    ...
                    {
                        "field": "wkttunggudokter",
                        "title": "Waktu Tunggu Dokter",
                        "width": "100px",
                    },
                    {
                        "field": "tglresep",
                        "title": "Verfikasi Farmasi",
                        "width": "100px",
                    },
                    {
                        "field": "wkttungguobat",
                        "title": "Waktu Tunggu Obat",
                        "width": "100px",
                    },
                ]
            };

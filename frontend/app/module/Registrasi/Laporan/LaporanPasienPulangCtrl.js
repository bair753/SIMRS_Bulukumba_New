define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanPasienPulangCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'MedifirstService', 'DateHelper',
        function (cacheHelper, $q, $rootScope, $scope, medifirstService, DateHelper) {
            ...
            function LoadData() {
                ...
                medifirstService.get("registrasi/laporan/get-laporan-pasien-pulang?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    + tempRuanganId
                    + tempDepartemen
                    ...
                    columns:
                        [
                            ...
                            },
                            {
                                ...
                                "title": "Jam Struk",
                                "width": "80px",
                                "template": "<span class='style-left'>{{formatJam('#: tglstruk #')}}</span>"
                            },
                            {
                                "field": "nodaftar",

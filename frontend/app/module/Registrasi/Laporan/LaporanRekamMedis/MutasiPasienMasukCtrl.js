define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('MutasiPasienMasukCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'MedifirstService', 'DateHelper',
        function (cacheHelper, $q, $rootScope, $scope, medifirstService, DateHelper) {
            ...
            function LoadData() {
                ...
                cacheHelper.set('RekapMutasiPasienCtrl', chacePeriode);
                 ...
                 medifirstService.get("registrasi/laporan/get-data-lap-pasien-masuk?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    // + tempDepartemenId
                    + tempRuanganId
            ...
            $("#kGrid").kendoGrid({
                ...
                excel: {
                    fileName: "LaporanPasienMasuk.xlsx",
                    allPages: true,

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('MutasiPasienPindahanCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'MedifirstService', 'DateHelper',
        function (cacheHelper, $q, $rootScope, $scope, medifirstService, DateHelper) {
            ...
            function LoadData() {
                ...
                cacheHelper.set('RekapMutasiPasienCtrl', chacePeriode);
                 ...
                 medifirstService.get("registrasi/laporan/get-data-lap-pasien-pindahan?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    // + tempDepartemenId
                    + tempRuanganId
            ...
            $("#kGrid").kendoGrid({
                toolbar: ["excel"],
                excel: {
                    fileName: "LaporanPasienPindahan.xlsx",
                    allPages: true,
                },
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "title": "Tanggal Inap",
                        "width": "100px",
                        "template": "<span class='style-left'>{{formatTanggal('#: tglmasukinap #')}}</span>"
                    },
                    {
                        "field": "namakelas",
                        "title": "Kelas",

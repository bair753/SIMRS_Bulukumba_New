define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('MutasiPasienKeluarCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'MedifirstService', 'DateHelper', 
        function (cacheHelper, $q, $rootScope, $scope, medifirstService, DateHelper) {
            ...
            function LoadData() {
                ...
                cacheHelper.set('RekapMutasiPasienCtrl', chacePeriode);
                 ...
                 medifirstService.get("registrasi/laporan/get-data-lap-pasien-keluar?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    // + tempDepartemenId
                    + tempRuanganId
            ...
            $("#kGrid").kendoGrid({
                toolbar: ["excel"],
                excel: {
                    fileName: "LaporanPasienKeluar.xlsx",
                    allPages: true,
                },

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RL32RawatDaruratCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'MedifirstService', 'ModelItem', 'DateHelper',
        function (cacheHelper, $q, $rootScope, $scope, medifirstService, ModelItem, DateHelper) {
            ...
            function LoadData() {
                ...
                medifirstService.get("registrasi/laporan/get-laporan-rl32?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir

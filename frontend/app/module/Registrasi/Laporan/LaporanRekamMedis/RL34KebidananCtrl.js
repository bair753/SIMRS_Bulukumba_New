define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RL34KebidananCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'MedifirstService', 'ModelItem', 'DateHelper',
        function (cacheHelper, $q, $rootScope, $scope, medifirstService, ModelItem, DateHelper) {
            ...
            medifirstService.get("registrasi/laporan/get-laporan-rl34?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RL33GigiDanMulutCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'MedifirstService',
        function (cacheHelper, $q, $rootScope, $scope, medifirstService) {
            //Inisial Variable 
            ...
            function LoadData() {
                ...
                medifirstService.get("registrasi/laporan/get-laporan-rl33?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir

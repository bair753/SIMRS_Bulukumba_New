define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RL312KeluargaBerencanaCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'MedifirstService', 'DateHelper',
        function (cacheHelper, $q, $rootScope, $scope, medifirstService, DateHelper) {
            ...
            function LoadData() {
                ...
                cacheHelper.set('LaporanRL3_12Ctrl', chacePeriode);

                  medifirstService.get("registrasi/laporan/get-laporan-rl312?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                ).then(function (data) {
                    var data = data.data
            ...
            $scope.panggil = function (cokot) {
                ...
                $("#kGrid").kendoGrid({
                    toolbar: ["excel"],
                    excel: {
                        fileName: "Keluarga Berencana.xlsx",
                        filterable: true,
                        allPages: true,
                    },
                    ...
                    columns: [
                        ...
                        {
                            title: "KB Baru Dengan Cara Masuk",
                            headerAttributes: { style: "text-align : center" },
                            columns: [
                                {
                                    "field": "",
                                ...
                                {
                                    "field": "",
                                    "title": "Rujukan R. Inap"
                                },
                                {
                                    "field": "",
                                    "title": "Rujukan R. Jalan"
                                },
                                {
                                    "field": "",
                                    "title": "Total"
                        ...
                        {
                            title: "KB Baru Dengan Kondisi",
                            headerAttributes: { style: "text-align : center" },
                            columns: [
                                {
                                    "field": "",
                                    "title": "Pasca Persalinan AN/Nifas"
                                },
                                {
                                    "field": "",
                                    "title": "Abortus"

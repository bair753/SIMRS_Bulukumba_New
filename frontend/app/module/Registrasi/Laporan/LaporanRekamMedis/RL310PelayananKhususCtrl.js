define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RL310PelayananKhususCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'MedifirstService', 'DateHelper',
        function (cacheHelper, $q, $rootScope, $scope, medifirstService, DateHelper ) {
            ...
            function LoadData() {
                ...
                cacheHelper.set('LaporanRl3_10Ctrl', chacePeriode);

                medifirstService.get("registrasi/laporan/get-laporan-rl310?"
                    + "tglAwal=" + tglAwal
            ...
            $scope.panggil = function (cokot) {
                ...
                $("#kGrid").kendoGrid({
                    toolbar: ["excel"],
                    excel: {
                        fileName: "Laporan Pelayanan Khusus.xlsx",
                        filterable: true,
                        allPages: true
                    },

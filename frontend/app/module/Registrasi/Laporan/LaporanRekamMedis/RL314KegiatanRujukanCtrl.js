define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RL314KegiatanRujukanCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'MedifirstService', 'DateHelper',
        function (cacheHelper, $q, $rootScope, $scope, medifirstService, DateHelper) {
            ...
            function LoadData() {
                ...
                cacheHelper.set('LaporanRL3_14Ctrl', chacePeriode);

                medifirstService.get("registrasi/laporan/get-laporan-rl314?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                ).then(function (data) {
                    var data = data.data
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            columns: [
                                {
                                    "field": "puskesmas",
                                    "title": "Diterima Dari Puskesmas"

                                },
                                {
                                    "field": "klinik",
                                    "title": "Diterima Dari Fasilitas Kes.Lain"
                                },
                                {
                                    "field": "hospital",
                                    "title": "Diterima Dari Rs Lain"
                                },
                                {
                                    "field": "DKembalikanKPuskes",
                                    "title": "Dikembalikan Ke Puskesmas"
                                },
                                {
                                    "field": "DKembalikanKKlinik",
                                    "title": "Dikembalikan Ke Fasilitas Kes.Lain"
                                },
                                {
                                    "field": "DKembalikanKRs",
                                    "title": "Dikembalikan Ke RS. Asal"
                                },
                            ]
                        },
                        {
                            ...
                            columns: [
                                {
                                    "field": "PasienRujukan",
                                    "title": "Pasien Rujukan"
                                },
                                {
                                    "field": "dtgsendiri",
                                    "title": "Pasien Datang Sendiri"
                                },
                                {
                                    "field": "DTrmaKembali",
                                    "title": "Diterima Kembali"
                                }
                            ]
                        }
                    ]

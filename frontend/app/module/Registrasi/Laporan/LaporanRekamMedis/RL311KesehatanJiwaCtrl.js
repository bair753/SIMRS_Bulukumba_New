define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RL311KesehatanJiwaCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'MedifirstService', 'DateHelper',
        function (cacheHelper, $q, $rootScope, $scope, medifirstService, DateHelper) {
            ...
            function LoadData() {
                ...
                medifirstService.get("registrasi/laporan/get-laporan-rl311?"
                    + "tglAwal=" + tglAwal

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanPengunjungTindakanCtrl', ['MedifirstService', 'CacheHelper', '$scope', 'DateHelper', '$state', 'ModelItem',
        function (medifirstService, cacheHelper, $scope, DateHelper, $state, ModelItem) {
            ...
            function loadData() {
                ...
                medifirstService.get("registrasi/laporan/get-data-lap-pengunjung-tindakan?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +
                    rm +
                    pasien +

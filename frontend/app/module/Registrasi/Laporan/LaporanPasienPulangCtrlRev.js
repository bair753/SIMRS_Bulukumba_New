define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanPasienPulangCtrlRev', ['CacheHelper', '$q', '$rootScope', '$scope', 'MedifirstService', 'DateHelper',
        function (cacheHelper, $q, $rootScope, $scope, medifirstService, DateHelper) {
            ...
            function LoadData() {
                ...
                cacheHelper.set('LaporanPasienPulangCtrlRev', chacePeriode);

                medifirstService.get("registrasi/laporan/get-laporan-pasien-pulangNew?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    + tempRuanganId
                    + tempDepartemen

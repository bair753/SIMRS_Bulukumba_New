define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('TindakanTahunanLabCtrl', ['CacheHelper', '$scope', 'MedifirstService', 'DateHelper',
        function (cacheHelper, $scope, medifirstService, DateHelper,) {
            ...
            function LoadData() {
                ...
                cacheHelper.set('TargetDanRealisasiKunjunganCtrl', chacePeriode);
                    ...
                    medifirstService.get("registrasi/laporan/get-data-lap-lab-tahunan?"
            ...
            $scope.columnGridP = {
                ...
                excel: {
                    fileName: "Laporan Jumalah pemeriksaan Laboratorium.xlsx",
                    allPages: true,
                ...
                excelExport: function (e) {
                    ...
                    rows.unshift({
                        cells: [{ value: "Laporan Jumalah pemeriksaan Laboratorium", background: "#fffff" }]
                    });
                },      
                columns: [

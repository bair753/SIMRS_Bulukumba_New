define(['initialize', 'Configuration'], function (initialize, configuration) {
    'use strict';
    initialize.controller('VerifikasiBayiCtrl', ['MedifirstService', '$scope', 'ModelItem', '$state', 'CacheHelper',
        function (medifirstService, $scope, modelItem, $state, cacheHelper) {
            ...
            $scope.VerificationNamaIbu = function () {
                ...
                medifirstService.get("registrasi/get-nocm-ibu?noCm=" + $scope.item.NoCM)
                    .then(function (e) {
                        $scope.isRouteLoading = false;

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarPermintaanLabelCtrl', ['CacheHelper', '$scope', 'ModelItem', 'DateHelper', 'MedifirstService',
        function (cacheHelper, $scope, ModelItem, DateHelper, medifirstService) {
            //Inisial Variable 
            ...
            function LoadData() {
                ...
                medifirstService.get("registrasi/orderlabel/get-daftar-permintaan?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    + nm
                    + rm
            ...
            medifirstService.get("registrasi/orderlabel/get-data-combo", false).then(function (data) {

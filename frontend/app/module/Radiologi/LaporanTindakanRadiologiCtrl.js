define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanTindakanRadiologiCtrl', ['MedifirstService', 'CacheHelper', '$scope', 'DateHelper', '$state', 'ModelItem',
            ...
            $scope.columnGrid = {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "title": "Harga",
                        "width": "150px",
                        "template": "<span class='style-right'>Rp. #: harga.toFixed(2) #</span>"
                    },
                    {
                        "field": "total",
                        "title": "Total",
                        "width": "150px",
                        "template": "<span class='style-right'>Rp. #: total.toFixed(2) #</span>"
                    }
                ]
            };

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarAntrianDokterRanapCtrl', ['SaveToWindow', '$rootScope', '$scope', 'ModelItem', '$state', 'DateHelper', 'socket', '$mdDialog', '$window', 'CetakHelper', 'MedifirstService', 'CacheHelper', '$q',
        function (saveToWindow, $rootScope, $scope, ModelItem, $state, DateHelper, socket, $mdDialog, window, cetakHelper, medifirstService, cacheHelper, $q) {
            ...
            $scope.UbahDokter = function (item, data) {
                ...
                $scope.item = data;
                medifirstService.get("pasien/get-dokters-combos", false).then(function (data) {

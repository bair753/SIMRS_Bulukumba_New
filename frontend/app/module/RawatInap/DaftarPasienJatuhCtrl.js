define(['initialize'], function (initialize) {
	'use strict';
	initialize.controller('DaftarPasienJatuhCtrl', ['$mdDialog', '$timeout', '$state', '$q', '$rootScope', '$scope', 'CacheHelper', 'DateHelper', 'MedifirstService',
		function ($mdDialog, $timeout, $state, $q, $rootScope, $scope, cacheHelper, dateHelper, medifirstService) {
			...
			function loadCombo() {
				...
				medifirstService.get("rawatinap/get-combo-pasien-jatuh", false).then(function (data) {
			...
			function loadData() {
				...
				medifirstService.get("rawatinap/get-pasien-jatuh?" +
					"tglAwal=" + tglAwal +
					"&tglAkhir=" + tglAkhir +
					reg + rm + nm + ins + rg
					+ ket)
				...
				// medifirstService.post('rensar/post-kejadian-pasien-jatuh').then(function (res) {

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('ProduksiObatInputSisaCtrl', ['$q', '$rootScope', '$scope', 'MedifirstService', '$state', 'CacheHelper',
        function ($q, $rootScope, $scope, medifirstService, $state, cacheHelper) {
            ...
            $scope.simpan = function () {
                ...
                manageLogistikPhp.post('farmasi/produksi/save-input-sisa-produksi-barang', objSave).then(function (e) {

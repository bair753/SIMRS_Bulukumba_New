define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('ResepElektronikProduksiSterilCtrl', ['$state', '$rootScope', '$scope', 'DateHelper', 'MedifirstService', 'CacheHelper',
        function($state, $rootScope, $scope, DateHelper, medifirstService, cacheHelper) {
        ...
        function LoadCache(){
         ...
         $scope.group = {
            ...
            $scope.refresh = function() {
                ...
                medifirstService.get('farmasi/get-order-produksi-steril?tglAwal='+ tglAwal+'&tglAkhir='+tglAkhir+nocm).then(function(e) {
            ...
            $scope.detailOrder = function() {                  
                ...
                //         medifirstService.updateStatusOrder($scope.item.noorder, 1).then(function(e) {
                //             $scope.refresh();
                //         });
                //     }else{

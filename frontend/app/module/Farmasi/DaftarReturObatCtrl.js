define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('DaftarReturObatCtrl', ['SaveToWindow', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper','DateHelper',  '$mdDialog', 'CetakHelper', 'MedifirstService','$q', 
        function (saveToWindow,$rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, $mdDialog, cetakHelper, medifirstService, $q) {
            
    // initialize.controller('DaftarReturObatCtrl', ['$q', '$rootScope', '$scope', 'medifirstService','$state','CacheHelper','DateHelper','medifirstService',
    //     function($q, $rootScope, $scope,medifirstService,$state,cacheHelper,dateHelper,medifirstService) {
            $scope.item = {};
            ...
            function init() {
                ...
                medifirstService.get("farmasi/get-daftar-retur-obat?"+
                    "tglAwal=" + tglAwal + 
                    "&tglAkhir=" + tglAkhir +

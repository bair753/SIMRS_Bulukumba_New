define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('InputResepApotikNonLayananReturCtrl', ['$scope', 'MedifirstService', 'CacheHelper',
        function($scope, medifirstService, cacheHelper) {
            $scope.item = {};
            ...
            function LoadCache(){
                // init()
                var chacePeriode = cacheHelper.get('cacheReturObatBebas');
...
// 30  0   t       jasa pelayanan Repacking obat injeksi
        ...
        // ];
            ...
            $scope.simpan = function(){
                ...
                //
                medifirstService.post('farmasi/save-retur-obat-non-layanan', objSave).then(function (e) {                

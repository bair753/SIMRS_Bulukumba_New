        ...
        function (saveToWindow, $rootScope, $scope, ModelItem, $state, cacheHelper, DateHelper, $mdDialog, cetakHelper, medifirstService, $q) {
            ...
            $scope.saveResep = function (){
                ...
                var objSave = {
					...
					jampengkajian: moment($scope.item.jamPengkajian).format('YYYY-MM-DD HH:mm'),
					pengkajian: reseppengkajian,
					jampenyiapanobat: moment($scope.item.jamPenyiapanObat).format('YYYY-MM-DD HH:mm'),
					penyiapanobat: reseppenyiapanObat,
					jamdispening: moment($scope.item.jamDispening).format('YYYY-MM-DD HH:mm'),
					dispening: resepdispeningian,
					jamserahinformasi: moment($scope.item.jamSerahInformasi).format('YYYY-MM-DD HH:mm'),

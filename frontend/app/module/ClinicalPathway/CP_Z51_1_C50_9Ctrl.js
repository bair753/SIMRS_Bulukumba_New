define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('CP_Z51_1_C50_9Ctrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
           ...
           LoadData($scope.cc.noregistrasi);
            function LoadData(noregistrasi) {
                ...
                medifirstService.get("cp/get-cp-transaksi-detail?cp=CP_Z51_1_C50_9&noregistrasi=" + noregistrasi  , true).then(function (dat) {                
                    $scope.item.obj = []
                    $scope.item.obj2 = []
                ...
                medifirstService.get("cp/get-colorchk?kodecp=CP_Z51_1_C50_9"  , true).then(function (dat) {     
                    dataLoad = dat.data.data           
                    for (var i = 0; i <= dataLoad.length - 1; i++) {
            ...
            function saveObj(cId,cValues){
                ...
                medifirstService.post('cp/save-cp-dinamis', jsonSave).then(function (e) {
                    ...
                    // 'CP_Z51_1_C50_9' + ' dengan noregistrasi - ' + $scope.cc.noregistrasi 

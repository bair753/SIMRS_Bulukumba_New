define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('CPCovid19HipertensiCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
           ...
           LoadData($scope.cc.noregistrasi);
            ...
            $scope.getListCP =function(){
                medifirstService.getPart('cp/get-list-cp', true, true, 20).then(function (data) {
            ...
            $scope.kodeCP = 'CPCovid19Hipertensi'

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('CPCovidAnakDgnGejalaRinganCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, medifirstService) {
           ...
           LoadData($scope.cc.noregistrasi);
            ...
            $scope.getListCP =function(){
                medifirstService.get('cp/get-list-cp?kddiagnosa=' + $scope.item.diagnosa.kddiagnosa, true, true, 20).then(function (datStick) {
                    $scope.listcp = datStick.data.cp;
                    $scope.showCP = false;
                })
            }
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('emr/save-emr-dinamis', jsonSave).then(function (e) {
                    ...
                    'FormClinicalPathwayCtrl' + ' dengan No EMR - ' +e.data.data.noemr +  ' pada No Registrasi ' 
            ...
            $scope.kodeCP = 'CPCovidAnakDgnGejalaRingan'

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarKeluhanPelangganCtrl', ['$rootScope', '$scope', 'ModelItem', '$state', 'DateHelper', 'CacheHelper', 'MedifirstService',
		function ($rootScope, $scope, ModelItem, $state, dateHelper, cacheHelper, medifirstService) {
            ...
            function Load() {
                var chacePeriode = cacheHelper.get('DaftarKeluhanPelangganCtrl');
            ...
            function GetData() {
                ...
                medifirstService.get("humas/get-data-keluhan-pelanggan?"
                    ...
                    + noMR + namaPasien, true).then(function (dat) {
                        ...
                        cacheHelper.set('DaftarKeluhanPelangganCtrl', chacePeriode);
            ...
            $scope.Ubah = function (current) {
                ...
                cacheHelper.set('KeluhanPelangganCtrl', chacePeriode);
                $state.go('KeluhanPelanggan', {
                    kpid: $scope.current.kpid,
                    noOrder: 'EditKeluhan'
                });
            }
            ...
            $scope.Hapus = function (current) {
                ...
                medifirstService.post('', objSave).then(function (e) {
                    GetData()
                })
            }

...
define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('DaftarPenangananKeluhanPelangganCtrl', ['$rootScope', '$scope', 'ModelItem', '$state', 'DateHelper', 'CacheHelper', 'MedifirstService',
		function($rootScope, $scope, ModelItem, $state, dateHelper, cacheHelper, medifirstService) {
			...
			function Load(){
				var chacePeriode = cacheHelper.get('DaftarPenangananKeluhanPelangganCtrl');
			...
			function GetData(){
                ...
                medifirstService.get("humas/get-penanganan-keluhan-pelanggan?"
                    ...
                    cacheHelper.set('DaftarPenangananKeluhanPelangganCtrl', chacePeriode);                    
                });
			}		
            ...
            $scope.Hapus = function(current){
                ...
                medifirstService.post('humas/save-batal-penangankeluhan',objSave).then(function (e) {
                    GetData()
                })
            }

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('PenangananKeluhanPelangganCtrl', ['$rootScope', '$scope', 'ModelItem', 'DateHelper', '$document', 'R', '$state', 'CacheHelper', 'MedifirstService',
        function ($rootScope, $scope, ModelItem, dateHelper, $document, r, $state, cacheHelper, medifirstService) {
            ...
            function LoadCache() {
                var chacePeriode = cacheHelper.get('PenangananKeluhanPelangganCtrl');
                if (chacePeriode != undefined) {
                    ...
                    cacheHelper.set('PenangananKeluhanPelangganCtrl', chacePeriode);
                } else {
                    init()
                }
            }
            ...
            function loadDataCombo() {
                medifirstService.getPart("humas/get-combo-pegawai", true, true, 20).then(function (data) {
                ...
                medifirstService.get("humas/get-daftar-combo?", true).then(function (dat) {
                    ...
                    $scope.listDataPekerjaan = dat.data.pekerjaan;
                });
            }
            ...
            function init() {
                if (noOrder != '') {
                    if (noOrder == 'ReplyKeluhan') {
                        ...
                        medifirstService.get("humas/get-data-keluhan-pelanggan?"
                        ...
                        $scope.isRouteLoading = true;
                        medifirstService.get("humas/get-penanganan-keluhan-pelanggan?"
                            + "IdKeluhan=" + kpid, true).then(function (dat) {
                                $scope.isRouteLoading = false;
                                var datas = dat.data.datas[0];
                                idKeluhan = kpid
            ...
            $scope.Save = function () {            
                ...
                medifirstService.post('humas/save-keluhan-penanganan-pelanggan', objSave).then(function (e) {
                    $state.go('DaftarPenangananKeluhanPelanggan');
                })
            };
        }
    ]);

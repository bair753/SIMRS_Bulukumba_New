define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('BPJSKlaimExcelCtrl', ['FindProduk',  '$rootScope', '$scope','$state', 'ModelItem', 'DateHelper','ManageLogistikPhp','CacheHelper',
            ...
            $scope.columnGrid = [
                ...
                },
                {
                    ...
                    "width": 110,
                    // "template": "<span class='style-left'>{{formatTanggal('#: tglverifikasi #')}}</span>"
                },
                {
                    "title": "Biaya",
                    "width": 100,
                    ...
                    "columns": [
                        {
                            ...
                            "template": "<span class='style-left'>{{formatRupiah('#: diajukan #', 'Rp.')}}</span>"
                        },
                        {
                            "field": "disetujui",
                            "title": "Disetujui",
                            ...
                            "template": "<span class='style-left'>{{formatRupiah('#: disetujui #', 'Rp.')}}</span>"
                        }
                    ]
                }
            ];

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('BPJSKlaimCtrl', ['$rootScope', '$scope', '$state', 'ModelItem', 'MedifirstService', 'CacheHelper',
        function ($rootScope, $scope, $state, ModelItem, medifirstService, cacheHelper) {
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('piutang/save-bpjs-klaim',objSave).then(function (e) {
            ...
            function readSingleFile(e) {
               ...
               var kodeRS =  stringFile.substr(0,7)

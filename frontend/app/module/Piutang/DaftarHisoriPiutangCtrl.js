define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarHisoriPiutangCtrl', ['$scope', 'MedifirstService', 'CacheHelper', 
        function ($scope, medifirstService, cacheHelper) {
            ...
            function loadCombo() {
                medifirstService.get("piutang/get-data-combo-piutang", true).then(function (dat) {
            ...
            function init() {
                ...
                medifirstService.get("piutang/get-data-histori-piutang?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RekapKlaimByDiagnosaCtrl', ['$rootScope', '$scope', 'ModelItem', 'MedifirstService',
        function ($rootScope, $scope, ModelItem, medifirstService) {
            ...
            $scope.cari = function () {
                ...
                medifirstService.get('piutang/rekap-klaim-by-diagnosa' + ptd).then(function (data) {
                    // var aing = 0
            ...
            $scope.Save = function () {
                ...
                medifirstService.post('piutang/save-bpjs-klaim-gagal-hitung',objSave).then(function (e) {
                    $scope.isRouteLoading = false;
                });

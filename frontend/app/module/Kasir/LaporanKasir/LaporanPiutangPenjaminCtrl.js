define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanPiutangPenjaminCtrl', ['CacheHelper', '$scope', 'DateHelper', 'MedifirstService',
        function (cacheHelper, $scope, DateHelper, medifirstService) {
            ...
            function FormLoad() {
                ...
                $scope.pegawai = medifirstService.getUserLogin();
            ...
            function LoadData() {
                ...
                medifirstService.get("kasir/get-data-lap-piutang-penjamin?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    + tempDepartemenId
                    + tempRuanganId
            ...
            $scope.CetakTagihan = function () {
                ...
                if ($scope.item.namaPenjamin == undefined) {
                    ...
                    var stt = 'false'
                    if (confirm('View Tagihan Piutang Pasien ? ')) {
                        // Save it!
                        stt = 'true';
                    } else {
                        // Do nothing!

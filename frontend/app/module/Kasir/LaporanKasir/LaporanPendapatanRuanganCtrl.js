define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanPendapatanRuanganCtrl', ['CacheHelper', '$scope', 'DateHelper', 'MedifirstService',
        function (cacheHelper, $scope, DateHelper, medifirstService) {
            ...
            function LoadData() {
                ...
                var ttlALL = 0
                medifirstService.get("kasir/get-data-lap-pendapatan-ruangan?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    + tempDepartemen
                    + tempRuanganId

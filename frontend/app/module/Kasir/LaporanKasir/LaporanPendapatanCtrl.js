define(['initialize'], function (initialize) {
  'use strict';
  initialize.controller('LaporanPendapatanCtrl', ['CacheHelper', '$scope', 'DateHelper', 'MedifirstService',
    function (cacheHelper, $scope, dateHelper, medifirstService) {
      ...
      function LoadData() {
        ...
        medifirstService.get("kasir/get-data-lap-pendapatan?"
          + "tglAwal=" + tglAwal
          + "&tglAkhir=" + tglAkhir
          + tempRuanganId
          + tempDepartemen
      ...
      $scope.CetakRekapPendapatan = function () {
        ...
        client.get('http://127.0.0.1:1237/printvb/kasir?cetak-rekap-pendapatan=1' +//$scope.item.namaKasir.id+
          '&tglAwal=' + tglAwal + '&tglAkhir=' + tglAkhir + '&idDepartemen=' + departemen + '&idRuangan=' + ruanganId + '&idDokter=' + dokter + '&PrinteDBY2=' + 1 + '&idKelompok=' + kelompokPasien + '&namaKasir=' + $scope.dataLogin.namaLengkap + '&view=true', function (response) {

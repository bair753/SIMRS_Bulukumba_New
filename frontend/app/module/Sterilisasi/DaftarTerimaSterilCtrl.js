define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarTerimaSterilCtrl', ['$scope', '$state', 'CacheHelper', 'DateHelper', 'MedifirstService',
        function ($scope, $state, cacheHelper, dateHelper, medifirstService) {
            ...
            function LoadCache() {
                var chacePeriode = cacheHelper.get('DaftarTerimaSterilCtrl');
            ...
            function init() {
                ...
                cacheHelper.set('DaftarTerimaSterilCtrl', chacePeriode);
            ...
            $scope.bersihkan = function(){               
                if ($scope.dataSelected == undefined) {
                    toastr.error("Pilih yg akan di ubah!!")
                    return;
                }

                if ($scope.dataSelected.statussteril != "Alat Kotor Setelah Pemakaian") {
                    toastr.error("Alat Yang Dibersihkan Harus Status (Alat Kotor Setelah Pemakaian)")
                    return;
                }
                ...
                medifirstService.post('sterilisasi/save-update-status-bersihkan', dataupdate).then(function (e) {
                    init();
                }, function (error) {
                    // $scope.saveShow = true;
                });
            ...
            $scope.steril = function(){
                if ($scope.dataSelected == undefined) {
                    toastr.error("Pilih yg akan di ubah!!")
                    return;
                }

                if ($scope.dataSelected.statusbersih != "Bersih") {
                    toastr.error("Alat Yang Disterilisasi Harus Status (Bersih)")
                    return;
                }
                ...
                medifirstService.post('sterilisasi/save-update-status-sterilisasi', dataupdate).then(function (e) {
                    init();
                }, function (error) {
                    // $scope.saveShow = true;
                });
            ...
            $scope.Kotor = function(){
                ...
                var dataupdate = {
                    strukkirimfk: $scope.dataSelected.norec,
                    status: "Alat Kotor Setelah Pemakaian"
                }

                medifirstService.post('sterilisasi/save-update-status-alatkotor', dataupdate).then(function (e) {
                    init();
                }, function (error) {
                    // $scope.saveShow = true;
                });

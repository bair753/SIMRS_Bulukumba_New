define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('StokSterilisasiCtrl', ['$sce', '$rootScope', '$scope', 'ModelItem', 'DateHelper', '$http', 'MedifirstService',
        function ($sce, $rootScope, $scope, ModelItem, dateHelper, $http, medifirstService) {
            ...
            var init = function () {
                ...
                medifirstService.get('sterilisasi/get-data-combo-steril').then(function (data) {
                    ...
                    $scope.listSumberDana = data.data.sumberdana;            
                    // $scope.item.passwordAd = dataCombo.passwordAdjusment
                })
            }        
            init();
            // $scope.columnGrid = [
            ...
            $scope.columnGrid = {
                ...
                toolbar: ["excel"],
                excel: {
                    fileName: "Daftar Barang Steril" + moment($scope.now).format('DD/MMM/YYYY'),
                    allPages: true,
                },
                // filterable: {
                //     extra: false,
            ...
            function initData() {
                ...
                medifirstService.get('sterilisasi/get-data-stok-steril?' +

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('TemplateDokumenCtrl', ['SaveToWindow', '$rootScope', '$scope', 'ModelItem', '$state', 'CacheHelper', 'DateHelper', '$mdDialog', 'CetakHelper', 'MedifirstService', '$q',
        function (saveToWindow, $rootScope, $scope, ModelItem, $state, cacheHelper, dateHelper, $mdDialog, cetakHelper, medifirstService, $q) {
            ...
            $scope.inputSurat = function(){
                ...
                cacheHelper.set('TemplateDokumenCtrl', chacePeriode);
            }
            ...
            $scope.Delete = function(){
                medifirstService.post("eoffice/delete-template?" +

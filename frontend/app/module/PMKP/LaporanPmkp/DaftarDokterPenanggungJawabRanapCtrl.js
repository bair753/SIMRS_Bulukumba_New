define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarDokterPenanggungJawabRanapCtrl', ['MedifirstService', 'CacheHelper', '$scope', 'DateHelper', '$state', 'ModelItem',
        function (medifirstService, cacheHelper, $scope, DateHelper, $state, ModelItem) {
            ...
            loadFirst()
            function loadFirst() {
                var chacePeriode = cacheHelper.get('DaftarDokterPenanggungJawabRanapCtrl');
            ...
            function loadData() {
                ...
                medifirstService.get("pmkp/get-data-laporan-dokter-penanggungjawab-rawat-inap?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +                
                    namaruangan +
                    dokter)
            ...
            $scope.columnGrid = {
                ...
                excel: {
                    fileName: "DaftarDokterPenanggungJawabRawatInap.xlsx",
                    allPages: true,
                },
                excelExport: function (e) {
                    ...
                    var myHeaders = [{
                        value: "Daftar Dokter Penanggung Jawab Rawat Inap",
                        fontSize: 20,
                        textAlign: "center",
                        background: "#ffffff",
                        // color:"#ffffff"

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarJamVisiteDokterRanapCtrl', ['MedifirstService', 'CacheHelper', '$scope', 'DateHelper', '$state', 'ModelItem',
        function (medifirstService, cacheHelper, $scope, DateHelper, $state, ModelItem) {
            ...
            loadFirst()
            function loadFirst() {
                var chacePeriode = cacheHelper.get('DaftarJamVisiteDokterRanap');
            ...
            function loadData() {
                ...
                medifirstService.get("pmkp/get-data-laporan-jamvisite-dokter-rawat-inap?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +                
                    namaruangan +
                    dokter)
            ...
            $scope.columnGrid = {
                ...
                excel: {
                    fileName: "DaftarJamVisiteDokterRanap.xlsx",
                    allPages: true,
                },
                excelExport: function (e) {
                    ...
                    var myHeaders = [{
                        value: "Daftar Jam Visite Dokter Ranap",
                        fontSize: 20,
                        textAlign: "center",
                        background: "#ffffff",
                        // color:"#ffffff"

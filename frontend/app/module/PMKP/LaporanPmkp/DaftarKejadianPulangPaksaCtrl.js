define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarKejadianPulangPaksaCtrl', ['MedifirstService', 'CacheHelper', '$scope', 'DateHelper', '$state', 'ModelItem',
        function (medifirstService, cacheHelper, $scope, DateHelper, $state, ModelItem) {
            ...
            loadFirst()
            function loadFirst() {
                var chacePeriode = cacheHelper.get('DaftarKejadianPulangPaksaCtrl');
            ...
            function loadData() {
                ...
                medifirstService.get("pmkp/get-data-laporan-pasien-pulang-paksa?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +                
                    namaruangan +
                    dokter)

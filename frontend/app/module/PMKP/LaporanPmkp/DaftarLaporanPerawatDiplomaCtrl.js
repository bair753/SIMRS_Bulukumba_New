define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarLaporanPerawatDiplomaCtrl', ['MedifirstService', 'CacheHelper', '$scope', 'DateHelper', '$state', 'ModelItem',
        function (medifirstService, cacheHelper, $scope, DateHelper, $state, ModelItem) {
            ...
            loadFirst()
            function loadFirst() {
                var chacePeriode = cacheHelper.get('DaftarLaporanPerawatDiplomaCtrl');
            ...
            function loadData() {
                ...
                medifirstService.get("pmkp/get-data-laporan-data-perawat-d3?" 
                    // +"tglAwal=" + tglAwal +
                    // "&tglAkhir=" + tglAkhir +                
                    // namaruangan +
                    // dokter
            ...
            $scope.columnGrid = {
                ...
                excel: {
                    fileName: "DaftarPerawatRumahSakit.xlsx",
                    allPages: true,
                },
                excelExport: function (e) {
                    ...
                    var myHeaders = [{
                        value: "Daftar Perawat Rumah Sakit",
                        fontSize: 20,
                        textAlign: "center",
                        background: "#ffffff",
                        // color:"#ffffff"

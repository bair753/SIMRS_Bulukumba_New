define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarDokterPemberiLayananRanapCtrl', ['MedifirstService', 'CacheHelper', '$scope', 'DateHelper', '$state', 'ModelItem',
        function (medifirstService, cacheHelper, $scope, DateHelper, $state, ModelItem) {
            ...
            loadFirst()
            function loadFirst() {
                var chacePeriode = cacheHelper.get('DaftarDokterPemberiLayananRanapCtrl');
            ...
            function loadData() {
                ...
                medifirstService.get("pmkp/get-data-laporan-dokter-rawat-inap?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +                
                    namaruangan +
                    dokter)
            ...
            $scope.columnGrid = {
                ...
                excel: {
                    fileName: "DaftarDokterPemberiLayananRawatInap.xlsx",
                    allPages: true,
                },
                excelExport: function (e) {
                    ...
                    var myHeaders = [{
                        value: "Daftar Dokter Pemberi Layanan Rawat Inap",
                        fontSize: 20,
                        textAlign: "center",
                        background: "#ffffff",
                        // color:"#ffffff"

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarKematianPasienIgdCtrl', ['MedifirstService', 'CacheHelper', '$scope', 'DateHelper', '$state', 'ModelItem',
        function (medifirstService, cacheHelper, $scope, DateHelper, $state, ModelItem) {
            ...
            loadFirst()
            function loadFirst() {
                var chacePeriode = cacheHelper.get('DaftarKematianPasienIgdCtrl');
            ...
            function loadData() {
                ...
                medifirstService.get("pmkp/get-data-laporan-data-kematian?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +                
                    namaruangan +
                    dokter)
            ...
            $scope.columnGrid = {
                ...
                excel: {
                    fileName: "DaftarKematianPasien.xlsx",
                    allPages: true,
                },
                excelExport: function (e) {
                    ...
                    var myHeaders = [{
                        value: "Daftar Kematian Pasien < 24 Jam",
                        fontSize: 20,
                        textAlign: "center",
                        background: "#ffffff",
                        // color:"#ffffff"

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarLaporanLamaHariPerawatanPasienCtrl', ['MedifirstService', 'CacheHelper', '$scope', 'DateHelper', '$state', 'ModelItem',
        function (medifirstService, cacheHelper, $scope, DateHelper, $state, ModelItem) {
            ...
            loadFirst()
            function loadFirst() {
                var chacePeriode = cacheHelper.get('DaftarLaporanLamaHariPerawatanPasienCtrl');
            ...
            function loadData() {
                ...
                medifirstService.get("pmkp/get-data-laporan-lama-hari-perawatan-pasien?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +                
                    namaruangan +
                    dokter)
            ...
            $scope.columnGrid = {
                ...
                excel: {
                    fileName: "DaftarPasienPulangPaksa.xlsx",
                    allPages: true,
                },
                excelExport: function (e) {
                    ...
                    var myHeaders = [{
                        value: "Daftar Pasien Pulang Paksa",
                        fontSize: 20,
                        textAlign: "center",
                        background: "#ffffff",
                        // color:"#ffffff"

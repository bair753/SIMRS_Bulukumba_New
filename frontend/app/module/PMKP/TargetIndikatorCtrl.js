define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('TargetIndikatorCtrl', ['$q', '$scope', 'MedifirstService', '$timeout',
        function ($q, $scope, medifirstService, $timeout) {
            ...
            function init() {
                ...
                $q.all([
                    medifirstService.get("sysadmin/general/rensar/get-target-indikator", true),
                ]).then(function (res) {
                    $scope.isRouteLoading = false;
            ...
            $scope.Save = function (data) {
                ...
                if (data.action && data.action === "remove") {
                    medifirstService.post('sysadmin/general/rensar/delete-target-indikator',item).then(function (e) {
                        init();
                    });
                } else {
                    medifirstService.post('sysadmin/general/rensar/save-target-indikator',item).then(function (e) {
                        // delete $scope.item;
                        // $scope.item = {};
                        init();
                    });

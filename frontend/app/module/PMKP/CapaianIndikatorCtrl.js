define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('CapaianIndikatorCtrl', ['$q', '$scope', 'MedifirstService',
        function ($q, $scope, medifirstService) {
            ...
            medifirstService.get('sysadmin/general/rensar/get-data-combo').then(function (e) {
            ...
            function postWTPL() {
                var data = {}
                $q.all([
                    medifirstService.post('sysadmin/general/rensar/post-waktu-tunggu-pelayanan-lab', data),
                    medifirstService.post('sysadmin/general/rensar/post-waktu-tunggu-pelayanan-rad', data),
                ]).then(function (res) {
                })
            }
            ...
            $scope.optionGridMaster = {
                ...
                columns: [
                    ...
                    { field: "numerator", title: "Numerator", width: 100 },
                    { field: "denumerator", title: "Denumerator", width: 100 },
            ...
            function init() {
                ...
                if ($scope.cari.jenisIndikator != undefined)
                    ...
                    $q.all([
                    medifirstService.get("sysadmin/general/rensar/get-data-indikator?indikator=" + indikator
                        + "&bulan=" + blns
                        + "&tahun=" + tahun
                        + "&target=" + target
                        + "&capaian=" + capaian
            ...
            $scope.Save = function () {
                var listRawRequired = [
                    ...
                    "item.denumerator|ng-model|Denumerator",
                    "item.numerator|ng-model|Numerator",
                ...
                if (isValid.status) {
                    ...
                    var data = {
                        ...
                        "numerator": $scope.item.numerator,
                        "denumerator": $scope.item.denumerator,
                    ...
                    medifirstService.post("sysadmin/general/rensar/save-indikator", data).then(function (e) {
                        init();
                        $scope.item = {}
                    });
                } else {
            ...
            $scope.hapus = function () {
                ...
                medifirstService.post("sysadmin/general/rensar/delete-indikator", data).then(function (e) {
                    init()
                    $scope.item = {}
                })
            }
            $scope.edit = function () {
                ...
                $scope.item.tahun = new Date($scope.dataSelect.tahun)
                $scope.item.numerator = $scope.dataSelect.numerator
                $scope.item.denumerator = $scope.dataSelect.denumerator
                $scope.dialogPopup.center().open()
            }

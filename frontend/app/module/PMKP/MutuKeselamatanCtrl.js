define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('MutuKeselamatanCtrl', ['$q', '$rootScope', '$scope', '$state', 'CacheHelper', 'MedifirstService',
        function ($q, $rootScope, $scope, $state, cacheHelper, medifirstService) {
            ...
            function init() {
                medifirstService.get("emr/get-emr-transaksi?jenisEmr=mutukeselamatan", true).then(function (dat) {
                ...
                medifirstService.get("emr/get-menu-rekam-medis-dynamic?namaemr=mutukeselamatan").then(function (e) {
            ...
            $scope.Lihat = function () {
                ...
                $state.go("MutuKeselamatan.MutuKeselamatanDetail", {
                    namaEMR: 37,
                    nomorEMR: noemr2
                });
            ...
            $scope.createSatu = function () {                
                $scope.showRiwayatEMR = true
                $scope.myVar = 3
                var noemr2 = '-'
                $state.go("MutuKeselamatan.LembarKerjaInvestigasiSederhana", {});
                // var arrStr = {
                //     0: noemr2
                // }
                // cacheHelper.set('cacheNomorEMR', arrStr);

define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('MutuKeselamatanDetailCtrl', ['$rootScope', '$scope', '$state', 'CacheHelper', 'MedifirstService',
        function ($rootScope, $scope, $state, cacheHelper, medifirstService) {
            ...
            if (nomorEMR == '-') {
                medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + $state.params.namaEMR).then(function (e) {
                    ...
                    $scope.cc.nocm = '-';
                    $scope.cc.namapasien = '-';
                    $scope.cc.jeniskelamin = '-'
                    $scope.cc.noregistrasi = '-';
                    $scope.cc.umur = '-';
                    $scope.cc.kelompokpasien = '-';
                    $scope.cc.tglregistrasi = null;
                    $scope.cc.norec = '-'
                    $scope.cc.norec_pd = '-';
                    $scope.cc.objectkelasfk = null
                    $scope.cc.namakelas = '-';
                    $scope.cc.objectruanganfk = null
                    $scope.cc.namaruangan = '-'
                    $scope.cc.DataNoregis = '-'
                ...
                medifirstService.get("emr/get-rekam-medis-dynamic?emrid=" + $state.params.namaEMR).then(function (e) {
                    ...
                    $scope.item.title = e.data.title
                    $scope.item.classgrid = e.data.classgrid
                    $scope.cc.norec_emr = e.data.norec
                    $scope.cc.emrfk = $state.params.namaEMR
            ...
            $scope.Save = function () {
                ...
                $scope.cc.jenisemr = 'mutukeselamatan'
                var jsonSave = {
                    head: $scope.cc,
                    jenisemr: 'mutukeselamatan',

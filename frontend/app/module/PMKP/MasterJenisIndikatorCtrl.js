define(['initialize'], function (initialize) {
	'use strict';
	initialize.controller('MasterJenisIndikatorCtrl', ['$q', '$scope', 'MedifirstService', '$timeout',
		function ($q, $scope, medifirstService, $timeout) {
			...
			function init() {
				...
				$q.all([
					medifirstService.get("sysadmin/general/rensar/get-jenis-indikator", true),
				]).then(function (res) {
			...
			$scope.Save = function (data) {
				...
				medifirstService.post('sysadmin/general/rensar/save-jenis-indikator',item).then(function (e) {
					// delete $scope.item;
					// $scope.item = {};
					// init();
				});

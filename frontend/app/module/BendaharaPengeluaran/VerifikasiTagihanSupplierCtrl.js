define(['initialize'], function (initialize) {
  'use strict';
  initialize.controller('VerifikasiTagihanSupplierCtrl', ['CacheHelper', '$scope', 'MedifirstService', '$state', 'DateHelper',
    function (cacheHelper, $scope, medifirstService, $state, dateHelper) {
      ...
      $scope.Verifikasi = function () {
        ...
        // }
        dataObjPost = {}
        // medifirstService.post("tagihan-rekanan/save-verifikasi-tagihan-rekanan?noRec=" + $scope.dataSelected.noRecStrukVerifikasi, dataObjPost).then(function (e) {
        // })
        loadData();
      };

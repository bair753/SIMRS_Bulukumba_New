                    ...
                    <section style="padding:1px">
                        <table style="table-layout:fixed;width:100%">
                            <tr aria-colspan="12" style="font-weight:bolder;text-align:center">
                                ...
                                <td colspan="3">ATS 1</td>
                                <td colspan="3">ATS 2</td>
                                <td colspan="3">ATS 3</td>
                                <td colspan="3">ATS 4</td>
                                <td colspan="3">ATS 5</td>
                            </tr>
                            <tr>
                                <td colspan="3">Jalan Napas</td>
                                <td colspan="3" valign="middle">@{{ item.obj[420454] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Obstruksi Total</td>
                                <td colspan="3" valign="middle">@{{ item.obj[420459] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Obstruksi Parsial</td>
                                <td colspan="3" valign="middle">@{{ item.obj[420463] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Paten</td>
                                <td colspan="3" valign="middle">@{{ item.obj[420466] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Paten</td>
                                <td colspan="3" valign="middle">@{{ item.obj[420469] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Paten</td>
                            </tr>
                            <tr  >
                                <td colspan="3" rowspan="2">Pernapasan</td>
                                <td colspan="3" valign="middle" style="border:1px solid #000;border-top:none;border-bottom:none">
                                    @{{ item.obj[420455] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Henti Napas
                                </td>
                                <td colspan="3" valign="middle"  style="border:1px solid #000;border-top:none;border-bottom:none">@{{ item.obj[420460] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Distress Napas Berat</td>
                                <td colspan="3" valign="middle"  style="border:1px solid #000;border-top:none;border-bottom:none">@{{ item.obj[420464] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Distress Napas Sedang</td>
                                <td colspan="3" valign="middle"  style="border:1px solid #000;border-top:none;border-bottom:none">@{{ item.obj[420467] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tidak Ada Distress Napas</td>
                            ...
                            <tr style="border-top:1px solid #000;">
                                ...
                                <td colspan="3" valign="middle" style="border:1px solid #000;border-top:none;border-bottom:none">@{{ item.obj[420461] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Gangguan Hemodinamik Berat</td>
                                <td colspan="3" valign="middle" style="border:1px solid #000;border-top:none;border-bottom:none">@{{ item.obj[420465] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Gangguan Hemodinamik Sedang-ringan</td>
                                <td colspan="3" valign="middle" style="border:1px solid #000;border-top:none;border-bottom:none">@{{ item.obj[420468] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Hemodinamik Stabil</td>
                            ...
                            <tr style="border-bottom:1px solid #000;">
                                ...
                                <td colspan="3" valign="middle">@{{ item.obj[420473] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} 9-12</td>
                                <td colspan="3" valign="middle">@{{ item.obj[420474] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} 13-15</td>
                                <td colspan="3" valign="middle">@{{ item.obj[420475] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} 15</td>
                            ...
                            <tr>
                                ...
                                <td colspan="3" valign="middle">@{{ item.obj[420477] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Nyeri Berat</td>
                                <td colspan="3" valign="middle">@{{ item.obj[420479] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Nyeri Sedang</td>
                                <td colspan="3" valign="middle">@{{ item.obj[420484] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Nyeri Ringan</td>
                            ...
                            <tr>
                                ...
                                <td colspan="3" valign="middle"> </td>
                                <td colspan="3" valign="middle">@{{ item.obj[420480] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tidak Kooperatif</td>
                                <td colspan="3" valign="middle">@{{ item.obj[420485] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Kooperatif</td>
                            ...
                            <tr style="border:1px solid #000;border-top:none;border-bottom:none">
                                ...
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none"></td>
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none">@{{ item.obj[420478] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Hipotermi</td>
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none">@{{ item.obj[420481] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Iritabel, Sulit Menyusui</td>
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none">@{{ item.obj[420486] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} BBLR</td>
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none">@{{ item.obj[420491] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Ikterik</td>
                            </tr>
                            <tr style="border:none;">
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none"></td>
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none"></td>
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none">@{{ item.obj[420482] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Pucat</td>
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none">@{{ item.obj[420487] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Ikterik Kraemer > 3, Ikterik Dalam 24 Jam Pertama, Ikterik Bertahan > 14 Hari</td>
                            ...
                            <tr style="border:none;">
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none"></td>
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none"></td>
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none">@{{ item.obj[420483] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Kelainan Kongenital Mayor</td>
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none">@{{ item.obj[420488] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Perdarahan</td>
                            ...
                            <tr style="border:none;">
                                ...
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none"></td>
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none"></td>
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none">@{{ item.obj[420489] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Trauma Lahir Minor</td>
                                <td colspan="3" valign="middle" style="border:1px solid #000; border-top:none;border-bottom:none"></td>
                            </tr>

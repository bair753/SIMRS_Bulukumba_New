...
<body ng-controller="cetakAsesmenAwalKeperawatanIGD">
      <section>
        <table width="100%" id="content" style="table-layout:fixed">
            <tr style="border:none;border-top:1px solid #000">
                ...
                <td rowspan="4" colspan="7" style="text-align:center;font-size:10px;border:none"><strong>{!! $res['profile']->namalengkap !!}</strong> <br>{!! $res['profile']->alamatlengkap !!}<br>TELP : (0413) 81292</td>
            ...
            <tr height="20px">
                ...
                <td colspan="8" style="border:none">: {!!  $res['d'][0]->namapasien  !!} {!!  $res['d'][0]->jeniskelamin == 'PEREMPUAN' ? '(P)' : '(L)'  !!}</td>
            </tr>
            <tr height="20px">
            ...
            <tr height="18px" style="border:1px solid #000">
                ...
                <td colspan="3" style="border:none">@{{ item.obj[420624] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Bedah</td>
                <td colspan="3" style="border:none">@{{ item.obj[420625] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Non Bedah</td>
                <td colspan="3" style="border:none">@{{ item.obj[420626] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Anak</td>
                <td colspan="9" style="border:none">@{{ item.obj[420627] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Kebidanan/Penyakit Kandungan</td>
            </tr>
            ...
            <tr height="18px" valign="middle">
                ...
                <td style="border:none" colspan="8" style="border:none;">: @{{ item.obj[420632] ? item.obj[420632] : '' }}</td>
                <td colspan="8" style="border:none;border-left:1px solid #000"></td>
            </tr>
            <tr height="18px" valign="middle">
                <td colspan="3" style="border:none">Hubungan dengan pasien</td>
                <td colspan="7" style="border:none;border-right:1px solid #000">: @{{ item.obj[420633] ? item.obj[420633] : '' }}</td>
            ...
            <tr height="18px">
                ...
                <td colspan="2" valign="middle" style="border:none;">@{{ item.obj[420635] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Normal</td>
                <td colspan="2" style="border:none;">@{{ item.obj[420636] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Masalah</td>
            ...
            <tr height="18px">
                ...
                <td style="border:none;" colspan="2">@{{ item.obj[420644] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Teratur</td>
                <td style="border:none;" colspan="5">@{{ item.obj[420645] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tidak Teratur </td>
            </tr>
            <tr height="18px">
                ...
                <td style="border:none;" colspan="3">@{{ item.obj[420647] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Hangat</td>
                <td style="border:none;" colspan="7">@{{ item.obj[420648] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Dingin</td>
            </tr>
            <tr height="18px">
                <td style="border:none;" colspan="6">Pendarahan/Kehilangan Cairan :</td>
                <td style="border:none;"></td>
                <td style="border:none;" colspan=""></td>
                <td style="border:none;" colspan="4">@{{ item.obj[420649] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tidak</td>
                <td style="border:none;" colspan="6">@{{ item.obj[420650] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Ada, Jelaskan : @{{ item.obj[420641] ? item.obj[420651] : '' }}</td>
            </tr>
            <tr height="18px">
                ...
                <td style="border:none;" colspan="5">SPO2, Jelaskan : @{{ item.obj[420653] ? item.obj[420653] : '___' }} %</td>
                <td style="border:none;" ></td>
            </tr>
            <tr height="18px" style="border-top:1px solid #000">
                <td style="border:none;border-right:1px solid #000" colspan="6"><b>Dissability/Neurologi</b></td>
                <td style="border:none;border-right:1px solid #000" colspan="6"></td>
                <td style="border:none;" colspan="6"></td>
            </tr>
            <tr height="18px">
                <td colspan="6" style="border:none;border-right:1px solid #000">Kesadaran : @{{ item.obj[420654] ? item.obj[420654] : '' }}</td>
                <td colspan="6" style="border:none;border-right:1px solid #000"></td>
                <td colspan="6" style="border:none;"></td>
            </tr>
            <tr height="18px">
                <td colspan="6" style="border:none;border-right:1px solid #000">GCS : E : @{{ item.obj[420655] ? item.obj[420655] : '' }}, V : @{{ item.obj[420656] ? item.obj[420656] : '' }}, M : @{{ item.obj[420657] ? item.obj[420657] : '' }}</td>
            ...
            <tr height="18px">
                <td style="border:none;"colspan="3">@{{ item.obj[420658] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Mandiri</td>
                <td style="border:none;border-right:1px solid #000"colspan="3">@{{ item.obj[420659] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Dibantu</td>
                <td style="border:none;"colspan="3">@{{ item.obj[420669] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Jelas</td>
                <td colspan="3" style="border:none;border-right:1px solid #000">@{{ item.obj[420670] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Pendarahan</td>
                <td colspan="6" style="border:none;">@{{ item.obj[420676] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Denyut Nadi (-)</td>
            </tr>
            <tr height="18px">
                <td style="border:none;"colspan="3">@{{ item.obj[420660] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Alert</td>
                <td style="border:none;border-right:1px solid #000" colspan="3">@{{ item.obj[420661] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Pain</td>
                <td style="border:none;"colspan="3">@{{ item.obj[420671] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Fraktur</td>
                <td style="border:none;border-right:1px solid #000" colspan="3">@{{ item.obj[420672] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Normal</td>
                <td style="border:none;"colspan="6">@{{ item.obj[420677] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Reflek Cahaya (-)</td>
            </tr>
            <tr height="18px">
                <td style="border:none;"colspan="3">@{{ item.obj[420662] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Verbal</td>
                <td style="border:none;border-right:1px solid #000"colspan="3">@{{ item.obj[420663] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Non Verbal</td>
                <td style="border:none;"colspan="3">@{{ item.obj[420673] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Hematom</td>
                <td style="border:none;border-right:1px solid #000"colspan="3">@{{ item.obj[420674] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Deformitas</td>
                <td style="border:none;"colspan="6">@{{ item.obj[420678] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} EKG Asystole</td>
            </tr>
            <tr height="18px">
            ...
            <tr height="18px">
                ...
                <td colspan="2" style="border:none">@{{ item.obj[420665] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Anisokor</td>
                <td colspan="2" style="border:none;border-right:1px solid #000">@{{ item.obj[420666] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Midriasis</td>
                <td colspan="6" style="border:none;border-right:1px solid #000"></td>
                <td colspan="6" style="border:none"></td>
            </tr>
            <tr>
                <td colspan="6" style="border:none;border-right:1px solid #000">Refleks: @{{ item.obj[420667] ? item.obj[420667] : '' }} / @{{ item.obj[420668] ? item.obj[420668] : '' }}</td>
                <td colspan="6" style="border:none;border-right:1px solid #000"></td>
                <td colspan="6" style="border:none;border-right:1px solid #000"></td>
            </tr>
            <tr height="18px" style="border-top: 1px solid #000;">
                <td colspan="4" rowspan="7" style="border:none;border-right:1px solid #000">Bio-Psiko-Sosio-Spiritual</td>
                <td colspan="3" style="border:none">@{{ item.obj[420680] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Rumah Sendiri</td>
                <td colspan="3" style="border:none">@{{ item.obj[420681] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Rumah Orang Tua</td>
                <td colspan="3" style="border:none">@{{ item.obj[420682] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Kontrak</td>
                <td colspan="2" style="border:none">@{{ item.obj[420683] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Kos</td>
                <td colspan="6" style="border:none">@{{ item.obj[420684] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Lainnya : @{{ item.obj[420685] ? item.obj[420685] : '' }}</td>
            </tr>
            <tr height="18px">
                <td colspan="3" style="border:none">@{{ item.obj[420687] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tenang</td>
                <td colspan="3" style="border:none">@{{ item.obj[420688] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Cemas</td>
                <td colspan="3" style="border:none">@{{ item.obj[420689] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Marah</td>
                <td colspan="6" style="border:none">@{{ item.obj[420690] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Lainnya : @{{ item.obj[420691] ? item.obj[420691] : '' }}</td>
            </tr>
            <tr height="18px">
                <td colspan="3" style="border:none">Status Perkawinan</td>
                <td colspan="4" style="border:none">@{{ item.obj[420693] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Kawin</td>
                <td colspan="4" style="border:none">@{{ item.obj[420694] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Belum Kawin</td>
            </tr>
            <tr height="18px">
                <td colspan="7" style="border:none">Nilai dan keyakinan yang mempengaruhi Kesehatan :</td>
                <td colspan="4" style="border:none">@{{ item.obj[420696] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tidak Ada</td>
                <td colspan="4" style="border:none">@{{ item.obj[420697] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Ada : @{{ item.obj[420698] ? item.obj[420698] : '' }}</td>
            </tr>
            <tr height="18px">
                <td colspan="2" style="border:none">Agama</td>
                <td colspan="2" style="border:none">@{{ item.obj[420700] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Islam</td>
                <td colspan="3" style="border:none">@{{ item.obj[420701] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Kristen Katolik</td>
                <td colspan="3" style="border:none">@{{ item.obj[420702] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Kristen Protestan</td>
                <td colspan="2" style="border:none">@{{ item.obj[420703] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Hindu</td>
                <td colspan="2" style="border:none">@{{ item.obj[420704] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Budha</td>
            </tr>
            <tr height="18px">
                <td colspan="2" style="border:none"></td>
                <td colspan="2" style="border:none">@{{ item.obj[420705] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Konghucu</td>
                <td colspan="6" style="border:none">@{{ item.obj[420706] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Kepercayaan terhadap Tuhan Yang Maha Esa</td>
            </tr>
            <tr height="18px">
                <td colspan="4" style="border:none">Menjalankan Ibadah</td>
                <td colspan="2" style="border:none">@{{ item.obj[420708] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Selalu</td>
                <td colspan="7" style="border:none">@{{ item.obj[420709] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Ada Hambatan : @{{ item.obj[420710] ? item.obj[420710] : '' }}</td>
            </tr>
            <tr height="18px" style="border:1px solid #000;">
                <td colspan="4" style="border:none;border-right:1px solid #000">Ekonomi</td>
                <td colspan="2" style="border:none">@{{ item.obj[420711] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} PNS</td>
                <td colspan="2" style="border:none">@{{ item.obj[420712] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} TNI/POLRI</td>
                <td colspan="3" style="border:none">@{{ item.obj[420713] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Pegawai Swasta</td>
                <td colspan="2" style="border:none">@{{ item.obj[420714] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Wiraswasta</td>
                <td colspan="3" style="border:none">@{{ item.obj[420715] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Petani/Nelayan</td>
                <td colspan="6" style="border:none">@{{ item.obj[420716] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Lain : @{{ item.obj[420717] ? item.obj[420717] : '' }}</td>
            </tr>
            <tr height="18px">
            ...
            <tr height="18px">
                ...
                <td colspan="6" style="border:none;">Panjang Badan Lahir : @{{ item.obj[420728] ? item.obj[420728] : '' }} cm</td>
                <td colspan="6" style="border:none;">Lingkar Kepala : @{{ item.obj[420729] ? item.obj[420729] : '' }} cm</td>
            </tr>
            <tr height="18px">
                <td colspan="4" style="border:none">Imunisasi: </td>
                <td colspan="2" style="border:none">@{{ item.obj[420731] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} BCG</td>
                <td colspan="2" style="border:none">@{{ item.obj[420732] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} DPT</td>
                <td colspan="2" style="border:none">@{{ item.obj[420733] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} POLIO</td>
                <td colspan="2" style="border:none">@{{ item.obj[420734] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Campak</td>
                <td colspan="2" style="border:none">@{{ item.obj[420735] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Hepatitis</td>
                <td colspan="4" style="border:none">@{{ item.obj[420736] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} @{{ item.obj[420737] ? item.obj[420737] : '' }}</td>
            </tr>
            <tr height="18px" style="border:1px solid #000">
                <td colspan="4">Riwayat Alergi</td>
                <td colspan="2" style="border:none">@{{ item.obj[420738] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tidak </td>
                <td colspan="16"  style="border:none">@{{ item.obj[420739] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Ya, Sebutkan : @{{ item.obj[420740] ? item.obj[420740] : '' }}</td>
            </tr>
            <tr height="18px" style="border:1px solid #000">
                <td colspan="4">Riwayat Penggunaan Obat</td>
                <td colspan="2" style="border:none">@{{ item.obj[420741] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tidak Ada</td>
                <td colspan="16"  style="border:none">@{{ item.obj[420742] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Ada : @{{ item.obj[420743] ? item.obj[420743] : '' }}</td>
            </tr>
            <tr height="18px" style="border:1px solid #000">
                <td colspan="4">Asesmen Nyeri</td>
                <td colspan="4" style="border:none">@{{ item.obj[420744] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tidak Nyeri</td>
                <td colspan="14"  style="border:none">@{{ item.obj[420745] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Nyeri Lanjut ke RM 36</td>
            </tr>
            <tr>
    ...
    2. Menopang saat akan duduk : Tampak memegang pinggiran kursi atau meja/ 
       benda lain sebagai penopang saat akan duduk.
                ...
                <td colspan="2" style="border:none">@{{ item.obj[420749] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Ya</td>
                <td colspan="2" style="border:none">@{{ item.obj[420750] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tidak</td>
            </tr>
            <tr>
                <td colspan="2" style="border:none">@{{ item.obj[420752] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Ya</td>
                <td colspan="2" style="border:none">@{{ item.obj[420753] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tidak</td>
            </tr>
            <tr>
                <td colspan="2" style="border:none">@{{ item.obj[420755] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Ya</td>
                <td colspan="2" style="border:none">@{{ item.obj[420756] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tidak</td>
            </tr>
            <!-- lembar ke dua  -->
            <tr height="18px"style="border-top:1px solid #000">
            ...
            <tr height="18px">
                ...
                <td colspan="4" style="border:none">@{{ item.obj[420763] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Mandiri</td>
                <td colspan="4" style="border:none">@{{ item.obj[420764] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Dibantu</td>
            ...
            <tr height="18px">
                <td colspan="18"><strong>Jika terdapat jawaban Ya, maka dilaporkan ke dietisien untuk dilakukan skrining lanjut.</strong></td>
            </tr>
            <tr>
                <td colspan="4" rowspan="3" valign="top">Kebutuhan Edukasi</td>
                <td colspan="18" style="border:none;padding:3px">Edukasi awal disampaikan tentang penggunaan obat-obatan, penggunaan peralatan medis, potensi interaksi antara obat, diet dan nutrisi, manajemen nyeri, teknik rehabilitasi, dan cuci tangan yang benar kepada :</td>
            </tr>
            <tr height="18px" style="border:none;">
                <td colspan="5" style="border:none;">@{{ item.obj[420785] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Pasien</td>
                <td colspan="13" style="border:none;">@{{ item.obj[420786] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Keluarga</td>
            </tr>
            <tr height="18px" style="border-bottom:1px solid #000;">
                <td colspan="18" style="border:none;">@{{ item.obj[420787] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tidak dapat memberikan edukasi kepada pasien atau keluarga,karena : @{{ item.obj[420789] ? item.obj[420789] : '' }}</td>
            </tr>
            <tr height="18px">
                <td colspan="4" rowspan="3">Perencanaan Pulang</td>
                <td colspan="4" style="border:none">Pasien disarankan pulang: </td>
                <td colspan="5" style="border:none">@{{ item.obj[420791] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Berobat Lanjut di FKTP</td>
                <td colspan="4" style="border:none">@{{ item.obj[420792] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Poli : @{{ item.obj[420793] ? item.obj[420793] : '' }}</td>
            </tr>
            <tr  height="18px" style="border:1px solid #000">
                <td colspan="4" style="border:none">Pasien Dirujuk</td>
                <td colspan="5" style="border:none">@{{ item.obj[420795] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Rujuk balik ke FKTP</td>
                <td colspan="9" style="border:none">@{{ item.obj[420796] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} RS</td>
            </tr>
            <tr  height="18px" style="border:1px solid #000">
                <td colspan="15" style="border:none">Rawat inap, Bagian / Ruang : @{{ item.obj[420799] ? item.obj[420799] : '' }}</td>
            ...
            <tr>
                <td style="border:none;border-right:1px solid #000" colspan="11" valign="top">Perawat Penanggung Jawab Asuhan : @{{ item.obj[420862] ? item.obj[420862] : '' }}</td>
                <td style="border:none;" colspan="11"><div id="qrcodePerawat" style="text-align: center"></div></td>
            </tr>
        </table>
    </section>

...
<body ng-controller="cetakPenolakanSkrining">
    <div class="header">
    ...
    <table>
        ...
        <tr style="text-align: center;">
            <td colspan="4">@foreach($res['d'] as $item) @if($item->emrdfk == 32116746) {!! $item->value !!} @endif @endforeach</td>
            <td></td>
            <td colspan="4">@foreach($res['d'] as $item) @if($item->emrdfk == 32116747) {!! $item->value !!} @endif @endforeach</td>
        </tr>
...
<script type="text/javascript">
    ...
    angular.controller('cetakPenolakanSkrining', function ($scope, $http, httpService) {
        $scope.item = {
            obj: [],
            obj2: []
        }
        ...
        var petugas1 = $scope.item.obj[32116746];
        var petugas2 = $scope.item.obj[32116747];

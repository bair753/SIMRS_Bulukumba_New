      ...
      <section>
        <table width="100%" id="content" style="table-layout:fixed">
            ...
            <tr style="border:none">
                ...
                <td style="border:none;">M : @{{ item.obj[31100369] ? item.obj[31100369] : '' }}</td>
            </tr>
            ...
            <tr>
                ...
                <td colspan=""  style="border:none;"> @{{ item.obj[31100378] ? item.obj[31100378] : '____' }} x / menit</td>
            ...
            <tr style="border:none;border-bottom:1px solid #000">
                ...
                <td colspan="3" style="border:1px solid #000;border-bottom:none;border-top:none;border-left:none">: @{{ item.obj[31100407] ? item.obj[31100407] : '____' }} gram</td>
            ...
            <tr style="border:none">
                ...
                <td colspan="3" style="border:none">: @{{ item.obj[31100421] ? item.obj[31100421] : '____' }} x @{{ item.obj[31100422] ? item.obj[31100422] : '____' }} cm</td>
            </tr>
            <tr style="border:none">
            ...
            <tr style="border:none">
                ...
                <td colspan="3" style="border:1px solid #000;border-bottom:none;border-top:none;border-left:none">: @{{ item.obj[31100423] ? item.obj[31100423] : '____' }} gram</td>
                <td colspan="1"  style="border:none">Jahitan Perineum</td>
                <td style="border:none"> : Luar : @{{ item.obj[31100424] ? item.obj[31100424] : '____' }}</td>
                <td colspan="2" style="border:none"> dalam : @{{ item.obj[31100425] ? item.obj[31100425] : '____' }}</td>
            </tr>
            <tr style="border:1px solid #000;border-bottom:none">
            ...
            <tr >
                ...
                <td style="border:none" colspan="6">:  
                    ...
                    @{{ item.obj[31100431] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tidak Ada @{{ item.obj[31100432] ? item.obj[31100432] : '___' }} cc</td>
            </tr>
            <tr >
...
<script type="text/javascript">
    ...
    angular.controller('cetakLaporanPersalinan', function ($scope, $http, httpService) {
        $scope.item = {
            obj: [],
            obj2: []
        }

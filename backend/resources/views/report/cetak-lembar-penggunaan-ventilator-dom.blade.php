        ...
        <table width="100%" style="table-layout:fixed;border:none">
            ...
            <tr style="text-align: center;">
                <td colspan="4" valign="bottom" style="border:none">
                    ...
                    <div style="text-align: center">@foreach($res['d1'] as $item) @if($item->emrdfk == 32110782) <img src="data:image/png;base64, {!! $item->qrcode !!} " style="height: 70px; width:70px;"> @endif @endforeach</div>
                </td>
                <td style="border:none"></td>
                <td colspan="4" valign="bottom" style="border:none">
        ...
        <table width="100%" style="table-layout:fixed;border:none">
            ...
            <tr style="text-align: center;">
                <td colspan="4" valign="bottom" style="border:none">
                    ...
                    <div style="text-align: center">@foreach($res['d2'] as $item) @if($item->emrdfk == 32110782) <img src="data:image/png;base64, {!! $item->qrcode !!} " style="height: 70px; width:70px;"> @endif @endforeach</div>
                </td>
                <td style="border:none"></td>
                <td colspan="4" valign="bottom" style="border:none">
                    <div id="qrcodePetugas2" style="text-align: center">
        ...
        <table width="100%" style="table-layout:fixed;border:none">
            ...
            <tr style="text-align: center;">
                <td colspan="4" valign="bottom" style="border:none">
                    ...
                    <div style="text-align: center">@foreach($res['d3'] as $item) @if($item->emrdfk == 32110782) <img src="data:image/png;base64, {!! $item->qrcode !!} " style="height: 70px; width:70px;"> @endif @endforeach</div>
                </td>
                <td style="border:none"></td>
                <td colspan="4" valign="bottom" style="border:none">
                    <div id="qrcodePetugas2" style="text-align: center">
        ...
        <table width="100%" style="table-layout:fixed;border:none">
            ...
            <tr style="text-align: center;">
                <td colspan="4" valign="bottom" style="border:none">
                    ...
                    <div style="text-align: center">@foreach($res['d4'] as $item) @if($item->emrdfk == 32110782) <img src="data:image/png;base64, {!! $item->qrcode !!} " style="height: 70px; width:70px;"> @endif @endforeach</div>
                </td>
                <td style="border:none"></td>
                <td colspan="4" valign="bottom" style="border:none">
                    <div id="qrcodePetugas2" style="text-align: center">
        ...
        <table width="100%" style="table-layout:fixed;border:none">
            ...
            <tr style="text-align: center;">
                <td colspan="4" valign="bottom" style="border:none">
                    ...
                    <div style="text-align: center">@foreach($res['d5'] as $item) @if($item->emrdfk == 32110782) <img src="data:image/png;base64, {!! $item->qrcode !!} " style="height: 70px; width:70px;"> @endif @endforeach</div>
                </td>
                <td style="border:none"></td>
                <td colspan="4" valign="bottom" style="border:none">
                    <div id="qrcodePetugas2" style="text-align: center">

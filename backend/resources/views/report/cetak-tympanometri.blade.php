...
<body>
    <table width="100%" style="table-layout:fixed;border:none">
        ...
        <tr style="text-align:center;border:none">
            <td colspan="9" style="border:none"><h2>TYMPANOMETRI</h2></td>
        </tr>

        <tr style="text-align:center;border:none">
            <td colspan="9" style="border:none">Tgl Pemeriksaan : {!! $res['d'][0]->value  !!}</td>
        </tr>
        
        <tr style="text-align: center;">
            <td colspan="9" valign="bottom" style="border:none"><center><img class="gambarAset" style="max-width:600px; max-height:800px" src="{!! $res['img']->image  !!}" /></center></td>

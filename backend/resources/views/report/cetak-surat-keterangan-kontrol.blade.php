...
<body ng-controller="cetakSuratKeteranganKontrol">
        ...
        <tr>
            ...
            <td>
                <center>
                    ...
                    <h2>H. ANDI SULTHAN DAENG RADJA</h2>
            ...
            <td>
                <img src="{{ $imageHusada }}" alt="" style="width: 60px;">
    ...
    <table width="100%">
        <tr style="text-align: center;font-size:16pt">
            <td colspan="6"><h1><b><u>SURAT KETERANGAN KONTROL</u></b></h1><br></td>
        </tr>
        
        <tr>
            <td>NO. KARTU</td>
            <td>:</td>
            <td>{!! $res['d'][0]->nobpjs !!}</td>
            <td>NO. RM</td>
            <td>:</td>
            <td>{!! $res['d'][0]->nocm !!}</td>
        </tr>
        ...
        <tr>
            <td>TERAPI</td>
            <td>:</td>
            <td>@{{ item.obj[32116173] }}</td>
            <td>NO. HP PASIEN</td>
            <td>:</td>
            <td>@{{ item.obj[32116174] }}</td>
        </tr>
        <tr>
            <td>TANGGAL SURAT RUJUKAN</td>
            <td>:</td>
            <td>@{{item.obj[32116175] | toDate | date:'dd MMMM yyyy'}}</td>
        </tr>
    </table>
    <br>
    <table width="100%">
        <tr>
            <td>Belum dapat dikembalikan ke Fasilitas Penunjuk dengan alasan * :</td>


        </tr>
        <tr>
            <td>1. @{{ item.obj[32116176] }}</td>


        </tr>
        <tr>
            <td>2. @{{ item.obj[32116177] }}</td>


        </tr>
        <tr>
            <td>3. @{{ item.obj[32116178] }}</td>


        </tr>
        <tr>
            <td>4. @{{ item.obj[32116179] }}</td>
    ...
    <table width="100%">
        ...
        <tr>
            <td>1. @{{ item.obj[32116180] }}</td>


        </tr>
        <tr>
            <td>2. @{{ item.obj[32116181] }}</td>


        </tr>
        <tr>
            <td>3. @{{ item.obj[32116182] }}</td>


        </tr>
        <tr>
            <td>4. @{{ item.obj[32116183] }}</td>


        </tr>
        <tr>
            <td>Surat keterangan ini digunakan untuk 1 (satu) kali kunjungan dengan diagnosa diatas, </td>


        </tr>
        <tr>
            <td>pada tanggal : @{{item.obj[32116184] | toDate | date:'dd MMMM yyyy'}}</td>
    ...
    <table width="100%">
        ...
        <tr style="text-align: center;">
            ...
            <td>
                Bulukumba, @{{item.obj[32116185] | toDate | date:'dd MMMM yyyy HH:mm'}}
            </td>
        </tr>
        ...
        <tr style="text-align: center;">
            ...
            <td valign="bottom">@{{ item.obj[32116186] ? item.obj[32116186] :
    ...
    <table width="100%">
        ...
        <tr>
            <td>1. <b>WAJIB</b> diisi dan dilengkap sebagai dasar penjaminan klaim BPJS
                Kesehatan</td>


        </tr>
        <tr>
            <td>2. Lembar kedua <b>WAJIB</b> diserahkan ke tempat pendaftaran pasien
                rawat jalan untuk didaftarkan pada kunjungan berikutnya</td>

...
<body>
    ...
    <div class="<?php print ($no == 1 or $no == 4 or $no == 7 or $no == 10) ? 'upage' : 'upageany';?>">
        <table>
            ...
            <tr>
                <td colspan="2" style="text-align: center; font-size:6pt;">sebelum/sesudah makan</td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: center; font-size:6pt;"><b>KOCOK DAHULU</b></td>
            </tr>
        </table>
    </div>
    @endforeach 

...
<head>
    ...
    <title>Surat Keterangan Sementara Berobat</title>
...
<body ng-controller="cetakSuketSementaraBerobat">
    <table width="100%" style="table-layout:fixed;border:none">
        ...
        <tr>
            <td style="border:none" colspan="9">Kami yang bertanda tangan dibawah ini Dokter Rumah Sakit Umum Daerah H. A. Sulthan Dg. Radja Bulukumba menerangkan bahwa:</td>
        </tr>
        <tr>
            <td style="border:none"></td>
            <td style="border:none">Nama</td>
            <td colspan="7" style="border:none">: @{{ item.obj[32116797] ? item.obj[32116797] : '..................................................' }}</td>
        </tr>
        <tr>
            <td style="border:none"></td>
            <td style="border:none">Umur</td>
            <td colspan="7" style="border:none">: @{{ item.obj[32116798] ? item.obj[32116798] : '..................................................' }}</td>
        </tr>
        <tr>
            <td style="border:none"></td>
            <td style="border:none">Pekerjaan</td>
            <td colspan="7" style="border:none">: @{{ item.obj[32116799] ? item.obj[32116799] : '..................................................' }}</td>
        </tr>
        <tr>
            <td style="border:none"></td>
            <td style="border:none">Alamat</td>
            <td colspan="7" style="border:none">: @{{ item.obj[32116800] ? item.obj[32116800] : '..................................................' }}</td>
        </tr>
        <tr>
            <td colspan="9" style="border:none;text-align: justify;line-height: 20pt;">Adalah benar sakit <b>SEMENTARA BEROBAT</b> pada Rumah Sakit Umum Daerah H. A. Sulthan Dg. Radja Bulukumba pada tanggal @{{item.obj[32116801] | toDate | date:'dd MMMM yyyy'}}, 
                maka diberikan kepadanya istirahat selama @{{ item.obj[32116802] ? item.obj[32116802] : '...' }}, 
                sejak tanggal @{{item.obj[32116803] | toDate | date:'dd MMMM yyyy'}} s/d @{{item.obj[32116804] | toDate | date:'dd MMMM yyyy'}}</td>
        </tr>
        <tr>
        ...
        <tr style="text-align: center;">
            ...
            <td style="border:none"></td>
            <td colspan="4" style="border:none">Bulukumba, @{{item.obj[32116805] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
        </tr>
        <tr style="text-align: center;">
            <td colspan="4" style="border:none"></td>
            <td style="border:none"></td>
        ...
        <tr style="text-align: center;">
            <td colspan="4" valign="bottom" style="border:none"></td>
            <td style="border:none"></td>
            <td colspan="4" valign="bottom" style="border:none">@{{ item.obj[32116806] ? item.obj[32116806] : '__________________________________________' }}</td>
        </tr>
...
<script type="text/javascript">
    ...
    angular.controller('cetakSuketSementaraBerobat', function ($scope, $http, httpService) {
        $scope.item = {
            obj: [],
            obj2: []
        }
        ...
        var petugas1 = $scope.item.obj[32116806];

        ...
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                <tr style="height:150px">
                    <td>@{{item.obj[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423055] ? item.obj[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423058]!=undefined">
                    <td>@{{item.obj[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423063] ? item.obj[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423066]!=undefined">
                    <td>@{{item.obj[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423071] ? item.obj[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423074]!=undefined">
                    <td>@{{item.obj[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423079] ? item.obj[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423082]!=undefined">
                    <td>@{{item.obj[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423087] ? item.obj[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423090]!=undefined">
                    <td>@{{item.obj[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423095] ? item.obj[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423098]!=undefined">
                    <td>@{{item.obj[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423103] ? item.obj[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423106]!=undefined">
                    <td>@{{item.obj[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423111] ? item.obj[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423114]!=undefined">
                    <td>@{{item.obj[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423119] ? item.obj[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423122]!=undefined">
                    <td>@{{item.obj[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423127] ? item.obj[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423130]!=undefined">
                    <td>@{{item.obj[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423135] ? item.obj[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423138]!=undefined">
                    <td>@{{item.obj[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423143] ? item.obj[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423146]!=undefined">
                    <td>@{{item.obj[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423151] ? item.obj[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423154]!=undefined">
                    <td>@{{item.obj[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423159] ? item.obj[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423162]!=undefined">
                    <td>@{{item.obj[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423167] ? item.obj[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423170]!=undefined">
                    <td>@{{item.obj[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423175] ? item.obj[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423178]!=undefined">
                    <td>@{{item.obj[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423183] ? item.obj[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423186]!=undefined">
                    <td>@{{item.obj[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423191] ? item.obj[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423194]!=undefined">
                    <td>@{{item.obj[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423199] ? item.obj[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423202]!=undefined">
                    <td>@{{item.obj[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423207] ? item.obj[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obj[423210]!=undefined">
                    <td>@{{item.obj[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obj[423215] ? item.obj[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obj[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d2']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji2[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423055] ? item.obji2[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423058]!=undefined">
                    <td>@{{item.obji2[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423063] ? item.obji2[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423066]!=undefined">
                    <td>@{{item.obji2[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423071] ? item.obji2[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423074]!=undefined">
                    <td>@{{item.obji2[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423079] ? item.obji2[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423082]!=undefined">
                    <td>@{{item.obji2[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423087] ? item.obji2[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423090]!=undefined">
                    <td>@{{item.obji2[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423095] ? item.obji2[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423098]!=undefined">
                    <td>@{{item.obji2[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423103] ? item.obji2[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423106]!=undefined">
                    <td>@{{item.obji2[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423111] ? item.obji2[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423114]!=undefined">
                    <td>@{{item.obji2[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423119] ? item.obji2[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423122]!=undefined">
                    <td>@{{item.obji2[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423127] ? item.obji2[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423130]!=undefined">
                    <td>@{{item.obji2[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423135] ? item.obji2[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423138]!=undefined">
                    <td>@{{item.obji2[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423143] ? item.obji2[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423146]!=undefined">
                    <td>@{{item.obji2[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423151] ? item.obji2[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423154]!=undefined">
                    <td>@{{item.obji2[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423159] ? item.obji2[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423162]!=undefined">
                    <td>@{{item.obji2[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423167] ? item.obji2[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423170]!=undefined">
                    <td>@{{item.obji2[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423175] ? item.obji2[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423178]!=undefined">
                    <td>@{{item.obji2[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423183] ? item.obji2[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423186]!=undefined">
                    <td>@{{item.obji2[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423191] ? item.obji2[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423194]!=undefined">
                    <td>@{{item.obji2[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423199] ? item.obji2[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423202]!=undefined">
                    <td>@{{item.obji2[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423207] ? item.obji2[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji2[423210]!=undefined">
                    <td>@{{item.obji2[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji2[423215] ? item.obji2[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji2[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d3']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji3[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423055] ? item.obji3[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423058]!=undefined">
                    <td>@{{item.obji3[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423063] ? item.obji3[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423066]!=undefined">
                    <td>@{{item.obji3[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423071] ? item.obji3[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423074]!=undefined">
                    <td>@{{item.obji3[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423079] ? item.obji3[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423082]!=undefined">
                    <td>@{{item.obji3[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423087] ? item.obji3[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423090]!=undefined">
                    <td>@{{item.obji3[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423095] ? item.obji3[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423098]!=undefined">
                    <td>@{{item.obji3[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423103] ? item.obji3[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423106]!=undefined">
                    <td>@{{item.obji3[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423111] ? item.obji3[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423114]!=undefined">
                    <td>@{{item.obji3[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423119] ? item.obji3[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423122]!=undefined">
                    <td>@{{item.obji3[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423127] ? item.obji3[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423130]!=undefined">
                    <td>@{{item.obji3[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423135] ? item.obji3[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423138]!=undefined">
                    <td>@{{item.obji3[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423143] ? item.obji3[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423146]!=undefined">
                    <td>@{{item.obji3[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423151] ? item.obji3[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423154]!=undefined">
                    <td>@{{item.obji3[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423159] ? item.obji3[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423162]!=undefined">
                    <td>@{{item.obji3[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423167] ? item.obji3[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423170]!=undefined">
                    <td>@{{item.obji3[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423175] ? item.obji3[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423178]!=undefined">
                    <td>@{{item.obji3[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423183] ? item.obji3[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423186]!=undefined">
                    <td>@{{item.obji3[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423191] ? item.obji3[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423194]!=undefined">
                    <td>@{{item.obji3[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423199] ? item.obji3[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423202]!=undefined">
                    <td>@{{item.obji3[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423207] ? item.obji3[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji3[423210]!=undefined">
                    <td>@{{item.obji3[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji3[423215] ? item.obji3[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji3[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d4']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji4[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423055] ? item.obji4[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423058]!=undefined">
                    <td>@{{item.obji4[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423063] ? item.obji4[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423066]!=undefined">
                    <td>@{{item.obji4[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423071] ? item.obji4[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423074]!=undefined">
                    <td>@{{item.obji4[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423079] ? item.obji4[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423082]!=undefined">
                    <td>@{{item.obji4[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423087] ? item.obji4[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423090]!=undefined">
                    <td>@{{item.obji4[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423095] ? item.obji4[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423098]!=undefined">
                    <td>@{{item.obji4[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423103] ? item.obji4[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423106]!=undefined">
                    <td>@{{item.obji4[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423111] ? item.obji4[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423114]!=undefined">
                    <td>@{{item.obji4[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423119] ? item.obji4[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423122]!=undefined">
                    <td>@{{item.obji4[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423127] ? item.obji4[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423130]!=undefined">
                    <td>@{{item.obji4[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423135] ? item.obji4[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423138]!=undefined">
                    <td>@{{item.obji4[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423143] ? item.obji4[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423146]!=undefined">
                    <td>@{{item.obji4[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423151] ? item.obji4[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423154]!=undefined">
                    <td>@{{item.obji4[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423159] ? item.obji4[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423162]!=undefined">
                    <td>@{{item.obji4[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423167] ? item.obji4[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423170]!=undefined">
                    <td>@{{item.obji4[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423175] ? item.obji4[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423178]!=undefined">
                    <td>@{{item.obji4[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423183] ? item.obji4[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423186]!=undefined">
                    <td>@{{item.obji4[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423191] ? item.obji4[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423194]!=undefined">
                    <td>@{{item.obji4[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423199] ? item.obji4[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423202]!=undefined">
                    <td>@{{item.obji4[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423207] ? item.obji4[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji4[423210]!=undefined">
                    <td>@{{item.obji4[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji4[423215] ? item.obji4[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji4[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d5']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji5[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423055] ? item.obji5[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423058]!=undefined">
                    <td>@{{item.obji5[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423063] ? item.obji5[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423066]!=undefined">
                    <td>@{{item.obji5[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423071] ? item.obji5[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423074]!=undefined">
                    <td>@{{item.obji5[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423079] ? item.obji5[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423082]!=undefined">
                    <td>@{{item.obji5[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423087] ? item.obji5[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423090]!=undefined">
                    <td>@{{item.obji5[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423095] ? item.obji5[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423098]!=undefined">
                    <td>@{{item.obji5[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423103] ? item.obji5[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423106]!=undefined">
                    <td>@{{item.obji5[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423111] ? item.obji5[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423114]!=undefined">
                    <td>@{{item.obji5[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423119] ? item.obji5[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423122]!=undefined">
                    <td>@{{item.obji5[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423127] ? item.obji5[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423130]!=undefined">
                    <td>@{{item.obji5[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423135] ? item.obji5[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423138]!=undefined">
                    <td>@{{item.obji5[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423143] ? item.obji5[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423146]!=undefined">
                    <td>@{{item.obji5[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423151] ? item.obji5[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423154]!=undefined">
                    <td>@{{item.obji5[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423159] ? item.obji5[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423162]!=undefined">
                    <td>@{{item.obji5[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423167] ? item.obji5[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423170]!=undefined">
                    <td>@{{item.obji5[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423175] ? item.obji5[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423178]!=undefined">
                    <td>@{{item.obji5[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423183] ? item.obji5[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423186]!=undefined">
                    <td>@{{item.obji5[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423191] ? item.obji5[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423194]!=undefined">
                    <td>@{{item.obji5[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423199] ? item.obji5[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423202]!=undefined">
                    <td>@{{item.obji5[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423207] ? item.obji5[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji5[423210]!=undefined">
                    <td>@{{item.obji5[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji5[423215] ? item.obji5[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji5[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d6']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji6[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423055] ? item.obji6[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423058]!=undefined">
                    <td>@{{item.obji6[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423063] ? item.obji6[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423066]!=undefined">
                    <td>@{{item.obji6[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423071] ? item.obji6[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423074]!=undefined">
                    <td>@{{item.obji6[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423079] ? item.obji6[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423082]!=undefined">
                    <td>@{{item.obji6[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423087] ? item.obji6[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423090]!=undefined">
                    <td>@{{item.obji6[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423095] ? item.obji6[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423098]!=undefined">
                    <td>@{{item.obji6[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423103] ? item.obji6[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423106]!=undefined">
                    <td>@{{item.obji6[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423111] ? item.obji6[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423114]!=undefined">
                    <td>@{{item.obji6[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423119] ? item.obji6[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423122]!=undefined">
                    <td>@{{item.obji6[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423127] ? item.obji6[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423130]!=undefined">
                    <td>@{{item.obji6[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423135] ? item.obji6[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423138]!=undefined">
                    <td>@{{item.obji6[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423143] ? item.obji6[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423146]!=undefined">
                    <td>@{{item.obji6[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423151] ? item.obji6[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423154]!=undefined">
                    <td>@{{item.obji6[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423159] ? item.obji6[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423162]!=undefined">
                    <td>@{{item.obji6[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423167] ? item.obji6[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423170]!=undefined">
                    <td>@{{item.obji6[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423175] ? item.obji6[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423178]!=undefined">
                    <td>@{{item.obji6[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423183] ? item.obji6[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423186]!=undefined">
                    <td>@{{item.obji6[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423191] ? item.obji6[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423194]!=undefined">
                    <td>@{{item.obji6[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423199] ? item.obji6[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423202]!=undefined">
                    <td>@{{item.obji6[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423207] ? item.obji6[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji6[423210]!=undefined">
                    <td>@{{item.obji6[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji6[423215] ? item.obji6[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji6[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d7']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji7[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423055] ? item.obji7[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423058]!=undefined">
                    <td>@{{item.obji7[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423063] ? item.obji7[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423066]!=undefined">
                    <td>@{{item.obji7[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423071] ? item.obji7[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423074]!=undefined">
                    <td>@{{item.obji7[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423079] ? item.obji7[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423082]!=undefined">
                    <td>@{{item.obji7[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423087] ? item.obji7[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423090]!=undefined">
                    <td>@{{item.obji7[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423095] ? item.obji7[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423098]!=undefined">
                    <td>@{{item.obji7[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423103] ? item.obji7[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423106]!=undefined">
                    <td>@{{item.obji7[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423111] ? item.obji7[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423114]!=undefined">
                    <td>@{{item.obji7[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423119] ? item.obji7[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423122]!=undefined">
                    <td>@{{item.obji7[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423127] ? item.obji7[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423130]!=undefined">
                    <td>@{{item.obji7[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423135] ? item.obji7[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423138]!=undefined">
                    <td>@{{item.obji7[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423143] ? item.obji7[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423146]!=undefined">
                    <td>@{{item.obji7[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423151] ? item.obji7[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423154]!=undefined">
                    <td>@{{item.obji7[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423159] ? item.obji7[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423162]!=undefined">
                    <td>@{{item.obji7[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423167] ? item.obji7[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423170]!=undefined">
                    <td>@{{item.obji7[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423175] ? item.obji7[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423178]!=undefined">
                    <td>@{{item.obji7[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423183] ? item.obji7[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423186]!=undefined">
                    <td>@{{item.obji7[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423191] ? item.obji7[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423194]!=undefined">
                    <td>@{{item.obji7[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423199] ? item.obji7[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423202]!=undefined">
                    <td>@{{item.obji7[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423207] ? item.obji7[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji7[423210]!=undefined">
                    <td>@{{item.obji7[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji7[423215] ? item.obji7[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji7[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d8']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji8[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423055] ? item.obji8[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423058]!=undefined">
                    <td>@{{item.obji8[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423063] ? item.obji8[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423066]!=undefined">
                    <td>@{{item.obji8[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423071] ? item.obji8[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423074]!=undefined">
                    <td>@{{item.obji8[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423079] ? item.obji8[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423082]!=undefined">
                    <td>@{{item.obji8[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423087] ? item.obji8[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423090]!=undefined">
                    <td>@{{item.obji8[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423095] ? item.obji8[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423098]!=undefined">
                    <td>@{{item.obji8[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423103] ? item.obji8[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423106]!=undefined">
                    <td>@{{item.obji8[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423111] ? item.obji8[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423114]!=undefined">
                    <td>@{{item.obji8[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423119] ? item.obji8[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423122]!=undefined">
                    <td>@{{item.obji8[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423127] ? item.obji8[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423130]!=undefined">
                    <td>@{{item.obji8[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423135] ? item.obji8[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423138]!=undefined">
                    <td>@{{item.obji8[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423143] ? item.obji8[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423146]!=undefined">
                    <td>@{{item.obji8[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423151] ? item.obji8[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423154]!=undefined">
                    <td>@{{item.obji8[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423159] ? item.obji8[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423162]!=undefined">
                    <td>@{{item.obji8[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423167] ? item.obji8[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423170]!=undefined">
                    <td>@{{item.obji8[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423175] ? item.obji8[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423178]!=undefined">
                    <td>@{{item.obji8[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423183] ? item.obji8[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423186]!=undefined">
                    <td>@{{item.obji8[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423191] ? item.obji8[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423194]!=undefined">
                    <td>@{{item.obji8[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423199] ? item.obji8[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423202]!=undefined">
                    <td>@{{item.obji8[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423207] ? item.obji8[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji8[423210]!=undefined">
                    <td>@{{item.obji8[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji8[423215] ? item.obji8[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji8[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d9']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji9[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423055] ? item.obji9[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423058]!=undefined">
                    <td>@{{item.obji9[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423063] ? item.obji9[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423066]!=undefined">
                    <td>@{{item.obji9[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423071] ? item.obji9[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423074]!=undefined">
                    <td>@{{item.obji9[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423079] ? item.obji9[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423082]!=undefined">
                    <td>@{{item.obji9[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423087] ? item.obji9[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423090]!=undefined">
                    <td>@{{item.obji9[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423095] ? item.obji9[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423098]!=undefined">
                    <td>@{{item.obji9[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423103] ? item.obji9[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423106]!=undefined">
                    <td>@{{item.obji9[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423111] ? item.obji9[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423114]!=undefined">
                    <td>@{{item.obji9[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423119] ? item.obji9[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423122]!=undefined">
                    <td>@{{item.obji9[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423127] ? item.obji9[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423130]!=undefined">
                    <td>@{{item.obji9[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423135] ? item.obji9[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423138]!=undefined">
                    <td>@{{item.obji9[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423143] ? item.obji9[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423146]!=undefined">
                    <td>@{{item.obji9[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423151] ? item.obji9[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423154]!=undefined">
                    <td>@{{item.obji9[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423159] ? item.obji9[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423162]!=undefined">
                    <td>@{{item.obji9[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423167] ? item.obji9[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423170]!=undefined">
                    <td>@{{item.obji9[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423175] ? item.obji9[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423178]!=undefined">
                    <td>@{{item.obji9[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423183] ? item.obji9[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423186]!=undefined">
                    <td>@{{item.obji9[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423191] ? item.obji9[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423194]!=undefined">
                    <td>@{{item.obji9[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423199] ? item.obji9[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423202]!=undefined">
                    <td>@{{item.obji9[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423207] ? item.obji9[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji9[423210]!=undefined">
                    <td>@{{item.obji9[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji9[423215] ? item.obji9[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji9[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d10']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji10[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423055] ? item.obji10[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423058]!=undefined">
                    <td>@{{item.obji10[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423063] ? item.obji10[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423066]!=undefined">
                    <td>@{{item.obji10[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423071] ? item.obji10[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423074]!=undefined">
                    <td>@{{item.obji10[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423079] ? item.obji10[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423082]!=undefined">
                    <td>@{{item.obji10[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423087] ? item.obji10[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423090]!=undefined">
                    <td>@{{item.obji10[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423095] ? item.obji10[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423098]!=undefined">
                    <td>@{{item.obji10[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423103] ? item.obji10[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423106]!=undefined">
                    <td>@{{item.obji10[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423111] ? item.obji10[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423114]!=undefined">
                    <td>@{{item.obji10[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423119] ? item.obji10[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423122]!=undefined">
                    <td>@{{item.obji10[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423127] ? item.obji10[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423130]!=undefined">
                    <td>@{{item.obji10[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423135] ? item.obji10[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423138]!=undefined">
                    <td>@{{item.obji10[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423143] ? item.obji10[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423146]!=undefined">
                    <td>@{{item.obji10[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423151] ? item.obji10[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423154]!=undefined">
                    <td>@{{item.obji10[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423159] ? item.obji10[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423162]!=undefined">
                    <td>@{{item.obji10[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423167] ? item.obji10[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423170]!=undefined">
                    <td>@{{item.obji10[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423175] ? item.obji10[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423178]!=undefined">
                    <td>@{{item.obji10[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423183] ? item.obji10[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423186]!=undefined">
                    <td>@{{item.obji10[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423191] ? item.obji10[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423194]!=undefined">
                    <td>@{{item.obji10[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423199] ? item.obji10[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423202]!=undefined">
                    <td>@{{item.obji10[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423207] ? item.obji10[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji10[423210]!=undefined">
                    <td>@{{item.obji10[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji10[423215] ? item.obji10[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji10[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d11']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji11[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423055] ? item.obji11[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423058]!=undefined">
                    <td>@{{item.obji11[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423063] ? item.obji11[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423066]!=undefined">
                    <td>@{{item.obji11[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423071] ? item.obji11[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423074]!=undefined">
                    <td>@{{item.obji11[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423079] ? item.obji11[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423082]!=undefined">
                    <td>@{{item.obji11[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423087] ? item.obji11[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423090]!=undefined">
                    <td>@{{item.obji11[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423095] ? item.obji11[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423098]!=undefined">
                    <td>@{{item.obji11[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423103] ? item.obji11[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423106]!=undefined">
                    <td>@{{item.obji11[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423111] ? item.obji11[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423114]!=undefined">
                    <td>@{{item.obji11[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423119] ? item.obji11[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423122]!=undefined">
                    <td>@{{item.obji11[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423127] ? item.obji11[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423130]!=undefined">
                    <td>@{{item.obji11[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423135] ? item.obji11[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423138]!=undefined">
                    <td>@{{item.obji11[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423143] ? item.obji11[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423146]!=undefined">
                    <td>@{{item.obji11[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423151] ? item.obji11[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423154]!=undefined">
                    <td>@{{item.obji11[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423159] ? item.obji11[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423162]!=undefined">
                    <td>@{{item.obji11[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423167] ? item.obji11[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423170]!=undefined">
                    <td>@{{item.obji11[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423175] ? item.obji11[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423178]!=undefined">
                    <td>@{{item.obji11[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423183] ? item.obji11[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423186]!=undefined">
                    <td>@{{item.obji11[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423191] ? item.obji11[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423194]!=undefined">
                    <td>@{{item.obji11[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423199] ? item.obji11[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423202]!=undefined">
                    <td>@{{item.obji11[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423207] ? item.obji11[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji11[423210]!=undefined">
                    <td>@{{item.obji11[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji11[423215] ? item.obji11[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji11[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d12']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji12[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423055] ? item.obji12[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423058]!=undefined">
                    <td>@{{item.obji12[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423063] ? item.obji12[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423066]!=undefined">
                    <td>@{{item.obji12[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423071] ? item.obji12[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423074]!=undefined">
                    <td>@{{item.obji12[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423079] ? item.obji12[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423082]!=undefined">
                    <td>@{{item.obji12[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423087] ? item.obji12[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423090]!=undefined">
                    <td>@{{item.obji12[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423095] ? item.obji12[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423098]!=undefined">
                    <td>@{{item.obji12[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423103] ? item.obji12[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423106]!=undefined">
                    <td>@{{item.obji12[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423111] ? item.obji12[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423114]!=undefined">
                    <td>@{{item.obji12[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423119] ? item.obji12[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423122]!=undefined">
                    <td>@{{item.obji12[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423127] ? item.obji12[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423130]!=undefined">
                    <td>@{{item.obji12[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423135] ? item.obji12[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423138]!=undefined">
                    <td>@{{item.obji12[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423143] ? item.obji12[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423146]!=undefined">
                    <td>@{{item.obji12[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423151] ? item.obji12[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423154]!=undefined">
                    <td>@{{item.obji12[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423159] ? item.obji12[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423162]!=undefined">
                    <td>@{{item.obji12[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423167] ? item.obji12[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423170]!=undefined">
                    <td>@{{item.obji12[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423175] ? item.obji12[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423178]!=undefined">
                    <td>@{{item.obji12[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423183] ? item.obji12[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423186]!=undefined">
                    <td>@{{item.obji12[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423191] ? item.obji12[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423194]!=undefined">
                    <td>@{{item.obji12[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423199] ? item.obji12[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423202]!=undefined">
                    <td>@{{item.obji12[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423207] ? item.obji12[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji12[423210]!=undefined">
                    <td>@{{item.obji12[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji12[423215] ? item.obji12[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji12[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d13']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji13[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423055] ? item.obji13[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423058]!=undefined">
                    <td>@{{item.obji13[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423063] ? item.obji13[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423066]!=undefined">
                    <td>@{{item.obji13[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423071] ? item.obji13[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423074]!=undefined">
                    <td>@{{item.obji13[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423079] ? item.obji13[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423082]!=undefined">
                    <td>@{{item.obji13[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423087] ? item.obji13[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423090]!=undefined">
                    <td>@{{item.obji13[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423095] ? item.obji13[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423098]!=undefined">
                    <td>@{{item.obji13[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423103] ? item.obji13[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423106]!=undefined">
                    <td>@{{item.obji13[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423111] ? item.obji13[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423114]!=undefined">
                    <td>@{{item.obji13[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423119] ? item.obji13[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423122]!=undefined">
                    <td>@{{item.obji13[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423127] ? item.obji13[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423130]!=undefined">
                    <td>@{{item.obji13[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423135] ? item.obji13[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423138]!=undefined">
                    <td>@{{item.obji13[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423143] ? item.obji13[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423146]!=undefined">
                    <td>@{{item.obji13[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423151] ? item.obji13[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423154]!=undefined">
                    <td>@{{item.obji13[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423159] ? item.obji13[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423162]!=undefined">
                    <td>@{{item.obji13[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423167] ? item.obji13[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423170]!=undefined">
                    <td>@{{item.obji13[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423175] ? item.obji13[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423178]!=undefined">
                    <td>@{{item.obji13[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423183] ? item.obji13[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423186]!=undefined">
                    <td>@{{item.obji13[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423191] ? item.obji13[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423194]!=undefined">
                    <td>@{{item.obji13[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423199] ? item.obji13[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423202]!=undefined">
                    <td>@{{item.obji13[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423207] ? item.obji13[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji13[423210]!=undefined">
                    <td>@{{item.obji13[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji13[423215] ? item.obji13[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji13[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d14']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji14[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423055] ? item.obji14[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423058]!=undefined">
                    <td>@{{item.obji14[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423063] ? item.obji14[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423066]!=undefined">
                    <td>@{{item.obji14[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423071] ? item.obji14[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423074]!=undefined">
                    <td>@{{item.obji14[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423079] ? item.obji14[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423082]!=undefined">
                    <td>@{{item.obji14[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423087] ? item.obji14[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423090]!=undefined">
                    <td>@{{item.obji14[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423095] ? item.obji14[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423098]!=undefined">
                    <td>@{{item.obji14[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423103] ? item.obji14[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423106]!=undefined">
                    <td>@{{item.obji14[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423111] ? item.obji14[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423114]!=undefined">
                    <td>@{{item.obji14[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423119] ? item.obji14[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423122]!=undefined">
                    <td>@{{item.obji14[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423127] ? item.obji14[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423130]!=undefined">
                    <td>@{{item.obji14[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423135] ? item.obji14[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423138]!=undefined">
                    <td>@{{item.obji14[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423143] ? item.obji14[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423146]!=undefined">
                    <td>@{{item.obji14[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423151] ? item.obji14[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423154]!=undefined">
                    <td>@{{item.obji14[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423159] ? item.obji14[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423162]!=undefined">
                    <td>@{{item.obji14[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423167] ? item.obji14[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423170]!=undefined">
                    <td>@{{item.obji14[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423175] ? item.obji14[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423178]!=undefined">
                    <td>@{{item.obji14[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423183] ? item.obji14[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423186]!=undefined">
                    <td>@{{item.obji14[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423191] ? item.obji14[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423194]!=undefined">
                    <td>@{{item.obji14[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423199] ? item.obji14[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423202]!=undefined">
                    <td>@{{item.obji14[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423207] ? item.obji14[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji14[423210]!=undefined">
                    <td>@{{item.obji14[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji14[423215] ? item.obji14[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji14[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d15']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji15[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423055] ? item.obji15[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423058]!=undefined">
                    <td>@{{item.obji15[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423063] ? item.obji15[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423066]!=undefined">
                    <td>@{{item.obji15[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423071] ? item.obji15[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423074]!=undefined">
                    <td>@{{item.obji15[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423079] ? item.obji15[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423082]!=undefined">
                    <td>@{{item.obji15[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423087] ? item.obji15[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423090]!=undefined">
                    <td>@{{item.obji15[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423095] ? item.obji15[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423098]!=undefined">
                    <td>@{{item.obji15[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423103] ? item.obji15[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423106]!=undefined">
                    <td>@{{item.obji15[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423111] ? item.obji15[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423114]!=undefined">
                    <td>@{{item.obji15[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423119] ? item.obji15[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423122]!=undefined">
                    <td>@{{item.obji15[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423127] ? item.obji15[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423130]!=undefined">
                    <td>@{{item.obji15[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423135] ? item.obji15[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423138]!=undefined">
                    <td>@{{item.obji15[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423143] ? item.obji15[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423146]!=undefined">
                    <td>@{{item.obji15[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423151] ? item.obji15[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423154]!=undefined">
                    <td>@{{item.obji15[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423159] ? item.obji15[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423162]!=undefined">
                    <td>@{{item.obji15[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423167] ? item.obji15[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423170]!=undefined">
                    <td>@{{item.obji15[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423175] ? item.obji15[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423178]!=undefined">
                    <td>@{{item.obji15[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423183] ? item.obji15[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423186]!=undefined">
                    <td>@{{item.obji15[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423191] ? item.obji15[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423194]!=undefined">
                    <td>@{{item.obji15[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423199] ? item.obji15[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423202]!=undefined">
                    <td>@{{item.obji15[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423207] ? item.obji15[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji15[423210]!=undefined">
                    <td>@{{item.obji15[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji15[423215] ? item.obji15[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji15[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d16']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji16[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423055] ? item.obji16[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423058]!=undefined">
                    <td>@{{item.obji16[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423063] ? item.obji16[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423066]!=undefined">
                    <td>@{{item.obji16[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423071] ? item.obji16[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423074]!=undefined">
                    <td>@{{item.obji16[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423079] ? item.obji16[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423082]!=undefined">
                    <td>@{{item.obji16[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423087] ? item.obji16[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423090]!=undefined">
                    <td>@{{item.obji16[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423095] ? item.obji16[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423098]!=undefined">
                    <td>@{{item.obji16[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423103] ? item.obji16[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423106]!=undefined">
                    <td>@{{item.obji16[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423111] ? item.obji16[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423114]!=undefined">
                    <td>@{{item.obji16[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423119] ? item.obji16[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423122]!=undefined">
                    <td>@{{item.obji16[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423127] ? item.obji16[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423130]!=undefined">
                    <td>@{{item.obji16[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423135] ? item.obji16[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423138]!=undefined">
                    <td>@{{item.obji16[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423143] ? item.obji16[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423146]!=undefined">
                    <td>@{{item.obji16[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423151] ? item.obji16[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423154]!=undefined">
                    <td>@{{item.obji16[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423159] ? item.obji16[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423162]!=undefined">
                    <td>@{{item.obji16[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423167] ? item.obji16[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423170]!=undefined">
                    <td>@{{item.obji16[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423175] ? item.obji16[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423178]!=undefined">
                    <td>@{{item.obji16[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423183] ? item.obji16[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423186]!=undefined">
                    <td>@{{item.obji16[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423191] ? item.obji16[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423194]!=undefined">
                    <td>@{{item.obji16[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423199] ? item.obji16[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423202]!=undefined">
                    <td>@{{item.obji16[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423207] ? item.obji16[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji16[423210]!=undefined">
                    <td>@{{item.obji16[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji16[423215] ? item.obji16[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji16[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d17']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji17[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423055] ? item.obji17[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423058]!=undefined">
                    <td>@{{item.obji17[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423063] ? item.obji17[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423066]!=undefined">
                    <td>@{{item.obji17[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423071] ? item.obji17[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423074]!=undefined">
                    <td>@{{item.obji17[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423079] ? item.obji17[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423082]!=undefined">
                    <td>@{{item.obji17[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423087] ? item.obji17[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423090]!=undefined">
                    <td>@{{item.obji17[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423095] ? item.obji17[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423098]!=undefined">
                    <td>@{{item.obji17[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423103] ? item.obji17[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423106]!=undefined">
                    <td>@{{item.obji17[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423111] ? item.obji17[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423114]!=undefined">
                    <td>@{{item.obji17[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423119] ? item.obji17[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423122]!=undefined">
                    <td>@{{item.obji17[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423127] ? item.obji17[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423130]!=undefined">
                    <td>@{{item.obji17[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423135] ? item.obji17[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423138]!=undefined">
                    <td>@{{item.obji17[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423143] ? item.obji17[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423146]!=undefined">
                    <td>@{{item.obji17[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423151] ? item.obji17[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423154]!=undefined">
                    <td>@{{item.obji17[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423159] ? item.obji17[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423162]!=undefined">
                    <td>@{{item.obji17[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423167] ? item.obji17[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423170]!=undefined">
                    <td>@{{item.obji17[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423175] ? item.obji17[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423178]!=undefined">
                    <td>@{{item.obji17[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423183] ? item.obji17[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423186]!=undefined">
                    <td>@{{item.obji17[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423191] ? item.obji17[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423194]!=undefined">
                    <td>@{{item.obji17[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423199] ? item.obji17[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423202]!=undefined">
                    <td>@{{item.obji17[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423207] ? item.obji17[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji17[423210]!=undefined">
                    <td>@{{item.obji17[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji17[423215] ? item.obji17[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji17[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d18']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji18[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423055] ? item.obji18[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423058]!=undefined">
                    <td>@{{item.obji18[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423063] ? item.obji18[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423066]!=undefined">
                    <td>@{{item.obji18[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423071] ? item.obji18[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423074]!=undefined">
                    <td>@{{item.obji18[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423079] ? item.obji18[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423082]!=undefined">
                    <td>@{{item.obji18[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423087] ? item.obji18[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423090]!=undefined">
                    <td>@{{item.obji18[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423095] ? item.obji18[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423098]!=undefined">
                    <td>@{{item.obji18[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423103] ? item.obji18[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423106]!=undefined">
                    <td>@{{item.obji18[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423111] ? item.obji18[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423114]!=undefined">
                    <td>@{{item.obji18[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423119] ? item.obji18[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423122]!=undefined">
                    <td>@{{item.obji18[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423127] ? item.obji18[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423130]!=undefined">
                    <td>@{{item.obji18[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423135] ? item.obji18[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423138]!=undefined">
                    <td>@{{item.obji18[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423143] ? item.obji18[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423146]!=undefined">
                    <td>@{{item.obji18[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423151] ? item.obji18[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423154]!=undefined">
                    <td>@{{item.obji18[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423159] ? item.obji18[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423162]!=undefined">
                    <td>@{{item.obji18[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423167] ? item.obji18[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423170]!=undefined">
                    <td>@{{item.obji18[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423175] ? item.obji18[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423178]!=undefined">
                    <td>@{{item.obji18[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423183] ? item.obji18[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423186]!=undefined">
                    <td>@{{item.obji18[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423191] ? item.obji18[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423194]!=undefined">
                    <td>@{{item.obji18[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423199] ? item.obji18[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423202]!=undefined">
                    <td>@{{item.obji18[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423207] ? item.obji18[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji18[423210]!=undefined">
                    <td>@{{item.obji18[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji18[423215] ? item.obji18[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji18[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d19']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji19[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423055] ? item.obji19[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423058]!=undefined">
                    <td>@{{item.obji19[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423063] ? item.obji19[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423066]!=undefined">
                    <td>@{{item.obji19[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423071] ? item.obji19[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423074]!=undefined">
                    <td>@{{item.obji19[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423079] ? item.obji19[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423082]!=undefined">
                    <td>@{{item.obji19[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423087] ? item.obji19[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423090]!=undefined">
                    <td>@{{item.obji19[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423095] ? item.obji19[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423098]!=undefined">
                    <td>@{{item.obji19[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423103] ? item.obji19[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423106]!=undefined">
                    <td>@{{item.obji19[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423111] ? item.obji19[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423114]!=undefined">
                    <td>@{{item.obji19[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423119] ? item.obji19[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423122]!=undefined">
                    <td>@{{item.obji19[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423127] ? item.obji19[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423130]!=undefined">
                    <td>@{{item.obji19[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423135] ? item.obji19[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423138]!=undefined">
                    <td>@{{item.obji19[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423143] ? item.obji19[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423146]!=undefined">
                    <td>@{{item.obji19[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423151] ? item.obji19[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423154]!=undefined">
                    <td>@{{item.obji19[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423159] ? item.obji19[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423162]!=undefined">
                    <td>@{{item.obji19[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423167] ? item.obji19[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423170]!=undefined">
                    <td>@{{item.obji19[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423175] ? item.obji19[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423178]!=undefined">
                    <td>@{{item.obji19[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423183] ? item.obji19[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423186]!=undefined">
                    <td>@{{item.obji19[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423191] ? item.obji19[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423194]!=undefined">
                    <td>@{{item.obji19[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423199] ? item.obji19[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423202]!=undefined">
                    <td>@{{item.obji19[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423207] ? item.obji19[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji19[423210]!=undefined">
                    <td>@{{item.obji19[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji19[423215] ? item.obji19[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji19[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
    ...
    @if (!empty($res['d20']))
        <section>
            <table width="100%" id="content" style="table-layout:fixed">
                ...
                {{-- 1 --}}
                <tr style="height:150px">
                    <td>@{{item.obji20[423050] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423055] ? item.obji20[423055] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423056] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423058]!=undefined">
                    <td>@{{item.obji20[423058] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423063] ? item.obji20[423063] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423064] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423066]!=undefined">
                    <td>@{{item.obji20[423066] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423071] ? item.obji20[423071] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423072] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423074]!=undefined">
                    <td>@{{item.obji20[423074] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423079] ? item.obji20[423079] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423080] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423082]!=undefined">
                    <td>@{{item.obji20[423082] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423087] ? item.obji20[423087] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423088] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423090]!=undefined">
                    <td>@{{item.obji20[423090] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423095] ? item.obji20[423095] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423096] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423098]!=undefined">
                    <td>@{{item.obji20[423098] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423103] ? item.obji20[423103] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423104] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423106]!=undefined">
                    <td>@{{item.obji20[423106] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423111] ? item.obji20[423111] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423112] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423114]!=undefined">
                    <td>@{{item.obji20[423114] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423119] ? item.obji20[423119] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423120] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423122]!=undefined">
                    <td>@{{item.obji20[423122] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423127] ? item.obji20[423127] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423128] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423130]!=undefined">
                    <td>@{{item.obji20[423130] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423135] ? item.obji20[423135] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423136] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423138]!=undefined">
                    <td>@{{item.obji20[423138] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423143] ? item.obji20[423143] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423144] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423146]!=undefined">
                    <td>@{{item.obji20[423146] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423151] ? item.obji20[423151] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423152] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423154]!=undefined">
                    <td>@{{item.obji20[423154] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423159] ? item.obji20[423159] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423160] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423162]!=undefined">
                    <td>@{{item.obji20[423162] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423167] ? item.obji20[423167] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423168] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423170]!=undefined">
                    <td>@{{item.obji20[423170] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423175] ? item.obji20[423175] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423176] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423178]!=undefined">
                    <td>@{{item.obji20[423178] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423183] ? item.obji20[423183] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423184] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423186]!=undefined">
                    <td>@{{item.obji20[423186] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423191] ? item.obji20[423191] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423192] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423194]!=undefined">
                    <td>@{{item.obji20[423194] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423199] ? item.obji20[423199] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423200] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423202]!=undefined">
                    <td>@{{item.obji20[423202] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423207] ? item.obji20[423207] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423208] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 
                ...
                <tr style="height:150px" ng-show="item.obji20[423210]!=undefined">
                    <td>@{{item.obji20[423210] | toDate | date:'MMMM dd yyyy HH:mm'}}</td>
                    ...
                    <td colspan="2">@{{ item.obji20[423215] ? item.obji20[423215] : '' }} <br><br> 
                        Tanggal : @{{item.obji20[423216] | toDate | date:'MMMM dd yyyy HH:mm'}} <br><br> 

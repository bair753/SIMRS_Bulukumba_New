...
@foreach ($res['data'] as $item)
                            ...
                            <table>
                                <tr>
                                    <td style="padding-left: 5px;padding-top:10px;padding-bottom:10px;">
                                        ...
                                        </span><span>{!! date('d-m-Y', strtotime($item->tglorder)) !!}</span>
                                    </td>
                                    <td style="padding-left: 5px;padding-top:10px;padding-bottom:10px;">
                                        <span class="f-s-15">Jam </span><span> : </span><span>{!! date('H:i', strtotime($item->tglorder)) !!}</span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left: 5px;padding-top:10px;padding-bottom:10px;">
                                        <center><span class="f-s-15"><div id="qrcodePengonsul{{ $item->pegawaifk }}{{ $no }}" style="text-align: center"></div></center>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-left: 5px;padding-top:10px;">
                        ...
                        <div>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left: 5px;padding-top:10px;padding-bottom:10px;">
                                        <center><span class="f-s-15"><div id="qrcodeDokterJawab{{ $item->pegawaifk }}{{ $no }}" style="text-align: center"></div></center>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-left: 5px;padding-top:10px;">
    ...
    <script>
        ...
        $('#qrcodePengonsul{{ $item->pegawaifk }}{{ $no }}').qrcode({
            text: 'Tanda Tangan Digital Oleh {{ $item->pengonsul }}' ,
            height: 100,
            width: 100
        });

        $('#qrcodeDokterJawab{{ $item->pegawaifk }}{{ $no }}').qrcode({
            text: 'Tanda Tangan Digital Oleh {{ $item->namalengkap }}',
            height: 100,
            width: 100
        });

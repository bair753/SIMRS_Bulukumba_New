...
<body>
    <table width='100%'>
        <tr height=20 class="noborder">
			...
			<td colspan="3" class="text-center">{{ substr($raw->nocm,0,1) }}</td>
			<td colspan="3" class="text-center">{{ substr($raw->nocm,1,1) }}</td>
			<td colspan="3" class="text-center">{{ substr($raw->nocm,2,1) }}</td>
			<td colspan="3" class="text-center">{{ substr($raw->nocm,3,1) }}</td>
			<td colspan="3" class="text-center">{{ substr($raw->nocm,4,1) }}</td>
			<td colspan="3" class="text-center">{{ substr($raw->nocm,5,1) }}</td>
			<!-- 49 columns  -->
			<!-- 29 columns  -->
			<!-- 68 columns  -->
        </tr>
        <tr class="noborder">
			...
			<td class="noborder" colspan="20">: {{ $raw->namapasien }}</td>
            <td colspan="2" class="noborder"></td>
            <td colspan="2" class="noborder">{!!  $raw->jeniskelamin == 'PEREMPUAN' ? '(P)' : '(L)'  !!}</td>
        </tr>
        <tr class="noborder">
			...
			<td colspan="20" class="noborder p3">: {!! date('d-m-Y',strtotime( $raw->tgllahir  )) !!}</td>
        ...
        <tr>
			...
			<td colspan="14" class="p3 noborder btm" style="font-size:9pt">: {{ $raw->namadokterpengirim }}</td>
			<td colspan="9" class="p3 noborder blf btm">Alamat</td>
			<td colspan="30" class="p3 noborder btm">: {{ $raw->alamatlengkap }}</td>
		</tr>
		<tr>
			<td colspan="15" class="p3 noborder btm">Tgl/Jam Pemeriksaan</td>
			<td colspan="14" class="p3 noborder btm">: {!! date('d-m-Y H:m',strtotime( $raw->tgljawab  )) !!}</td>
			<td colspan="9" class="p3 noborder blf btm" rowspan="2">Status</td>
			<td colspan="10" class="p3 noborder" rowspan="2">: {{ $raw->kelompokpasien }}</td>
		</tr>
		<tr>
		...
		<tr class="text-center">
			<td colspan="44" class="noborder"></td>
			<td colspan="24" class="noborder"><div id="qrcoded1" style="text-align: center"></td>
		</tr>
		<tr class="text-center">
			<td colspan="44" class="noborder"><div id="qrcoded1" style="text-align: center"></td>
			<td colspan="24" class="noborder">({{ $raw->namadokterpemeriksa }})</td>
		</tr>
...
<script>
    var d1 = {!! json_encode($raw->namadokterpemeriksa )!!}

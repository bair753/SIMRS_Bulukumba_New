    ...
    <div class="format">
        <table width='100%'>
            ...
            <tr>
                ...
                <td colspan="35" class="noborder">{{ $item->keteritrosit }}</td>
                <td colspan="5" class="noborder"></td>
            </tr>
            <tr  valign="top">
                <td colspan="5" class="noborder"></td>
                ...
                <td class="noborder" colspan="3">:</td>
                <td colspan="35" class="noborder">{{ $item->ketleukosit }}</td>
                <td colspan="5" class="noborder"></td>
            </tr>
            <tr  valign="top">
                <td colspan="5" class="noborder"></td>
                ...
                <td class="noborder" colspan="3">:</td>
                <td colspan="35" class="noborder">{{ $item->kettrombosit }}</td>
                <td colspan="5" class="noborder"></td>
            </tr>
            <tr  valign="top" style="height:40pt">
                ...
                <td class="noborder" colspan="3">:</td>
                <td colspan="35" class="noborder">{{ $item->kesimpulan }}</td>
                <td colspan="5" class="noborder"></td>
            </tr>

...
<head>
    ...
    <title>Hasil Pemeriksaan Sitologi</title>
...
<body ng-controller="cetakSuketKematian">
    <table width="100%" style="table-layout:fixed;border:none">
        ...
        <tr style="text-align:center">
            <td colspan="9" style="border:none;"><h3>HASIL PEMERIKSAAN SITOLOGI</h3></td>
        </tr>
        ...
        <tr>
            <td colspan="9" style="border:none;;text-align:justify"><b>Anjuran : </b>{{  $raw->anjuran }}</td>
        </tr>
        <tr style="text-align: center;">

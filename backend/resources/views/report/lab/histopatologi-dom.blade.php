...
<body>
    ...
    <table width="100%" style="table-layout:fixed;border:none">
        ...
        <tr style="text-align:center;">
            <td colspan="9" style="border:none;padding-bottom:20px"><h3>HASIL PEMERIKSAAN HISPATOLOGI</h3></td>
        </tr>
        ...
        <tr>
            <td colspan="9" style="border:none;text-align:justify;padding-bottom:15px"><b>Lokasi/Bahan Jaringan : </b>{{  $raw->jaringanasal }}</td>
        </tr>
        
        <tr>
            <td colspan="9" style="border:none;text-align:justify;padding-bottom:15px"><b>Cara Mendapatkan Jaringan : </b>{{  $raw->getjaringan }}</td>
        </tr>
        <tr>

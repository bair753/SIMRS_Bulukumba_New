                    ...
                    <td>
                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <font style="font-size: 11pt" color="#000000">: {!! $cek->dokterpenanggungjawab !!}</font>
                                </td>
                            </tr>
                            <tr>
                                <td>
                ...
                <tr>
                    <td style="padding-top:20px;">
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="text-align:center">
                            ...
                            <tr>
                                <td style="align-items: center">
                                    <font style="font-size: 8pt;font-weight:bold;" color="#000000">{!! $cek->dokterperiksa !!}
                                    </font>
                                </td>
                                <td style="align-items: center">
                                    <font style="font-size: 8pt;font-weight:bold;" color="#000000">{!! $cek->dokterpenanggungjawab !!}
                                    </font>
                                </td>
                            </tr>
                        </table>

...
<head>
    ...
    <title>Surat Jaminan Penunjang Diagnostik</title>
...
<body ng-controller="cetakJaminanPenunjangDiagnostik">
    ...
    <table width="100%" style="border:none">
        ...
        <tr>
            ...
            <td colspan="4">:</td>
            <td colspan="4">@{{ item.obj[32116146] ? item.obj[32116146] : '' }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="4">:</td>
            <td colspan="4">@{{item.obj[32116148] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
        </tr>
        <tr>
            <td colspan="4">Diagnosa Masuk</td>
            <td colspan="4">:</td>
            <td colspan="4">@{{ item.obj[32116149] ? item.obj[32116149] : '' }}</td>
        </tr>
        <tr>
    ...
    <table width="100%" style="table-layout:fixed;border:none">
        ...
        <tr style="text-align: center;">
            ...
            <td colspan="4" style="border:none">Bulukumba, @{{item.obj[32116150] | toDate | date:'dd MMMM yyyy HH:mm'}}</td>
        </tr>
        <tr style="text-align: center;">
            <td colspan="4" style="border:none"></td>
            <td style="border:none"></td>
        ...
        <tr style="text-align: center;">
            <td colspan="4" valign="bottom" style="border:none"></td>
            <td style="border:none"></td>
            <td colspan="4" valign="bottom" style="border:none">@{{ item.obj[32116151] ? item.obj[32116151] : '___________________' }}</td>
        </tr>
...
<script type="text/javascript">
    ...
    angular.controller('cetakJaminanPenunjangDiagnostik', function ($scope, $http, httpService) {
        $scope.item = {
            obj: [],
            obj2: []
        }
        ...
        var petugas2 = $scope.item.obj[32116151];

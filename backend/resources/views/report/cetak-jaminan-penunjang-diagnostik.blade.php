...
<body ng-controller="cetakJaminanPenunjangDiagnostik" cellspacing="0">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0"  style="padding:  10px 10px 10px 40px; border:none; font-size:13px;">
        <tr style="text-align: center;">
            ...
            <td colspan="4" style="border:none">Bulukumba, @foreach($res['d'] as $item) @if($item->emrdfk == 32116150) {!! $item->value !!} @endif @endforeach</td>
        </tr>
        <tr style="text-align: center;">
            <td colspan="4" style="border:none"></td>
            <td style="border:none"></td>
        ...
        <tr style="text-align: center;">
            <td colspan="4" valign="bottom" style="border:none"></td>
            <td style="border:none"></td>
            <td colspan="4" valign="bottom" style="border:none">@foreach($res['d'] as $item) @if($item->emrdfk == 32116151) {!! $item->value !!} @endif @endforeach</td>
        </tr>

...
<body ng-controller="cetakSuketKematian">
    <table width="100%" style="table-layout:fixed;border:none">
        ...
        <tr style="text-align:center;border:none">
            <td colspan="7" style="border:none"><h1>DINAS KESEHATAN</h1></td>
            {{-- sesuaikan dengan colspan yang ada di text 1 --}}
        </tr>

        <tr style="text-align:center;border:none">
            <td colspan="7" style="border:none"><h2>UPT RSUD H. ANDI SULTHAN DAENG RADJA</h2></td>
        </tr>
        <tr style="text-align:center;border:none">

        ...
        <tbody>
            <tr>
                <td>
                    <table width="100%" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="8%" align="center" style="border:1px solid black;padding-bottom: 20px;border-top: 3px solid black;border-right: 3px solid black;background-color:black">
                                ...
                                <font style="font-size: 22pt;" color="white" >23</font>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" cellspacing="10" cellpadding="0" border="0" style="border: 3px solid black;padding-bottom: 20px;">
                        <tr>
                            <td width="20%"><font style="font-size: 12pt;" color="#000000;" >Tanggal / No Foto</font></td>
                            <td width="80%"><font style="font-size: 12pt;" color="#000000" >: {{ date('d-m-Y H:i', strtotime($item->tanggal)) }} / {{ $item->nofoto }} </font></td>
                        </tr>
                        <tr>
                            <td width="20%"><font style="font-size: 12pt;" color="#000000;" >Klinis</font></td>
                            <td width="80%"><font style="font-size: 12pt;" color="#000000" >: {{ $item->klinis }}</font></td>
                        </tr>
                        <tr>
                            <td width="20%"><font style="font-size: 12pt;" color="#000000;" >Status</font></td>
                            <td width="80%"><font style="font-size: 12pt;" color="#000000" >: {{ $item->statusradctscan }}</font></td>
                        </tr>
                        <tr>
                            <td width="20%"><font style="font-size: 12pt;" color="#000000;" >Dokter Pengirim</font></td>
                            <td width="80%"><font style="font-size: 12pt;" color="#000000" >: {{ $item->dokterpengirim == null ? $item->dokterluar : $item->dokterpengirim }}</font></td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" style="border-left: 3px solid black;border-right: 3px solid black;border-bottom: 3px solid black;padding-top:150px">
                        <tr>
                            {{-- <td align="right">
                                ...
                                <font style="text-align: right;padding-right: 50px; font-size:14pt">( {{ $item->dokterrad }} )</font><br>

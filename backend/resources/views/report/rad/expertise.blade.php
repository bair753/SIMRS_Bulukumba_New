                ...
                <td>
                    ...
                    <table width="100%" cellspacing="10" cellpadding="0" border="0" style="border: 3px solid black;padding-bottom: 20px;">
                        <tr>
                            ...
                            <td width="80%"><font style="font-size: 12pt;" color="#000000" >: {{ date('d-m-Y H:i', strtotime($raw->tanggal)) }} / {{ $raw->nofoto }} </font></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="80%"><font style="font-size: 12pt;" color="#000000" >: {{ $raw->dokterpengirim == null ? $raw->dokterluar : $raw->dokterpengirim }}</font></td>
                        </tr>
                    </table>

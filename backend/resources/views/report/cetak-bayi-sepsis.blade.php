...
<body ng-controller="cetakBayiSepsis">
    <table width='100%'>
        ...
        <tr class="noborder">
            ...
            <td colspan="5" class="border-lr" rowspan="2" style="font-size: xxx-large;text-align:center">65</td>
        </tr>
        <tr class="noborder">
		...
		<tr>
			...
			<td colspan="21" class="noborder">: @{{ item.obj[31100366] ? item.obj[31100366] : '_______________' }} kg</td>
			<td colspan="5" class="noborder">Usia Kehamilan</td>
			<td colspan="19" class="noborder">: @{{ item.obj[31100367] ? item.obj[31100367] : '_______________' }} minggu</td>
		</tr>
		<tr>
			<td colspan="49">
		...
		<tr>
			<td class="noborder" colspan="49">(Cek yang sesuai)</td>
		</tr>
		<tr class="border-bt">
				...
				<div class="p3">
					<section>
						<table width="100%" class="noborder">
							...
							<tr>
								<td colspan="22">@{{ item.obj[32104039] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}	Demam pada ibu > 38.0 <sup>0</sup>C</td>
								<td colspan="5" class="border-lr"></td>
							...
							<tr>
								<td colspan="22">@{{ item.obj[32104040] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}	Air ketuban berbau</td>
								<td colspan="5" class="border-lr"></td>
							...
							<tr>
								<td colspan="22">@{{ item.obj[32104041] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}	Nyeri tekan uterus</td>
							...
							<tr class="noborder">
								<td colspan="22">@{{ item.obj[32104042] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}	Leukosit &gt; 15.000</td>
							...
							<tr>
								...
								<td colspan="10" class="noborder">@{{ item.obj[31100820] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} 36.6>S>37.5</td>
								<td colspan="12" class="noborder">@{{ item.obj[31100821] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tampak lesu dan sakit</td>
								<td colspan="22" class="noborder">@{{ item.obj[31100822] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Tidak menghisap dengan baik</td>
							</tr>
							<tr>
								<td colspan="49" class="noborder">@{{ item.obj[31100823] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Jika ada apa pun factor risiko ibu atau setelah dilahirkan apa pun factor risiko neonatal dengan tanda sepsis, terus</td>
							</tr>
							<tr>
								<td class="noborder" colspan="49">Indikasi Lain: @{{ item.obj[31100824] ? item.obj[31100824] : '_______________' }}</td>
							</tr>
							<tr>
								<td class="noborder" colspan="8">Tanda Vital: @{{ item.obj[31100825] ? item.obj[31100825] : '____' }} <sup>0</sup>C</td>
								<td class="noborder" colspan="8">DJ: @{{ item.obj[31100826] ? item.obj[31100826] : '____' }} </td>
								<td class="noborder" colspan="8">RR: @{{ item.obj[31100827] ? item.obj[31100827] : '____' }} </td>
								<td class="noborder" colspan="12">Saturasi O<sub>2</sub> : @{{ item.obj[31100828] ? item.obj[31100828] : '____' }}</td>
		...
		<tr class="btp">
			<td colspan="27" class="br noborder">@{{ item.obj[31100829] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Keadaan riwayat atau tanda dehidrasi</td>
			<td class="noborder" colspan="22">Riwayat atau tanda dehidrasi</td>
		</tr>
		<tr class="noborder">
			<td class="br noborder" colspan="27">@{{ item.obj[31100830] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Beri bayi susu	menyusui 15 menit	NGT 10cc/kg = @{{ item.obj[31100831] ? item.obj[31100831] : '____' }} cc	       ATAU</td>
			<td class="noborder" colspan="11">@{{ item.obj[31100835] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}  &lt; 2 kali air seni/hari</td>
			<td class="noborder" colspan="11">@{{ item.obj[31100838] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}  Kurang minum</td>
		</tr>
		<tr class="noborder">
			<td colspan="27" class="br noborder">Bolus	NS @{{ item.obj[31100832] ? item.obj[31100832] : '____' }}	RL @{{ item.obj[31100833] ? item.obj[31100833] : '____' }}	10cc/kg = @{{ item.obj[31100834] ? item.obj[31100834] : '____' }} cc selama   30 m	1j*</td>
			<td colspan="11" class="noborder border-lt">@{{ item.obj[31100836] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}  Kurang Bergerak</td>
			<td colspan="11" class="noborder border-lt">@{{ item.obj[31100839] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}  Denyut jantung &gt;160</td>
		</tr>
		<tr class="btm">
			<td colspan="27" class="br noborder"><small>(*beri bolusperlahan pada bayi &lt; 4 bln untuk menghindari kelebihan cairan)</small></td>
			<td colspan="11" class="noborder border-lt">@{{ item.obj[31100837] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}  Laju pernapasan &gt; 65</td>
			<td colspan="11" class="noborder border-lt">@{{ item.obj[31100840] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }}  Suhu &gt;36.5</td>
		</tr>
		<tr class="btp">
			<td colspan="27" class="br noborder">
				@{{ item.obj[31100841] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Dapatkan kultur darah sebelum memberi antibiotik. Waktu : @{{ item.obj[31100842] ? item.obj[31100842] : '____' }}
			</td>
			<td colspan="22" class="noborder"></td>
		</tr>
		<tr>
			<td colspan="27" class="br noborder">
				@{{ item.obj[31100843] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Bayi ≤ 7 hari. Gentamicin1 5 mg/kg = @{{ item.obj[31100844] ? item.obj[31100844] : '.......' }} mg IV/IM tiap @{{ item.obj[31100845] ? item.obj[31100845] : '.......' }} jam +
			</td>
		</tr>
		<tr>
			<td colspan="27" class="br noborder">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;≤ 2.0kg: Ampicillin2 50 mg/kg q 12 jam = @{{ item.obj[31100846] ? item.obj[31100846] : '.......' }} mg IV/IM q 12 jam
			</td>
			<td colspan="22" class="text-center noborder"><strong>SELANG WAKTU PEMBERIAN GENTAMICIN 5mg/kg1</strong></td>
		</tr>
		<tr>
			<td colspan="27" class="br noborder">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;> 2.0kg: Ampicillin2 50 mg/kg q 8 jam = @{{ item.obj[31100847] ? item.obj[31100847] : '.......' }} mg IV/IM q 8 jam
			</td>
		</tr>
		<tr>
			<td colspan="27" class="br noborder">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bayi > 7 hari. Gentamicin1 5 mg/kg = @{{ item.obj[31100848] ? item.obj[31100848] : '.......' }} mg IV/IM tiap @{{ item.obj[31100849] ? item.obj[31100849] : '____' }} jam +
			</td>
		...
		<tr>
			<td colspan="27" class="br noborder">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt; 1.2kg: Ampicillin2 50 mg/kg tiap 12 jam = @{{ item.obj[31100848] ? item.obj[31100850] : '.......' }}mg IV/IM tiap 12 jam
			</td>
		...
		<tr>
			<td colspan="27" class="br noborder">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.2kg-2.0kg: Ampicillin2 50 mg/kg tiap 8 jam = @{{ item.obj[31100851] ? item.obj[31100851] : '.......' }} mg IV/IM tiap 8 jam
			</td>
			<td colspan="7" class="noborder text-center">> 1200 g</td>
		...
		<tr>
			<td colspan="27" class="br noborder">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;> 2kg: Ampicillin2 50 mg/kg tiap 6 jam = @{{ item.obj[31100852] ? item.obj[31100852] : '.......' }} mg IV/IM tiap 6 jam
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="27" class="br noborder">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Waktu dosis pertama diberikan : @{{ item.obj[32110721] ? item.obj[32110721] : '.......' }}
			</td>
			<td colspan="22" class="br noborder">
		...
		<tr>
			<td colspan="27" class="br noborder">
				@{{ item.obj[31100853] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Lain-lain : @{{ item.obj[31100854] ? item.obj[31100854] : '.......' }}
			</td>
			<td colspan="22" class="br noborder"></td>
		</tr>
		<tr class="btp">
			<td colspan="27" class="br noborder">
				@{{ item.obj[31100855] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Pertimbangkan LP bila < 2 bln dan 36.5 ≥ S ≥ 38.0 C dan demam tidak spesifik
			</td>
			<td colspan="22" class="br noborder"></td>
		</tr>
		<tr class="">
			<td colspan="27" class="br noborder">
				@{{ item.obj[31100856] ? item.obj[31100856] : '.......' }} WBC @{{ item.obj[31100857] ? item.obj[31100857] : '.......' }} RBC @{{ item.obj[31100858] ? item.obj[31100858] : '.......' }} Protein
			</td>
			<td colspan="22" class="br noborder">
		...
		<tr class="">
			<td colspan="27" class="br noborder">
				@{{ item.obj[31100859] ? '[&#10004;]' : '[&nbsp;&nbsp;&nbsp;]' }} Kalau WBC > 5 per microliter di CSF, obatkan bayi untuk meningitis
			</td>
			<td colspan="22" class="br noborder"></td>
		</tr>
		<tr class="">
			<td colspan="27" class="br noborder">
				Bayi ≤ 7 hari. Gentamicin1 5 mg/kg = @{{ item.obj[31100860] ? item.obj[31100860] : '.......' }} mg IV/IM tiap @{{ item.obj[31100861] ? item.obj[31100861] : '.......' }} jam +
			</td>
			<td colspan="22" class="br noborder"></td>
		</tr>
		<tr class="">
			<td colspan="27" class="br noborder">
				≤ 2.0kg: Ampicillin2 100 mg/kg q 12 jam = @{{ item.obj[31100862] ? item.obj[31100862] : '.......' }} mg IV/IM q 12 jam
			</td>
			<td colspan="22" class="br noborder"></td>
		</tr>
		<tr class="">
			<td colspan="27" class="br noborder">
				< 1.2kg: Ampicillin2 100 mg/kg q 8 jam = @{{ item.obj[31100863] ? item.obj[31100863] : '.......' }} mg IV/IM q 8 jam
			</td>
			<td colspan="22" class="br noborder"></td>
		</tr>
		<tr class="">
			<td colspan="27" class="br noborder">
				Bayi > 7 hari. Gentamicin1 5 mg/kg = @{{ item.obj[31100864] ? item.obj[31100864] : '.......' }} mg IV/IM tiap @{{ item.obj[31100865] ? item.obj[31100865] : '.......' }} jam +
			</td>
			<td colspan="22" class="br noborder"></td>
		</tr>
		<tr class="">
			<td colspan="27" class="br noborder">
				< 1.2kg: Ampicillin2 100 mg/kg tiap 12 jam = @{{ item.obj[31100866] ? item.obj[31100866] : '.......' }} mg IV/IM tiap 12 jam
			</td>
			<td colspan="22" class="br noborder"></td>
		</tr>
		<tr class="">
			<td colspan="27" class="br noborder">
				1.2kg-2.0kg: Ampicillin2 100 mg/kg tiap 8 jam = @{{ item.obj[31100867] ? item.obj[31100867] : '.......' }} mg IV/IM tiap 8 jam
			</td>
			<td colspan="22" class="br noborder"></td>
		</tr>
		<tr class="">
			<td colspan="27" class="br noborder">
				> 2kg: Ampicillin2 100 mg/kg tiap 6 jam = @{{ item.obj[31100868] ? item.obj[31100868] : '.......' }} mg IV/IM tiap 6 jam
			</td>
			<td colspan="22" class="br noborder"></td>
		</tr>
		<tr class="">

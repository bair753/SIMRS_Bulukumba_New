...
//            $PelPasien->jasa =  $item['jasacito'];
            ...
            if(isset( $item['istarifdetault'])){
                $PelPasien->istarifdetault =  $item['istarifdetault'];
            }
            if(isset( $item['hargadijamin'])){
                $PelPasien->hargadijamin =  $item['hargadijamin'];
            }
        ...
        //            $PelPasienPetugas->tglpelayanan = $itemPPP['tglpelayanan'];
            ...
            foreach ($item['komponenharga'] as $itemKomponen) {
                     ...
                     if(isset( $itemKomponen['hargadijamin'])){
                        $PelPasienDetail->hargadijamin =  $itemKomponen['hargadijamin'];
                     }
...
//        $dataLogin = $request->all();
        if(isset($request['idPenjamin']) && $request['idPenjamin'] !='null' && $request['idPenjamin']!=''

...
//            dd($query);
    ...
    public function getTTeuy($kdProfile)
    {
     
        $q = collect(DB::select("SELECT  case when kmr.kodesirs is not null then  kmr.kodesirs else  kl.kodesirs end AS id_tt,
        ...
        if($method == 'post'){
            ...
            foreach ($q as $v){
                $arr = array(
                    ...
                    "terpakai"=>  $v->terpakai ,
                    "terpakai_suspek"=> 0,
                    "terpakai_konfirmasi"=>  $v->covid == 1 ?  $v->terpakai : 0,
                    "prepare"=>  0 ,
                    "prepare_plan"=>  0,
                    "covid"=>   $v->covid ,
//                    "tower"=>  $v->qdepartemen ,

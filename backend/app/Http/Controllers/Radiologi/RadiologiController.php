...
//                    ->leftJOIN('lisorder as lis', 'lis.ono', '=', 'so.noorder')
                    ...
                    ->select('ps.nocm', 'ps.namapasien', 'jk.jeniskelamin', 'pp.tglpelayanan', 'pp.produkfk', 'pr.namaproduk',
                        ...
                        ,DB::raw("case when lis.no_lab is not null then 'Sudah Dikirim' else '-' end as statusbridging,'' as hr_norec , null as nourutrad") // syamsu tambahan
                    )
                    ->where('pp.kdprofile',$idProfile)
    ...
    public function saveHasilRadiologiUsg(Request $request) {
        ...
        try{
            ...
            if ($request['norec_usg'] == "") {
                ...
                $dataSO->status = 'Usg';
                $dataSO->statusrad =  $request['statusrad'];
                $dataSO->save();

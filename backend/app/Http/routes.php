...
//        Route::group(['prefix' => 'bridging'], function () {
           ...
           // }
            ...
            // Route::group(['prefix' => 'inacbg'], function () {
              ...
              Route::get('bridging/inacbg/get-daftar-pasien-klaim','Bridging\InaCbgController@getDaftarPasienKlaim');
        ...
        */
        ...
        // Route::group(['prefix' => 'laboratorium'], function () {
          ...
          Route::get('report/cetak-resep-dokter-dom','Report\ReportController@cetakResepDokterDom');
...
//            Route::get('registrasi/identifikasi-label', 'Registrasi\RegistrasiController@IdentifikasiLabel');
            ...
            // Route::group(['prefix' => 'daftar-registrasi'], function () {
              ...
              Route::get('registrasi/daftar-registrasi/get-daftar-echo-pasien', 'Registrasi\RegistrasiController@getDaftarEchoPasien');
...
//          Route::post('remunerasi/save-closing-ccs', 'Remunerasi\RemunerasiController@saveClosingCCStaff');
        ...
        // Route::group(['prefix' => 'sdm'], function () {
            /*GET*/
            //Mesin Presensi
            Route::get('sdm/get-log-presensi-pegawai-1', 'SDM\SumberDayaManusiaController@getLogPresensiPegawai1');
            Route::get('sdm/get-log-presensi-pegawai-2', 'SDM\SumberDayaManusiaController@getLogPresensiPegawai2');
            Route::get('sdm/get-log-presensi-pegawai-3', 'SDM\SumberDayaManusiaController@getLogPresensiPegawai3');
...
//                Route::get('sysadmin/menu/get-menu-dinamis', 'SysAdmin\ModulAplikasiController@getMenuDinamis');
            ...
            // Route::group(['prefix' => 'general'], function () {
                ...
                Route::get('sysadmin/master/get-admin', 'SysAdmin\Master\MasterController@getAdmin');
...
//                Route::get('get-tindakan', 'TataRekening\TindakanController@getTindakan');
        ...
        Route::get('report/cetak-hasil-lab-all-dom','Report\ReportController@cetakHasilLabAllDOM');
        ...
        Route::get('report/cetak-persetujuan-tes-skrining', 'Report\ReportController@persetujuanTesSkrining');
        Route::get('report/cetak-penolakan-tes-skrining', 'Report\ReportController@penolakanTesSkrining');
        ...
        Route::get('report/cetak-lembar-penggunaan-ventilator', 'Report\ReportController@lembarPenggunaanVentilator');
        Route::get('report/cetak-jadwal-tindakan-hemodialisa', 'Report\ReportController@jadwalTindakanHemodialisa');
        Route::get('report/cetak-jaminan-penunjang-diagnostik', 'Report\ReportController@jaminanPenunjangDiagnostik');
        Route::get('report/cetak-rinc-billing', 'Report\ReportController@cetakRincBilling');
        Route::get('report/cetak-surat-keterangan-kontrol', 'Report\ReportController@suratKeteranganKontrol');

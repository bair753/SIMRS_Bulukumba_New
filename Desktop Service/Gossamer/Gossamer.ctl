...
Begin VB.UserControl Gossamer 
   ...
   Begin DesktopService.GossClient gcClients 
      Index           =   0
      Left            =   0
      Top             =   0
      _extentx        =   741
...
Private Sub UserControl_Initialize()
    mServerHeader = "Server:@epics" & GOSS_VERSION_MAJOR & "." & GOSS_VERSION_MINOR _
                  & vbCrLf _
                  & "X-Powered-By:vb6 is the best" _
                  & vbCrLf _
                  & "X-MESSAGE: RSD MAGUSADA" _
                  & vbCrLf _
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    Port = PropBag.ReadProperty("Port", 1237)
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    PropBag.WriteProperty "Port", Port, 1237

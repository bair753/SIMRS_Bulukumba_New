...
Begin VB.Form FrmViewerLaporanNew3 
   ClientHeight    =   7050
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5850
   Icon            =   "FrmViewerLaporanNew3.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7050
   ScaleWidth      =   5850
   ...
   End
End
Attribute VB_Name = "FrmViewerLaporanNew3"
...
Dim Report As New crsuratpengambilan
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set FrmViewerLaporanNew3 = Nothing
End Sub

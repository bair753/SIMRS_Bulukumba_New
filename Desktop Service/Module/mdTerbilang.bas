...
Public Function TerbilangNotCurrency(InputCurrency As String, Optional MataUang As String = "") As String
 Dim strInput As String
 Dim strBilangan As String
 Dim strPecahan As String
   On Error GoTo Pesan
 ...
 ' strBilangan = Right(strInput, InStr(1, strInput, _
  ...
  If CLng(Trim(strPecahan)) > 99 Then
    ...
    If CLng(Trim(strPecahan)) = 0 Then
    TerbilangNotCurrency = (KonversiBilangan(strBilangan) & MataUang & " " & KonversiBilangan(strPecahan))
 Else
  TerbilangNotCurrency = (KonversiBilangan(strBilangan) & MataUang & " " & KonversiBilangan(strPecahan) & "")
    End If
  Else
    TerbilangNotCurrency = (KonversiBilangan(strBilangan) & "koma " & KonversiPecahan(strPecahan))
  End If
  
 Else
    TerbilangNotCurrency = (KonversiBilangan(strInput))
  End If
 Exit Function
Pesan:
  TerbilangNotCurrency = "(maksimal 15 digit)"
End Function

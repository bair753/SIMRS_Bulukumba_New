...
Begin VB.Form frmCetakLabelFarmasi 
   ...
   ClientTop       =   345
   ClientWidth     =   5775
   Icon            =   "frmCetakLabelFarmasi.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7170
   ScaleWidth      =   5775
...
Dim Report As New Cr_cetakLabelObatE
'Dim ii As Integer
...
Set Report = New Cr_cetakLabelObatE
    strSQL = "select ps.nocm, ps.namapasien, ps.tgllahir, sr.noresep, sr.tglresep, pr.namaproduk, pp.aturanpakai,pp.rke, " & _
            "case when alm.alamatlengkap is null then '-' else alm.alamatlengkap end as alamat,ps.notelepon " & _
            ...
            str1 & _
            ""
    strSQL = strSQL & " union all select distinct ps.nocm,ps.namapasien, ps.tgllahir, sr.noresep, sr.tglresep,'Racikan' as namaproduk, pp.aturanpakai,pp.rke, " & _
            "case when alm.alamatlengkap is null then '-' else alm.alamatlengkap end as alamat,ps.notelepon " & _
...
errLoad:
End Sub
Public Sub CetakLabelFarmasiCeklis(norec As String, ProdukFk As String, view As String, User As String)
'On Error GoTo errLoad
'On Error Resume Next
    Dim str1, str2 As String

...
Begin VB.Form frmLaporanJurnalRev 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5790
   Icon            =   "frmLaporanJurnalRev.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5790
   ...
   End
End
Attribute VB_Name = "frmLaporanJurnalRev"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crLaporanJurnalRev
...
Set Report = New crLaporanJurnalRev
    ...
    strSQL = "select pjd.objectaccountfk as accountid, coa.noaccount, " & _
             "coa.namaaccount, " & _
             "sum(pjd.hargasatuand) as hargasatuand,sum(pjd.hargasatuank) as hargasatuank, '' as keteranganlainnya, " & _
...
'            .usKeterangan.SetUnboundFieldSource ("{ado.keterangan}")
            ...
            .ucDebet.SetUnboundFieldSource ("{ado.hargasatuand}")
            .ucKredit.SetUnboundFieldSource ("{ado.hargasatuank}")

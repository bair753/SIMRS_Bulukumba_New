...
Begin VB.Form frmCRLaporanPenerimaanRemun 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmLaporanPenerimaanRemun.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCRLaporanPenerimaanRemun"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crLaporanPenerimaanRemun
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCRLaporanPenerimaanRemun = Nothing
End Sub
...
Set Report = New crLaporanPenerimaanRemun
...
'             " and to_char( pd.tglregistrasi,'ID')::INTEGER < 6 and (date_part('hour', pd.tglregistrasi) < 7 or  date_part('hour', pd.tglregistrasi) > 12) " & _

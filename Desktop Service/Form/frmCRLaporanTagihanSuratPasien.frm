...
Begin VB.Form frmCRLaporanTagihanSuratPasien 
   ...
   ClientTop       =   345
   ClientWidth     =   6330
   Icon            =   "frmCRLaporanTagihanSuratPasien.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   6705
   ScaleWidth      =   6330
...
Dim adocmd As New ADODB.Command
    ...
    StrFilter = " where pd.noregistrasi = '" & Noregistrasi & "' "
    ...
    With Report
        If Not RS2.EOF Then
            ...
            .txtTelp.SetText strNoTlpn
            .txtFax.SetText strNoFax
            .txtWebEmail.SetText strEmail & ", " & strWebSite
            .txtNamaKota.SetText strNamaKota & ", "
            .txtWebEmail1.SetText strEmail

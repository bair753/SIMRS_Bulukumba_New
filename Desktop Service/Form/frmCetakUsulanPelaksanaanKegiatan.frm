...
bolStrukResep = True
        ...
        With ReportResep
            ...
            strSQL = "select " & _
                    ...
                    "sp.keterangankeperluan,sp.keteranganorder,ru.namaruangan as ruangan,ru.id as ruid,ru2.namaruangan as ruangantujuan, " & _
                    "op.hargasatuan,op.hargadiscount,ru2.id as ruidtujuan,sp.totalhargasatuan,sp.Status,pr.kdproduk,pr.namaproduk,ss.satuanstandar, " & _
                    "op.qtyproduk,op.qtyprodukkonfirmasi,case when op.hargappn is null then 0 else op.hargappn end as hargappn,(op.qtyproduk*(op.hargasatuan)) as total, " & _
                    "case when op.hargappn is null then 0 else op.hargappn end as hargappn,(op.qtyprodukkonfirmasi*(op.hargasatuan)) as totalkonfirmasi, " & _
                    "op.tglpelayananakhir as tglkebutuhan,op.deskripsiprodukquo as spesifikasi,pr.id as prid,sv.noverifikasi as noconfirm, " & _
                    "sv.tglverifikasi as tglconfirm,sv.objectpegawaipjawabfk as pegawaiupkid,pg1.namalengkap as pegawaiupk,pg1.nippns " & _
            ...
            .database.AddADOCommand CN_String, adoReport
             ...
             .unQtyKon.SetUnboundFieldSource ("{Ado.qtyprodukkonfirmasi}")

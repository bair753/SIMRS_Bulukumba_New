...
Public Sub CetakLaporanPenerimaanKasir(idKasir As String, tglAwal As String, tglAkhir As String, idPegawai As String, idDept As String, idRuangan As String, idDokter As String, view As String)

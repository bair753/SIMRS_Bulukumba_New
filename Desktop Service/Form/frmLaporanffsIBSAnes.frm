...
Begin VB.Form frmLaporanffsIBSAnes 
   Caption         =   "Medifirst2000"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmLaporanffsIBSAnes.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmLaporanffsIBSAnes"
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmLaporanffsIBSAnes = Nothing
End Sub
...
Set Report = New crLaporanffsIBS
    strSQL = "select *, " & SQLdateLibur & "  case when hari='Saturday ' then 'Sabtu' when hari='Sunday   ' then 'Minggu' when hari='Monday   ' then 'Senin' when hari='Tuesday  ' then 'Selasa' when hari='Wednesday' then 'Rabu' when hari='Thursday ' then 'Kamis' when hari='Friday   ' then 'Jumat' " & STREND & "  end as harihari from ( " & _
            ...
            "Where  objectjenispetugaspefk = 6  and ru.objectdepartemenfk=25  " & dokter & idRuangan & idKelompokPasien & "" & _

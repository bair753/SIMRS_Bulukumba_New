...
Begin VB.Form frmExpertiseLaboratoriumNonPapSmear 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ...
   Icon            =   "frmExpertiseLaboratoriumNonPapSmear.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmExpertiseLaboratoriumNonPapSmear"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crHasilLabNonPapSmear
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmExpertiseLaboratoriumNonPapSmear = Nothing
End Sub
...
End If
    ...
    With Report
            strSQL = " SELECT pd.noregistrasi,pm.nocm,pm.namapasien,jk.jeniskelamin || '/ ' || EXTRACT(YEAR FROM AGE(pd.tglregistrasi, pm.tgllahir)) || ' Thn ' " & _
                     ...
                     "  to_char(sbm.tglsbm, 'DD-MM-YYYY HH24:MI:SS') AS tglbayar,pg.namalengkap,CASE WHEN hpl.diagnosaklinik IS NULL THEN '' ELSE hpl.diagnosaklinik END AS diagnosaklinik, " & _
                     ...
                     " CASE WHEN hpl.anjuran IS NULL THEN '' ELSE hpl.anjuran END AS anjuran,pg1.namalengkap AS namapenanggungjawab,pg1.nippns,hpl.nomorpa " & _
            ...
            If RS2.EOF = False Then
               'HEADER
                ...
                .txtJudul.SetText "HASIL PEMERIKSAAN SITOLOGI"
               'HEADER
               'BODY
        ...
        If view = "false" Then
            strPrinter1 = GetTxt("Setting.ini", "Printer", "HasilLaboratoriumSistologi")

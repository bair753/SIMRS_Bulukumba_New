...
Begin VB.Form frmCetakEmrAsesmenAwalKeperawatanGadar 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrAsesmenAwalKeperawatanGadar.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrAsesmenAwalKeperawatanGadar"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrAsesmenAwalKeperawatanGadar
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrAsesmenAwalKeperawatanGadar = Nothing
End Sub
...
Set Report = New crEmrAsesmenAwalKeperawatanGadar

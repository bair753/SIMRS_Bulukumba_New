...
Begin VB.Form frmCetakEmrTriasePengkajianIGD 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrTriasePengkajianIGD.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrTriasePengkajianIGD"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrTriasePengkajianIGD
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrTriasePengkajianIGD = Nothing
End Sub
...
Set Report = New crEmrTriasePengkajianIGD
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.value ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (21045) Order by emrdp.emrdfk ASC "
    ...
    With Report
        ...
        If rs.RecordCount <> 0 Then
              ...
              For i = 0 To rs.RecordCount - 1
                ...
                If rs!emrdfk >= 21003565 And rs!emrdfk <= 21003570 Then
                ...
                ElseIf rs("type") = "datetime" Then
                    If rs!emrdfk = 21003521 Then
                        .Section8.ReportObjects("txt" & rs!emrdfk).SetText Format(Left(rs!Value, 10), "dd-MM-yyyy")
                        .txtJamDatang.SetText Format(Mid(rs!Value, 12, 8), "HH:mm:ss")
                    Else
                        .Section8.ReportObjects("txt" & rs!emrdfk).SetText Format(Left(rs!Value, 10), "dd-MM-yyyy")
                    End If

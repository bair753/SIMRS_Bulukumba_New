...
Begin VB.Form frmCetakEmrSkriningPasien 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrSkriningPasien.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrSkriningPasien"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrSkriningPasien
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrSkriningPasien = Nothing
End Sub
...
Set Report = New crEmrSkriningPasien
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.value ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (21028) Order by emrdp.emrdfk ASC "
        ...
        If rs.RecordCount <> 0 Then
              ...
              For i = 0 To rs.RecordCount - 1
                ...
                ElseIf rs("type") = "datetime" Then
                    ...
                    .txtJamKedatangan.SetText Format(Mid(rs!Value, 12, 8), "HH:mm:ss")

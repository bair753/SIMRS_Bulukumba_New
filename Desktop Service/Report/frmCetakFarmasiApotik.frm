...
bolStrukResep = True
        ...
        With ReportResep
            ...
            If Left(strNores, 10) = "NonLayanan" Then
                ...
                strSQL = "select top 1 sp.nostruk as noresep, '-' as noregistrasi,sp.nostruk_intern as nocm,tglfaktur as tglregistrasi," & _
            ...
            Else
                strSQL = "SELECT top 1 pd.noregistrasi, ps.nocm,'=' as umur, " & _
                       ...
                       " ((pp.jumlah * pp.hargasatuan ) - (CASE when pp.hargadiscount is null then 0 ELSE  pp.hargadiscount * pp.jumlah end))+case when pp.jasa is null then 0 else pp.jasa end as totalbiaya FROM pelayananpasien_t AS pp " & _

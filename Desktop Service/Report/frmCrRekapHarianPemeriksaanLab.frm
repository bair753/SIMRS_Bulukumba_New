...
Begin VB.Form frmCRRekapHarianPemeriksaanLab 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   ControlBox      =   0   'False
   Icon            =   "frmCrRekapHarianPemeriksaanLab.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCRRekapHarianPemeriksaanLab"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crRekapHarianPemeriksaanLab
...
Public Sub Cetak(idKasir As String, tglAwal As String, tglAkhir As String, NamaKasir As String, view As String)
'On Error GoTo errLoad
'On Error Resume Next

Set frmCRRekapHarianPemeriksaanLab = Nothing
...
Set Report = New crRekapHarianPemeriksaanLab
    strSQL = "SELECT " & _
                " produk_m.id, " & _
                ...
                " Where " & _
                " pelayananpasien_t.tglpelayanan BETWEEN '" & tglAwal & "' and '" & tglAkhir & "' " & _
                " and antrianpasiendiperiksa_t.objectruanganfk='276' and strukpelayanan_t.statusenabled is null" & _
                " Group By " & _

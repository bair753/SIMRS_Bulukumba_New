...
Begin VB.Form frmCRCetakLaporanPasienPulangTemp 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCRCetakLaporanPasienPulangTemp.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCRCetakLaporanPasienPulangTemp"
...
Public Sub CetakLaporanPasienPulang(tglAwal As String, tglAkhir As String, idlaporan As String, strIdDepartemen As String, strIdRuangan As String, _

...
Begin VB.Form frmCetakEmrFormb 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrFormb.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrFormb"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrFormb
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrObservasiFisik = Nothing
End Sub
...
Set Report = New crEmrFormb
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " Where emrdp.statusenabled = 1 and emrd.statusenabled = 1 and emrd.satuan = 1" & _
                " AND emrd.satuan = 1 " & _

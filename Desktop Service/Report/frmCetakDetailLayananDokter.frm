...
Public Sub CetakDetailLayanan(ID As String, tglAwal As String, tglAkhir As String, idlaporan As String, strIdDepartemen As String, strIdRuangan As String, _
                                        strIdKelompokPasien As String, Layanan As String, strIdDokter As String)
...
'            "left join departemen_m as dp on dp.id = ru.objectdepartemenfk " & orderby
    strSQL = "select * from templaporanlayanan_t where idlaplayanan = '" & idlaporan & "'"
    ...
    With Report
        ...
        'If Not RS.EOF Then
            ...
            .udTanggal.SetUnboundFieldSource ("{ado.tgllayanan}")
            .usNoCm.SetUnboundFieldSource ("{ado.nocm}")
            .usPasien.SetUnboundFieldSource ("{ado.namapasien}")
            .usRuanganPelayanan.SetUnboundFieldSource ("{ado.unit}")
            ...
            .usInap.SetUnboundFieldSource ("{ado.statusinap}")
            .usPenjamin.SetUnboundFieldSource ("{ado.rekanan}")
            .usLayanan.SetUnboundFieldSource ("{ado.layanan}")
            .ucHargaLayanan.SetUnboundFieldSource ("{ado.tarif}")
            .unJumlah.SetUnboundFieldSource ("{ado.jumlah}")
            .usPaid.SetUnboundFieldSource ("{ado.paid}")

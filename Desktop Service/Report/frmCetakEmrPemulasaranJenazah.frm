...
Begin VB.Form frmCetakEmrPemulasaranJenazah 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrPemulasaranJenazah.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrPemulasaranJenazah"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrPemulasaranJenazah
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrPemulasaranJenazah = Nothing
End Sub
...
Set Report = New crEmrPemulasaranJenazah
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.value ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (21074) Order by emrdp.emrdfk ASC "
    ...
    strSQL = "select ps.nocm,ps.namapasien,to_char(ps.tgllahir,'dd - MM - yyyy') as tgllahir,CASE WHEN ps.objectjeniskelaminfk=1 then 'L' else 'P' END as jk, " & _
            "EXTRACT(YEAR FROM AGE(pd.tglregistrasi, ps.tgllahir)) || ' Th ' as umur," & _
            " al.alamatlengkap || ', ' || al.kecamatan || ', ' || al.kotakabupaten as alamatlengkap," & _
            " rm.namaruangan, pd.tglregistrasi, pd.tglpulang, ps.nobpjs " & _
    ...
    With Report
        ...
        .usNoBPJS.SetUnboundFieldSource ("{Ado.nobpjs}")
        ...
        .usAsalRuangan.SetUnboundFieldSource ("{Ado.namaruangan}")

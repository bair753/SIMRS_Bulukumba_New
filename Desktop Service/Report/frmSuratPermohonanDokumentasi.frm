...
Begin VB.Form frmSurafrmSuratPermohonanDokumentasitPermohonanNarasumber 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmSuratPermohonanDokumentasi.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmSurafrmSuratPermohonanDokumentasitPermohonanNarasumber"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crSuratPermohonanDokumentasi
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmSurafrmSuratPermohonanDokumentasitPermohonanNarasumber = Nothing
End Sub
...
Set Report = New crSuratPermohonanDokumentasi
    ...
    strSQL = "select sp.tglpengajuan,upper(sp.namaplanning) as namaplanning,sp.deskripsiplanning as penyelenggara, " & _
             ...
             "pg2.namalengkap as kepalainstalasi,jb2.namajabatan as jabataninstalasi,pg2.nippns as nipkpi,na.id as narasumberfk,na.namalengkap as narasumber, " & _
             "sa.norec,sad.tglPelatihan,sad.sesikegiatan, sad.keterangan,sad.jpl " & _
             "from strukplanning_t as sp " & _
             "left join strukagenda_t as sa on sa.noplanningfk = sp.norec " & _
             "left join strukagendadetail_t as sad on sad.strukagendafk=sa.norec " & _
             ...
             "where sp.statusenabled = 1 and sp.noplanning = '" & noPlanning & "' " & _
             "GROUP BY sp.tglpengajuan,sp.namaplanning,sp.deskripsiplanning,sp.tempat, " & _
             "sp.keteranganlainnya,sp.tglsiklusawal,sp.tglsiklusakhir,pg2.namalengkap, " & _
             "jb2.namajabatan,pg2.nippns,na.id,na.namalengkap,sad.tglPelatihan,sad.sesikegiatan, " & _
             "sa.norec,sad.keterangan,sad.jpl"
...
'            .txtTglPrint2.SetText Format(strDate, "dd ") & bulan & Format(strDate, " yyyy")
            .txtHariTanggal.SetText hari & ", " & Format(rs!tglsiklusawal, "dd ") & bulan1 & Format(rs!tglsiklusawal, " yyyy")
            .udtWaktuMulai.SetUnboundFieldSource ("{ado.tglsiklusawal}")
...
'            .txtTglPelaksanaan.SetText tglPelatihan
            .udtWaktu.SetUnboundFieldSource ("{ado.tglPelatihan}")
            .usNorecAgenda.SetUnboundFieldSource ("{ado.norec}")
            .usKegiatan.SetUnboundFieldSource ("{ado.sesikegiatan}")

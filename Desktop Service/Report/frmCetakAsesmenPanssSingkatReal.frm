...
Begin VB.Form frmCetakAsesmenPanssSingkatReal 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakAsesmenPanssSingkatReal.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakAsesmenPanssSingkatReal"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrAsesmenPanssSingkatReal
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakAsesmenPanssSingkatReal = Nothing
End Sub
...
Set Report = New crEmrAsesmenPanssSingkatReal
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (142) and " & _
                " emrd.id  >= 10100 and emrd.id  <= 300002   Order by emrdp.emrdfk ASC "

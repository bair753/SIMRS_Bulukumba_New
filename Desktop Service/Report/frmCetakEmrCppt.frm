...
Begin VB.Form frmCetakEmrCppt 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrCppt.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrCppt"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrCpptRajal
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrCppt = Nothing
End Sub

Sub GetSection(Report As crEmrCpptRajal, namasection As String, typedata As String, emrdfk As String, Optional Value As String = "")
...
Set Report = New crEmrCpptRajal
    ...
    strSQL2 = " SELECT emrp.nocm, to_char(emrp.tglemr,'dd-MM-yyyy hh24:mi:ss') as tglemr, jp.jenispegawai, emrdp.emrpasienfk ,emrdp.value ,emrdp.emrdfk," & _

...
Begin VB.Form frmCetakEmrAsesmenAwalMedisRanap 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrAsesmenAwalMedisRanap.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrAsesmenAwalMedisRanap"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrAsesmenAwalMedisRanap
...
Private Sub Form_Load()
    ...
    Next
    cboPrinter.Text = GetTxt("Setting.ini", "Printer", "EMR-AssemenAwalMedisRawatInap")
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrAsesmenAwalMedisRanap = Nothing
End Sub
...
Set Report = New crEmrAsesmenAwalMedisRanap
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.value ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (21073) Order by emrdp.emrdfk ASC "
    ...
    With Report
        ...
        .usNocmRAM.SetUnboundFieldSource ("{Ado.nocm}")
        .usNamapasienRAM.SetUnboundFieldSource ("{Ado.namapasien}")
        .usJenisKelaminRAM.SetUnboundFieldSource ("{Ado.jk}")
        .udTgllahirRAM.SetUnboundFieldSource ("{Ado.tgllahir}")
        
        .txttglcetak.SetText Format(Now, "dd-MM-yyyy")
        .txtjamcetak.SetText Format(Now, "HH:mm:ss")
        ...
        If rs.RecordCount <> 0 Then
              ...
              For i = 0 To rs.RecordCount - 1
                If Not IsNull(rs!Value) Then
                    ...
                    If rs!emrdfk >= 21009502 And rs!emrdfk <= 21009509 Then
                        If rs!emrdfk = 21009502 Then
                    ...
                    Else
                        If rs("type") = "checkbox" Then
                            If rs!Value = "1" Then
                                .Section2.ReportObjects("txt" & rs!emrdfk).SetText "V"
                            End If
                        ElseIf rs("type") = "combobox" Then
                            arraySplit = Split(rs!Value, "~")
                            .Section2.ReportObjects("txt" & rs!emrdfk).SetText arraySplit(1)
                        
                        ElseIf rs("type") = "datetime" Then
                            .Section2.ReportObjects("txt" & rs!emrdfk).SetText Format(Left(rs!Value, 10), "dd-MM-yyyy")
                            .Section2.ReportObjects("txt" & rs!emrdfk & "1").SetText Format(Mid(rs!Value, 12, 8), "HH:mm:ss")
                            
                        ElseIf rs("type") = "time" Then
                            .Section2.ReportObjects("txt" & rs!emrdfk).SetText Format(Mid(rs!Value, 12, 8), "HH:mm:ss")
                        
                        ElseIf rs("type") = "textarea" Then
                            .Section2.ReportObjects("txt" & rs!emrdfk).SetText rs!Value
                        
                        ElseIf rs("type") = "checkboxtextbox" Then
                            .Section2.ReportObjects("txt" & rs!emrdfk & "1").SetText "V"
                            .Section2.ReportObjects("txt" & rs!emrdfk).SetText rs!Value
        ...
        End If
           ...
           If view = "false" Then
                ...
                strPrinter = GetTxt("Setting.ini", "Printer", "EMR-AssemenAwalMedisRawatInap")

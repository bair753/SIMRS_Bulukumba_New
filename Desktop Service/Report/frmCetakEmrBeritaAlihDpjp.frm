...
Begin VB.Form frmCetakEmrBeritaAlihDpjp 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrBeritaAlihDpjp.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrBeritaAlihDpjp"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrBeritaAlihDpjp
...
Set Report = New crEmrBeritaAlihDpjp
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (140) and " & _
                " emrd.id  >= 3426 and emrd.id  <= 3444   Order by emrdp.emrdfk ASC "

...
Begin VB.Form frmCetakEmrPanssSingkatReal 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrPanssSingkatReal.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrPanssSingkatReal"
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrPanssSingkatReal = Nothing
End Sub
...
Set Report = New crEmrAsesmenPanssSingkatReal
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " emrd.id  >= 10100 and emrd.id  emrd.id <=300002  Order by emrdp.emrdfk ASC "

...
Begin VB.Form frmCetakEmrSkriningMpp 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrSkriningMpp.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrSkriningMpp"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrSkriningMpp
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrSkriningMpp = Nothing
End Sub
...
Set Report = New crEmrSkriningMpp
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (143) and " & _
                " emrd.id  >= 10313 and emrd.id  <=102576 and emrd.id!=10340  Order by emrdp.emrdfk ASC "

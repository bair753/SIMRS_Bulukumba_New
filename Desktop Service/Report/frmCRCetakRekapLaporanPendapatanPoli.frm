...
Begin VB.Form frmCRCetakRekapLaporanPendapatanPoli 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCRCetakRekapLaporanPendapatanPoli.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCRCetakRekapLaporanPendapatanPoli"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report3 As New crRekapLaporanPendapatanPoli
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCRCetakRekapLaporanPendapatanPoli = Nothing
End Sub
...
Set Report3 = New crRekapLaporanPendapatanPoli
...
'    strFilter = strFilter & " and IdRuangan like '%" & strIdRuangan & "%' and IdDepartement like '%" & strIdDepartement & "%' and IdKelompokPasien like '%" & strIdKelompokPasien & "%' and IdDokter Like '%" & strIdDokter & "%'"
    If strIdDepartemen <> "" Then
        If strIdDepartemen = 18 Then
            StrFilter = StrFilter & " and dp.id <> 16 "
        Else
            If strIdDepartemen <> "" Then

...
Begin VB.Form frmExpertiseLaboratorium 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ...
   Icon            =   "frmExpertiseLaboratorium.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmExpertiseLaboratorium"
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmExpertiseLaboratorium = Nothing
End Sub

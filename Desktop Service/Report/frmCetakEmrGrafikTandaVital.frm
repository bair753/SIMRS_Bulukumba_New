...
Begin VB.Form frmCetakEmrGrafikTandaVital 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrGrafikTandaVital.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrGrafikTandaVital"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrGrafikTandaVital
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrGrafikTandaVital = Nothing
End Sub
...
'Set Report = New crEmrGrafikTandaVital
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (188) Order by emrdp.emrdfk ASC "

...
Begin VB.Form frmCetakSuratPermintaanRawatInap 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakSuratPermintaanRawatInap.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakSuratPermintaanRawatInap"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crSuratPermintaanRawatInap
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakSuratPermintaanRawatInap = Nothing
End Sub
...
Set Report = New crSuratPermintaanRawatInap
...
'                " emrd.caption,  emrd.nourut,emrd.reportdisplay,  emrd.kodeexternal AS kodeex, " & _
'                " emrd.satuan,emr.caption as namaform,emrd.type " & _
...
'                " Where emrdp.statusenabled = 1" & _
'                " AND emrp.nocm = '" & noCm & "' and emrp.norec='" & emr & "' " & _
'                " AND emr.id in (224) Order by emrd.nourut ASC "
...
'            If rs!nourut > 6 Then Exit For
            If rs("type") = "checkbox" Then
                .Section8.ReportObjects("tx" & rs!nourut).SetText "V"
            ElseIf rs("type") = "combobox" Then
                arraySplit = Split(rs!Value, "~")
                .Section8.ReportObjects("tx" & rs!nourut).SetText arraySplit(1)
            
            ElseIf rs("type") = "datetime" And rs!nourut <> 13 Then
                .Section8.ReportObjects("tx" & rs!nourut).SetText Format(Left(rs!Value, 10), "dd-MM-yyyy")
               
            ElseIf rs!nourut = 13 Then
                    .txtTglPrintJam.SetText Format(rs("value"), "dd-MM-yyyy HH:mm")
            Else
                If rs!nourut = 12 Then
                    .txt12.SetText "V"
                    .Section8.ReportObjects("tx" & rs!nourut).SetText rs!Value

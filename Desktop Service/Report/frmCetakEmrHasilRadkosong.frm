...
Begin VB.Form frmCetakEmrHasilRadkosong 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrHasilRadkosong.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrHasilRadkosong"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrHasilRadkosong
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrHasilRadkosong = Nothing
End Sub
...
Set Report = New crEmrHasilRadkosong
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (373) and " & _
                " emrd.id = 102506   Order by emrdp.emrdfk ASC "

...
Begin VB.Form frmCetakEmrHPPwisc 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrHPPWisc.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrHPPwisc"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrHPPwisc
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrHPPwisc = Nothing
End Sub
...
Set Report = New crEmrHPPwisc
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (326) and " & _
                " emrd.id  >= 101002 and emrd.id  <= 101012   Order by emrdp.emrdfk ASC "

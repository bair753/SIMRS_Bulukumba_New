...
Begin VB.Form frmCetakPemberianInformasi 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakPemberianInformasi.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakPemberianInformasi"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crSuratPemberianInformasi
...
Private Sub Form_Load()
    ...
    Next
    cboPrinter.Text = GetTxt("Setting.ini", "Printer", "EMR-PemberianInformasi")
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakPemberianInformasi = Nothing
End Sub
...
Set Report = New crSuratPemberianInformasi
...
'
                strPrinter = GetTxt("Setting.ini", "Printer", "EMR-PemberianInformasi")

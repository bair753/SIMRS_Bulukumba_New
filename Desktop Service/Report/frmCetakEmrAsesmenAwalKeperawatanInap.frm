...
Begin VB.Form frmCetakEmrAsesmenAwalKeperawatanInap 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrAsesmenAwalKeperawatanInap.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrAsesmenAwalKeperawatanInap"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrAsesmenAwalKeperawatanInap
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrAsesmenAwalKeperawatanInap = Nothing
End Sub
...
Set Report = New crEmrAsesmenAwalKeperawatanInap
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " Where emrdp.statusenabled = 1 and emrd.statusenabled = 1 and emrd.style =174" & _
                " AND emrp.nocm = '" & noCm & "' and emrp.norec='" & emr & "' " & _
                " AND emr.id in (174) and " & _
                " emrd.id  >= 6004 and emrd.id  <= 108797   Order by emrdp.emrdfk ASC "
        ...
        If rs.RecordCount <> 0 Then
              ...
              For i = 0 To rs.RecordCount - 1
                ...
                If rs("type") = "checkbox" Then
                        If rs("value") = "1" Then
                        .Section8.ReportObjects("txt" & rs!emrdfk).SetText "P"
                        End If
               ...
               ElseIf rs("type") = "datetime" Then
                ...
                ElseIf rs("type") = "time" Then
                    .Section8.ReportObjects("txt" & rs!emrdfk).SetText Format(Mid(rs!Value, 12, 8), "HH:mm")

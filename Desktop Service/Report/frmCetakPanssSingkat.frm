...
Begin VB.Form frmCetakPanssSingkat 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakPanssSingkat.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakPanssSingkat"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrAsesmenPanssSingkat
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakPanssSingkat = Nothing
End Sub
...
Set Report = New crEmrAsesmenPanssSingkat
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
               ...
               ' " emrd.id  >= 9063 and emrd.id  <= 9100 and emrd.id=300000  Order by emrdp.emrdfk ASC "
        ...
        If rs.RecordCount <> 0 Then
              ...
              For i = 0 To rs.RecordCount - 1
                ...
                If rs("type") = "checkbox" Then
                    If rs("value") = "1" Then
                        .Section8.ReportObjects("Text" & rs!nourut).SetText "P"
                        End If
                ...
                ElseIf rs("type") = "datetime" Then
                  If Not IsNull(rs("value")) Then
                    .Section8.ReportObjects("Text" & rs!nourut).SetText Format(Left(rs!Value, 10), "dd-MM-yyyy")
                  End If

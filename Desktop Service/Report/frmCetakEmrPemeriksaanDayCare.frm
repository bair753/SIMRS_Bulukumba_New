...
Begin VB.Form frmCetakEmrPemeriksaanDayCare 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrPemeriksaanDayCare.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrPemeriksaanDayCare"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrAsesmenPemeriksaanDayCare
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrPemeriksaanDayCare = Nothing
End Sub
...
Set Report = New crEmrAsesmenPemeriksaanDayCare
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (243) and " & _
                " emrd.id  >= 80061 and emrd.id  <= 80140   Order by emrdp.emrdfk ASC "

...
Begin VB.Form frmCetakEmrCatatanEdukasi 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrCatatanEdukasi.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrCatatanEdukasi"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrCatatanEdukasi
...
Private Sub Form_Load()
    ...
    Next
    cboPrinter.Text = GetTxt("Setting.ini", "Printer", "EMR-CatatanEdukasi")
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrCatatanEdukasi = Nothing
End Sub
...
Set Report = New crEmrCatatanEdukasi
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.value ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (21050) Order by emrdp.emrdfk ASC "
        ...
        If rs.RecordCount <> 0 Then
              ...
              For i = 0 To rs.RecordCount - 1
                If Not IsNull(rs!Value) Then
                    If rs!emrdfk >= 21007240 And rs!emrdfk <= 21007372 Then

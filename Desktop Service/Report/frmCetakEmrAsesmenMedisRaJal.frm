...
Begin VB.Form frmCetakEmrAsesmenMedisRaJal 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrAsesmenMedisRaJal.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrAsesmenMedisRaJal"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrAsesmenMedisRaJal
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrAsesmenMedisRaJal = Nothing
End Sub
...
Set Report = New crEmrAsesmenMedisRaJal
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (227) Order by emrdp.emrdfk ASC "

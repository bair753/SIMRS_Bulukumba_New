...
Begin VB.Form frmCetakSuratBarangMilikPasien 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakSuratBarangMilikPasien.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakSuratBarangMilikPasien"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crSuratBarangMilikPasien
...
Private Sub Form_Load()
    ...
    Next
    cboPrinter.Text = GetTxt("Setting.ini", "Printer", "EMR-SuratBarangMilikPasien")
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakSuratBarangMilikPasien = Nothing
End Sub
...
Set Report = New crSuratBarangMilikPasien
...
'            "where ps.statusenabled = 1 and ps.nocm = '" & noCm & "' "
    ...
    With Report
        ...
        .txtTglPrint.SetText Format(Now, "dd MMMM YYYY")
        .txtJam.SetText " Jam : " & Format(Now, "HH:mm")
        
            If view = "false" Then
                Dim strPrinter As String
'
                strPrinter = GetTxt("Setting.ini", "Printer", "EMR-SuratBarangMilikPasien")

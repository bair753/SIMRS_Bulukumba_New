...
Begin VB.Form frmCetakEmrHiv 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrHiv.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrHiv"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrHiv
...
Set Report = New crEmrHiv
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (127) and " & _
                " emrd.id  >= 3164 and emrd.id  <= 102504 Order by emrdp.emrdfk ASC "
        ...
        If rs.RecordCount <> 0 Then
              ...
              For i = 0 To rs.RecordCount - 1
                ...
                ElseIf rs("type") = "checkboxtextbox" Then
                    .Section8.ReportObjects("Text" & rs!emrdfk & "1").SetText "P"
                    .Section8.ReportObjects("Text" & rs!emrdfk).SetText rs!Value

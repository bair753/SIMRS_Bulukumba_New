...
Begin VB.Form frmCetakEmrSkorEwsDewasa 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrSkorEwsDewasa.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrSkorEwsDewasa"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrSkorEwsDewasa
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrSkorEwsDewasa = Nothing
End Sub

Public Sub Cetak(noCm As String, emr As String, id_emr As String, view As String)
...
'Set Report = New crEmrSkorEwsDewasa
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " AND emr.id in ('" & id_emr & "') Order by emrdp.emrdfk ASC "

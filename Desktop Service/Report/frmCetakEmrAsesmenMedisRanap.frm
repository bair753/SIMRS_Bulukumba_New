...
Begin VB.Form frmCetakEmrAsesmenMedisRanap 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrAsesmenMedisRanap.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrAsesmenMedisRanap"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrAsesmenMedisRanap
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrAsesmenMedisRanap = Nothing
End Sub
...
Set Report = New crEmrAsesmenMedisRanap
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (113) and " & _
                " emrd.id  >= 2917 and emrd.id  <= 7038 and emrd.id  != 2967    Order by emrdp.emrdfk ASC "

...
Begin VB.Form frmCetakEmrFormaNew 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrFormaNew.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrFormaNew"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrFormaNew
...
Set Report = New crEmrFormaNew
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " AND emr.id in (426) and " & _
                " emrd.id  >= 25115 and emrd.id  <= 110838 Order by emrdp.emrdfk ASC "
        ...
        If rs.RecordCount <> 0 Then
              ...
              For i = 0 To rs.RecordCount - 1
                ...
                If rs("type") = "checkbox" Then
                        If rs("value") = "1" Then
                        .Section8.ReportObjects("Text" & rs!emrdfk).SetText "P"
                        End If
                ...
                ElseIf rs("type") = "datetime" Then
                  If Not IsNull(rs("value")) Then
                    .Section8.ReportObjects("Text" & rs!emrdfk).SetText Format(Left(rs!Value, 16), "dd-MM-yyyy HH:mm")
                  End If

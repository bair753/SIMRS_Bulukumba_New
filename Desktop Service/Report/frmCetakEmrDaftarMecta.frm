...
Begin VB.Form frmCetakEmrDaftarMecta 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrDaftarMecta.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrDaftarMecta"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrDaftarMecta
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrTotalcare = Nothing
End Sub
...
Set frmCetakEmrRestrain = Nothing
Dim adocmd As New ADODB.Command
Dim strFilter, strFilter1 As String

Set Report = New crEmrDaftarMecta
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.[value] ,emrdp.emrdfk," & _
                ...
                " Where emrdp.statusenabled = 1 and emrd.statusenabled = 1 and emrd.kodeexternal=1" & _
        ...
        If rs.RecordCount <> 0 Then
              ...
              For i = 0 To rs.RecordCount - 1
                ...
                ElseIf rs("type") = "checkboxtextbox" Then
                    .Section8.ReportObjects("text" & rs!nourut & "1").SetText "P"
                    .Section8.ReportObjects("text" & rs!nourut).SetText rs!Value

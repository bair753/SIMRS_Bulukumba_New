...
Begin VB.Form frmCetakEmrHasilRad 
   Caption         =   "Transmedic"
   ClientHeight    =   7005
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   5820
   Icon            =   "frmCetakEmrHasilRad.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7005
   ScaleWidth      =   5820
   ...
   End
End
Attribute VB_Name = "frmCetakEmrHasilRad"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim Report As New crEmrHasilRad
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmCetakEmrHasilRad = Nothing
End Sub

Public Sub Cetak(noCm As String, emr As String, view As String, idEmr As String)
...
Set Report = New crEmrHasilRad
    ...
    strSQL = "select ps.nocm,ps.namapasien,to_char(ps.tgllahir,'dd - MM - yyyy') as tgllahir,CASE WHEN ps.objectjeniskelaminfk=1 then 'L' else 'P' END as jk, " & _
            " al.alamatlengkap, al.kecamatan,al.kotakabupaten,ru.namaruangan as unit " & _
            ...
            " where ps.statusenabled = true and ps.nocm = '" & noCm & "' limit 1"
    ...
    strSQL2 = " SELECT emrp.nocm,emrdp.emrpasienfk ,emrdp.value ,emrdp.emrdfk," & _
                ...
                " Where emrdp.statusenabled = true and emrd.statusenabled = true" & _
                " AND emrp.nocm = '" & noCm & "' and emrp.norec='" & emr & "' " & _
                " AND emr.id = '" & idEmr & "' Order by emrdp.emrdfk ASC "
    ...
    With Report
        ...
        .usAlam.SetUnboundFieldSource ("{Ado.alamatlengkap}")
        .usUnit.SetUnboundFieldSource ("{Ado.unit}")
        ...
        If rs.RecordCount <> 0 Then
              ...
              For i = 0 To rs.RecordCount - 1
                ...
                If rs("type") = "checkbox" Then
                        .Section8.ReportObjects("Text" & rs!nourut).SetText "V"
                ...
                Else
                 .Section8.ReportObjects("Text" & rs!nourut).SetText arraySplit(1)
                ...
                ElseIf rs("type") = "datetime" Then
                  If Not IsNull(rs("value")) Then
                    .Section8.ReportObjects("Text" & rs!nourut).SetText Format(Left(rs!Value, 16), "dd-MM-yyyy HH:mm")
                  End If
                  
                  '  If rs("emrdfk") = 15250 Then
                 '    .Text15250.SetText Format(rs("value"), "dd-MM-yyyy")
                ...
                ElseIf rs("type") = "time" Then
                    .Section8.ReportObjects("Text" & rs!nourut).SetText Format(Mid(rs!Value, 12, 8), "HH:mm")
                
                ElseIf rs("type") = "textarea" Then
                    .Section8.ReportObjects("Text" & rs!nourut).SetText rs!Value
                
                ElseIf rs("type") = "checkboxtextbox" Then
                    .Section8.ReportObjects("Text" & rs!nourut & "1").SetText "V"
                    .Section8.ReportObjects("Text" & rs!nourut).SetText rs!Value
